...
package superlord.prehistoricfauna.world.feature.cretaceous.araucaria.small;
...
public class AraucariaSmallTree4 extends PHFAbstractTreeFeature<PHFTreeConfig> {

    public AraucariaSmallTree4(Function<Dynamic<?>, ? extends PHFTreeConfig> configIn) {
        super(configIn);
    }
