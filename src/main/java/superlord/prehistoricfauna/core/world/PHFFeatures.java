...
public class PHFFeatures {
    ...
    public static final Feature<PrehistoricGiantTreeFeatureConfig> METASEQUOIA_TREE = createFeature("metasequoia_tree", new MetasequoiaTreeGenerator(PrehistoricGiantTreeFeatureConfig::deserializeMetasequoia));
    public static final Feature<PrehistoricGiantTreeFeatureConfig> PROTOJUNIPER_TREE = createFeature("protojuniper_tree", new MetasequoiaTreeGenerator(PrehistoricGiantTreeFeatureConfig::deserializeProtojuniper));
    ...
    public static final Feature<AraucariaConfig> ARAUCARIA_FEATURE = createFeature("araucaria_feature", new AraucariaTreeGenerator(AraucariaConfig::deserialize));
    public static final Feature<AraucariaSmallConfig> ARAUCARIA_SMALL_TREE_FEATURE = createFeature("araucaria_small_tree_feature", new AraucariaSmallTreeGenerator(AraucariaSmallConfig::deserialize));
