...
public class PHFConfiguredFeatures {
	...
	public static final ConfiguredFeature<PHFTreeConfig, ?> PROTOJUNIPEROXYLON_TREE1 = createConfiguredFeature("proto_juniper_tree1", PHFFeatures.METASEQUOIA_TREE1.withConfiguration(new PHFTreeConfig.Builder().setTrunkBlock(BlockInit.PROTOJUNIPEROXYLON_LOG.getDefaultState()).setLeavesBlock(BlockInit.PROTOJUNIPEROXYLON_LEAVES).setMinHeight(44).setMaxHeight(56).build()));
	public static final ConfiguredFeature<PHFTreeConfig, ?> PROTOJUNIPEROXYLON_TREE2 = createConfiguredFeature("proto_juniper_tree2", PHFFeatures.METASEQUOIA_TREE2.withConfiguration(new PHFTreeConfig.Builder().setTrunkBlock(BlockInit.PROTOJUNIPEROXYLON_LOG.getDefaultState()).setLeavesBlock(BlockInit.PROTOJUNIPEROXYLON_LEAVES).setMinHeight(41).setMaxHeight(53).build()));
	...
	public static final ConfiguredFeature<?, ?> MOSS = createConfiguredFeature("moss", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.MOSS_CARPET.getDefaultState()), new SimpleBlockPlacer())).tries(64).func_227317_b_().build()).withPlacement(Placement.COUNT_HEIGHTMAP_DOUBLE.configure(new FrequencyConfig(80))));
	...
	public static final ConfiguredFeature<?, ?> OSMUNDA_DOUBLE = createConfiguredFeature("double_osmuda", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.TALL_OSMUNDA.getDefaultState()), new DoublePlantBlockPlacer())).tries(64).func_227317_b_().build()).withPlacement(Placement.COUNT_HEIGHTMAP_32.configure(new FrequencyConfig(20))));
	public static final ConfiguredFeature<?, ?> OSMUNDACAULIS = createConfiguredFeature("osmundacaulis", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.TALL_OSMUNDACAULIS.getDefaultState()), new DoublePlantBlockPlacer())).tries(64).func_227317_b_().build()).withPlacement(Placement.COUNT_HEIGHTMAP_32.configure(new FrequencyConfig(15))));
	public static final ConfiguredFeature<?, ?> OSMUNDACAULIS_SHORT = createConfiguredFeature("osmundacaulis_short", Feature.RANDOM_PATCH.withConfiguration((new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(BlockInit.OSMUNDACAULIS.getDefaultState()), new SimpleBlockPlacer())).tries(64).func_227317_b_().build()).withPlacement(Placement.COUNT_HEIGHTMAP_DOUBLE.configure(new FrequencyConfig(10))));
