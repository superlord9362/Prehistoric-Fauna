 ...
 */
@OnlyIn(Dist.CLIENT)
public class SaurosuchusSkeletonModel extends EntityModel<SaurosuchusSkeletonEntity> {
    ...
    public SaurosuchusSkeletonModel() {
        ...
        this.setRotateAngle(Arm_1, 0.0F, 0.03944444092862428F, 0.0F);
