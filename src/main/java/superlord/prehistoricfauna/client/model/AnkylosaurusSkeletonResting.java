 ...
 */
@OnlyIn(Dist.CLIENT)
public class AnkylosaurusSkeletonResting extends EntityModel<AnkylosaurusSkeletonEntity> {
    ...
    public AnkylosaurusSkeletonResting() {
        ...
        this.setRotateAngle(LeftThigh, -0.5473352640780661F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftArm, -0.9773843811168246F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail1, -0.19547687289441354F, 0.11728612207217244F, 0.0F);
        ...
        this.setRotateAngle(RightArm, -0.9773843811168246F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail2, -0.0781907508222411F, 0.0781907508222411F, 0.0F);
        this.RightFoot = new ModelRenderer(this, 6, 188);
        this.RightFoot.mirror = true;
        this.RightFoot.setRotationPoint(0.0F, 7.0F, 0.0F);
        this.RightFoot.addBox(-3.5F, -2.0F, -5.0F, 7.0F, 2.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightFoot, 0.9773843811168246F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightLeg, -0.4300491170387584F, 0.0F, 0.0F);
        ...
        this.Body.setRotationPoint(0.0F, 5.0F, 12.0F);
        ...
        this.setRotateAngle(LeftLeg, -0.4300491170387584F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightThigh, -0.5473352640780661F, 0.0F, 0.0F);
        ...
        this.LeftFoot.addBox(-3.5F, -2.0F, -5.0F, 7.0F, 2.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftFoot, 0.9773843811168246F, 0.0F, 0.0F);
