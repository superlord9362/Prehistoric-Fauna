 ...
 */
@OnlyIn(Dist.CLIENT)
public class SaurosuchusSkeletonActionRightModel extends EntityModel<SaurosuchusSkeletonEntity> {
    ...
    public SaurosuchusSkeletonActionRightModel() {
        ...
        this.Calf_1.addBox(-1.9F, -1.0F, -2.0F, 4.0F, 6.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Calf_1, 0.4300491170387584F, 0.0F, -0.0781907508222411F);
        ...
        this.setRotateAngle(Arm_1, -0.19547687289441354F, 0.0F, 0.3909537457888271F);
        ...
        this.setRotateAngle(Arm, -0.19547687289441354F, 0.0F, -0.3909537457888271F);
        ...
        this.Thigh.setRotationPoint(4.0F, 0.0F, 6.0F);
        this.Thigh.addBox(-2.0F, -2.0F, -2.0F, 5.0F, 12.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Thigh, -0.1563815016444822F, -0.27366763203903305F, 0.0F);
        ...
        this.setRotateAngle(Head, -0.0781907508222411F, -0.27366763203903305F, 0.0F);
        ...
        this.setRotateAngle(Neck, -0.11728612207217244F, -0.19547687289441354F, 0.0F);
        ...
        this.setRotateAngle(Tail, -0.1563815016444822F, 0.19547687289441354F, 0.0F);
        ...
        this.setRotateAngle(Foot, -0.23457224414434488F, 0.0F, 0.0781907508222411F);
        ...
        this.Thigh_1.setRotationPoint(-4.0F, 0.0F, 6.0F);
        this.Thigh_1.addBox(-3.0F, -2.0F, -2.0F, 5.0F, 12.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Thigh_1, -0.3909537457888271F, 0.35185837453889574F, 0.0F);
        this.Calf = new ModelRenderer(this, 20, 2);
        this.Calf.setRotationPoint(1.0F, 10.0F, 2.0F);
        this.Calf.addBox(-2.1F, -1.0F, -2.0F, 4.0F, 6.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Calf, 0.19547687289441354F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Foot_1, -0.19547687289441354F, -0.1563815016444822F, 0.03909537541112055F);
        ...
        this.setRotateAngle(Tail2, -0.0781907508222411F, 0.3127630032889644F, 0.0F);
