 ...
 */
@OnlyIn(Dist.CLIENT)
public class TyrannosaurusrexskeletonActionRightModel extends EntityModel<TyrannosaurusSkeletonEntity> {
    ...
    public TyrannosaurusrexskeletonActionRightModel() {
        ...
        this.setRotateAngle(LeftFeet, -0.0781907508222411F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightFeet, -0.0781907508222411F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightLeg2, -0.1563815016444822F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail2, 0.0F, 0.27366763203903305F, 0.0F);
        ...
        this.setRotateAngle(Jaw1, 0.4300491170387584F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail1, -0.16283921787949038F, 0.1563815016444822F, 0.0F);
        this.RightLeg1 = new ModelRenderer(this, 152, 126);
        this.RightLeg1.setRotationPoint(-6.0F, 6.0F, 3.0F);
        this.RightLeg1.addBox(-7.0F, -6.0F, -9.0F, 10.0F, 30.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightLeg1, 0.0781907508222411F, 0.0F, 0.0F);
        this.Body1 = new ModelRenderer(this, 0, 0);
        this.Body1.setRotationPoint(0.0F, -29.0F, 0.0F);
        this.Body1.addBox(-7.5F, -7.0F, -16.0F, 15.0F, 33.0F, 33.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Body1, 0.1563815016444822F, 0.0F, 0.0F);
        this.LeftLeg1 = new ModelRenderer(this, 152, 126);
        this.LeftLeg1.mirror = true;
        this.LeftLeg1.setRotationPoint(6.0F, 4.0F, 3.0F);
        this.LeftLeg1.addBox(-3.0F, -6.0F, -9.0F, 10.0F, 30.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftLeg1, -0.5864306020384839F, -0.19547687289441354F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.35185837453889574F, -0.4300491170387584F, 0.0F);
