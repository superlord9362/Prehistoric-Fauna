	...
	public void setupAnim(Edmontosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -20, -15);
				this.LeftThigh.y = Mth.lerp(sleepProgress, -20, -15);
				...
				this.LeftFoot.z = Mth.lerp(sleepProgress, 0, 1F);
				this.RightFoot.z = Mth.lerp(sleepProgress, 0, 1F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -15, -20);
				this.LeftThigh.y = Mth.lerp(sleepProgress, -15, -20);
				this.LeftArm.y = Mth.lerp(sleepProgress, 18, 14);
				this.RightArm.y = Mth.lerp(sleepProgress, 18, 14);
				this.LeftLeg.y = Mth.lerp(sleepProgress, 17.9F, 22F);
				this.RightLeg.y = Mth.lerp(sleepProgress, 17.9F, 22F);
				this.LeftFoot.z = Mth.lerp(sleepProgress, 1, 0F);
				this.RightFoot.z = Mth.lerp(sleepProgress, 1, 0F);
				this.Tail1.z = Mth.lerp(sleepProgress, 33, 39);
				this.Neck.y = Mth.lerp(sleepProgress, -1.5F, -4F);
