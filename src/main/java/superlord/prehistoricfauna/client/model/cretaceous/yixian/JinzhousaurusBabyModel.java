...
public class JinzhousaurusBabyModel extends EntityModel<Jinzhousaurus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -4.0F, -8.5F, 6.0F, 7.0F, 11.0F, new CubeDeformation(0.0F))
				.texOffs(18, 24).addBox(0.0F, -5.0F, -7.5F, 0.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.0F, 3.5F));
		...
		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(23, 1).mirror().addBox(0.0F, 5.0F, -2.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 1.0F, -6.5F));
		...
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(23, 1).addBox(0.0F, 5.0F, -2.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 1.0F, -6.5F));
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(2, 18).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(0, 24).addBox(0.0F, -2.0F, 1.0F, 0.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 2.5F));
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(23, 1).addBox(-1.5F, -2.0F, -5.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
				.texOffs(0, 7).addBox(0.0F, -3.0F, -4.0F, 0.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, -8.5F));
		...
		PartDefinition LeftThigh = partdefinition.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(0, 18).mirror().addBox(-1.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 16.0F, 3.0F));
		...
		PartDefinition RightThigh = partdefinition.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(0, 18).addBox(-2.0F, -2.0F, -2.0F, 3.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 16.0F, 3.0F));
	...
	public void setupAnim(Jinzhousaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 16, 19.7F);
				...
				this.LeftThigh.y = Mth.lerp(sleepProgress, 16, 19.7F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 20, 16F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 19.7F, 16F);
				...
				this.LeftThigh.y = Mth.lerp(sleepProgress, 19.7F, 16);
				...
				if (entity.isBipedal()) {
					if (bipedalProgress != 0 && entity.getEntityData().get(Jinzhousaurus.BIPEDAL_TICK) > 0) {
						this.Body.xRot = Mth.lerp(bipedalProgress, 0, -0.3F);
						this.LeftArm.xRot = Mth.lerp(bipedalProgress, 0, 0.5F);
						this.RightArm.xRot = Mth.lerp(bipedalProgress, 0, 0.5F);
						this.Tail.xRot = Mth.lerp(bipedalProgress, (-Math.abs(-0.05F * Mth.sin(0.1F * ageInTicks / 5))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount - 0.15F), 0.3F);
						this.Neck.xRot = Mth.lerp(bipedalProgress, (Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 3))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount + 0.15F), 0.3F);
					} else {
						crouchPose();
						this.Tail.xRot = (-Math.abs(-0.05F * Mth.sin(0.1F * ageInTicks / 5))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount + 0.3F);
						this.Neck.xRot = (Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 3))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount + 0.3F);
					}
					...
					if (bipedalProgress != 0 && entity.getEntityData().get(Scelidosaurus.BIPEDAL_TICK) > 0) {
						...
						this.LeftArm.xRot = Mth.lerp(bipedalProgress, 0.5F, 0);
						this.RightArm.xRot = Mth.lerp(bipedalProgress, 0.5F, 0);
						this.Tail.xRot = Mth.lerp(bipedalProgress, 0.3F, (-Math.abs(-0.05F * Mth.sin(0.1F * ageInTicks / 5))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount - 0.15F));
						this.Neck.xRot = Mth.lerp(bipedalProgress, 0.3F, (Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 3))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount + 0.15F));
						this.RightThigh.xRot = Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.4F * limbSwingAmount + attackProgress * (float) Math.toRadians(7F);
						this.RightLeg.xRot = Mth.cos(limbSwing * speed * 0.3F) * degree * 0.3F * limbSwingAmount;
						this.LeftThigh.xRot = Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * -0.4F * limbSwingAmount + attackProgress * (float) Math.toRadians(7F);
						this.LeftLeg.xRot = Mth.cos(limbSwing * speed * 0.3F) * degree * -0.3F * limbSwingAmount;
