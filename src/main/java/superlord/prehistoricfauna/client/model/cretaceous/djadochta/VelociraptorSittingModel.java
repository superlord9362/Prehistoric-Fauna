 ...
 */
@OnlyIn(Dist.CLIENT)
public class VelociraptorSittingModel extends EntityModel<VelociraptorEntity> {
    ...
    public VelociraptorSittingModel() {
        ...
        this.Thighright.setRotationPoint(-0.5F, 21.0F, 2.0F);
        this.Thighright.addBox(-2.0F, -1.0F, -1.0F, 2.0F, 5.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Thighright, -0.6981317007977318F, 0.0F, 0.0F);
        this.Thighleft = new ModelRenderer(this, 46, 0);
        this.Thighleft.setRotationPoint(0.5F, 21.0F, 2.0F);
        this.Thighleft.addBox(0.0F, -1.0F, -1.0F, 2.0F, 5.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Thighleft, -0.6981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Wingleft, 0.4363323129985824F, 0.0F, -1.0471975511965976F);
        ...
        this.setRotateAngle(Wingright, 0.4363323129985824F, 0.0F, 1.0471975511965976F);
