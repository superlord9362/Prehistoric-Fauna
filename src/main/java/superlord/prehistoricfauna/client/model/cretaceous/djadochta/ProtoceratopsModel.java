...
public class ProtoceratopsModel extends EntityModel<Protoceratops> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TailFeathers = Tail.addOrReplaceChild("TailFeathers", CubeListBuilder.create().texOffs(24, 41).addBox(0.0F, -11.0F, 3.0F, 0.0F, 9.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void setupAnim(Protoceratops entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.FeetLeft.xRot = Mth.lerp(sleepProgress, 0, -0.291993575869168F);
				this.FeetLeft.yRot = Mth.lerp(sleepProgress, 0, 3.141592653589793F);
				this.FeetLeft.zRot = Mth.lerp(sleepProgress, 0, -1.7453292129831807E-4F);
				this.BLegRight.x = Mth.lerp(sleepProgress, 1.5F, 2.2F);
				this.BLegRight.y = Mth.lerp(sleepProgress, 2, 3.8F);
				this.BLegRight.z = Mth.lerp(sleepProgress, 4, 4.1F);
				this.BLegRight.xRot = Mth.lerp(sleepProgress, 0, -0.1090830782496456F);
				this.BLegRight.yRot = Mth.lerp(sleepProgress, 0, 0.03630284710990151F);
				this.BLegRight.zRot = Mth.lerp(sleepProgress, 0, 0.8389797661073521F);
				this.BLegLeft.x = Mth.lerp(sleepProgress, -1.5F, -1.2F);
				this.BLegLeft.y = Mth.lerp(sleepProgress, 2, 1.0F);
				this.BLegLeft.z = Mth.lerp(sleepProgress, 4, 4.3F);
				this.BLegLeft.xRot = Mth.lerp(sleepProgress, 0, 0.7298966878577064F);
				this.BLegLeft.yRot = Mth.lerp(sleepProgress, 0, -0.055326938619800786F);
				this.BLegLeft.zRot = Mth.lerp(sleepProgress, 0, 0.12740903872453743F);
				...
				this.FLegRight.x = Mth.lerp(sleepProgress, -1.5F, -1.4F);
				this.FLegRight.y = Mth.lerp(sleepProgress, 5, 2.0F);
				this.FLegRight.z = Mth.lerp(sleepProgress, -2, -1.2F);
				this.FLegRight.xRot = Mth.lerp(sleepProgress, 0, -0.9861110273767961F);
				this.FLegRight.yRot = Mth.lerp(sleepProgress, 0, 0.07312929665724782F);
				this.FLegRight.zRot = Mth.lerp(sleepProgress, 0, 0.1090830782496456F);
				this.FLegLeft.x = Mth.lerp(sleepProgress, 1.5F, 1.5F);
				this.FLegLeft.y = Mth.lerp(sleepProgress, 5, 5.0F);
				this.FLegLeft.xRot = Mth.lerp(sleepProgress, 0, 0.037175515064850034F);
				this.FLegLeft.yRot = Mth.lerp(sleepProgress, 0, 0.07278023113974408F);
				this.FLegLeft.zRot = Mth.lerp(sleepProgress, 0, 1.2039281766152325F);
				this.FeetRight.xRot = Mth.lerp(sleepProgress, 0, 0.8402014912574258F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.FeetLeft.xRot = Mth.lerp(sleepProgress, -0.291993575869168F, 0);
				this.FeetLeft.yRot = Mth.lerp(sleepProgress, 3.141592653589793F, 0);
				this.FeetLeft.zRot = Mth.lerp(sleepProgress, -1.7453292129831807E-4F, 0);
				this.BLegRight.x = Mth.lerp(sleepProgress, 2.2F, 1.5F);
				this.BLegRight.y = Mth.lerp(sleepProgress, 3.8F, 2F);
				this.BLegRight.z = Mth.lerp(sleepProgress, 4.1F, 4F);
				this.BLegRight.xRot = Mth.lerp(sleepProgress, -0.1090830782496456F, 0);
				this.BLegRight.yRot = Mth.lerp(sleepProgress, 0.03630284710990151F, 0);
				this.BLegRight.zRot = Mth.lerp(sleepProgress, 0.8389797661073521F, 0);
				this.BLegLeft.x = Mth.lerp(sleepProgress, -1.2F, -1.5F);
				this.BLegLeft.y = Mth.lerp(sleepProgress, 1, 2.0F);
				this.BLegLeft.z = Mth.lerp(sleepProgress, 4.3F, 4F);
				this.BLegLeft.xRot = Mth.lerp(sleepProgress, 0.7298966878577064F, 0);
				this.BLegLeft.yRot = Mth.lerp(sleepProgress, -0.055326938619800786F, 0);
				this.BLegLeft.zRot = Mth.lerp(sleepProgress, 0.12740903872453743F, 0);
				...
				this.FLegRight.x = Mth.lerp(sleepProgress, -1.4F, -1.5F);
				this.FLegRight.y = Mth.lerp(sleepProgress, 2, 5.0F);
				this.FLegRight.z = Mth.lerp(sleepProgress, -1.2F, -2F);
				this.FLegRight.xRot = Mth.lerp(sleepProgress, -0.9861110273767961F, 0);
				this.FLegRight.yRot = Mth.lerp(sleepProgress, 0.07312929665724782F, 0);
				this.FLegRight.zRot = Mth.lerp(sleepProgress, 0.1090830782496456F, 0);
				this.FLegLeft.xRot = Mth.lerp(sleepProgress, 0.037175515064850034F, 0);
				this.FLegLeft.yRot = Mth.lerp(sleepProgress, 0.07278023113974408F, 0);
				this.FLegLeft.zRot = Mth.lerp(sleepProgress, 1.2039281766152325F, 0);
				this.FeetRight.xRot = Mth.lerp(sleepProgress, 0.8402014912574258F, 0);
