	...
	public void setupAnim(Yutyrannus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.0349F, 0.24434609527920614F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0.0698F, 1.0878637547259988F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0.0349F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, 1.0878637547259988F, 0.0698F);
