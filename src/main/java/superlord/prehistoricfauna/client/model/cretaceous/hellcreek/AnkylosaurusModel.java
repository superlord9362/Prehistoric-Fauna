	...
	public void setupAnim(Ankylosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Head1.xRot = Mth.lerp(sleepProgress, 0, 0.02827433396553192F);
				this.Head1.yRot = Mth.lerp(sleepProgress, 0, 0.11728612207217244F);
				this.Head1.zRot = Mth.lerp(sleepProgress, 0, -0.11746065899211351F);
				this.RightHindLeg3.xRot = Mth.lerp(sleepProgress, 0, 1.5645131308350726F);
				this.LeftHindLeg1.yRot = Mth.lerp(sleepProgress, 0, -0.15707963267948966F);
				this.RightHindLeg1.xRot = Mth.lerp(sleepProgress, 0, 0.017453292519943295F);
				this.RightHindLeg1.yRot = Mth.lerp(sleepProgress, 0, 0.15707963267948966F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, -0.03909537541112055F);
				this.RightFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -0.8208283259076444F);
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, 0, -0.3909537457888271F);
				this.RightFrontLeg.zRot = Mth.lerp(sleepProgress, 0, -0.31293754020890546F);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0, 0.03263765709551775F);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0, -0.11728612207217244F);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 0, -1.5317009888344788F);
				this.RightHindLeg2.yRot = Mth.lerp(sleepProgress, 0, 0.33021629580890766F);
				this.RightHindLeg2.zRot = Mth.lerp(sleepProgress, 0, 0.017453292519943295F);
				this.LeftHindLeg3.xRot = Mth.lerp(sleepProgress, 0, 1.5247196451948906F);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -0.8990190684075072F);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, 0, 0.31293754020890546F);
				this.LeftFrontLeg.zRot = Mth.lerp(sleepProgress, 0, 0.07644542323472245F);
				this.LeftHindLeg2.xRot = Mth.lerp(sleepProgress, 0, -1.5247196451948906F);
				this.LeftHindLeg2.yRot = Mth.lerp(sleepProgress, 0, -0.2738421523142173F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.3862413488189591F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, 0.11728612207217244F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.Tail1.xRot = Mth.lerp(sleepProgress, 0, -0.18901915665940536F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, -0.27366763203903305F);
				this.Body.y = Mth.lerp(sleepProgress, 1, 9);
				this.Head1.y = Mth.lerp(sleepProgress, -1, -1.5F);
				this.RightFrontLeg.x = Mth.lerp(sleepProgress, -14, -16.75F); 
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, 14, 14.5F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Head1.xRot = Mth.lerp(sleepProgress, 0.02827433396553192F, 0);
				this.Head1.yRot = Mth.lerp(sleepProgress, 0.11728612207217244F, 0);
				this.Head1.zRot = Mth.lerp(sleepProgress, .11728612207217244F, 0);
				this.RightHindLeg3.xRot = Mth.lerp(sleepProgress, 1.5645131308350726F, 0);
				this.LeftHindLeg1.yRot = Mth.lerp(sleepProgress, -0.15707963267948966F, 0);
				this.RightHindLeg1.xRot = Mth.lerp(sleepProgress, 0.017453292519943295F, 0);
				this.RightHindLeg1.yRot = Mth.lerp(sleepProgress, 0.15707963267948966F, 0);
				this.Body.xRot = Mth.lerp(sleepProgress, -0.03909537541112055F, 0);
				this.RightFrontLeg.xRot = Mth.lerp(sleepProgress, -0.8208283259076444F, 0);
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, -0.3909537457888271F, 0);
				this.RightFrontLeg.zRot = Mth.lerp(sleepProgress, -0.31293754020890546F, 0);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.03263765709551775F, 0);
				this.Tail2.yRot = Mth.lerp(sleepProgress, -0.11728612207217244F, 0);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, -1.5317009888344788F, 0);
				this.RightHindLeg2.yRot = Mth.lerp(sleepProgress, 0.33021629580890766F, 0);
				this.RightHindLeg2.zRot = Mth.lerp(sleepProgress, 0.017453292519943295F, 0);
				this.LeftHindLeg3.xRot = Mth.lerp(sleepProgress, 1.5247196451948906F, 0);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, -0.8990190684075072F, 0);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, 0.31293754020890546F, 0);
				this.LeftFrontLeg.zRot = Mth.lerp(sleepProgress, 0.07644542323472245F, 0);
				this.LeftHindLeg2.xRot = Mth.lerp(sleepProgress, -1.5247196451948906F, 0);
				this.LeftHindLeg2.yRot = Mth.lerp(sleepProgress, -0.2738421523142173F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.3862413488189591F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0.11728612207217244F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.18901915665940536F, 0);
				this.Tail1.yRot = Mth.lerp(sleepProgress, -0.27366763203903305F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 9, 1);
				this.Head1.y = Mth.lerp(sleepProgress, -1.5F, -1F);
				this.RightFrontLeg.x = Mth.lerp(sleepProgress, -16.75F, -14F); 
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, 14.5F, 14F);
			} else {
