...
public class EdmontosaurusJuvenileModel extends EntityModel<Edmontosaurus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(76, 30).addBox(-4.0F, -2.01F, -3.0F, 7.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -11.0F));
