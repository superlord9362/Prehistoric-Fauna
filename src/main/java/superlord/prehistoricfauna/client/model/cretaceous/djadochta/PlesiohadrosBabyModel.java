...
public class PlesiohadrosBabyModel extends EntityModel<Plesiohadros> {
	...
	public void setupAnim(Plesiohadros entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				//Torso
				this.Torso.y = Mth.lerp(sleepProgress, 13, 17);
				this.Torso.xRot = Mth.lerp(sleepProgress, 0, 0.17453292519943295F);
				//LLeg
				this.LLeg.y = Mth.lerp(sleepProgress, 17, 19.5F);
				this.LLeg.z = Mth.lerp(sleepProgress, 2, 3);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 0, -0.7330382858376184F);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0, 0.2585053606381855F);
				//RLeg
				this.RLeg.y = Mth.lerp(sleepProgress, 17, 19.5F);
				this.RLeg.z = Mth.lerp(sleepProgress, 2, 3);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, -0.7330382858376184F);
				this.RLeg.yRot = Mth.lerp(sleepProgress, 0, -0.2585053606381855F);
				//LForeleg
				this.LForeleg.y = Mth.lerp(sleepProgress, 19, 22);
				this.LForeleg.xRot = Mth.lerp(sleepProgress, 0, -1.2330382858376184F);
				this.LForeleg.zRot = Mth.lerp(sleepProgress, 0, -0.6475712110370513F);
				//RForeleg
				this.RForeleg.y = Mth.lerp(sleepProgress, 19, 22);
				this.RForeleg.xRot = Mth.lerp(sleepProgress, 0, -1.3962634015954636F);
				this.RForeleg.yRot = Mth.lerp(sleepProgress, 0, 0.13962634015954636F);
				this.RForeleg.zRot = Mth.lerp(sleepProgress, 0, -0.13962634015954636F);
				//LLeg2
				this.LLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8377580409572781F);
				//RLeg2
				this.RLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8377580409572781F);
				//TailBase
				this.TailBase.z = Mth.lerp(sleepProgress, 11.5F, 10.5F);
				...
				//Neck
				this.Neck.y = Mth.lerp(sleepProgress, 2.5F, 2F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				//Torso
				this.Torso.y = Mth.lerp(sleepProgress, 17, 13);
				this.Torso.xRot = Mth.lerp(sleepProgress, 0.17453292519943295F, 0);
				//LLeg
				this.LLeg.y = Mth.lerp(sleepProgress, 19.5F, 17F);
				this.LLeg.z = Mth.lerp(sleepProgress, 3, 2);
				this.LLeg.xRot = Mth.lerp(sleepProgress, -0.7330382858376184F, 0);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0.2585053606381855F, 0);
				//RLeg
				this.RLeg.y = Mth.lerp(sleepProgress, 19.5F, 17F);
				this.RLeg.z = Mth.lerp(sleepProgress, 3, 2);
				this.RLeg.xRot = Mth.lerp(sleepProgress, -0.7330382858376184F, 0);
				this.RLeg.yRot = Mth.lerp(sleepProgress, -0.2585053606381855F, 0);
				//LForeleg
				this.LForeleg.y = Mth.lerp(sleepProgress, 22, 19);
				this.LForeleg.xRot = Mth.lerp(sleepProgress, -1.2330382858376184F, 0);
				this.LForeleg.zRot = Mth.lerp(sleepProgress, -0.6475712110370513F, 0);
				//RForeleg
				this.RForeleg.y = Mth.lerp(sleepProgress, 22, 19);
				this.RForeleg.xRot = Mth.lerp(sleepProgress, -1.3962634015954636F, 0);
				this.RForeleg.yRot = Mth.lerp(sleepProgress, 0.13962634015954636F, 0);
				this.RForeleg.zRot = Mth.lerp(sleepProgress, -0.13962634015954636F, 0);
				//LLeg2
				this.LLeg2.xRot = Mth.lerp(sleepProgress, -0.8377580409572781F, 0);
				//RLeg2
				this.RLeg2.xRot = Mth.lerp(sleepProgress, -0.8377580409572781F, 0);
				//TailBase
				this.TailBase.z = Mth.lerp(sleepProgress, 10.5F, 11.5F);
	...
	public void sleepPose() {
		...
		this.LLeg.yRot = 0.2585053606381855F;
		//RLeg
		this.RLeg.y = 19.5F;
		this.RLeg.z = 3;
		this.RLeg.xRot = -0.7330382858376184F;
		this.RLeg.yRot = -0.2585053606381855F;
		//LForeleg
		this.LForeleg.y = 22;
		this.LForeleg.xRot = -1.2330382858376184F;
		this.LForeleg.zRot = -0.6475712110370513F;
		//RForeleg
		this.RForeleg.y = 22;
