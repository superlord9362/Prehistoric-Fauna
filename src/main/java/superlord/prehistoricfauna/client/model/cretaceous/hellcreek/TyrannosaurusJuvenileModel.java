...
//				this.LeftArm.x = 4.1F;
			...
			if (entity.isJuvenile()) {
				...
				this.Body1.xRot = Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount;
				...
				this.Head1.xRot = Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount - 0.1F;
