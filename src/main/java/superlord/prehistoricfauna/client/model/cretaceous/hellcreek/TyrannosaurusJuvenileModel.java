	...
	public void setupAnim(Tyrannosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LeftLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8761552978169589F);
				this.LeftFeet.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.RightFeet.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.Head1.yRot = Mth.lerp(sleepProgress, 0, -1.0471975511965976F);
				this.RightLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8639379797371932F);
				this.RightLeg2.yRot = Mth.lerp(sleepProgress, 0, -0.17453292519943295F);
				this.RightLeg2.zRot = Mth.lerp(sleepProgress, 0, -0.17453292519943295F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.2275909337942703F, 0.41887902047863906F);
				...
				this.RightLeg1.yRot = Mth.lerp(sleepProgress, 0, 0.3490658503988659F);
				this.Body2.xRot = Mth.lerp(sleepProgress, 0, 0.17453292519943295F);
				this.Body2.yRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
				this.Body1.xRot = Mth.lerp(sleepProgress, 0, -0.17453292519943295F);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				...
				this.LeftLeg1.xRot = Mth.lerp(sleepProgress, 0, -0.6981317007977318F);
				this.LeftLeg1.yRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0.27314402127920984F, 0.7330382858376184F);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				this.RightArm.zRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.04555309164612875F, -0.17453292519943295F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, 0.593411945678072F);
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 0.6283185307179586F, 0.6283185307179586F);
				this.LeftArm.zRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.Body1.y = Mth.lerp(sleepProgress, -10, 12.6F);
				this.Tail2.x = Mth.lerp(sleepProgress, 0, -1);
				this.Body2.x = Mth.lerp(sleepProgress, 0, -2);
				this.Body2.y = Mth.lerp(sleepProgress, -1, -3);
				this.Body2.z = Mth.lerp(sleepProgress, -5, -6);
				this.Neck.x = Mth.lerp(sleepProgress, 0, -2);
				this.Head1.x = Mth.lerp(sleepProgress, 0, -2);
				this.Head1.y = Mth.lerp(sleepProgress, -11.1F, -11);
				this.Head1.z = Mth.lerp(sleepProgress, -4, -6.7F);
				this.LeftArm.x = Mth.lerp(sleepProgress, 4.1F, 4.5F);
				this.RightArm.x = Mth.lerp(sleepProgress, -4.1F, -5F);
				this.RightArm.z = Mth.lerp(sleepProgress, -14, -14.5F);
				this.LeftLeg1.x = Mth.lerp(sleepProgress, 4, 6);
				this.LeftLeg1.y = Mth.lerp(sleepProgress, -7, 8.8F);
				this.LeftLeg2.z = Mth.lerp(sleepProgress, 5, 4);
				this.LeftFeet.z = Mth.lerp(sleepProgress, 2, 1);
				this.RightLeg1.x = Mth.lerp(sleepProgress, -4, -6);
				this.RightLeg1.y = Mth.lerp(sleepProgress, -7, 8.8F);
				this.RightLeg2.z = Mth.lerp(sleepProgress, 5, 4);
				this.RightFeet.z = Mth.lerp(sleepProgress, 2, 1);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LeftLeg2.xRot = Mth.lerp(sleepProgress, -0.8761552978169589F, 0);
				this.LeftFeet.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.RightFeet.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.Head1.yRot = Mth.lerp(sleepProgress, -1.0471975511965976F, 0);
				this.RightLeg2.xRot = Mth.lerp(sleepProgress, -0.8639379797371932F, 0);
				this.RightLeg2.yRot = Mth.lerp(sleepProgress, -0.17453292519943295F, 0);
				this.RightLeg2.zRot = Mth.lerp(sleepProgress, -0.17453292519943295F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0.2275909337942703F);
				...
				this.RightLeg1.yRot = Mth.lerp(sleepProgress, 0.3490658503988659F, 0);
				this.Body2.xRot = Mth.lerp(sleepProgress, 0.17453292519943295F, 0);
				this.Body2.yRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
				this.Body1.xRot = Mth.lerp(sleepProgress, -0.17453292519943295F, 0);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				...
				this.LeftLeg1.xRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
				this.LeftLeg1.yRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0.7330382858376184F, 0.27314402127920984F);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				this.RightArm.zRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.17453292519943295F, -0.04555309164612875F);
				...
				this.Body1.y = Mth.lerp(sleepProgress, 12.6F, -10F);
				this.Tail2.x = Mth.lerp(sleepProgress, -1, 0);
				this.Body2.x = Mth.lerp(sleepProgress, -2, 0);
				this.Body2.y = Mth.lerp(sleepProgress, -3, -1);
				this.Body2.z = Mth.lerp(sleepProgress, -6, -5);
				this.Neck.x = Mth.lerp(sleepProgress, -2, 0);
				this.Head1.x = Mth.lerp(sleepProgress, -2, 0);
				this.Head1.y = Mth.lerp(sleepProgress, -11F, -11.1F);
				this.Head1.z = Mth.lerp(sleepProgress, -6.7F, -4F);
				this.LeftArm.x = Mth.lerp(sleepProgress, 4.5F, 4.1F);
				this.RightArm.x = Mth.lerp(sleepProgress, -5F, -4.1F);
				this.RightArm.z = Mth.lerp(sleepProgress, -14.5F, -14F);
				this.LeftLeg1.x = Mth.lerp(sleepProgress, 6, 4);
				this.LeftLeg1.y = Mth.lerp(sleepProgress, 8.8F, -7F);
				this.LeftLeg2.z = Mth.lerp(sleepProgress, 4, 5);
				this.LeftFeet.z = Mth.lerp(sleepProgress, 1, 2);
				this.RightLeg1.x = Mth.lerp(sleepProgress, -6, -4);
				this.RightLeg1.y = Mth.lerp(sleepProgress, 8.8F, -7F);
				this.RightLeg2.z = Mth.lerp(sleepProgress, 4, 5);
				this.RightFeet.z = Mth.lerp(sleepProgress, 1, 2);
			} else {
				float speed = 0.8f;
				float degree = 1.0f;
