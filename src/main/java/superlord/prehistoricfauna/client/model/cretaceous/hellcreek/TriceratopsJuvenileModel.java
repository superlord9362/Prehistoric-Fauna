	...
	public void setupAnim(Triceratops entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isSleeping()) {
			if (sleepProgress != 0 && entity.getEntityData().get(Triceratops.SLEEP_TICK) > 0) {
				this.Tail1.xRot = Mth.lerp(sleepProgress, 0, -0.43598323915870024F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, 0.11728612207217244F);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 0, 2.5413739344815873F);
				this.RightHindLeg2.zRot = Mth.lerp(sleepProgress, 0, -0.3127630032889644F);
				this.RightHindLeg1.xRot = Mth.lerp(sleepProgress, 0, -1.13376586611655F);
				this.RightHindLeg1.yRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -1.2119566751954398F);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, 0, -0.27366763203903305F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.1563815016444822F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -0.46914448828868976F);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0, 0.14905111745452548F);
				this.Head1.yRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.RightFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -1.291369076266349F);
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, 0, -0.23457224414434488F);
				this.LeftHindLeg1.xRot = Mth.lerp(sleepProgress, 0, -1.13376586611655F);
				this.LeftHindLeg1.yRot = Mth.lerp(sleepProgress, 0, -0.19547687289441354F);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0, 0.13020156286456727F);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.LeftHindLeg2.xRot = Mth.lerp(sleepProgress, 0, 2.5411994974301875F);
				this.LeftHindLeg2.zRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.Body.y = Mth.lerp(sleepProgress, 3, 13);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, 7, 19);
				this.RightFrontLeg.y = Mth.lerp(sleepProgress, 7, 19);
				this.LeftHindLeg1.y = Mth.lerp(sleepProgress, 3, 15);
				this.RightHindLeg1.y = Mth.lerp(sleepProgress, 3, 15);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(Triceratops.SLEEP_TICK) > 0) {
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.43598323915870024F, 0);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0.11728612207217244F, 0);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 2.5413739344815873F, 0);
				this.RightHindLeg2.zRot = Mth.lerp(sleepProgress, -0.3127630032889644F, 0);
				this.RightHindLeg1.xRot = Mth.lerp(sleepProgress, -1.13376586611655F, 0);
				this.RightHindLeg1.yRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, -1.2119566751954398F, 0);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, -0.27366763203903305F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.1563815016444822F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, -0.46914448828868976F, 0);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0.14905111745452548F, 0);
				this.Head1.yRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.RightFrontLeg.xRot = Mth.lerp(sleepProgress, -1.291369076266349F, 0);
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, -0.23457224414434488F, 0);
				this.LeftHindLeg1.xRot = Mth.lerp(sleepProgress, -1.13376586611655F, 0);
				this.LeftHindLeg1.yRot = Mth.lerp(sleepProgress, -0.19547687289441354F, 0);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.13020156286456727F, 0);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.LeftHindLeg2.xRot = Mth.lerp(sleepProgress, 2.5411994974301875F, 0);
				this.LeftHindLeg2.zRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 13, 3);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, 19, 7);
				this.RightFrontLeg.y = Mth.lerp(sleepProgress, 19, 7);
				this.LeftHindLeg1.y = Mth.lerp(sleepProgress, 15, 3);
				this.RightHindLeg1.y = Mth.lerp(sleepProgress, 15, 3);
			} else {
