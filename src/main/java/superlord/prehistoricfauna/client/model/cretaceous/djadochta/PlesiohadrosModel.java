...
public class PlesiohadrosModel extends EntityModel<Plesiohadros> {
	...
	public void setupAnim(Plesiohadros entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.ThighR.y = Mth.lerp(sleepProgress, -2, 6.6F);
				this.ThighR.x = Mth.lerp(sleepProgress, 5, 9);
				this.ThighR.z = Mth.lerp(sleepProgress, 7, 3);
				this.ThighL.y = Mth.lerp(sleepProgress, -2, 6);
				this.ThighL.x = Mth.lerp(sleepProgress, -5, -3);
				this.LegFrontL.y = Mth.lerp(sleepProgress, 5, 18);
				this.LegFrontR.y = Mth.lerp(sleepProgress, 5, 20);
				this.LegBackL.y = Mth.lerp(sleepProgress, 13, 17F);
				this.LegBackR.y = Mth.lerp(sleepProgress, 13, 17F);
				...
				this.Neck.y = Mth.lerp(sleepProgress, 1.5F, 1.5F);
				...
				this.ThighL.xRot = Mth.lerp(sleepProgress, 0, 0.3330382858376184F);
				this.ThighL.yRot = Mth.lerp(sleepProgress, 0, 0.2585053606381855F);
				...
				this.LegBackL.xRot = Mth.lerp(sleepProgress, 0, 1.1345F);
				...
				this.LegBackR.xRot = Mth.lerp(sleepProgress, 0, 1.1345F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, 0.17453292519943295F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, -0.15F, -0.5585053606381855F);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.TailTip.xRot = Mth.lerp(sleepProgress, 0.15F, 0.41887902047863906F);
				...
				this.ThighR.xRot = Mth.lerp(sleepProgress, 0, 0.3330382858376184F);
				this.ThighR.yRot = Mth.lerp(sleepProgress, 0, 0.3330382858376184F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 10, -2);
				this.ThighR.y = Mth.lerp(sleepProgress, 6.6F, -2F);
				this.ThighR.x = Mth.lerp(sleepProgress, 9, 5);
				this.ThighR.z = Mth.lerp(sleepProgress, 3, 7);
				this.ThighL.y = Mth.lerp(sleepProgress, 6, -2);
				this.ThighL.x = Mth.lerp(sleepProgress, -3, -5);
				this.LegFrontL.y = Mth.lerp(sleepProgress, 18, 5);
				this.LegFrontR.y = Mth.lerp(sleepProgress, 20, 5);
				this.LegBackL.y = Mth.lerp(sleepProgress, 17, 13F);
				this.LegBackR.y = Mth.lerp(sleepProgress, 17, 13F);
				...
				this.ThighL.xRot = Mth.lerp(sleepProgress, 0.3330382858376184F, 0);
				this.ThighL.yRot = Mth.lerp(sleepProgress, 0.2585053606381855F, 0);
				...
				this.LegBackL.xRot = Mth.lerp(sleepProgress, 1.1345F, 0);
				...
				this.LegBackR.xRot = Mth.lerp(sleepProgress, 1.1345F, 0);
				this.Body.xRot = Mth.lerp(sleepProgress, 0.17453292519943295F, 0);
				this.TailBase.xRot = Mth.lerp(sleepProgress, -0.5585053606381855F, -0.15F);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.TailTip.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0.15F);
				this.TailTip.yRot = Mth.lerp(sleepProgress, 0.593411945678072F, 0);
				this.TailTip.zRot = Mth.lerp(sleepProgress, 0.10471975511965977F, 0);
				this.ThighR.xRot = Mth.lerp(sleepProgress, 0.3330382858376184F, 0);
				this.ThighR.yRot = Mth.lerp(sleepProgress, 0.3330382858376184F, 0);
			} else {
	...
	public void sleepPose() {
		...
		this.ThighR.xRot = 0.3330382858376184F;
		this.ThighR.yRot = 0.3330382858376184F;
	}
