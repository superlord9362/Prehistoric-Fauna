...
public class AepyornithomimusModel extends EntityModel<Aepyornithomimus> {
	...
	public void setupAnim(Aepyornithomimus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		resetModel();
		if (entity.isAsleep()) {//Thighleft_1
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Thighleft_1.y = Mth.lerp(sleepProgress, 12, 21);
				this.Thighleft_1.xRot = Mth.lerp(sleepProgress, 0, -0.46931902520863084F);
				this.Thighleft_1.yRot = Mth.lerp(sleepProgress, 0, 0.03909537541112055F);
				//Wingright
				this.Wingright.xRot = Mth.lerp(sleepProgress, 0, 0.35185837453889574F);
				this.Wingright.zRot = Mth.lerp(sleepProgress, 0, -1.2892747663851107F);
				//Tailbase
				this.Tailbase.xRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.Tailbase.yRot = Mth.lerp(sleepProgress, 0, 0.4300491170387584F);
				//Wingleft
				this.Wingleft.xRot = Mth.lerp(sleepProgress, 0, 0.35185837453889574F);
				this.Wingleft.zRot = Mth.lerp(sleepProgress, 0, 1.2892747663851107F);
				//HeadNeck
				this.HeadNeck.xRot = Mth.lerp(sleepProgress, 0, 0.5864306020384839F);
				this.HeadNeck.yRot = Mth.lerp(sleepProgress, 0, -1.759291939273506F);
				this.HeadNeck.zRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				//Tailtip
				this.Tailtip.yRot = Mth.lerp(sleepProgress, 0, 0.5082398928281348F);
				//Thighleft
				this.Thighleft.y = Mth.lerp(sleepProgress, 12, 21);
				this.Thighleft.xRot = Mth.lerp(sleepProgress, 0, -0.46931902520863084F);
				this.Thighleft.yRot = Mth.lerp(sleepProgress, 0, -0.03909537541112055F);
				//Body
				this.Body.y = Mth.lerp(sleepProgress, 12, 21);
			} else setSleepingPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Thighleft_1.y = Mth.lerp(sleepProgress, 21, 12);
				this.Thighleft_1.xRot = Mth.lerp(sleepProgress, -0.46931902520863084F, 0);
				this.Thighleft_1.yRot = Mth.lerp(sleepProgress, 0.03909537541112055F, 0);
				//Wingright
				this.Wingright.xRot = Mth.lerp(sleepProgress, 0.35185837453889574F, 0);
				this.Wingright.zRot = Mth.lerp(sleepProgress, -1.2892747663851107F, 0);
				//Tailbase
				this.Tailbase.xRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.Tailbase.yRot = Mth.lerp(sleepProgress, 0.4300491170387584F, 0);
				//Wingleft
				this.Wingleft.xRot = Mth.lerp(sleepProgress, 0.35185837453889574F, 0);
				this.Wingleft.zRot = Mth.lerp(sleepProgress, 1.2892747663851107F, 0);
				//HeadNeck
				this.HeadNeck.xRot = Mth.lerp(sleepProgress, 0.5864306020384839F, 0);
				this.HeadNeck.yRot = Mth.lerp(sleepProgress, -1.759291939273506F, 0);
				this.HeadNeck.zRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				//Tailtip
				this.Tailtip.yRot = Mth.lerp(sleepProgress, 0.5082398928281348F, 0);
				//Thighleft
				this.Thighleft.y = Mth.lerp(sleepProgress, 21, 12);
				this.Thighleft.xRot = Mth.lerp(sleepProgress, -0.46931902520863084F, 0);
				this.Thighleft.yRot = Mth.lerp(sleepProgress, -0.03909537541112055F, 0);
				//Body
				this.Body.y = Mth.lerp(sleepProgress, 21, 12);
			} else {
