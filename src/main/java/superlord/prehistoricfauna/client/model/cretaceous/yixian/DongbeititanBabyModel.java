	...
	public void setupAnim(Dongbeititan entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Torso.y = Mth.lerp(sleepProgress, -5, 10F);
				...
				this.RForeleg.x = Mth.lerp(sleepProgress, 5.5F, 7.5F);
				this.RForeleg.y = Mth.lerp(sleepProgress, 7, 20.0F);
				this.RForeleg.z = Mth.lerp(sleepProgress, -8, -10.0F);
				...
				this.TailBase.y = Mth.lerp(sleepProgress, 5, 3F);
				this.TailBase.z = Mth.lerp(sleepProgress, 27, 27F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, 0, -0.24260075936930908F);
				...
				this.LForeleg.x = Mth.lerp(sleepProgress, -6.5F, -7.5F);
				this.LForeleg.y = Mth.lerp(sleepProgress, 7, 20);
				this.LForeleg.z = Mth.lerp(sleepProgress, -8, -10);
				...
				this.LFoot.y = Mth.lerp(sleepProgress, 8, 6.0F);
				this.LFoot.z = Mth.lerp(sleepProgress, 2, 1.0F);
				this.LFoot.xRot = Mth.lerp(sleepProgress, 0, 0.3874631072585466F);
				this.LFoot.zRot = Mth.lerp(sleepProgress, 0, -0.10471975511965977F);
				this.LLeg2.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.LLeg2.y = Mth.lerp(sleepProgress, 11, 10.1F);
				this.LLeg2.z = Mth.lerp(sleepProgress, -2, 1);
				this.RFoot.xRot = Mth.lerp(sleepProgress, 0, 0.3490658503988659F);
				this.RFoot.y = Mth.lerp(sleepProgress, 8, 6.5F);
				this.RFoot.z = Mth.lerp(sleepProgress, 2, 1F);
				this.RLeg2.x = Mth.lerp(sleepProgress, 0, 0.5F);
				this.RLeg2.y = Mth.lerp(sleepProgress, 11, 10.2F);
				this.RLeg2.z = Mth.lerp(sleepProgress, -2, 1);
				this.RLeg2.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.LLeg.x = Mth.lerp(sleepProgress, -5.5F, -5.5F);
				this.LLeg.y = Mth.lerp(sleepProgress, 2, 18);
				this.LLeg.z = Mth.lerp(sleepProgress, 6, 10);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 0, -1.9198621771937625F);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0, 0.3839724354387525F);
				this.LLeg.zRot = Mth.lerp(sleepProgress, 0, 0.10471975511965977F);
				this.RLeg.x = Mth.lerp(sleepProgress, 5.5F, 5.5F);
				this.RLeg.y = Mth.lerp(sleepProgress, 2, 18);
				this.RLeg.z = Mth.lerp(sleepProgress, 6, 10);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, -1.9198621771937625F);
				this.RLeg.yRot = Mth.lerp(sleepProgress, 0, -0.5082398595386212F);
				this.Neck.x = Mth.lerp(sleepProgress, 0, -3F);
				this.Neck.y = Mth.lerp(sleepProgress, 6, 6F);
				this.Neck.z = Mth.lerp(sleepProgress, 0, 2);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.9162978572970231F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -1.3294172592861477F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, 0.11728612207217244F);
				this.TailTip.xRot = Mth.lerp(sleepProgress, 0, 0.4518657326886875F);
				this.TailTip.yRot = Mth.lerp(sleepProgress, 0, 0.3909537457888271F);
				this.TailTip.zRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Torso.y = Mth.lerp(sleepProgress, 10, -5F);
				...
				this.RForeleg.x = Mth.lerp(sleepProgress, 7.5F, 5.5F);
				this.RForeleg.y = Mth.lerp(sleepProgress, 20, 7.0F);
				this.RForeleg.z = Mth.lerp(sleepProgress, -10, -8.0F);
				...
				this.TailBase.y = Mth.lerp(sleepProgress, 3, 5F);
				this.TailBase.z = Mth.lerp(sleepProgress, 27, 27F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, -0.24260075936930908F, 0);
				...
				this.LForeleg.x = Mth.lerp(sleepProgress, -7.5F, -6.5F);
				this.LForeleg.y = Mth.lerp(sleepProgress, 20, 7);
				this.LForeleg.z = Mth.lerp(sleepProgress, -10, -8);
				...
				this.LFoot.y = Mth.lerp(sleepProgress, 6, 8.0F);
				this.LFoot.z = Mth.lerp(sleepProgress, 1, 2.0F);
				this.LFoot.xRot = Mth.lerp(sleepProgress, 0.3874631072585466F, 0);
				this.LFoot.zRot = Mth.lerp(sleepProgress, -0.10471975511965977F, 0);
				this.LLeg2.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.LLeg2.y = Mth.lerp(sleepProgress, 10.1F, 11F);
				this.LLeg2.z = Mth.lerp(sleepProgress, 1, -2);
				this.RFoot.xRot = Mth.lerp(sleepProgress, 0.3490658503988659F, 0);
				this.RFoot.y = Mth.lerp(sleepProgress, 6.5F, 8);
				this.RFoot.z = Mth.lerp(sleepProgress, 1, 2F);
				this.RLeg2.x = Mth.lerp(sleepProgress, 0.5F, 0);
				this.RLeg2.y = Mth.lerp(sleepProgress, 10.2F, 11F);
				this.RLeg2.z = Mth.lerp(sleepProgress, 1, -2);
				this.RLeg2.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.LLeg.x = Mth.lerp(sleepProgress, -5.5F, -5.5F);
				this.LLeg.y = Mth.lerp(sleepProgress, 18, 2);
				this.LLeg.z = Mth.lerp(sleepProgress, 10, 6);
				this.LLeg.xRot = Mth.lerp(sleepProgress, -1.9198621771937625F, 0);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0.3839724354387525F, 0);
				this.LLeg.zRot = Mth.lerp(sleepProgress, 0.10471975511965977F, 0);
				this.RLeg.x = Mth.lerp(sleepProgress, 5.5F, 5.5F);
				this.RLeg.y = Mth.lerp(sleepProgress, 18, 2);
				this.RLeg.z = Mth.lerp(sleepProgress, 10, 6);
				this.RLeg.xRot = Mth.lerp(sleepProgress, -1.9198621771937625F, 0);
				this.RLeg.yRot = Mth.lerp(sleepProgress, -0.5082398595386212F, 0);
				this.Neck.x = Mth.lerp(sleepProgress, -3, 0F);
				this.Neck.y = Mth.lerp(sleepProgress, 6, 6F);
				this.Neck.z = Mth.lerp(sleepProgress, 2, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.9162978572970231F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, -1.3294172592861477F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0.11728612207217244F, 0);
				this.TailTip.xRot = Mth.lerp(sleepProgress, 0.4518657326886875F, 0);
				this.TailTip.yRot = Mth.lerp(sleepProgress, 0.3909537457888271F, 0);
				this.TailTip.zRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				this.Head.x = Mth.lerp(sleepProgress, 0, 0);
				this.Head.z = Mth.lerp(sleepProgress, -2, -2);
