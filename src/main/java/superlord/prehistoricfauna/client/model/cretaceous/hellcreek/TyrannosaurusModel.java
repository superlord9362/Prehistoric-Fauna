	...
	public void setupAnim(Tyrannosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body2.xRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.Body2.yRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.2275909337942703F, 0.8203047484373349F);
				...
				this.RightLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8726646259971648F);
				...
				this.LeftLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8726646259971648F);
				...
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.04555309164612875F, -0.24434609527920614F);
				...
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 0.27314402127920984F, 1.3264502315156905F);
				this.LeftArm.yRot = Mth.lerp(sleepProgress, 0, -0.13962634015954636F);
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0.27314402127920984F, 1.0878637547259988F);
				...
				this.Body1.y = Mth.lerp(sleepProgress, -29, -1.6F);
				this.Body2.x = Mth.lerp(sleepProgress, 0, 4);
				this.Body2.y = Mth.lerp(sleepProgress, -3, -1);
				this.Body2.z = Mth.lerp(sleepProgress, -16, -20);
				this.RightArm.x = Mth.lerp(sleepProgress, 10.1F, 11);
				this.RightArm.z = Mth.lerp(sleepProgress, -13, -14);
				this.Neck.y = Mth.lerp(sleepProgress, 6, 10);
				this.Neck.z = Mth.lerp(sleepProgress, -22, -20);
				this.Head1.x = Mth.lerp(sleepProgress, 0, -1);
				this.Head1.y = Mth.lerp(sleepProgress, -17.1F, -15);
				this.Head1.z = Mth.lerp(sleepProgress, -7, -6);
				this.Tail1.x = Mth.lerp(sleepProgress, 0, 3);
				this.Tail1.z = Mth.lerp(sleepProgress, 17, 19.5F);
				this.Tail2.x = Mth.lerp(sleepProgress, 0, 0.6F);
				this.LeftLeg1.y = Mth.lerp(sleepProgress, -26, -5);
				this.LeftLeg1.z = Mth.lerp(sleepProgress, -1, 3);
				this.LeftLeg2.y = Mth.lerp(sleepProgress, 26, 22);
				this.LeftLeg2.z = Mth.lerp(sleepProgress, 9, 8);
				this.RightLeg1.x = Mth.lerp(sleepProgress, 6, 7);
				this.RightLeg1.y = Mth.lerp(sleepProgress, -26, -5);
				this.RightLeg1.z = Mth.lerp(sleepProgress, -1, 2);
				this.RightLeg2.y = Mth.lerp(sleepProgress, 26, 22);
				this.RightLeg2.z = Mth.lerp(sleepProgress, 9, 8);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body2.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.Body2.yRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.8203047484373349F, 0.2275909337942703F);
				...
				this.RightLeg2.xRot = Mth.lerp(sleepProgress, -0.8726646259971648F, 0);
				...
				this.LeftLeg2.xRot = Mth.lerp(sleepProgress, -0.8726646259971648F, 0);
				...
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.24434609527920614F, -0.04555309164612875F);
				...
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 1.3264502315156905F, 0.27314402127920984F);
				this.LeftArm.yRot = Mth.lerp(sleepProgress, -0.13962634015954636F, 0);
				this.RightArm.xRot = Mth.lerp(sleepProgress, 1.0878637547259988F, 0.27314402127920984F);
				...
				this.Body1.y = Mth.lerp(sleepProgress, -1.6F, -29F);
				this.Body2.x = Mth.lerp(sleepProgress, 4, 1);
				this.Body2.y = Mth.lerp(sleepProgress, -1, -3);
				this.Body2.z = Mth.lerp(sleepProgress, -20, -16);
				this.RightArm.x = Mth.lerp(sleepProgress, 11F, 10.1F);
				this.RightArm.z = Mth.lerp(sleepProgress, -14, -13);
				this.Neck.y = Mth.lerp(sleepProgress, 10, 6);
				this.Neck.z = Mth.lerp(sleepProgress, -20, -22);
				this.Head1.x = Mth.lerp(sleepProgress, -1, 0);
				this.Head1.y = Mth.lerp(sleepProgress, -15F, -17.1F);
				this.Head1.z = Mth.lerp(sleepProgress, -6, -7);
				this.Tail1.x = Mth.lerp(sleepProgress, 3, 0);
				this.Tail1.z = Mth.lerp(sleepProgress, 19.5F, 17F);
				this.Tail2.x = Mth.lerp(sleepProgress, 0.6F, 0F);
				this.LeftLeg1.y = Mth.lerp(sleepProgress, -5, -26);
				this.LeftLeg1.z = Mth.lerp(sleepProgress, 3, -1);
				this.LeftLeg2.y = Mth.lerp(sleepProgress, 22, 26);
				this.LeftLeg2.z = Mth.lerp(sleepProgress, 8, 9);
				this.RightLeg1.x = Mth.lerp(sleepProgress, 7, 6);
				this.RightLeg1.y = Mth.lerp(sleepProgress, -5, -26);
				this.RightLeg1.z = Mth.lerp(sleepProgress, 2, -1);
				this.RightLeg2.y = Mth.lerp(sleepProgress, 27, 26);
				this.RightLeg2.z = Mth.lerp(sleepProgress, 8, 9);
			} else {
				...
				this.Body1.xRot = (Math.abs(-0.025F * Mth.cos(0.1F * ageInTicks / 3))) + (Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount);
