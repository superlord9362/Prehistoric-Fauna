	...
	public void setupAnim(Udanoceratops entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 9, 17);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 9, 17);
				...
				this.LeftLeg.xRot = Mth.lerp(sleepProgress, 0, -0.6377580409572781F);
				...
				this.RightLeg.xRot = Mth.lerp(sleepProgress, 0, -0.6377580409572781F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 17, 9);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 17, 9);
				...
				this.Neck.z = Mth.lerp(sleepProgress, 1.5F, 0F);
				...
				this.LeftLeg.xRot = Mth.lerp(sleepProgress, -0.6377580409572781F, 0);
				...
				this.RightLeg.xRot = Mth.lerp(sleepProgress, -0.6377580409572781F, 0);
				...
				this.RightThigh.yRot = Mth.lerp(sleepProgress, -0.9330382858376184F, 0);
			} else {
				this.Neck.xRot = 0;
