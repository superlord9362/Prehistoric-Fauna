 ...
 */
@OnlyIn(Dist.CLIENT)
public class HerrerasaurusSkeletonActionModel extends EntityModel<HerrerasaurusSkeletonEntity> {
    ...
    public HerrerasaurusSkeletonActionModel() {
        this.textureWidth = 128;
        this.textureHeight = 128;
        this.RLeg = new ModelRenderer(this, 0, 0);
        this.RLeg.setRotationPoint(0.0F, 9.9F, 3.0F);
        this.RLeg.addBox(0.0F, -3.0F, -5.0F, 3.0F, 8.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RLeg, -0.19547687289441354F, 0.0F, 0.0F);
        this.RThigh = new ModelRenderer(this, 100, 0);
        this.RThigh.setRotationPoint(1.0F, 7.6F, 15.5F);
        this.RThigh.addBox(0.0F, -2.0F, -3.5F, 3.0F, 9.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RThigh, 0.0F, -0.23457224414434488F, 0.0F);
        ...
        this.setRotateAngle(LArm, -0.19547687289441354F, 0.0F, 0.3909537457888271F);
        ...
        this.LThigh.setRotationPoint(-3.0F, 4.5F, 15.5F);
        this.LThigh.addBox(-1.0F, 0.0F, -3.5F, 3.0F, 9.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LThigh, -0.27366763203903305F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RArm, -0.19547687289441354F, 0.0F, -0.3909537457888271F);
