...
public class KayentavenatorModel extends EntityModel<Kayentavenator> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightThigh = Root.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(38, 40).addBox(-2.0F, -2.5F, -2.5F, 4.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 0.0F, 0.0F));

		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(44, 60).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.5F, 3.5F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(55, 53).addBox(-2.5F, 0.0F, -6.0F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.0F, 0.0F));

		PartDefinition LeftThigh = Root.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(38, 40).mirror().addBox(-2.0F, -2.5F, -2.5F, 4.0F, 10.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 0.0F, 0.0F));

		PartDefinition LeftLeg = LeftThigh.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(44, 60).mirror().addBox(-1.5F, 0.0F, 0.0F, 3.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 7.5F, 3.5F));

		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(55, 53).mirror().addBox(-1.5F, 0.0F, -6.0F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 10.0F, 0.0F));
		...
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(23, 39).addBox(-1.0F, -1.0F, -1.5F, 2.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 3.5F, -12.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(23, 39).mirror().addBox(-1.0F, -1.0F, -1.5F, 2.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 3.5F, -12.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(66, 10).addBox(-2.5F, -2.9664F, -2.1305F, 5.0F, 7.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 5.5F, -0.1309F, 0.0F, 0.0F));

		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(26, 0).addBox(-1.5F, -0.95F, -2.0F, 3.0F, 4.0F, 33.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.9914F, 11.8695F, 0.1309F, 0.0F, 0.0F));

		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(2, 34).addBox(-1.5F, -10.0F, -5.0F, 3.0F, 13.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, -14.5F, 0.1745F, 0.0F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(1, 63).addBox(-1.5F, -1.001F, -11.0F, 3.0F, 4.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(21, 72).addBox(-1.0F, 2.999F, -11.0F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(1, 53).addBox(-2.0F, -1.001F, -4.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.0F, -3.0F, -0.0436F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(18, 56).addBox(-3.0F, 1.649F, -2.0F, 2.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -5.15F, -8.75F, 0.0436F, 0.0F, 0.0F));

		PartDefinition Jaw = Head.addOrReplaceChild("Jaw", CubeListBuilder.create().texOffs(27, 82).addBox(-1.5F, -0.001F, -11.0F, 2.0F, 1.0F, 7.0F, new CubeDeformation(0.0F))
				.texOffs(0, 84).addBox(-2.5F, -0.001F, -4.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(18, 82).addBox(-2.0F, -2.001F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.01F))
				.texOffs(0, 76).addBox(-2.0F, 0.999F, -11.0F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 2.0F, 0.0F));

		PartDefinition Dewlap = Jaw.addOrReplaceChild("Dewlap", CubeListBuilder.create().texOffs(23, 63).addBox(0.0F, 0.0F, -4.0F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 2.0F, -2.5F));
	...
	public void setupAnim(Kayentavenator entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightLeg.xRot = Mth.lerp(sleepProgress, 0, -1.3685127304046198F);
				...
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.8418312220247435F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, 0.3122393925291412F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, -0.23457224414434488F);
				this.Tail1.xRot = Mth.lerp(sleepProgress, 0, -0.27366763203903305F);
				...
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 0, -0.03909537541112055F);
				...
				this.LeftLeg.xRot = Mth.lerp(sleepProgress, 0, -0.4300491170387584F);
				this.LeftLeg.yRot = Mth.lerp(sleepProgress, 0, -0.01728612207217244F);
				this.LeftLeg.zRot = Mth.lerp(sleepProgress, 0, -0.19547687289441354F);
				this.RightThigh.y = Mth.lerp(sleepProgress, 0, 12.0F);
				this.RightThigh.xRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				...
				this.LeftThigh.x = Mth.lerp(sleepProgress, -3, -0.5F);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 0, 16.2F);
				this.LeftThigh.xRot = Mth.lerp(sleepProgress, 0, 0.4300491170387584F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0, 0.1738421523142173F);
				this.RightArm.zRot = Mth.lerp(sleepProgress, 0, 0.2035422454473641F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RightLeg.xRot = Mth.lerp(sleepProgress, -1.3685127304046198F, 0);
				...
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.8418312220247435F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0.3122393925291412F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, -0.23457224414434488F, 0);
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.27366763203903305F, 0);
				...
				this.LeftArm.xRot = Mth.lerp(sleepProgress, -0.03909537541112055F, 0);
				...
				this.LeftLeg.xRot = Mth.lerp(sleepProgress, -0.4300491170387584F, 0);
				this.LeftLeg.yRot = Mth.lerp(sleepProgress, -0.01728612207217244F, 0);
				this.LeftLeg.zRot = Mth.lerp(sleepProgress, -0.19547687289441354F, 0);
				this.RightThigh.y = Mth.lerp(sleepProgress, 12.0F, 0);
				this.RightThigh.xRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				...
				this.LeftThigh.x = Mth.lerp(sleepProgress, -0.5F, -3);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 16.2F, 0);
				this.LeftThigh.xRot = Mth.lerp(sleepProgress, 0.4300491170387584F, 0);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0.1738421523142173F, 0);
				this.RightArm.zRot = Mth.lerp(sleepProgress, 0.2035422454473641F, 0);
			} else {
	...
	public void sleepPose() {
		...
		this.LeftLeg.yRot = -0.01728612207217244F;
