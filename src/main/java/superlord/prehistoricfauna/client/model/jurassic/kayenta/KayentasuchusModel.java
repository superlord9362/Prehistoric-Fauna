...
public class KayentasuchusModel {
//	extends EntityModel<Kayentasuchus> {
//
...
//				this.Body.xRot = Mth.lerp(sleepProgress, 0.0873F, 0);
...
//			if (sitProgress != 0 && entity.getEntityData().get(Kayentasuchus.SIT_TICK) > 0) {
//				this.Body.y = Mth.lerp(sitProgress, 18F, 22F);
//				this.RightLeg.y = Mth.lerp(sitProgress, 19, 23);
//				this.LeftLeg.y = Mth.lerp(sitProgress, 19, 23);
//				this.LeftArm.y = Mth.lerp(sitProgress, 20, 23);
//				this.RightArm.y = Mth.lerp(sitProgress, 20, 23);
//				this.Body.xRot = Mth.lerp(sitProgress, 0.0873F, 0);
...
//				this.Tail.xRot = (-Math.abs(-0.05F * Mth.sin(0.1F * ageInTicks / 5))) - 0.0873F;
...
//				this.Body.xRot = Mth.lerp(sleepProgress, 0, 0.0873F);
...
//			} else if (sitProgress != 0 && entity.getEntityData().get(Kayentasuchus.SIT_TICK) > 0) {
//				this.Body.y = Mth.lerp(sitProgress, 22, 18);
//				this.RightLeg.y = Mth.lerp(sitProgress, 23, 19);
//				this.LeftLeg.y = Mth.lerp(sitProgress, 23, 19);
//				this.LeftArm.y = Mth.lerp(sitProgress, 23, 20);
//				this.RightArm.y = Mth.lerp(sitProgress, 23, 20);
//				this.Body.xRot = Mth.lerp(sitProgress, 0, 0.0873F);
