...
public class AbrosaurusBabyModel extends EntityModel<Abrosaurus> {
	...
	public AbrosaurusBabyModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(38, 41).addBox(-2.0F, -1.0F, -5.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.025F, 0.0F));
		...
		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(18, 41).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.5F, 9.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(43, 0).addBox(-1.0F, -3.0F, -2.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 5.0F, -8.0F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(43, 0).mirror().addBox(-1.0F, -3.0F, -2.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.5F, 5.0F, -8.0F));

		PartDefinition LeftLeg = Root.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(0, 38).addBox(1.5F, -2.0F, -2.5F, 4.0F, 11.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(18, 38).addBox(1.5F, 7.0F, -3.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -9.0F, 3.5F));

		PartDefinition RightLeg = Root.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(0, 38).mirror().addBox(-5.5F, -2.0F, -2.5F, 4.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(18, 38).mirror().addBox(-5.5F, 7.0F, -3.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -9.0F, 3.5F));
