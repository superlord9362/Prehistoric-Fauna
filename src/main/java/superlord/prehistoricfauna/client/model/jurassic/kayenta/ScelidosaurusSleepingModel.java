...
public class ScelidosaurusSleepingModel extends EntityModel<ScelidosaurusEntity> {
    ...
    public ScelidosaurusSleepingModel() {
        ...
        this.setRotateAngle(LegRight, 0.0F, 0.03909537541112055F, -0.27366763203903305F);
        ...
        this.setRotateAngle(Leg2Right, -0.9782570324270162F, 0.0F, 0.0F);
        ...
        this.FootRight.setRotationPoint(0.5F, 3.5F, -0.3F);
        this.FootRight.addBox(-2.0F, 0.0F, -4.0F, 4.0F, 1.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(FootRight, 1.0555751236166873F, -0.3909537457888271F, -0.1558579075294158F);
