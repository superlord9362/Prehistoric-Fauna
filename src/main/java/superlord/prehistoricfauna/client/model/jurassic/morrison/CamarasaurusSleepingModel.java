...
public class CamarasaurusSleepingModel extends EntityModel<CamarasaurusEntity> {
    ...
    public CamarasaurusSleepingModel() {
        ...
        this.RightHindLeg1.setRotationPoint(-24.0F, 4.0F, 24.0F);
        this.RightHindLeg1.addBox(-8.5F, -13.0F, -12.0F, 17.0F, 45.0F, 24.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightHindLeg1, -1.9198621771937625F, 0.3839724354387525F, 0.10471975511965977F);
        this.RightHindLeg3 = new ModelRenderer(this, 0, 223);
        this.RightHindLeg3.mirror = true;
        this.RightHindLeg3.setRotationPoint(0.0F, 26.2F, -3.0F);
        this.RightHindLeg3.addBox(-8.0F, 0.0F, -14.0F, 16.0F, 6.0F, 20.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightHindLeg3, 0.3874631072585466F, 0.0F, -0.10471975511965977F);
        ...
        this.setRotateAngle(LeftHindLeg1, -1.9198621771937625F, -0.5082398928281348F, 0.0F);
        ...
        this.setRotateAngle(Head, -0.5269149104981519F, 0.03909537541112055F, 0.2562143561638466F);
        ...
        this.LeftHindLeg2.setRotationPoint(0.0F, 24.02F, 4.0F);
        ...
        this.RightHindLeg2.setRotationPoint(0.0F, 24.02F, 0.0F);
        ...
        this.LeftHindLeg3.setRotationPoint(0.0F, 24.6F, -2.0F);
