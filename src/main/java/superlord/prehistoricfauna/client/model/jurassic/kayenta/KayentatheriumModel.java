		...
		resetModel();
			if (entity.isAsleep()) {
				if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
					this.Body.y = Mth.lerp(sleepProgress, 18, 20);
					this.Body.z = Mth.lerp(sleepProgress, -7, -6.0F);
					this.Head.xRot = Mth.lerp(sleepProgress, 0, 0.46931902520863084F);
					this.LeftLeg.xRot = Mth.lerp(sleepProgress, 0, 1.602910321115726F);
					...
					this.LeftArm.xRot = Mth.lerp(sleepProgress, 0, -1.0164797856562695F);
					this.LeftArm.yRot = Mth.lerp(sleepProgress, 0, -0.8991936386169619F);
					this.RightArm.xRot = Mth.lerp(sleepProgress, 0, -1.0164797856562695F);
					this.RightArm.yRot = Mth.lerp(sleepProgress, 0, 0.8991936386169619F);
					this.RightLeg.xRot = Mth.lerp(sleepProgress, 0, 1.6030848913251807F);
					this.RightLeg.yRot = Mth.lerp(sleepProgress, 0, -0.3909537457888271F);
				} else sleepPose();
			} else {
				if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
					this.Body.y = Mth.lerp(sleepProgress, 20, 18);
					this.Body.z = Mth.lerp(sleepProgress, -6, -7.0F);
					this.Head.xRot = Mth.lerp(sleepProgress, 0.46931902520863084F, 0);
					this.LeftLeg.xRot = Mth.lerp(sleepProgress, 1.602910321115726F, 0);
					...
					this.LeftArm.xRot = Mth.lerp(sleepProgress, -1.0164797856562695F, 0);
					this.LeftArm.yRot = Mth.lerp(sleepProgress, -0.8991936386169619F, 0);
					this.RightArm.xRot = Mth.lerp(sleepProgress, -1.0164797856562695F, 0);
					this.RightArm.yRot = Mth.lerp(sleepProgress, 0.8991936386169619F, 0);
					this.RightLeg.xRot = Mth.lerp(sleepProgress, 1.6030848913251807F, 0);
