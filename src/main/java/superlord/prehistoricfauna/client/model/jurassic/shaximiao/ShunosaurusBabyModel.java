...
public class ShunosaurusBabyModel extends EntityModel<Shunosaurus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Root = partdefinition.addOrReplaceChild("Root", CubeListBuilder.create(), PartPose.offset(0.0F, 16.0F, 4.5F));

		PartDefinition Body = Root.addOrReplaceChild("Body", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Chest = Body.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, -4.0F, -10.5F, 6.0F, 7.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, 0.0F));

		PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(26, 20).addBox(-1.0F, -0.2552F, -8.851F, 2.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.25F, -8.0F, -0.5672F, 0.0F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(42, 33).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.01F))
		.texOffs(42, 38).addBox(-1.0F, 1.0F, -4.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.01F))
		.texOffs(42, 42).addBox(-0.5F, 0.0F, -4.0F, 1.0F, 1.0F, 2.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, 0.7448F, -8.851F, 0.829F, 0.0F, 0.0F));

		PartDefinition Tail1 = Chest.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(0, 20).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.25F, 1.5F, -0.1309F, 0.0F, 0.0F));

		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 33).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 8.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(38, 0).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.5F, 1.0F, -8.5F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(38, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 1.0F, -8.5F));

		PartDefinition LeftLeg = Root.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(24, 33).addBox(-1.0F, -1.5F, -1.5F, 2.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, 0.5F, 0.0F));

		PartDefinition RightLeg = Root.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(24, 33).mirror().addBox(-1.0F, -1.5F, -1.5F, 2.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 0.5F, 0.0F));
	...
	public void setupAnim(Shunosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Root.y = Mth.lerp(sleepProgress, 16, 20F);
				...
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0, -0.13039819087864056F);
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.1309F, -0.24260075936930908F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, 0.2864306020384839F);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.1309F, 0.44260075936930908F);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0, 0.3864306020384839F);
				this.Tail2.zRot = Mth.lerp(sleepProgress, 0, 0.2127630032889644F);
				...
				this.Neck.z = Mth.lerp(sleepProgress, -8, -10);
				this.Neck.xRot = Mth.lerp(sleepProgress, -0.5672F, 0.4162978572970231F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -0.7294172592861477F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, 0.11728612207217244F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Root.y = Mth.lerp(sleepProgress, 20, 16F);
				...
				this.RightArm.yRot = Mth.lerp(sleepProgress, -0.13039819087864056F, 0);
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.24260075936930908F, -0.1309F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0.2864306020384839F, 0);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.44260075936930908F, 0.1309F);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0.3864306020384839F, 0);
				this.Tail2.zRot = Mth.lerp(sleepProgress, 0.2127630032889644F, 0);
				...
				this.Neck.z = Mth.lerp(sleepProgress, -10, -8);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.4162978572970231F, -0.5672F);
				this.Neck.yRot = Mth.lerp(sleepProgress, -0.7294172592861477F, 0);
...
//				this.Body.xRot = Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 2));
				...
				this.Tail1.xRot = (-Math.abs(-0.05F * Mth.sin(0.05F * ageInTicks / 5))) + (Mth.cos(1.0F + (limbSwing / 2) * speed * 0.3F) * degree * 0.2F * limbSwingAmount - 0.1309F);
				...
				this.Tail2.xRot = (-Math.abs(-0.05F * Mth.sin(0.05F * ageInTicks / 5))) + (Mth.cos(1.0F + (limbSwing / 2) * speed * 0.3F) * degree * 0.2F * limbSwingAmount + 0.1309F);
				...
				this.Neck.xRot = (Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 2))) + (Mth.cos((limbSwing / 2) * speed * 0.3F) * degree * 0.15F * limbSwingAmount - 0.5672F) + (headPitch * ((float) Math.PI / 180F)) + (attackProgress * (float)Math.toRadians(50) - 25F);
				this.Neck.yRot = (Mth.cos((limbSwing / 2) * speed * 0.15F) * degree * 0.1F * limbSwingAmount) + (netHeadYaw * ((float) Math.PI / 180F));
				this.Head.xRot = (-Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 2))) + (Mth.cos((limbSwing / 2) * speed * 0.3F) * degree * 0.1F * limbSwingAmount + 0.829F);
...
//				this.Body.xRot = attackProgress * (float)Math.toRadians(-50);
	...
	public void sleepPose() {
		...
		this.Neck.z = -10;
		this.Neck.xRot = 0.4162978572970231F;
		this.Neck.yRot = -0.7294172592861477F;
