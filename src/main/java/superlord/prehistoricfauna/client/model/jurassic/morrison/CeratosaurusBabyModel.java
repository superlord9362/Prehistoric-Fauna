	...
	public void setupAnim(Ceratosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RForeleg.xRot = Mth.lerp(sleepProgress, 0, 0.8932595164970201F);
				this.RForeleg.yRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				this.Torso.y = Mth.lerp(sleepProgress, 13, 16.5F);
				this.Torso.xRot = Mth.lerp(sleepProgress, 0, -0.10471975511965977F);
				this.Head.x = Mth.lerp(sleepProgress, 0, 1);
				this.Head.z = Mth.lerp(sleepProgress, -1, -1);
				this.Head.xRot = Mth.lerp(sleepProgress, 0, -0.7864453849170947F);
				this.Head.yRot = Mth.lerp(sleepProgress, 0, 0.6658431362674476F);
				this.Head.zRot = Mth.lerp(sleepProgress, 0, -1.1339404363260046F);
				this.TailBase.z = Mth.lerp(sleepProgress, 11, 11.5F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0, -0.3490658503988659F);
				this.RFoot.xRot = Mth.lerp(sleepProgress, 0, -0.8377580409572781F);
				this.LFoot.xRot = Mth.lerp(sleepProgress, 0, -0.8377580409572781F);
				...
				this.LLeg.x = Mth.lerp(sleepProgress, -1.5F, -2);
				this.LLeg.y = Mth.lerp(sleepProgress, 15.5F, 19.7F);
				this.LLeg.z = Mth.lerp(sleepProgress, 2, 2);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 0, -0.7330382858376184F);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				this.RLeg.x = Mth.lerp(sleepProgress, 1, 2);
				this.RLeg.y = Mth.lerp(sleepProgress, 15.5F, 20.7F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, -0.7330382858376184F);
				this.RLeg.yRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.LForeleg.xRot = Mth.lerp(sleepProgress, 0, 0.6066764186984569F);
				this.LForeleg.zRot = Mth.lerp(sleepProgress, 0, 0.10471975511965977F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RForeleg.xRot = Mth.lerp(sleepProgress, 0.8932595164970201F, 0);
				this.RForeleg.yRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				this.Torso.y = Mth.lerp(sleepProgress, 16.5F, 13F);
				this.Torso.xRot = Mth.lerp(sleepProgress, -0.10471975511965977F, 0);
				this.Head.x = Mth.lerp(sleepProgress, 1, 0);
				this.Head.z = Mth.lerp(sleepProgress, -1, -1);
				this.Head.xRot = Mth.lerp(sleepProgress, -0.7864453849170947F, 0);
				this.Head.yRot = Mth.lerp(sleepProgress, 0.6658431362674476F, 0);
				this.Head.zRot = Mth.lerp(sleepProgress, -1.1339404363260046F, 0);
				this.TailBase.z = Mth.lerp(sleepProgress, 11.5F, 11);
				this.TailBase.xRot = Mth.lerp(sleepProgress, -0.24434609527920614F, 0);
				this.TailBase.yRot = Mth.lerp(sleepProgress, -0.3490658503988659F, 0);
				this.RFoot.xRot = Mth.lerp(sleepProgress, -0.8377580409572781F, 0);
				this.LFoot.xRot = Mth.lerp(sleepProgress, -0.8377580409572781F, 0);
				...
				this.LLeg.x = Mth.lerp(sleepProgress, -2, -1.5F);
				this.LLeg.y = Mth.lerp(sleepProgress, 19.7F, 15.5F);
				this.LLeg.z = Mth.lerp(sleepProgress, 2, 2);
				this.LLeg.xRot = Mth.lerp(sleepProgress, -0.7330382858376184F, 0);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				this.RLeg.x = Mth.lerp(sleepProgress, 2, 1);
				this.RLeg.y = Mth.lerp(sleepProgress, 20.7F, 15.5F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, -0.7330382858376184F, 0);
				this.RLeg.yRot = Mth.lerp(sleepProgress, -0.24434609527920614F, 0);
				this.LForeleg.xRot = Mth.lerp(sleepProgress, 0.6066764186984569F, 0);
				this.LForeleg.zRot = Mth.lerp(sleepProgress, 0.10471975511965977F, 0);
			} else {
