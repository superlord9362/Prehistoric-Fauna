...
public class AllosaurusModel extends EntityModel<AllosaurusEntity> {
	...
	public void setRotationAngles(AllosaurusEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entityIn.isAsleep()) {
			this.Body2.rotateAngleX = 0.0781907508222411F;
			this.LeftLeg2.rotateAngleX = -0.8991936386169619F;
			this.LeftLeg2.rotateAngleY = -0.5082398928281348F;
			this.LeftLeg2.rotateAngleZ = 0.46914448828868976F;
			this.RightLeg2.rotateAngleX = -0.8600982340775168F;
			this.RightLeg2.rotationPointY = 13.0F;
			this.Tail1.rotateAngleX = -0.4300491170387584F;
			this.Tail1.rotateAngleY = 0.19547687289441354F;
			this.Head1.rotationPointZ = -7;
			this.Head1.rotateAngleX = -1.7201964681550337F;
			this.Head1.rotateAngleY = 0.03909537541112055F;
			this.Head1.rotateAngleZ = -0.0781907508222411F;
			this.RightLeg1.rotationPointX = 1;
			this.RightLeg1.rotationPointY = 10;
			this.RightLeg1.rotateAngleX = -0.7428121536172364F;
			this.RightLeg1.rotateAngleY = 0.23457224414434488F;
			this.RightFoot.rotationPointZ = -3F;
			this.RightFoot.rotateAngleX = 1.602910321115726F;
			this.Neck.rotationPointY = -4.0F;
			this.Neck.rotateAngleX = 1.681101130194616F;
			this.Neck.rotateAngleY = 0.03909537541112055F;
			this.Neck.rotateAngleZ = 0.27366763203903305F;
			this.Tail2.rotateAngleX = -0.19547687289441354F;
			this.Tail2.rotateAngleY = 0.3909537457888271F;
			this.Body1.rotationPointY = 6.0F;
			this.Body1.rotateAngleX = 0.0781907508222411F;
			this.Body1.rotateAngleZ = -0.46914448828868976F;
			this.LeftFoot.rotationPointZ = -3.0F;
			this.LeftFoot.rotateAngleX = 1.4465288361160007F;
			this.LeftFoot.rotateAngleY = 0.27366763203903305F;
			this.RightArm.rotateAngleX = -1.4856243072344728F;
			this.RightArm.rotateAngleY = 0.3909537457888271F;
			this.RightArm.rotateAngleZ = 0.3513347637790725F;
			this.LeftArm.rotateAngleX = -0.35185837453889574F;
			this.LeftArm.rotateAngleZ = -0.4300491170387584F;
			this.LeftLeg1.rotationPointX = 3;
			this.LeftLeg1.rotationPointY = 9;
			this.LeftLeg1.rotateAngleX = -0.547160727158125F;
			this.LeftLeg1.rotateAngleY = -0.35185837453889574F;
			this.LeftLeg1.rotateAngleZ = -0.3909537457888271F;
		} else {
	...
	public void resetModel() {
		...
		this.Body1.rotateAngleZ = 0;
		this.LeftFoot.rotationPointZ = 2.0F;
		...
		this.LeftLeg1.rotationPointX = 1.0F;
