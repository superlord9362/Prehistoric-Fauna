...
public class TorvosaurusBabyModel extends EntityModel<Torvosaurus> {
	...
	public TorvosaurusBabyModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 19).addBox(-2.5F, -6.0F, -5.0F, 5.0F, 6.0F, 12.0F, new CubeDeformation(0.0F))
				.texOffs(0, 37).addBox(0.0F, -7.0F, -2.0F, 0.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 18.0F, 0.0F));

		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(2, 2).addBox(-1.0F, -0.9F, 0.0F, 2.0F, 3.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.0F, 6.0F));

		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(34, 19).addBox(-1.0F, -4.75F, -4.0F, 2.0F, 7.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(18, 37).addBox(0.0F, -5.75F, -2.0F, 0.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.25F, -4.0F, 0.3491F, 0.0F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(36, 9).addBox(-1.0F, -2.0F, -3.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(36, 0).addBox(-0.5F, -2.0F, -8.0F, 2.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -2.5F, -2.5F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition LeftLeg = LeftThigh.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(24, 37).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 5.0F, 2.0F));
		...
		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(24, 37).mirror().addBox(-0.5F, 0.0F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 5.0F, 2.0F));
		...
		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(12, 37).addBox(0.0F, 0.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, -2.0F, -3.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(12, 37).mirror().addBox(0.0F, 0.0F, -2.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.5F, -2.0F, -3.0F, 0.0F, 0.0F, 0.0873F));
