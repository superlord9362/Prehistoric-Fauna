	...
	public void setupAnim(Allosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RFoot.xRot = Mth.lerp(sleepProgress, 0, -0.9F);
				this.RFoot.yRot = Mth.lerp(sleepProgress, 0, -0.5082398928281348F);
				this.RFoot.zRot = Mth.lerp(sleepProgress, 0, 0);
				this.LFoot.xRot = Mth.lerp(sleepProgress, 0, -0.8600982340775168F);
				this.LFoot.y = Mth.lerp(sleepProgress, 4.3F, 4.5F);
				this.TailBase.y = Mth.lerp(sleepProgress, 1.1F, 1.5F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, 0, -0.4300491170387584F);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				...
				this.LLeg.x = Mth.lerp(sleepProgress, -2, -1);
				this.LLeg.y = Mth.lerp(sleepProgress, 14.5F, 21);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 0, -0.7428121536172364F);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0, 0.23457224414434488F);
				...
				this.Torso.y = Mth.lerp(sleepProgress, 11, 18.0F);
				this.Torso.xRot = Mth.lerp(sleepProgress, 0, 0.0781907508222411F);
				this.Torso.zRot = Mth.lerp(sleepProgress, 0, -0.46914448828868976F);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0, -1.4856243072344728F);
				this.LArm.yRot = Mth.lerp(sleepProgress, 0, 0.3909537457888271F);
				this.LArm.zRot = Mth.lerp(sleepProgress, 0, 0.3513347637790725F);
				this.RArm.xRot = Mth.lerp(sleepProgress, 0, -0.35185837453889574F);
				this.RArm.zRot = Mth.lerp(sleepProgress, 0, -0.4300491170387584F);
				this.RLeg.x = Mth.lerp(sleepProgress, 2, 2.5F);
				this.RLeg.y = Mth.lerp(sleepProgress, 14.5F, 19);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, -0.547160727158125F);
				this.RLeg.yRot = Mth.lerp(sleepProgress, 0, -0.35185837453889574F);
				this.RLeg.zRot = Mth.lerp(sleepProgress, 0, -0.3909537457888271F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RFoot.xRot = Mth.lerp(sleepProgress, -0.9F, 0);
				this.RFoot.yRot = Mth.lerp(sleepProgress, -0.5082398928281348F, 0);
				this.RFoot.zRot = Mth.lerp(sleepProgress, 0, 0);
				this.LFoot.xRot = Mth.lerp(sleepProgress, -0.8600982340775168F, 0);
				this.LFoot.y = Mth.lerp(sleepProgress, 4.5F, 4.3F);
				this.TailBase.y = Mth.lerp(sleepProgress, 1.5F, 1.1F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, -0.4300491170387584F, 0);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				...
				this.LLeg.x = Mth.lerp(sleepProgress, -1, -2);
				this.LLeg.y = Mth.lerp(sleepProgress, 21F, 14.5F);
				this.LLeg.xRot = Mth.lerp(sleepProgress, -0.7428121536172364F, 0);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0.23457224414434488F, 0);
				...
				this.Torso.y = Mth.lerp(sleepProgress, 18, 11.0F);
				this.Torso.xRot = Mth.lerp(sleepProgress, 0.0781907508222411F, 0);
				this.Torso.zRot = Mth.lerp(sleepProgress, -0.46914448828868976F, 0);
				this.LArm.xRot = Mth.lerp(sleepProgress, -1.4856243072344728F, 0);
				this.LArm.yRot = Mth.lerp(sleepProgress, 0.3909537457888271F, 0);
				this.LArm.zRot = Mth.lerp(sleepProgress, 0.3513347637790725F, 0);
				this.RArm.xRot = Mth.lerp(sleepProgress, -0.35185837453889574F, 0);
				this.RArm.zRot = Mth.lerp(sleepProgress, -0.4300491170387584F, 0);
				this.RLeg.x = Mth.lerp(sleepProgress, 2.5F, 2F);
				this.RLeg.y = Mth.lerp(sleepProgress, 19F, 14.5F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, -0.547160727158125F, 0);
				this.RLeg.yRot = Mth.lerp(sleepProgress, -0.35185837453889574F, 0);
				this.RLeg.zRot = Mth.lerp(sleepProgress, -0.3909537457888271F, 0);
			} else {
