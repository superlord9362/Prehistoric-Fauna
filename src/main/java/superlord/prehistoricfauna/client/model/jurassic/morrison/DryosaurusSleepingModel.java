...
public class DryosaurusSleepingModel extends EntityModel<DryosaurusEntity> {
    ...
    public DryosaurusSleepingModel() {
        ...
        this.RLeg2 = new ModelRenderer(this, 6, 0);
        this.RLeg2.setRotationPoint(-0.5F, 6.0F, 3.0F);
        this.RLeg2.addBox(-1.0F, 0.0F, 0.0F, 2.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RLeg2, -0.6981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.8600982340775168F, 0.9779079585871342F, 0.0F);
        this.LLeg2 = new ModelRenderer(this, 6, 0);
        this.LLeg2.mirror = true;
        this.LLeg2.setRotationPoint(0.5F, 6.0F, 3.0F);
        this.LLeg2.addBox(-1.1F, 0.0F, 0.0F, 2.0F, 11.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LLeg2, -0.6981317007977318F, 0.0F, 0.0F);
        ...
        this.RLeg1.setRotationPoint(3.5F, 17.8F, 3.5F);
        ...
        this.Body.setRotationPoint(0.0F, 11.7F, -10.0F);
        ...
        this.LLeg1.setRotationPoint(-3.5F, 17.8F, 3.5F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.RLeg1, this.Body, this.LLeg1).forEach((modelRenderer) -> { 
