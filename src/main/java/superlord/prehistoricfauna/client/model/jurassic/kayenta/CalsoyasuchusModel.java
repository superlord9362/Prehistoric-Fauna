	...
	public void setupAnim(Calsoyasuchus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.belly.y = Mth.lerp(sleepProgress, 20, 22.0F);
				this.belly.z = Mth.lerp(sleepProgress, -1, -1.0F);
				this.FrontR.x = Mth.lerp(sleepProgress, 1, 1.0F);
				this.FrontR.y = Mth.lerp(sleepProgress, 21, 23.3F);
				this.FrontR.z = Mth.lerp(sleepProgress, -3, -3.0F);
				this.BackR.x = Mth.lerp(sleepProgress, 1, 1.0F);
				this.BackR.y = Mth.lerp(sleepProgress, 21, 23.0F);
				this.BackR.z = Mth.lerp(sleepProgress, 4, 4.0F);
				this.FrontL.x = Mth.lerp(sleepProgress, -1, -1.0F);
				this.FrontL.y = Mth.lerp(sleepProgress, 21, 23.3F);
				this.FrontL.z = Mth.lerp(sleepProgress, -3, -3.0F);
				this.BackL.x = Mth.lerp(sleepProgress, -1, -1.0F);
				this.BackL.y = Mth.lerp(sleepProgress, 21, 23.0F);
				this.BackL.z = Mth.lerp(sleepProgress, 4, 4.0F);
				this.tail.xRot = Mth.lerp(sleepProgress, 0, -0.0572467989660713F);
				this.tail.yRot = Mth.lerp(sleepProgress, 0, 0.3909537457888271F);
				this.FrontL.zRot = Mth.lerp(sleepProgress, 0, 1.0946705281561322F);
				this.head.xRot = Mth.lerp(sleepProgress, 0, 0.11728612207217244F);
				this.head.yRot = Mth.lerp(sleepProgress, 0, -0.3909537457888271F);
				this.hand_1.zRot = Mth.lerp(sleepProgress, 0, 1.1728612040769677F);
				this.hand.zRot = Mth.lerp(sleepProgress, 0, -1.0946705281561322F);
				this.feet_1.zRot = Mth.lerp(sleepProgress, 0, 0.9382889765773795F);
				this.feet.zRot = Mth.lerp(sleepProgress, 0, -0.9382889765773795F);
				this.BackL.zRot = Mth.lerp(sleepProgress, 0, 0.9382889765773795F);
				this.BackR.zRot = Mth.lerp(sleepProgress, 0, -0.9382889765773795F);
				this.FrontR.zRot = Mth.lerp(sleepProgress, 0, -1.1728612040769677F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.belly.y = Mth.lerp(sleepProgress, 22, 20.0F);
				this.belly.z = Mth.lerp(sleepProgress, -1, -1.0F);
				this.FrontR.x = Mth.lerp(sleepProgress, 1, 1.0F);
				this.FrontR.y = Mth.lerp(sleepProgress, 23.3F, 21F);
				this.FrontR.z = Mth.lerp(sleepProgress, -3, -3.0F);
				this.BackR.x = Mth.lerp(sleepProgress, 1, 1.0F);
				this.BackR.y = Mth.lerp(sleepProgress, 23, 21.0F);
				this.BackR.z = Mth.lerp(sleepProgress, 4, 4.0F);
				this.FrontL.x = Mth.lerp(sleepProgress, -1, -1.0F);
				this.FrontL.y = Mth.lerp(sleepProgress, 23.3F, 21F);
				this.FrontL.z = Mth.lerp(sleepProgress, -3, -3.0F);
				this.BackL.x = Mth.lerp(sleepProgress, -1, -1.0F);
				this.BackL.y = Mth.lerp(sleepProgress, 23, 21.0F);
				this.BackL.z = Mth.lerp(sleepProgress, 4, 4.0F);
				this.tail.xRot = Mth.lerp(sleepProgress, -0.0572467989660713F, 0);
				this.tail.yRot = Mth.lerp(sleepProgress, 0.3909537457888271F, 0);
				this.FrontL.zRot = Mth.lerp(sleepProgress, 1.0946705281561322F, 0);
				this.head.xRot = Mth.lerp(sleepProgress, 0.11728612207217244F, 0);
				this.head.yRot = Mth.lerp(sleepProgress, -0.3909537457888271F, 0);
				this.hand_1.zRot = Mth.lerp(sleepProgress, 1.1728612040769677F, 0);
				this.hand.zRot = Mth.lerp(sleepProgress, -1.0946705281561322F, 0);
				this.feet_1.zRot = Mth.lerp(sleepProgress, 0.9382889765773795F, 0);
				this.feet.zRot = Mth.lerp(sleepProgress, -0.9382889765773795F, 0);
				this.BackL.zRot = Mth.lerp(sleepProgress, 0.9382889765773795F, 0);
				this.BackR.zRot = Mth.lerp(sleepProgress, -0.9382889765773795F, 0);
				this.FrontR.zRot = Mth.lerp(sleepProgress, -1.1728612040769677F, 0);
			} else {
