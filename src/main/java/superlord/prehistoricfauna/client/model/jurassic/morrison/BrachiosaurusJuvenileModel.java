...
public class BrachiosaurusJuvenileModel extends EntityModel<Brachiosaurus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hips = Root.addOrReplaceChild("Hips", CubeListBuilder.create(), PartPose.offset(0.0F, -22.0F, 14.0F));

		PartDefinition cube_r1 = Hips.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(82, 54).addBox(-8.0F, -22.0F, -5.0F, 16.0F, 22.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, -8.0F, -0.2182F, 0.0F, 0.0F));

		PartDefinition Chest = Hips.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-11.0F, -29.0F, -1.0F, 22.0F, 29.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, -32.0F));

		PartDefinition Neck1 = Chest.addOrReplaceChild("Neck1", CubeListBuilder.create().texOffs(94, 0).addBox(-3.5F, -28.0F, -10.5F, 7.0F, 39.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -30.0F, 6.5F, 0.2618F, 0.0F, 0.0F));

		PartDefinition Neck2 = Neck1.addOrReplaceChild("Neck2", CubeListBuilder.create().texOffs(0, 97).addBox(-1.5F, -35.0F, -5.0F, 3.0F, 37.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -28.0F, -2.0F, -0.1745F, 0.0F, 0.0F));

		PartDefinition Head = Neck2.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(64, 97).addBox(-2.0F, -1.0F, -4.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(64, 106).addBox(-1.5F, 1.0F, -8.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(64, 113).addBox(-1.0F, -2.0F, -6.0F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(132, 20).addBox(-0.5F, 4.0F, -5.5F, 1.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -34.0F, -3.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition LeftArm = Chest.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(20, 97).mirror().addBox(-4.0F, -3.0F, -3.0F, 5.0F, 29.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(94, 51).mirror().addBox(-5.0F, 25.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(11.0F, -10.0F, 5.0F));

		PartDefinition RightArm = Chest.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(20, 97).addBox(-1.0F, -3.0F, -3.0F, 5.0F, 29.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(94, 51).addBox(4.0F, 25.0F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-11.0F, -10.0F, 5.0F));

		PartDefinition Tail1 = Hips.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(82, 95).addBox(-4.0F, -2.0F, 0.0F, 8.0F, 9.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 7.0F, -0.1745F, 0.0F, 0.0F));

		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 54).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 5.0F, 38.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 15.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition LeftThigh = Root.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(64, 121).mirror().addBox(-4.0F, -3.0F, -5.0F, 6.0F, 13.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(8.0F, -22.0F, 14.0F));

		PartDefinition LeftLeg = LeftThigh.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(20, 132).mirror().addBox(-2.0F, 0.0F, 0.0F, 4.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.0F, 10.0F, -2.0F));

		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(132, 0).mirror().addBox(-2.5F, 0.0F, -5.975F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 10.0F, 4.0F));

		PartDefinition RightThigh = Root.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(64, 121).addBox(-2.0F, -3.0F, -5.0F, 6.0F, 13.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(-8.0F, -22.0F, 14.0F));

		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(20, 132).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 10.0F, -2.0F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(132, 0).addBox(-2.5F, 0.0F, -5.975F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.0F, 4.0F));
	...
	public void setupAnim(Brachiosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Hips.y = Mth.lerp(sleepProgress, -22, -7F);
				...
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.1745F, -0.34260075936930908F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, 0.2864306020384839F);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.0873F, 0.3518657326886875F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0, -1.2589378856769737F);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0, -0.03039819087864056F);
				this.LeftThigh.y = Mth.lerp(sleepProgress, -22, -9.75F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -22, -9.75F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.34260075936930908F, -0.1745F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0.2864306020384839F, 0);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.3518657326886875F, 0.0873F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, -1.2589378856769737F, 0);
				this.RightArm.yRot = Mth.lerp(sleepProgress, -0.03039819087864056F, 0);
				this.LeftThigh.y = Mth.lerp(sleepProgress, -9.75F, -22);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -9.75F, -22);
				...
				this.Neck1.xRot = (Math.abs(-0.025F * Mth.sin(0.1F * ageInTicks / 3))) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount + 0.2618F) + (headPitch * ((float) Math.PI / 180F)) + (attackProgress * (float)Math.toRadians(50) - 25F);
