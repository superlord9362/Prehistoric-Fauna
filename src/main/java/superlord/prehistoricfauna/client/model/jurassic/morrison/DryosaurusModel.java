	...
	public void setupAnim(Dryosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.45378560551852565F);
				this.LLeg1.xRot = Mth.lerp(sleepProgress, 0, -0.8726646259971648F);
				this.LLeg1.yRot = Mth.lerp(sleepProgress, 0, -0.296705972839036F);
				this.LLeg1.y = Mth.lerp(sleepProgress, 5, 3.2F);
				this.LArm.z = Mth.lerp(sleepProgress, 3, 2.5F);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0, 0.8726646259971648F);
				this.LLeg3.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.RLeg3.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Body.y = Mth.lerp(sleepProgress, 5, 12);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.Tail2.x = Mth.lerp(sleepProgress, 0, 0.5F);
				this.Tail2.z = Mth.lerp(sleepProgress, 15, 14.4F);
				...
				this.RLeg1.y = Mth.lerp(sleepProgress, 5, 3.2F);
				this.RLeg1.xRot = Mth.lerp(sleepProgress, 0, -0.8726646259971648F);
				this.RLeg1.yRot = Mth.lerp(sleepProgress, 0, 0.296705972839036F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.8726646259971648F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, 0.9773843811168246F);
				this.Head.x = Mth.lerp(sleepProgress, 0, 0.5F);
				this.Head.z = Mth.lerp(sleepProgress, -1, -1.5F);
				this.Head.xRot = Mth.lerp(sleepProgress, 0, 0.5585053606381855F);
				this.Head.yRot = Mth.lerp(sleepProgress, 0, 1.3962634015954636F);
				this.RLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.45378560551852565F);
				this.RArm.xRot = Mth.lerp(sleepProgress, 0, 0.8726646259971648F);
				this.RArm.z = Mth.lerp(sleepProgress, 3, 2.5F);
				this.Tail1.x = Mth.lerp(sleepProgress, 0, 0.7F);
				this.Tail1.z = Mth.lerp(sleepProgress, 19, 18);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LLeg2.xRot = Mth.lerp(sleepProgress, -0.45378560551852565F, 0);
				this.LLeg1.xRot = Mth.lerp(sleepProgress, -0.8726646259971648F, 0);
				this.LLeg1.yRot = Mth.lerp(sleepProgress, -0.296705972839036F, 0);
				this.LLeg1.y = Mth.lerp(sleepProgress, 3.2F, 5F);
				this.LArm.z = Mth.lerp(sleepProgress, 2.5F, 3F);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0.8726646259971648F, 0);
				this.LLeg3.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.RLeg3.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 12, 5);
				this.Body.xRot = Mth.lerp(sleepProgress, -0.24434609527920614F, 0);
				this.Tail2.x = Mth.lerp(sleepProgress, 0.5F, 0);
				this.Tail2.z = Mth.lerp(sleepProgress, 14.4F, 15);
				...
				this.RLeg1.y = Mth.lerp(sleepProgress, 3.2F, 5F);
				this.RLeg1.xRot = Mth.lerp(sleepProgress, -0.8726646259971648F, 0);
				this.RLeg1.yRot = Mth.lerp(sleepProgress, 0.296705972839036F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.8726646259971648F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0.9773843811168246F, 0);
				this.Head.x = Mth.lerp(sleepProgress, 0.5F, 0);
				this.Head.z = Mth.lerp(sleepProgress, -1.5F, -1);
				this.Head.xRot = Mth.lerp(sleepProgress, 0.5585053606381855F, 0);
				this.Head.yRot = Mth.lerp(sleepProgress, 1.3962634015954636F, 0);
				this.RLeg2.xRot = Mth.lerp(sleepProgress, -0.45378560551852565F, 0);
				this.RArm.xRot = Mth.lerp(sleepProgress, 0.8726646259971648F, 0);
				this.RArm.z = Mth.lerp(sleepProgress, 2.5F, 3);
				this.Tail1.x = Mth.lerp(sleepProgress, 0.7F, 0F);
				this.Tail1.z = Mth.lerp(sleepProgress, 18, 19);
