...
public class BrontosaurusJuvenileModel extends EntityModel<Brontosaurus> {
	...
	public BrontosaurusJuvenileModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Root = partdefinition.addOrReplaceChild("Root", CubeListBuilder.create(), PartPose.offset(0.0F, 11.0F, -8.0F));

		PartDefinition Body = Root.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-8.0F, -10.0F, -29.0F, 16.0F, 22.0F, 35.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, 21.0F));

		PartDefinition Neck1 = Body.addOrReplaceChild("Neck1", CubeListBuilder.create().texOffs(0, 107).addBox(-4.0F, -2.0F, -16.0F, 8.0F, 12.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.0F, -28.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Neck1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(36, 103).mirror().addBox(0.0F, 0.0F, -16.0F, 0.0F, 3.0F, 18.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, 10.0F, 0.0F, 0.0F, 0.0F, 0.4363F));

		PartDefinition cube_r2 = Neck1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(36, 103).addBox(0.0F, 0.0F, -16.0F, 0.0F, 3.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 10.0F, 0.0F, 0.0F, 0.0F, -0.4363F));

		PartDefinition Neck2 = Neck1.addOrReplaceChild("Neck2", CubeListBuilder.create().texOffs(97, 50).addBox(-1.5F, -2.0F, -24.0F, 3.0F, 8.0F, 28.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, -16.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Neck2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(36, 103).addBox(0.0F, 0.0F, -19.0F, 0.0F, 3.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, 6.0F, 0.0F, 0.0F, 0.0F, 0.4363F));

		PartDefinition cube_r4 = Neck2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(36, 103).mirror().addBox(0.0F, 0.0F, -19.0F, 0.0F, 3.0F, 21.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(1.5F, 6.0F, 0.0F, 0.0F, 0.0F, -0.4363F));

		PartDefinition Head = Neck2.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(120, 34).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(124, 43).addBox(-2.0F, 2.0F, -8.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, -23.0F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r5 = Head.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(84, 107).addBox(-2.0F, -1.0F, -3.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 2.0F, -3.9F, 0.0873F, 0.0F, 0.0F));

		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(102, 0).addBox(-5.0F, -2.0F, -1.0F, 10.0F, 14.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 6.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(50, 57).addBox(-3.0F, -1.0F, -1.0F, 6.0F, 8.0F, 35.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 19.0F, 0.0436F, 0.0F, 0.0F));

		PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(0, 57).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 4.0F, 46.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 34.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(0, 57).addBox(-3.0F, -2.0F, -2.5F, 4.0F, 23.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(84, 111).addBox(-4.0F, 20.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, 4.0F, -24.5F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 57).mirror().addBox(-1.0F, -2.0F, -2.5F, 4.0F, 23.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(84, 111).mirror().addBox(3.0F, 20.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-8.0F, 4.0F, -24.5F));

		PartDefinition LeftThigh = Root.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(18, 57).addBox(-4.0F, -2.0F, -4.0F, 6.0F, 17.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(8.0F, -12.0F, 21.0F));

		PartDefinition LeftLeg = LeftThigh.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(102, 34).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 15.0F, -2.5F));

		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(102, 48).addBox(-2.5F, 1.0F, -6.0F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, 5.025F));

		PartDefinition RightThigh = Root.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(18, 57).mirror().addBox(-2.0F, -2.0F, -4.0F, 6.0F, 17.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-8.0F, -12.0F, 21.0F));

		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(102, 34).mirror().addBox(-2.0F, 0.0F, 0.0F, 4.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.0F, 15.0F, -2.5F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(102, 48).mirror().addBox(-2.5F, 1.0F, -6.0F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 7.0F, 5.025F));

		return LayerDefinition.create(meshdefinition, 162, 139);
	}
	...
	public void setupAnim(Brontosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, -12, 3.25F);
				...
				this.Neck1.y = Mth.lerp(sleepProgress, -9, -6);
				this.Neck1.xRot = Mth.lerp(sleepProgress, -0.2618F, 0.5231F);
				...
				this.LeftThigh.y = Mth.lerp(sleepProgress, -12, 1F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -12, 1F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 3.25F, -12);
				...
				this.Neck1.y = Mth.lerp(sleepProgress, -6, -9);
				this.Neck1.xRot = Mth.lerp(sleepProgress, 0.5231F, -0.2618F);
				...
				this.LeftThigh.y = Mth.lerp(sleepProgress, 1, -12F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 1F, -12);
	...
	public void resetModel() {
		...
		this.LeftArm.x = 8F;
		this.LeftArm.y = 4F;
		this.LeftArm.z = -24.5F;
		this.LeftArm.xRot = 0;
		this.LeftArm.yRot = 0;
		this.LeftArm.zRot = 0;
		this.LeftFoot.y = 7F;
		this.LeftFoot.z = 5.025F;
