...
public class CamarasaurusJuvenileModel extends EntityModel<Camarasaurus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Root = partdefinition.addOrReplaceChild("Root", CubeListBuilder.create(), PartPose.offset(0.0F, 9.5F, 0.0F));

		PartDefinition Body = Root.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-8.5F, -11.0F, -25.5F, 17.0F, 23.0F, 33.0F, new CubeDeformation(0.0F))
		.texOffs(43, 24).addBox(0.0F, -13.0F, -25.0F, 0.0F, 2.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.0F, 9.0F, -0.1309F, 0.0F, 0.0F));

		PartDefinition Neck1 = Body.addOrReplaceChild("Neck1", CubeListBuilder.create().texOffs(0, 95).addBox(-3.5F, -10.0F, -9.5F, 7.0F, 22.0F, 11.0F, new CubeDeformation(0.0F))
		.texOffs(14, 54).addBox(0.0F, -10.0F, 1.0F, 0.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, -25.5F, 0.829F, 0.0F, 0.0F));

		PartDefinition Neck2 = Neck1.addOrReplaceChild("Neck2", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -20.0F, -7.0F, 3.0F, 22.0F, 7.0F, new CubeDeformation(0.0F))
		.texOffs(0, 49).addBox(0.0F, -22.0F, -5.0F, 0.0F, 22.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.0F, -0.5F, -0.1745F, 0.0F, 0.0F));

		PartDefinition Head = Neck2.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(100, 33).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(100, 40).addBox(-2.0F, 2.0F, -6.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
		.texOffs(99, 29).addBox(-1.5F, 0.0F, -5.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -20.0F, -5.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(0, 56).addBox(-3.5F, -1.0F, -1.0F, 7.0F, 10.0F, 29.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.0F, 7.5F, -0.0873F, 0.0F, 0.0F));

		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(72, 58).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 5.0F, 28.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 28.0F, 0.0873F, 0.0F, 0.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(67, 0).addBox(-3.0F, -2.0F, -2.5F, 4.0F, 21.0F, 5.0F, new CubeDeformation(0.0F))
		.texOffs(67, 0).addBox(-4.0F, 18.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.5F, 10.0F, -19.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(67, 0).mirror().addBox(-1.0F, -2.0F, -2.5F, 4.0F, 21.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(67, 0).mirror().addBox(3.0F, 18.0F, -1.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.5F, 10.0F, -19.0F, 0.1309F, 0.0F, 0.0F));

		PartDefinition LeftThigh = Root.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(36, 95).addBox(-4.0F, -3.0F, -4.0F, 6.0F, 17.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(8.5F, -12.5F, 9.0F));

		PartDefinition LeftLeg = LeftThigh.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(50, 120).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.5F, 14.0F, -2.5F));

		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(0, 128).addBox(-3.5F, 0.0F, -9.0F, 7.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 10.0F, 5.025F));

		PartDefinition RightThigh = Root.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(36, 95).mirror().addBox(-2.0F, -3.0F, -4.0F, 6.0F, 17.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-8.5F, -12.5F, 9.0F));

		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(50, 120).mirror().addBox(-2.5F, 0.0F, 0.0F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(1.5F, 14.0F, -2.5F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(0, 128).mirror().addBox(-3.5F, 0.0F, -9.0F, 7.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 10.0F, 5.025F));

		return LayerDefinition.create(meshdefinition, 136, 140);
	}
	...
	public void setupAnim(Camarasaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, -12, 3F);
				...
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.0873F, -0.24260075936930908F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, 0.2864306020384839F);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.0873F, 0.4518657326886875F);
				...
				this.LeftThigh.y = Mth.lerp(sleepProgress, -12.5F, 2.25F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -12.5F, 0.25F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 3F, -12);
				...
				this.Tail1.xRot = Mth.lerp(sleepProgress, -0.24260075936930908F, -0.0873F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0.2864306020384839F, 0);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.4518657326886875F, 0.0873F);
				...
				this.LeftThigh.y = Mth.lerp(sleepProgress, 2.25F, -12.5F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 0.25F, -12.5F);
