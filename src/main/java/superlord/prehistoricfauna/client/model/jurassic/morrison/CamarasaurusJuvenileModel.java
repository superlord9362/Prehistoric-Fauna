	...
	public void setupAnim(Camarasaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.body.y = Mth.lerp(sleepProgress, -15, 10F);
				this.body.yRot = Mth.lerp(sleepProgress, 0, -0.038920842652368684F);
				this.body.zRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.RightFrontLeg.x = Mth.lerp(sleepProgress, 14.5F, 18.5F);
				this.RightFrontLeg.y = Mth.lerp(sleepProgress, 3, 14.0F);
				this.RightFrontLeg.z = Mth.lerp(sleepProgress, -46, -46.0F);
				...
				this.Tail1.y = Mth.lerp(sleepProgress, -10, -8F);
				this.Tail1.z = Mth.lerp(sleepProgress, 2.5F, 2.5F);
				...
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, -14.5F, -16.5F);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, 3, 13);
				this.LeftFrontLeg.z = Mth.lerp(sleepProgress, -46, -46);
				...
				this.LeftHindLeg3.y = Mth.lerp(sleepProgress, 20, 17.0F);
				this.LeftHindLeg3.z = Mth.lerp(sleepProgress, 1, 1.0F);
				...
				this.LeftHindLeg2.y = Mth.lerp(sleepProgress, 17, 17.1F);
				this.LeftHindLeg2.z = Mth.lerp(sleepProgress, 1, 1);
				...
				this.RightHindLeg3.y = Mth.lerp(sleepProgress, 20, 17.0F);
				this.RightHindLeg3.z = Mth.lerp(sleepProgress, 1, 1F);
				this.RightHindLeg2.y = Mth.lerp(sleepProgress, 17, 17.2F);
				this.RightHindLeg2.z = Mth.lerp(sleepProgress, 1, 1);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.LeftHindLeg1.x = Mth.lerp(sleepProgress, -15.5F, -16.5F);
				this.LeftHindLeg1.y = Mth.lerp(sleepProgress, -17, 9);
				this.LeftHindLeg1.z = Mth.lerp(sleepProgress, 17, 17);
				...
				this.RightHindLeg1.x = Mth.lerp(sleepProgress, 15.5F, 16.5F);
				this.RightHindLeg1.y = Mth.lerp(sleepProgress, -17, 9);
				...
				this.Neck1.x = Mth.lerp(sleepProgress, 0, -6F);
				this.Neck1.y = Mth.lerp(sleepProgress, -10, -10F);
				this.Neck1.z = Mth.lerp(sleepProgress, 3, 3);
				...
				this.Head.x = Mth.lerp(sleepProgress, 0, 0);
				this.Head.z = Mth.lerp(sleepProgress, -2, -2);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.body.y = Mth.lerp(sleepProgress, 10, -15F);
				this.body.yRot = Mth.lerp(sleepProgress, -0.038920842652368684F, 0);
				this.body.zRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.RightFrontLeg.x = Mth.lerp(sleepProgress, 18.5F, 14.5F);
				this.RightFrontLeg.y = Mth.lerp(sleepProgress, 14, 3.0F);
				this.RightFrontLeg.z = Mth.lerp(sleepProgress, -46, -46.0F);
				...
				this.Tail1.y = Mth.lerp(sleepProgress, -8, -10F);
				this.Tail1.z = Mth.lerp(sleepProgress, 2.5F, 2.5F);
				...
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, -16.5F, -14.5F);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, 13, 3);
				this.LeftFrontLeg.z = Mth.lerp(sleepProgress, -46, -46);
				...
				this.LeftHindLeg3.y = Mth.lerp(sleepProgress, 17, 20.0F);
				this.LeftHindLeg3.z = Mth.lerp(sleepProgress, 1, 1.0F);
				...
				this.LeftHindLeg2.y = Mth.lerp(sleepProgress, 17.1F, 17);
				this.LeftHindLeg2.z = Mth.lerp(sleepProgress, 1, 1);
				...
				this.RightHindLeg3.y = Mth.lerp(sleepProgress, 17.0F, 20.0F);
				this.RightHindLeg3.z = Mth.lerp(sleepProgress, 1, 1F);
				this.RightHindLeg2.y = Mth.lerp(sleepProgress, 17.2F, 17);
				this.RightHindLeg2.z = Mth.lerp(sleepProgress, 1, 1);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.LeftHindLeg1.x = Mth.lerp(sleepProgress, -16.5F, -15.5F);
				this.LeftHindLeg1.y = Mth.lerp(sleepProgress, 9, -17);
				this.LeftHindLeg1.z = Mth.lerp(sleepProgress, 17, 17);
				...
				this.RightHindLeg1.x = Mth.lerp(sleepProgress, 16.5F, 15.5F);
				this.RightHindLeg1.y = Mth.lerp(sleepProgress, 9, -17);
				...
				this.Neck1.x = Mth.lerp(sleepProgress, -6, 0F);
				this.Neck1.y = Mth.lerp(sleepProgress, -10, -10F);
				this.Neck1.z = Mth.lerp(sleepProgress, 3, 3);
