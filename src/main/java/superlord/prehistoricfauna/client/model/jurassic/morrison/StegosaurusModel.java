	...
	public void setupAnim(Stegosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Neck.x = Mth.lerp(sleepProgress, 0, 3);
				this.Neck.y = Mth.lerp(sleepProgress, 10, 11);
				...
				this.LeftThigh.x = Mth.lerp(sleepProgress, -8, -6);
				this.LeftThigh.y = Mth.lerp(sleepProgress, -8, 1);
				this.LeftThigh.z = Mth.lerp(sleepProgress, 15, 14);
				...
				this.RightArm.y = Mth.lerp(sleepProgress, 1, 21.2F);
				...
				this.Tail1.y = Mth.lerp(sleepProgress, 7, 8.0F);
				this.Tail1.z = Mth.lerp(sleepProgress, 44, 43);
				...
				this.Body.x = Mth.lerp(sleepProgress, 0, 17);
				this.Body.y = Mth.lerp(sleepProgress, -18, 6.6F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -8, 17.7F);
				...
				this.LeftArm.y = Mth.lerp(sleepProgress, 1, 5.0F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Neck.x = Mth.lerp(sleepProgress, 3, 0);
				this.Neck.y = Mth.lerp(sleepProgress, 11, 10);
				...
				this.LeftThigh.x = Mth.lerp(sleepProgress, -6, -8);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 1, -8);
				this.LeftThigh.z = Mth.lerp(sleepProgress, 14, 15);
				...
				this.RightArm.y = Mth.lerp(sleepProgress, 21.2F, 1F);
				...
				this.Tail1.y = Mth.lerp(sleepProgress, 8, 7.0F);
				this.Tail1.z = Mth.lerp(sleepProgress, 43, 44);
				...
				this.Body.x = Mth.lerp(sleepProgress, 17, 0);
				this.Body.y = Mth.lerp(sleepProgress, 6.6F, -18);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 17.7F, -8);
				...
				this.LeftArm.y = Mth.lerp(sleepProgress, 5, 1.0F);
