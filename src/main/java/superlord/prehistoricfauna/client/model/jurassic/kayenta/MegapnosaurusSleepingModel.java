...
public class MegapnosaurusSleepingModel extends EntityModel<MegapnosaurusEntity> {
    ...
    public MegapnosaurusSleepingModel() {
        ...
        this.Leg2.addBox(-1.5F, -5.8F, -1.4F, 3.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.Leg2_1.addBox(-1.5F, -5.8F, -1.4F, 3.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Body, this.Leg, this.Leg_1).forEach((modelRenderer) -> { 
