	...
	public void setupAnim(Camarasaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.body.y = Mth.lerp(sleepProgress, -41, -4.8F);
				this.body.yRot = Mth.lerp(sleepProgress, 0, -0.038920842652368684F);
				this.body.zRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.RightFrontLeg.x = Mth.lerp(sleepProgress, 19.5F, 25.5F);
				this.RightFrontLeg.y = Mth.lerp(sleepProgress, 14, 17.0F);
				this.RightFrontLeg.z = Mth.lerp(sleepProgress, -42, -43.0F);
				this.RightFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -1.1405726395466833F);
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, 0, -0.039269908169872414F);
				this.RightFrontLeg.zRot = Mth.lerp(sleepProgress, 0, 0.3909537457888271F);
				this.Tail1.z = Mth.lerp(sleepProgress, 26, 21);
				...
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, -19.5F, -25.5F);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, 14, 12);
				this.LeftFrontLeg.z = Mth.lerp(sleepProgress, -42, -41);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -1.2189378856769737F);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, 0, -0.43039819087864056F);
				this.LeftHindLeg3.y = Mth.lerp(sleepProgress, 30, 26.2F);
				this.LeftHindLeg3.z = Mth.lerp(sleepProgress, 1, -3.0F);
				this.LeftHindLeg3.xRot = Mth.lerp(sleepProgress, 0, 0.3874631072585466F);
				this.LeftHindLeg3.zRot = Mth.lerp(sleepProgress, 0, -0.10471975511965977F);
				this.LeftHindLeg2.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.LeftHindLeg2.y = Mth.lerp(sleepProgress, 24, 24.02F);
				this.LeftHindLeg2.z = Mth.lerp(sleepProgress, 3, 0);
				this.Neck2.xRot = Mth.lerp(sleepProgress, 0, 0.02775073568927633F);
				this.Neck2.yRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.Neck2.zRot = Mth.lerp(sleepProgress, 0, 1.2510520131558576F);
				this.RightHindLeg3.xRot = Mth.lerp(sleepProgress, 0, 0.3490658503988659F);
				this.RightHindLeg3.y = Mth.lerp(sleepProgress, 30, 24.6F);
				this.RightHindLeg3.z = Mth.lerp(sleepProgress, 1, -2F);
				this.RightHindLeg2.y = Mth.lerp(sleepProgress, 24, 24.02F);
				this.RightHindLeg2.z = Mth.lerp(sleepProgress, 3, 4);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.LeftHindLeg1.x = Mth.lerp(sleepProgress, -20, -24);
				this.LeftHindLeg1.y = Mth.lerp(sleepProgress, -36, 4);
				this.LeftHindLeg1.z = Mth.lerp(sleepProgress, 26, 24);
				this.LeftHindLeg1.xRot = Mth.lerp(sleepProgress, 0, -1.9198621771937625F);
				this.LeftHindLeg1.yRot = Mth.lerp(sleepProgress, 0, 0.3839724354387525F);
				this.LeftHindLeg1.zRot = Mth.lerp(sleepProgress, 0, 0.10471975511965977F);
				this.RightHindLeg1.x = Mth.lerp(sleepProgress, 20, 24);
				this.RightHindLeg1.y = Mth.lerp(sleepProgress, -36, 0);
				this.RightHindLeg1.xRot = Mth.lerp(sleepProgress, 0, -1.9198621771937625F);
				this.RightHindLeg1.yRot = Mth.lerp(sleepProgress, 0, -0.5082398595386212F);
				this.Neck1.x = Mth.lerp(sleepProgress, 0, -6.2F);
				this.Neck1.y = Mth.lerp(sleepProgress, 10, -8F);
				this.Neck1.z = Mth.lerp(sleepProgress, -49, -52);
				this.Neck1.xRot = Mth.lerp(sleepProgress, 0, 0.9162978572970231F);
				...
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0, 0.4518657326886875F);
				...
				this.Head.z = Mth.lerp(sleepProgress, -2, 0);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.body.y = Mth.lerp(sleepProgress, -4.8F, -41);
				this.body.yRot = Mth.lerp(sleepProgress, -0.038920842652368684F, 0);
				this.body.zRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.RightFrontLeg.x = Mth.lerp(sleepProgress, 25.5F, 19.5F);
				this.RightFrontLeg.y = Mth.lerp(sleepProgress, 17, 14.0F);
				this.RightFrontLeg.z = Mth.lerp(sleepProgress, -43, -42.0F);
				this.RightFrontLeg.xRot = Mth.lerp(sleepProgress, -1.1405726395466833F, 0);
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, -0.039269908169872414F, 0);
				this.RightFrontLeg.zRot = Mth.lerp(sleepProgress, 0.3909537457888271F, 0);
				this.Tail1.z = Mth.lerp(sleepProgress, 21, 26);
				...
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, -25.5F, -19.5F);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, 12, 14);
				this.LeftFrontLeg.z = Mth.lerp(sleepProgress, -41, -42);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, -1.2189378856769737F, 0);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, -0.43039819087864056F, 0);
				this.LeftHindLeg3.y = Mth.lerp(sleepProgress, 26.2F, 30);
				this.LeftHindLeg3.z = Mth.lerp(sleepProgress, -3, 1.0F);
				this.LeftHindLeg3.xRot = Mth.lerp(sleepProgress, 0.3874631072585466F, 0);
				this.LeftHindLeg3.zRot = Mth.lerp(sleepProgress, -0.10471975511965977F, 0);
				this.LeftHindLeg2.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.LeftHindLeg2.y = Mth.lerp(sleepProgress, 24.02F, 24);
				this.LeftHindLeg2.z = Mth.lerp(sleepProgress, 0, 3);
				this.Neck2.xRot = Mth.lerp(sleepProgress, 0.02775073568927633F, 0);
				this.Neck2.yRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.Neck2.zRot = Mth.lerp(sleepProgress, 1.2510520131558576F, 0);
				this.RightHindLeg3.xRot = Mth.lerp(sleepProgress, 0.3490658503988659F, 0);
				this.RightHindLeg3.y = Mth.lerp(sleepProgress, 24.6F, 30);
				this.RightHindLeg3.z = Mth.lerp(sleepProgress, -2F, 1);
				this.RightHindLeg2.y = Mth.lerp(sleepProgress, 24.02F, 24);
				this.RightHindLeg2.z = Mth.lerp(sleepProgress, 4, 3);
				this.RightHindLeg2.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.LeftHindLeg1.x = Mth.lerp(sleepProgress, -24, -20);
				this.LeftHindLeg1.y = Mth.lerp(sleepProgress, 4, -36);
				this.LeftHindLeg1.z = Mth.lerp(sleepProgress, 24, 26);
				this.LeftHindLeg1.xRot = Mth.lerp(sleepProgress, -1.9198621771937625F, 0);
				this.LeftHindLeg1.yRot = Mth.lerp(sleepProgress, 0.3839724354387525F, 0);
				this.LeftHindLeg1.zRot = Mth.lerp(sleepProgress, 0.10471975511965977F, 0);
				this.RightHindLeg1.x = Mth.lerp(sleepProgress, 24, 20);
				this.RightHindLeg1.y = Mth.lerp(sleepProgress, 0, -36);
				this.RightHindLeg1.xRot = Mth.lerp(sleepProgress, -1.9198621771937625F, 0);
				this.RightHindLeg1.yRot = Mth.lerp(sleepProgress, -0.5082398595386212F, 0);
				this.Neck1.x = Mth.lerp(sleepProgress, -6.2F, 0);
				this.Neck1.y = Mth.lerp(sleepProgress, -8, 10);
				this.Neck1.z = Mth.lerp(sleepProgress, -52, -49);
				this.Neck1.xRot = Mth.lerp(sleepProgress, 0.9162978572970231F, 0);
				...
				this.Tail2.xRot = Mth.lerp(sleepProgress, 0.4518657326886875F, 0);
				...
				this.Head.z = Mth.lerp(sleepProgress, 0, -2);
