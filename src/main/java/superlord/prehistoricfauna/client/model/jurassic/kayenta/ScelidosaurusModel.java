...
public class ScelidosaurusModel extends EntityModel<Scelidosaurus> {
	...
	public void setupAnim(Scelidosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.LegLeft.xRot = Mth.lerp(sleepProgress, 0, 0.23909537541112055F);
				...
				this.Leg2Left.y = Mth.lerp(sleepProgress, 6.5F, 6);
				...
				this.Head.xRot = Mth.lerp(sleepProgress, 0.25F, 0.35185837453889574F);
				this.LegRight.x = Mth.lerp(sleepProgress, -1.5F, -1.0F);
				this.LegRight.y = Mth.lerp(sleepProgress, 11, 15.5F);
				this.LegRight.z = Mth.lerp(sleepProgress, 5.9F, 7.0F);
				this.LegRight.xRot = Mth.lerp(sleepProgress, 0, 0.23909537541112055F);
				...
				this.Leg2Right.y = Mth.lerp(sleepProgress, 6.5F, 6F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.LegLeft.y = Mth.lerp(sleepProgress, 15.5F, 11);
				this.LegLeft.z = Mth.lerp(sleepProgress, 7.0F, 5.9F);
				this.LegLeft.xRot = Mth.lerp(sleepProgress, 0.23909537541112055F, 0);
				...
				this.Head.xRot = Mth.lerp(sleepProgress, 0.35185837453889574F, 0.25F);
				this.LegRight.x = Mth.lerp(sleepProgress, -1F, -1.5F);
				this.LegRight.y = Mth.lerp(sleepProgress, 15.5F, 11);
				this.LegRight.z = Mth.lerp(sleepProgress, 7F, 5.9F);
				this.LegRight.xRot = Mth.lerp(sleepProgress, 0.23909537541112055F, 0);
				...
				this.Body.y = Mth.lerp(sleepProgress, 17.3F, 12);
				this.Leg2Right.y = Mth.lerp(sleepProgress, 6F, 6.5F);
	...
	public void sleepPose() {
		...
		this.LegLeft.z = 7.0F;
		this.LegLeft.xRot = 0.23909537541112055F;
		...
		this.LegRight.xRot = 0.23909537541112055F;
