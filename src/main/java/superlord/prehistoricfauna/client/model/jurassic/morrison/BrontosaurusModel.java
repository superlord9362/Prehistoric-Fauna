...
public class BrontosaurusModel extends EntityModel<Brontosaurus> {
	...
	public BrontosaurusModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Root = partdefinition.addOrReplaceChild("Root", CubeListBuilder.create(), PartPose.offset(-2.0F, -13.0F, 189.0F));

		PartDefinition Body = Root.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-17.0F, -39.0F, -50.0F, 34.0F, 48.0F, 77.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 0.0F, -175.0F));

		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(126, 126).addBox(-11.0F, -16.0345F, -0.3071F, 22.0F, 30.0F, 43.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.25F, 25.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(62, 201).addBox(-6.0F, -9.0076F, -0.349F, 12.0F, 17.0F, 76.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.9656F, 42.6929F, 0.0436F, 0.0F, 0.0F));

		PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(38, 295).addBox(-2.5F, -3.9886F, -1.2615F, 5.0F, 8.0F, 101.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.9924F, 75.651F, -0.0873F, 0.0F, 0.0F));

		PartDefinition Neck1 = Body.addOrReplaceChild("Neck1", CubeListBuilder.create().texOffs(1, 126).addBox(-9.0F, -13.9415F, -40.2528F, 18.0F, 27.0F, 44.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -26.0F, -44.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Neck1.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(172, -30).mirror().addBox(0.0F, 0.0F, -19.0F, 0.0F, 4.0F, 38.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-9.0F, 13.0585F, -21.2528F, 0.0F, 0.0F, 0.4363F));

		PartDefinition cube_r2 = Neck1.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(172, -30).addBox(0.0F, 0.0F, -19.0F, 0.0F, 4.0F, 38.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, 13.0585F, -21.2528F, 0.0F, 0.0F, -0.4363F));

		PartDefinition Neck2 = Neck1.addOrReplaceChild("Neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -3.9415F, -37.2528F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r3 = Neck2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(157, -53).mirror().addBox(0.0F, -0.0009F, -26.4564F, 0.0F, 3.0F, 53.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.5F, 9.1936F, -26.3835F, -0.0395F, 0.0184F, 0.436F));

		PartDefinition cube_r4 = Neck2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(157, -53).addBox(0.0F, -0.0009F, -26.4564F, 0.0F, 3.0F, 53.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, 9.1936F, -26.3835F, -0.0395F, -0.0184F, -0.436F));

		PartDefinition cube_r5 = Neck2.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(1, 198).addBox(-7.0F, -11.0F, -2.0F, 7.0F, 17.0F, 61.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, 1.9552F, -54.6383F, -0.0436F, 0.0F, 0.0F));

		PartDefinition Head = Neck2.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(2, 2).addBox(-4.0F, -4.6305F, -6.2508F, 8.0F, 10.0F, 9.0F, new CubeDeformation(0.0F))
		.texOffs(2, 23).addBox(-4.0F, -0.6305F, -13.2508F, 8.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.9613F, -54.1645F, 0.9163F, 0.0F, 0.0F));

		PartDefinition cube_r6 = Head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(3, 36).addBox(-3.0F, 1.0F, -6.0F, 6.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.6305F, -6.2508F, 0.0873F, 0.0F, 0.0F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(1, 198).mirror().addBox(-1.0F, -7.0F, -6.0F, 9.0F, 50.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false)
		.texOffs(33, 203).mirror().addBox(8.0F, 40.0F, -5.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-18.0F, -6.0F, -39.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(1, 198).addBox(-8.0F, -7.0F, -6.0F, 9.0F, 50.0F, 10.0F, new CubeDeformation(0.0F))
		.texOffs(33, 203).addBox(-11.0F, 40.0F, -5.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(18.0F, -6.0F, -39.0F));

		PartDefinition LeftThigh = Root.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(1, 277).addBox(-9.0F, -16.0F, -9.0F, 12.0F, 37.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offset(19.0F, -6.0F, -163.0F));

		PartDefinition LeftLeg = LeftThigh.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(13, 333).addBox(-3.5F, 0.25F, 0.0F, 8.0F, 17.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.5F, 20.75F, -5.0F));

		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(6, 362).addBox(-5.0F, 0.5F, -7.0F, 10.0F, 5.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.5F, 16.75F, 3.0F));

		PartDefinition RightThigh = Root.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(1, 277).mirror().addBox(-3.0F, -16.0F, -9.0F, 12.0F, 37.0F, 18.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-15.0F, -6.0F, -163.0F));

		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(13, 333).mirror().addBox(-4.5F, 0.25F, 0.0F, 8.0F, 17.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(3.5F, 20.75F, -5.0F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(6, 362).mirror().addBox(-5.0F, 0.5F, -7.0F, 10.0F, 5.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-0.5F, 16.75F, 3.0F));
	...
	public void setupAnim(Brontosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 0, 32.25F);
				...
				this.Neck1.xRot = Mth.lerp(sleepProgress, -0.2618F, 0.6031F);
				this.Neck1.yRot = Mth.lerp(sleepProgress, 0, 0.3487F);
				this.Neck1.zRot = Mth.lerp(sleepProgress, 0, -0.02275F);
				this.Neck2.xRot = Mth.lerp(sleepProgress, -0.3927F, -0.2269F);
				...
				this.LeftThigh.x = Mth.lerp(sleepProgress, 19, 26);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 20.75F, 20.25F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, -15, 20.25F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 32.25F, 0);
				...
				this.LeftThigh.x = Mth.lerp(sleepProgress, 26, 19);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 20.25F, 20.75F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 20.25F, -15);
				...
				this.Tail1.xRot = (-Math.abs(-0.025F * Mth.sin(0.05F * ageInTicks / 5))) + (Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.05F * limbSwingAmount - 0.0873F);
				...
				this.Tail2.xRot = (-Math.abs(-0.025F * Mth.sin(0.05F * ageInTicks / 5))) + (Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.05F * limbSwingAmount + 0.0436F);
				this.Tail2.yRot = (-0.12F * Mth.sin(0.05F * ageInTicks / 5)) + (Mth.cos(1.0F + limbSwing * speed * 0.15F) * degree * 0.5F * limbSwingAmount);
				this.Tail3.xRot = (-Math.abs(-0.025F * Mth.sin(0.05F * ageInTicks / 5))) + (Mth.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.05F * limbSwingAmount - 0.0873F);
				this.Tail3.yRot = (-0.12F * Mth.sin(0.05F * ageInTicks / 5)) + (Mth.cos(1.0F + limbSwing * speed * 0.15F) * degree * 0.5F * limbSwingAmount);
				this.Neck1.xRot = 0.05F * Mth.sin(0.1F * ageInTicks / 3) + (Mth.cos(limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount - 0.2618F) + (headPitch * ((float) Math.PI / 180F)) + (attackProgress * (float)Math.toRadians(50));
	...
	public void resetModel() {
		...
		this.Neck2.yRot = 0;
		this.Neck2.zRot = 0;
		this.RightFoot.y = 16.75F;
		this.RightFoot.z = 3;
		this.RightFoot.xRot = 0;
		this.RightFoot.yRot = 0;
		this.RightFoot.zRot = 0;
		this.RightLeg.y = 20.75F;
		this.RightLeg.z = -5;
		this.RightLeg.xRot = 0;
		this.RightLeg.yRot = 0;
		this.RightLeg.zRot = 0;
		this.LeftThigh.x = 19F;
		this.LeftThigh.y = -6;
		this.LeftThigh.z = -163;
		this.LeftThigh.xRot = 0;
		this.LeftThigh.yRot = 0;
		this.LeftThigh.zRot = 0;
		this.RightThigh.x = -15F;
		this.RightThigh.y = -6;
