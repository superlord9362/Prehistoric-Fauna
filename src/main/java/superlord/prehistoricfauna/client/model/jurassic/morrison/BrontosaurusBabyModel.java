...
public class BrontosaurusBabyModel extends EntityModel<Brontosaurus> {
	...
	public BrontosaurusBabyModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(28, 23).addBox(-1.5F, -11.0F, -2.0F, 3.0F, 13.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(0, 23).addBox(-1.0F, -6.0F, -3.0F, 2.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 2.0F, -11.0F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(0, 7).addBox(-1.5F, 0.0F, -6.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.025F, 0.0F));
