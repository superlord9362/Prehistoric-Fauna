	...
	public void setupAnim(Ceratosaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0, 0.8932595164970201F);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				...
				this.Body1.y = Mth.lerp(sleepProgress, -1.1F, 10.5F);
				this.Body1.xRot = Mth.lerp(sleepProgress, 0, -0.10471975511965977F);
				this.LeftFoot.z = Mth.lerp(sleepProgress, 0, -1.0F);
				this.LeftFoot.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Head1.x = Mth.lerp(sleepProgress, 0, 2);
				this.Head1.z = Mth.lerp(sleepProgress, -3, -5);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0, -0.7864453849170947F);
				this.Head1.yRot = Mth.lerp(sleepProgress, 0, 0.6658431362674476F);
				this.Head1.zRot = Mth.lerp(sleepProgress, 0, -1.1339404363260046F);
				this.Tail1.z = Mth.lerp(sleepProgress, 4, 1.5F);
				...
				this.RightLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8377580409572781F);
				this.LeftLeg2.xRot = Mth.lerp(sleepProgress, 0, -0.8377580409572781F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 1.0929251589567215F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, 1.2117821049859852F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, 0.2350958549041681F);
				this.LeftLeg1.x = Mth.lerp(sleepProgress, -2, -4);
				this.LeftLeg1.y = Mth.lerp(sleepProgress, -1, 10.7F);
				this.LeftLeg1.z = Mth.lerp(sleepProgress, 2, 10);
				this.LeftLeg1.xRot = Mth.lerp(sleepProgress, 0, -0.7330382858376184F);
				this.LeftLeg1.yRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				this.RightLeg1.x = Mth.lerp(sleepProgress, 2, 4);
				this.RightLeg1.y = Mth.lerp(sleepProgress, -1, 10.7F);
				this.RightLeg1.xRot = Mth.lerp(sleepProgress, 0, -0.7330382858376184F);
				this.RightLeg1.yRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 0, 0.6066764186984569F);
				this.LeftArm.zRot = Mth.lerp(sleepProgress, 0, 0.10471975511965977F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0.8932595164970201F, 0);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				...
				this.Body1.y = Mth.lerp(sleepProgress, 10.5F, -1.1F);
				this.Body1.xRot = Mth.lerp(sleepProgress, -0.10471975511965977F, 0);
				this.LeftFoot.z = Mth.lerp(sleepProgress, -1, 0F);
				this.LeftFoot.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Head1.x = Mth.lerp(sleepProgress, 2, 0);
				this.Head1.z = Mth.lerp(sleepProgress, -5, -3);
				this.Head1.xRot = Mth.lerp(sleepProgress, -0.7864453849170947F, 0);
				this.Head1.yRot = Mth.lerp(sleepProgress, 0.6658431362674476F, 0);
				this.Head1.zRot = Mth.lerp(sleepProgress, -1.1339404363260046F, 0);
				this.Tail1.z = Mth.lerp(sleepProgress, 1.5F, 4F);
				...
				this.RightLeg2.xRot = Mth.lerp(sleepProgress, -0.8377580409572781F, 0);
				this.LeftLeg2.xRot = Mth.lerp(sleepProgress, -0.8377580409572781F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 1.0929251589567215F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, 1.2117821049859852F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0.2350958549041681F, 0);
				this.LeftLeg1.x = Mth.lerp(sleepProgress, -4, -2);
				this.LeftLeg1.y = Mth.lerp(sleepProgress, 10.7F, -1F);
				this.LeftLeg1.z = Mth.lerp(sleepProgress, 10, 2);
				this.LeftLeg1.xRot = Mth.lerp(sleepProgress, -00.7330382858376184F, 0);
				this.LeftLeg1.yRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				this.RightLeg1.x = Mth.lerp(sleepProgress, 4, 2);
				this.RightLeg1.y = Mth.lerp(sleepProgress, 10.7F, -1);
				this.RightLeg1.xRot = Mth.lerp(sleepProgress, -0.7330382858376184F, 0);
				this.RightLeg1.yRot = Mth.lerp(sleepProgress, -0.24434609527920614F, 0);
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 0.6066764186984569F, 0);
				this.LeftArm.zRot = Mth.lerp(sleepProgress, 0.10471975511965977F, 0);
			} else {
