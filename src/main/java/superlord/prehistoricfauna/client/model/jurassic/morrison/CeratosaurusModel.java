...
public class CeratosaurusModel extends EntityModel<CeratosaurusEntity> {
	...
	public void setRotationAngles(CeratosaurusEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entityIn.isAsleep()) {
			this.LeftArm.rotateAngleX = 0.8932595164970201F;
			this.LeftArm.rotateAngleY = 0.19547687289441354F;
			this.Tail2.rotateAngleX = 0.20943951023931953F;
			this.Tail2.rotateAngleY = -0.5585053606381855F;
			this.Body1.rotationPointY = 10.5F;
			this.Body1.rotateAngleX = -0.10471975511965977F;
			this.RightFoot.rotationPointZ = -1.0F;
			this.RightFoot.rotateAngleX = 1.5707963267948966F;
			this.Head1.rotationPointX = 2;
			this.Head1.rotationPointZ = -5;
			this.Head1.rotateAngleX = -0.7864453849170947F;
			this.Head1.rotateAngleY = 0.6658431362674476F;
			this.Head1.rotateAngleZ = -1.1339404363260046F;
			this.Tail1.rotationPointZ = 1.5F;
			this.Tail1.rotateAngleX = -0.24434609527920614F;
			this.Tail1.rotateAngleY = -0.3490658503988659F;
			this.LeftFoot.rotationPointZ = -1;
			this.LeftFoot.rotateAngleX = 1.5707963267948966F;
			this.LeftLeg2.rotateAngleX = -0.8377580409572781F;
			this.RightLeg2.rotateAngleX = -0.8377580409572781F;
			this.Neck.rotateAngleX = 1.0929251589567215F;
			this.Neck.rotateAngleY = 1.2117821049859852F;
			this.Neck.rotateAngleZ = 0.2350958549041681F;
			this.RightLeg1.rotationPointX = -4;
			this.RightLeg1.rotationPointY = 10.7F;
			this.RightLeg1.rotationPointZ = 10;
			this.RightLeg1.rotateAngleX = -0.7330382858376184F;
			this.RightLeg1.rotateAngleY = 0.24434609527920614F;
			this.LeftLeg1.rotationPointX = 4;
			this.LeftLeg1.rotationPointY = 10.7F;
			this.LeftLeg1.rotateAngleX = -0.7330382858376184F;
			this.LeftLeg1.rotateAngleY = -0.24434609527920614F;
			this.RightArm.rotateAngleX = 0.6066764186984569F;
			this.RightArm.rotateAngleZ = 0.10471975511965977F;
		} else {
			this.Neck.rotateAngleX = (MathHelper.cos(-1.0F + limbSwing * walkSpeed * 0.3F) * walkDegree * 0.3F * limbSwingAmount + 0.35F) + (headPitch * ((float) Math.PI / 180F)) + attackProgress * (float) Math.toRadians(25F);
			...
			this.Head1.rotateAngleX = MathHelper.cos(-1.0F + limbSwing * walkSpeed * 0.3F) * walkDegree * 0.25F * limbSwingAmount - 0.2F + attackProgress * (float) Math.toRadians(-25F);
			...
			if (entityIn.isInWater()) {
				...
				this.LeftLeg1.rotateAngleX = -0.25F * MathHelper.sin(0.2F * ageInTicks / 1.5F);
				this.RightLeg1.rotateAngleX = 0.25F * MathHelper.sin(0.2F * ageInTicks / 1.5F);
	...
	public void resetModel() {
		...
		this.RightLeg1.rotationPointX = -2;
		this.RightLeg1.rotationPointY = -2;
		this.RightLeg1.rotationPointZ = 9;
		this.RightLeg1.rotateAngleX = 0;
		this.RightLeg1.rotateAngleY = 0;
		this.LeftLeg1.rotationPointX = 2;
		this.LeftLeg1.rotationPointY = -2;
