...
//				this.Head1.x = Mth.lerp(sleepProgress, 0, 2);
				this.Head1.y = Mth.lerp(sleepProgress, -4.1F, -4.5F);
				this.Head1.z = Mth.lerp(sleepProgress, -3, -4);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0, 0.25672F);
...
//				this.Head1.zRot = Mth.lerp(sleepProgress, 0, -1.1339404363260046F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.Head1.y = Mth.lerp(sleepProgress, -4.5F, -4.1F);
				this.Head1.z = Mth.lerp(sleepProgress, -4, -3);
				this.Head1.xRot = Mth.lerp(sleepProgress, 0.25672F, 0);
