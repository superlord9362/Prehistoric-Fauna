...
public class Sillosuchus extends EntityModel<SillosuchusEntity> {
    ...
    public Sillosuchus() {
        ...
        this.RightFoot = new ModelRenderer(this, 177, 59);
        this.RightFoot.mirror = true;
        this.RightFoot.setRotationPoint(0.0F, 16.0F, 4.0F);
        this.RightFoot.setTextureOffset(1, 63).addBox(-3.5F, -1.0F, -15.5F, 7.0F, 4.0F, 18.0F, 0.0F, 0.0F, 0.0F);
        this.RightThigh = new ModelRenderer(this, 45, 56);
        this.RightThigh.setRotationPoint(-4.0F, -14.0F, 4.0F);
        this.RightThigh.setTextureOffset(100, 24).addBox(-7.0F, -3.0F, -5.0F, 8.0F, 22.0F, 13.0F, 0.0F, 0.0F, 0.0F);
    ...
    public void setRotationAngles(SillosuchusEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entityIn.getMotion().x !=  0 && entityIn.getMotion().y != 0 && entityIn.getMotion().z != 0) {
			...
			this.Head.rotateAngleX = MathHelper.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.15F * limbSwingAmount - 0.1F;
			...
			this.Neck.rotateAngleX = (Math.abs(-0.025F * MathHelper.sin(0.1F * ageInTicks / 3))) + (MathHelper.cos(-1.0F + limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount + 0.25F) + (headPitch * ((float)Math.PI / 180F));
