...
public class HenosSummonedModel extends EntityModel<Henos> {
	...
	public HenosSummonedModel(ModelPart root, float modelScale) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Body.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(158, 0).addBox(-7.0F, -27.0F, -12.0F, 14.0F, 32.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offset(-17.0F, 0.0F, 5.0F));

		PartDefinition Mouth = Head.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(183, 86).addBox(-8.0F, -3.0F, -4.0F, 16.0F, 15.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, -10.0F));
