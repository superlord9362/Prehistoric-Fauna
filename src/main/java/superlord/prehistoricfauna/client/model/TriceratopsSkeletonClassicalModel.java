 ...
 */
@OnlyIn(Dist.CLIENT)
public class TriceratopsSkeletonClassicalModel extends EntityModel<TriceratopsSkeletonEntity> {
    ...
    public TriceratopsSkeletonClassicalModel() {
        ...
        this.setRotateAngle(Tail2, 0.4429645495087748F, 0.0F, 0.0F);
        ...
        this.RightHindLeg1.setRotationPoint(-11.0F, -9.0F, 10.0F);
        this.RightHindLeg1.addBox(-4.0F, -5.0F, -8.0F, 8.0F, 25.0F, 19.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightHindLeg1, 0.0F, 0.0F, 0.3909537457888271F);
        ...
        this.LeftHindLeg1.setRotationPoint(11.0F, -9.0F, 10.0F);
        this.LeftHindLeg1.addBox(-4.0F, -5.0F, -8.0F, 8.0F, 25.0F, 19.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftHindLeg1, -0.0F, 0.0F, -0.3909537457888271F);
        ...
        this.setRotateAngle(Tail1, -0.8269370182370409F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Head1, -0.1637118858344389F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftHindLeg2, 0.0F, 0.0F, 0.3909537457888271F);
        ...
        this.setRotateAngle(RightHindLeg2, 0.0F, 0.0F, -0.3909537457888271F);
        ...
        this.setRotateAngle(Neck, 0.5475098009980072F, 0.0F, 0.0F);
