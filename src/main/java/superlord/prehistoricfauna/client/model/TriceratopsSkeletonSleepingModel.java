 ...
 */
@OnlyIn(Dist.CLIENT)
public class TriceratopsSkeletonSleepingModel extends EntityModel<TriceratopsSkeletonEntity> {
    ...
    public TriceratopsSkeletonSleepingModel() {
        ...
        this.setRotateAngle(Tail2, 0.05201081204232616F, 0.3909537457888271F, 0.0F);
        ...
        this.setRotateAngle(Head1, 0.07086036663228437F, -0.46914448828868976F, 0.0F);
        ...
        this.LeftHindLeg3.setRotationPoint(0.0F, 13.0F, -1.0F);
        this.LeftHindLeg3.addBox(-4.0F, 0.0F, -6.0F, 8.0F, 3.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftHindLeg3, 1.2119566751954398F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftHindLeg2, -0.7428121536172364F, 0.0F, 0.0F);
        this.LeftHindLeg1 = new ModelRenderer(this, 190, 0);
        this.LeftHindLeg1.setRotationPoint(11.0F, 0.0F, 10.0F);
        this.LeftHindLeg1.addBox(-4.0F, -5.0F, -8.0F, 8.0F, 25.0F, 19.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftHindLeg1, -0.46914448828868976F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg2, -0.7428121536172364F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.3127630032889644F, -0.19547687289441354F, 0.0F);
        ...
        this.setRotateAngle(Tail1, -0.3968878679087689F, 0.3127630032889644F, 0.0F);
        this.RightHindLeg1 = new ModelRenderer(this, 190, 0);
        this.RightHindLeg1.mirror = true;
        this.RightHindLeg1.setRotationPoint(-11.0F, 0.0F, 10.0F);
        this.RightHindLeg1.addBox(-4.0F, -5.0F, -8.0F, 8.0F, 25.0F, 19.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightHindLeg1, -0.46914448828868976F, 0.0F, 0.0F);
        this.LeftFrontLeg = new ModelRenderer(this, 220, 75);
        this.LeftFrontLeg.setRotationPoint(11.0F, 8.0F, -14.0F);
        this.LeftFrontLeg.addBox(-3.0F, 0.0F, -3.0F, 6.0F, 27.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftFrontLeg, -1.0950196019960143F, 0.0F, 0.0F);
        this.RightFrontLeg = new ModelRenderer(this, 220, 75);
        this.RightFrontLeg.mirror = true;
        this.RightFrontLeg.setRotationPoint(-11.0F, 8.0F, -14.0F);
        this.RightFrontLeg.addBox(-3.0F, 0.0F, -3.0F, 6.0F, 27.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightFrontLeg, -1.0946705281561322F, 0.0F, 0.0F);
        ...
        this.RightHindLeg3.setRotationPoint(0.0F, 13.0F, -1.0F);
        this.RightHindLeg3.addBox(-4.0F, 0.0F, -6.0F, 8.0F, 3.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightHindLeg3, 1.2119566751954398F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.LeftHindLeg1, this.RightHindLeg1, this.LeftFrontLeg, this.RightFrontLeg, this.Saddle, this.Body).forEach((modelRenderer) -> { 
