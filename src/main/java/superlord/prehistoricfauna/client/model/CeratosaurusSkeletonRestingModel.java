 ...
 */
@OnlyIn(Dist.CLIENT)
public class CeratosaurusSkeletonRestingModel extends EntityModel<CeratosaurusSkeletonEntity> {
    ...
    public CeratosaurusSkeletonRestingModel() {
        ...
        this.setRotateAngle(RightFoot, 1.016654289286697F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Head1, -0.35185837453889574F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightLeg2, -0.6255260065779288F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftFoot, 1.0164797856562695F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftLeg2, -0.6255260065779288F, 0.0F, 0.0F);
        ...
        this.Neck.setRotationPoint(0.0F, 0.0F, -28.0F);
        ...
        this.setRotateAngle(TailVetebrae, -0.27366763203903305F, 0.0F, 0.0F);
