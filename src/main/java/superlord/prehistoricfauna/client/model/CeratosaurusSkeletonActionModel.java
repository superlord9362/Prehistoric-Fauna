 ...
 */
@OnlyIn(Dist.CLIENT)
public class CeratosaurusSkeletonActionModel extends EntityModel<CeratosaurusSkeletonEntity> {
    ...
    public CeratosaurusSkeletonActionModel() {
        ...
        this.setRotateAngle(Jaw1, 0.5473352640780661F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(TailVertebrae2, -0.03909537541112055F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(TailVetebrae, -0.0781907508222411F, 0.0F, 0.0F);
        this.Body1 = new ModelRenderer(this, 155, 56);
        this.Body1.setRotationPoint(0.0F, -1.0F, 8.0F);
        ...
        this.setRotateAngle(LeftArm, 0.0F, 0.0F, -0.3909537457888271F);
        ...
        this.setRotateAngle(LeftLeg1, -0.19547687289441354F, -0.27366763203903305F, 0.0F);
        ...
        this.setRotateAngle(RightLeg2, -0.19547687289441354F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck, -0.11728612207217244F, 0.0F, 0.19547687289441354F);
        ...
        this.RightLeg1.setRotationPoint(-2.0F, -0.3F, -5.0F);
        this.RightLeg1.addBox(-6.0F, -4.0F, -6.0F, 6.0F, 17.0F, 11.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightLeg1, 0.03909537541112055F, 0.35185837453889574F, 0.0F);
        ...
        this.setRotateAngle(RightArm, 0.0F, 0.0F, 0.3909537457888271F);
