...
public class CitipatiModel extends EntityModel<CitipatiEntity> {
    ...
    public CitipatiModel() {
        ...
        this.ThighLeft = new ModelRenderer(this, 0, 33);
        this.ThighLeft.mirror = true;
        this.ThighLeft.setRotationPoint(1.0F, 1.0F, 6.0F);
        this.ThighLeft.setTextureOffset(0, 11).addBox(0.0F, -1.0F, -2.0F, 3.0F, 9.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.ThighRight = new ModelRenderer(this, 0, 33);
        this.ThighRight.setRotationPoint(-1.0F, 1.0F, 6.0F);
        this.ThighRight.setTextureOffset(0, 11).addBox(-3.0F, -1.0F, -2.0F, 3.0F, 9.0F, 6.0F, 0.0F, 0.0F, 0.0F);
