 ...
 */
@OnlyIn(Dist.CLIENT)
public class HerrerasaurusSkeletonRunningModel extends EntityModel<HerrerasaurusSkeletonEntity> {
    ...
    public HerrerasaurusSkeletonRunningModel() {
        ...
        this.RLeg.setRotationPoint(0.0F, 9.8F, 2.6F);
        this.RLeg.addBox(0.0F, -3.0F, -5.0F, 3.0F, 8.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RLeg, -0.3127630032889644F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RThigh, 0.19547687289441354F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail2, -0.0781907508222411F, 0.0F, 0.0F);
        ...
        this.LThigh.setRotationPoint(-3.0F, 3.0F, 15.5F);
        this.LThigh.addBox(-1.0F, 0.0F, -3.5F, 3.0F, 9.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LThigh, -0.35185837453889574F, 0.0F, 0.0F);
        ...
        this.Body.setRotationPoint(0.0F, 6.0F, -15.0F);
        ...
        this.LLeg.setRotationPoint(-1.0F, 9.9F, 3.5F);
        this.LLeg.addBox(0.0F, -1.0F, -5.0F, 3.0F, 8.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LLeg, -0.1563815016444822F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LArm, 0.6646214111173737F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RArm, 0.6646214111173737F, 0.0F, 0.0F);
