 ...
 */
@OnlyIn(Dist.CLIENT)
public class AllosaurusSkeletonModel extends EntityModel<AllosaurusSkeletonEntity> {
    ...
    public AllosaurusSkeletonModel() {
        ...
        this.setRotateAngle(LeftArm, 0.15707963267948966F, 0.0F, 0.0F);
