 ...
 */
@OnlyIn(Dist.CLIENT)
public class AllosaurusSkeletonRetroModel extends EntityModel<AllosaurusSkeletonEntity> {
    ...
    public AllosaurusSkeletonRetroModel() {
        this.textureWidth = 250;
        this.textureHeight = 250;
        this.Body1 = new ModelRenderer(this, 0, 0);
        this.Body1.setRotationPoint(0.0F, -18.0F, 9.0F);
        this.Body1.addBox(-7.5F, -3.0F, -11.0F, 15.0F, 21.0F, 25.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Body1, -0.8726646259971648F, 0.0F, 0.0F);
        this.RightArm = new ModelRenderer(this, 51, 51);
        this.RightArm.mirror = true;
        this.RightArm.setRotationPoint(-9.5F, 14.0F, -15.0F);
        ...
        this.setRotateAngle(Neck_1, -0.03909537541112055F, 0.0F, 0.0F);
        ...
        this.RightLeg2.setRotationPoint(-1.0F, 10.0F, 8.5F);
        ...
        this.LeftLeg1.setRotationPoint(5.5F, 9.0F, 2.0F);
        ...
        this.LeftLeg2.setRotationPoint(1.0F, 10.0F, 8.5F);
        ...
        this.LeftArm.setRotationPoint(9.5F, 14.0F, -15.0F);
