 ...
 */
@OnlyIn(Dist.CLIENT)
public class AllosaurusSkeletonActionLeftModel extends EntityModel<AllosaurusSkeletonEntity> {
    ...
    public AllosaurusSkeletonActionLeftModel() {
        ...
        this.setRotateAngle(RightArm, 0.15707963267948966F, 0.5084143964585622F, 0.9773843811168246F);
        ...
        this.RightFoot.setRotationPoint(0.0F, 18.0F, 2.0F);
        this.RightFoot.addBox(-4.0F, 0.0F, -11.0F, 8.0F, 3.0F, 11.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightFoot, 0.35185837453889574F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftArm, 0.15707963267948966F, -0.5084143964585622F, -0.9773843811168246F);
        ...
        this.setRotateAngle(Tail1, -0.11728612207217244F, -0.1563815016444822F, 0.0F);
        ...
        this.setRotateAngle(Tail2, -0.11728612207217244F, -0.0781907508222411F, 0.0F);
        this.Body1 = new ModelRenderer(this, 0, 0);
        this.Body1.setRotationPoint(0.0F, -16.0F, 9.0F);
        this.Body1.addBox(-7.5F, -3.0F, -11.0F, 15.0F, 21.0F, 25.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Body1, 0.19547687289441354F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftLeg2, -0.19547687289441354F, 0.0F, 0.15655603856442327F);
        this.LeftLeg1 = new ModelRenderer(this, 76, 153);
        this.LeftLeg1.mirror = true;
        this.LeftLeg1.setRotationPoint(5.5F, -6.5F, 8.5F);
        this.LeftLeg1.addBox(-3.0F, -6.5F, -5.5F, 8.0F, 21.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftLeg1, 0.23457224414434488F, -0.27366763203903305F, -0.19547687289441354F);
        ...
        this.LeftFoot.setRotationPoint(0.0F, 19.0F, 0.0F);
        ...
        this.setRotateAngle(Head1, -0.35185837453889574F, 0.0F, -0.35185837453889574F);
        this.RightLeg1 = new ModelRenderer(this, 76, 153);
        this.RightLeg1.setRotationPoint(-5.5F, -8.5F, 8.5F);
        this.RightLeg1.addBox(-5.0F, -6.6F, -5.5F, 8.0F, 21.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightLeg1, -0.23457224414434488F, 0.4300491170387584F, 0.0F);
        ...
        this.setRotateAngle(Body2, 0.0F, 0.19547687289441354F, 0.0F);
        ...
        this.setRotateAngle(RightLeg2, -0.11728612207217244F, 0.0F, 0.0F);
