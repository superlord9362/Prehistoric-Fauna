 ...
 */
@OnlyIn(Dist.CLIENT)
public class Didelphodon extends EntityModel<DidelphodonEntity> {
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Frontlegright, this.Frontlegleft, this.Hindlegright, this.Body, this.Hindlegleft).forEach((modelRenderer) -> { 
