 ...
 */
@OnlyIn(Dist.CLIENT)
public class TyrannosaurusrexskeletonSittingModel extends EntityModel<TyrannosaurusSkeletonEntity> {
    ...
    public TyrannosaurusrexskeletonSittingModel() {
        ...
        this.LeftFeet.setRotationPoint(0.0F, 20.0F, 1.0F);
        this.LeftFeet.addBox(-4.0F, -1.0F, -13.0F, 8.0F, 3.0F, 14.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftFeet, 1.3292428222347474F, 0.0F, 0.11728612207217244F);
        ...
        this.setRotateAngle(LeftLeg2, -0.7429866572476639F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail2, 0.11728612207217244F, 0.23457224414434488F, 0.0F);
        ...
        this.setRotateAngle(Tail1, -0.3583161074186607F, 0.23457224414434488F, 0.0F);
        ...
        this.setRotateAngle(RightLeg1, -0.5864306020384839F, 0.19547687289441354F, 0.0F);
        ...
        this.RightFeet.setRotationPoint(0.0F, 20.0F, 1.0F);
        this.RightFeet.addBox(-4.0F, -1.0F, -13.0F, 8.0F, 3.0F, 14.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightFeet, 1.3292428222347474F, 0.0F, -0.11728612207217244F);
