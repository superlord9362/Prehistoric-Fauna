...
@OnlyIn(Dist.CLIENT)
public class PrehistoricBoatModel extends SegmentedModel<PrehistoricBoatEntity> {
    ...
    */
   public void setRotationAngles(PrehistoricBoatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
   ...
   protected void func_228244_a_(PrehistoricBoatEntity p_228244_1_, int p_228244_2_, float p_228244_3_) {
