 ...
 */
@OnlyIn(Dist.CLIENT)
public class Ceratosaurus extends EntityModel<CeratosaurusEntity> {
	...
	public void setRotationAngles(CeratosaurusEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entityIn.getMotion().x !=  0 && entityIn.getMotion().y != 0 && entityIn.getMotion().z != 0) {
			this.Neck.rotateAngleX = (MathHelper.cos(-1.0F + limbSwing * speed * 0.3F) * degree * 0.1F * limbSwingAmount + 0.25F) + ((headPitch * ((float)Math.PI / 180F)));
			this.Body1.rotateAngleX = MathHelper.cos(1.0F + limbSwing * speed * 0.3F) * 0.5F * 0.1F * limbSwingAmount;
			...
			this.LeftLeg1.rotateAngleX = 0.12F * limbSwingAmount * MathHelper.sin((0.1F + limbSwing)) * 1.5F;
			this.RightLeg1.rotateAngleX = -(0.12F * limbSwingAmount * MathHelper.sin((0.1F + limbSwing)) * 1.5F);
			...
			this.Tail2.rotateAngleY = (-0.12F * MathHelper.sin(0.2F * ageInTicks / 5)) + (MathHelper.cos(limbSwing * speed * 0.15F) * degree * 0.25F * limbSwingAmount);
			...
			this.Body1.rotateAngleX = Math.abs(-0.025F * MathHelper.sin(0.1F * ageInTicks / 3));
			this.Neck.rotateAngleX = Math.abs(-0.025F * MathHelper.sin(0.1F * ageInTicks / 3));
			this.Head1.rotateAngleX = -Math.abs(-0.025F * MathHelper.sin(0.1F * ageInTicks / 3));
			this.Jaw1.rotateAngleX = Math.abs(-0.025F * MathHelper.sin(0.1F * ageInTicks / 3));
			...
			this.Neck.rotateAngleX = (headPitch * ((float)Math.PI / 180F)) + (MathHelper.cos(-1.0F + limbSwing * speed * 0.3F) * 0.15F * 0.1F * limbSwingAmount + 0.1F);
			this.Neck.rotateAngleY = netHeadYaw * ((float)Math.PI / 180F);
			this.LeftLeg1.rotateAngleX = MathHelper.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.6F * limbSwingAmount - 0.05F;
			this.LeftLeg2.rotateAngleX = MathHelper.cos(1.0F + limbSwing * speed * 0.3F) * degree * 0.4F * limbSwingAmount + 0.05F;
			this.LeftFoot.rotateAngleX = MathHelper.cos(2.0F + limbSwing * speed * 0.3F) * degree * 0.3F * limbSwingAmount;
