...
/**
 * DakotaraptorSitting - Either Mojang or a mod author (Taken From Memory)
 * Created using Tabula 8.0.0
 */
@OnlyIn(Dist.CLIENT)
public class DakotaraptorSittingModel extends EntityModel<DakotaraptorEntity> {
    ...
    public DakotaraptorSittingModel() {
        ...
        this.part21.setRotationPoint(0.0F, -4.0F, -16.0F);
        this.part21.addBox(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(part21, 0.6829473549475088F, 0.0F, 0.0F);
        ...
        this.Body.addChild(this.part21);
        this.Neck.addChild(this.Head1);
        this.Body.addChild(this.LeftWing);
        this.Head1.addChild(this.Snout);
        this.part21.addChild(this.Neck);
        this.Body.addChild(this.Tail1);
    }

    @Override
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Body, this.LeftLeg1, this.RightLeg1).forEach((modelRenderer) -> { 
