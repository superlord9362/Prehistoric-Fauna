...
public class HerrerasaurusSleepingModel extends EntityModel<HerrerasaurusEntity> {
	...
	public HerrerasaurusSleepingModel() {
		...
		this.RThigh.setRotationPoint(3.0F, 1.7F, 18.5F);
		this.RThigh.addBox(-2.0F, -2.0F, -3.5F, 3.0F, 12.0F, 7.0F, 0.0F, 0.0F, 0.0F);
		this.setRotateAngle(RThigh, -0.5235987755982988F, -0.296705972839036F, -0.12217304763960307F);
		...
		this.LThigh.setRotationPoint(-3.0F, 1.7F, 18.5F);
		this.LThigh.addBox(-1.0F, -2.0F, -3.5F, 3.0F, 12.0F, 7.0F, 0.0F, 0.0F, 0.0F);
		this.setRotateAngle(LThigh, -0.5235987755982988F, 0.296705972839036F, 0.12217304763960307F);
