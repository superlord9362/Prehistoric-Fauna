	...
	public void setupAnim(Saurosuchus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RArm.y = Mth.lerp(sleepProgress, 4, 5.5F);
				this.RArm.xRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.LArm.y = Mth.lerp(sleepProgress, 4, 5.5F);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.TailBase.xRot = Mth.lerp(sleepProgress, 0, -0.17453292519943295F);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0, 0.6108652381980153F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.17453292519943295F);
				this.Torso.y = Mth.lerp(sleepProgress, 14, 18F);
				this.LLeg.x = Mth.lerp(sleepProgress, -2.5F, 2.5F);
				this.LLeg.y = Mth.lerp(sleepProgress, 17.5F, 22.5F);
				this.LLeg.z = Mth.lerp(sleepProgress, 3.5F, 4);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0, 0.6981317007977318F);
				this.RLeg.x = Mth.lerp(sleepProgress, 2.5F, -2.5F);
				this.RLeg.y = Mth.lerp(sleepProgress, 17.5F, 22.5F);
				this.RLeg.z = Mth.lerp(sleepProgress, 3.5F, 4);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.RLeg.yRot = Mth.lerp(sleepProgress, 0, -0.6981317007977318F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.RArm.y = Mth.lerp(sleepProgress, 5.5F, 4F);
				this.RArm.xRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.LArm.y = Mth.lerp(sleepProgress, 5.5F, 4F);
				this.LArm.xRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.TailBase.xRot = Mth.lerp(sleepProgress, -0.17453292519943295F, 0);
				this.TailBase.yRot = Mth.lerp(sleepProgress, 0.6108652381980153F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.17453292519943295F, 0);
				this.Torso.y = Mth.lerp(sleepProgress, 18, 14F);
				this.LLeg.x = Mth.lerp(sleepProgress, 2.5F, -2.5F);
				this.LLeg.y = Mth.lerp(sleepProgress, 22.5F, 17.5F);
				this.LLeg.z = Mth.lerp(sleepProgress, 4F, 3.5F);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0.6981317007977318F, 0);
				this.RLeg.x = Mth.lerp(sleepProgress, -2.5F, 2.5F);
				this.RLeg.y = Mth.lerp(sleepProgress, 22.5F, 17.5F);
				this.RLeg.z = Mth.lerp(sleepProgress, 4F, 3.5F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.RLeg.yRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
			} else {
