	...
	public void setupAnim(Chromogisaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 16, 22);
				this.Body.zRot = Mth.lerp(sleepProgress, 0, -0.19547687289441354F);
				this.LeftLeg.x = Mth.lerp(sleepProgress, -0.6F, -0.5F);
				this.LeftLeg.y = Mth.lerp(sleepProgress, 5, 3.6F);
				this.LeftLeg.z = Mth.lerp(sleepProgress, 1, 0.9F);
				...
				this.LeftArm.x = Mth.lerp(sleepProgress, -1.5F, -2.3F);
				this.LeftArm.y = Mth.lerp(sleepProgress, 1, 0.9F);
				this.LeftArm.z = Mth.lerp(sleepProgress, -6, -5.0F);
				this.LeftArm.xRot = Mth.lerp(sleepProgress, 0, -1.6030848913251807F);
				this.LeftArm.yRot = Mth.lerp(sleepProgress, 0, -0.036477379868653376F);
				this.LeftArm.zRot = Mth.lerp(sleepProgress, 0, 0.6003932893176602F);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 15, 23.0F);
				this.LeftThigh.z = Mth.lerp(sleepProgress, 2, 5.0F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 15, 23.0F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, 0, -1.486671462175092F);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0, 0.002617993982021224F);
				this.RightArm.zRot = Mth.lerp(sleepProgress, 0, -0.24015730906916136F);
				this.Neck.z = Mth.lerp(sleepProgress, -3, -7.1F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.23177972000431504F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -0.39357173300891585F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, 0.37262780195869205F);
				this.Tail.y = Mth.lerp(sleepProgress, -0.9F, -0.4F);
				this.Tail.xRot = Mth.lerp(sleepProgress, 0, -0.1563815016444822F);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.Tail.zRot = Mth.lerp(sleepProgress, 0, 0.11903145798206952F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 22, 16);
				this.Body.zRot = Mth.lerp(sleepProgress, -0.19547687289441354F, 0);
				this.LeftLeg.x = Mth.lerp(sleepProgress, -0.5F, -0.6F);
				this.LeftLeg.y = Mth.lerp(sleepProgress, 3.6F, 5F);
				this.LeftLeg.z = Mth.lerp(sleepProgress, 0.9F, 1F);
				...
				this.LeftArm.x = Mth.lerp(sleepProgress, -2.3F, -1.5F);
				this.LeftArm.y = Mth.lerp(sleepProgress, 0.9F, 1);
				this.LeftArm.z = Mth.lerp(sleepProgress, -5, -6.0F);
				this.LeftArm.xRot = Mth.lerp(sleepProgress, -1.6030848913251807F, 0);
				this.LeftArm.yRot = Mth.lerp(sleepProgress, -0.036477379868653376F, 0);
				this.LeftArm.zRot = Mth.lerp(sleepProgress, 0.6003932893176602F, 0);
				this.LeftThigh.y = Mth.lerp(sleepProgress, 23, 15.0F);
				this.LeftThigh.z = Mth.lerp(sleepProgress, 5, 2.0F);
				...
				this.RightThigh.y = Mth.lerp(sleepProgress, 23, 15.0F);
				...
				this.RightArm.xRot = Mth.lerp(sleepProgress, -1.486671462175092F, 0);
				this.RightArm.yRot = Mth.lerp(sleepProgress, 0.002617993982021224F, 0);
				this.RightArm.zRot = Mth.lerp(sleepProgress, -0.24015730906916136F, 0);
				this.Neck.z = Mth.lerp(sleepProgress, -7.1F, -3F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.23177972000431504F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, -0.39357173300891585F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0.37262780195869205F, 0);
				this.Tail.y = Mth.lerp(sleepProgress, -0.4F, -0.9F);
				this.Tail.xRot = Mth.lerp(sleepProgress, -0.1563815016444822F, 0);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.Tail.zRot = Mth.lerp(sleepProgress, 0.11903145798206952F, 0);
			} else {
