	...
	public void setupAnim(Herrerasaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.Body.y = Mth.lerp(sleepProgress, 2, 7.0F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, -0.3490658503988659F);
				...
				this.RArm.xRot = Mth.lerp(sleepProgress, 0, 0.8726646259971648F);
				this.LThigh.y = Mth.lerp(sleepProgress, 4, 1.7F);
				this.LThigh.z = Mth.lerp(sleepProgress, 15.5F, 18.5F);
				this.LThigh.xRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
				this.LThigh.yRot = Mth.lerp(sleepProgress, 0, -0.296705972839036F);
				this.LThigh.zRot = Mth.lerp(sleepProgress, 0, -0.12217304763960307F);
				this.LFoot.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, -0.6981317007977318F);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0, 0.8726646259971648F);
				this.RThigh.y = Mth.lerp(sleepProgress, 4, 1.7F);
				this.RThigh.z = Mth.lerp(sleepProgress, 15.5F, 18.5F);
				this.RThigh.xRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
				this.RThigh.yRot = Mth.lerp(sleepProgress, 0, 0.296705972839036F);
				this.RThigh.zRot = Mth.lerp(sleepProgress, 0, 0.12217304763960307F);
				this.RFoot.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Tail1.xRot = Mth.lerp(sleepProgress, 0, 0.06981317007977318F);
				this.Tail1.yRot = Mth.lerp(sleepProgress, 0, -0.593411945678072F);
				this.Tail1.zRot = Mth.lerp(sleepProgress, 0, -0.03490658503988659F);
				this.Neck.x = Mth.lerp(sleepProgress, 0, -0.3F);
				this.Neck.y = Mth.lerp(sleepProgress, 4, 2.5F);
				this.Neck.z = Mth.lerp(sleepProgress, 1, 0.0F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.5585053606381855F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, 2.3387411976724017F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, 0.03490658503988659F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LLeg.xRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 7, 2.0F);
				this.Body.xRot = Mth.lerp(sleepProgress, -0.3490658503988659F, 0);
				...
				this.RArm.xRot = Mth.lerp(sleepProgress, 0.8726646259971648F, 0);
				this.LThigh.y = Mth.lerp(sleepProgress, 1.7F, 4F);
				this.LThigh.z = Mth.lerp(sleepProgress, 18.5F, 15.5F);
				this.LThigh.xRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
				this.LThigh.yRot = Mth.lerp(sleepProgress, -0.296705972839036F, 0);
				this.LThigh.zRot = Mth.lerp(sleepProgress, -0.12217304763960307F, 0);
				this.LFoot.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.RLeg.xRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0.8726646259971648F, 0);
				this.RThigh.y = Mth.lerp(sleepProgress, 1.7F, 4F);
				this.RThigh.z = Mth.lerp(sleepProgress, 18.5F, 15.5F);
				this.RThigh.xRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
				this.RThigh.yRot = Mth.lerp(sleepProgress, 0.296705972839036F, 0);
				this.RThigh.zRot = Mth.lerp(sleepProgress, 0.12217304763960307F, 0);
				this.RFoot.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Tail1.xRot = Mth.lerp(sleepProgress, 0.06981317007977318F, 0);
				this.Tail1.yRot = Mth.lerp(sleepProgress, -0.593411945678072F, 0);
				this.Tail1.zRot = Mth.lerp(sleepProgress, -0.03490658503988659F, 0);
				this.Neck.x = Mth.lerp(sleepProgress, -0.3F, 0);
				this.Neck.y = Mth.lerp(sleepProgress, 2.5F, 4F);
				this.Neck.z = Mth.lerp(sleepProgress, 0, 1.0F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.5585053606381855F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, 2.3387411976724017F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0.03490658503988659F, 0);
			} else {
