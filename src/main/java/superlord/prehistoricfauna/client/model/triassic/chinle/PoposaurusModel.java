	...
	public void setupAnim(Poposaurus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Thigh_R.x = Mth.lerp(sleepProgress, 2, 3);
				this.Thigh_R.y = Mth.lerp(sleepProgress, 3, 12);
				this.Thigh_R.z = Mth.lerp(sleepProgress, -1, 4);
				this.Thigh_R.xRot = Mth.lerp(sleepProgress, 0, -0.8726646259971648F);
				this.Thigh_R.yRot = Mth.lerp(sleepProgress, 0, -0.3490658503988659F);
				this.Foot_L.y = Mth.lerp(sleepProgress, 10, 9.0F);
				this.Foot_L.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Foot_L.zRot = Mth.lerp(sleepProgress, 0, -0.0781907508222411F);
				this.Arm_R.y = Mth.lerp(sleepProgress, 5, 9.0F);
				this.Arm_R.z = Mth.lerp(sleepProgress, -16, -14.0F);
				this.Arm_R.xRot = Mth.lerp(sleepProgress, 0, -1.13376586611655F);
				this.Arm_R.zRot = Mth.lerp(sleepProgress, 0, -1.524545074985436F);
				this.Leg_L.y = Mth.lerp(sleepProgress, 9, 7.0F);
				this.Leg_L.z = Mth.lerp(sleepProgress, 3, 5.0F);
				this.Leg_L.xRot = Mth.lerp(sleepProgress, 0, -0.6981317007977318F);
				this.Foot_R.y = Mth.lerp(sleepProgress, 10, 9.0F);
				this.Foot_R.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Tail_3.xRot = Mth.lerp(sleepProgress, 0, -0.03490658503988659F);
				this.Tail_3.yRot = Mth.lerp(sleepProgress, 0, 0.35185837453889574F);
				this.Tail_3.zRot = Mth.lerp(sleepProgress, 0, -0.0781907508222411F);
				this.Neck.x = Mth.lerp(sleepProgress, 0, -1.0F);
				this.Neck.y = Mth.lerp(sleepProgress, -1, 1.0F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.5864306020384839F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -0.6646214111173737F);
				this.Arm_L.y = Mth.lerp(sleepProgress, 5, 7.0F);
				this.Arm_L.z = Mth.lerp(sleepProgress, -16, -15.0F);
				this.Arm_L.xRot = Mth.lerp(sleepProgress, 0, -1.0555751236166873F);
				this.Arm_L.yRot = Mth.lerp(sleepProgress, 0, -0.11728612207217244F);
				this.Arm_L.zRot = Mth.lerp(sleepProgress, 0, 1.2901473511162753F);
				this.Body.y = Mth.lerp(sleepProgress, 3, 16.0F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, -0.03909537541112055F);
				this.Body.yRot = Mth.lerp(sleepProgress, 0, 0.03909537541112055F);
				this.Jaw_base.xRot = Mth.lerp(sleepProgress, 0, 0.3127630032889644F);
				this.Head.y = Mth.lerp(sleepProgress, -2.5F, -1.6F);
				this.Head.z = Mth.lerp(sleepProgress, -9, -8.0F);
				this.Head.xRot = Mth.lerp(sleepProgress, 0, -0.8600982340775168F);
				this.Head.yRot = Mth.lerp(sleepProgress, 0, -0.3909537457888271F);
				this.Head.zRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				this.Leg_R.y = Mth.lerp(sleepProgress, 9, 7.0F);
				this.Leg_R.z = Mth.lerp(sleepProgress, 3, 5.0F);
				this.Leg_R.xRot = Mth.lerp(sleepProgress, 0, -0.6981317007977318F);
				this.Tail_1.x = Mth.lerp(sleepProgress, 0, -1.0F);
				this.Tail_1.z = Mth.lerp(sleepProgress, 7, 5.0F);
				this.Tail_1.xRot = Mth.lerp(sleepProgress, 0, -0.15707963267948966F);
				this.Tail_1.yRot = Mth.lerp(sleepProgress, 0, 0.5082398928281348F);
				this.Tail_1.zRot = Mth.lerp(sleepProgress, 0, 0.0781907508222411F);
				this.Tail_2.xRot = Mth.lerp(sleepProgress, 0, -0.03490658503988659F);
				this.Tail_2.yRot = Mth.lerp(sleepProgress, 0, 0.5082398928281348F);
				this.Tail_2.zRot = Mth.lerp(sleepProgress, 0, -0.19547687289441354F);
				this.Thigh_L.x = Mth.lerp(sleepProgress, -2, -2.7F);
				this.Thigh_L.y = Mth.lerp(sleepProgress, 3, 12.0F);
				this.Thigh_L.z = Mth.lerp(sleepProgress, -1, 4.2F);
				this.Thigh_L.xRot = Mth.lerp(sleepProgress, 0, -0.8726646259971648F);
				this.Thigh_L.yRot = Mth.lerp(sleepProgress, 0, 0.3490658503988659F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Thigh_R.x = Mth.lerp(sleepProgress, 3, 2);
				this.Thigh_R.y = Mth.lerp(sleepProgress, 12, 3);
				this.Thigh_R.z = Mth.lerp(sleepProgress, 4, -1);
				this.Thigh_R.xRot = Mth.lerp(sleepProgress, -0.8726646259971648F, 0);
				this.Thigh_R.yRot = Mth.lerp(sleepProgress, -0.3490658503988659F, 0);
				this.Foot_L.y = Mth.lerp(sleepProgress, 9, 10.0F);
				this.Foot_L.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Foot_L.zRot = Mth.lerp(sleepProgress, -0.0781907508222411F, 0);
				this.Arm_R.y = Mth.lerp(sleepProgress, 9, 5.0F);
				this.Arm_R.z = Mth.lerp(sleepProgress, -14, -16.0F);
				this.Arm_R.xRot = Mth.lerp(sleepProgress, -1.13376586611655F, 0);
				this.Arm_R.zRot = Mth.lerp(sleepProgress, -1.524545074985436F, 0);
				this.Leg_L.y = Mth.lerp(sleepProgress, 7, 9.0F);
				this.Leg_L.z = Mth.lerp(sleepProgress, 5, 3.0F);
				this.Leg_L.xRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
				this.Foot_R.y = Mth.lerp(sleepProgress, 9, 10.0F);
				this.Foot_R.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Tail_3.xRot = Mth.lerp(sleepProgress, -0.03490658503988659F, 0);
				this.Tail_3.yRot = Mth.lerp(sleepProgress, 0.35185837453889574F, 0);
				this.Tail_3.zRot = Mth.lerp(sleepProgress, -0.0781907508222411F, 0);
				this.Neck.x = Mth.lerp(sleepProgress, -1, 0.0F);
				this.Neck.y = Mth.lerp(sleepProgress, 1, -1.0F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.5864306020384839F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, -0.6646214111173737F, 0);
				this.Arm_L.y = Mth.lerp(sleepProgress, 7, 5.0F);
				this.Arm_L.z = Mth.lerp(sleepProgress, -15, -16.0F);
				this.Arm_L.xRot = Mth.lerp(sleepProgress, -1.0555751236166873F, 0);
				this.Arm_L.yRot = Mth.lerp(sleepProgress, -0.11728612207217244F, 0);
				this.Arm_L.zRot = Mth.lerp(sleepProgress, 1.2901473511162753F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 16, 3.0F);
				this.Body.xRot = Mth.lerp(sleepProgress, -0.03909537541112055F, 0);
				this.Body.yRot = Mth.lerp(sleepProgress, 0.03909537541112055F, 0);
				this.Jaw_base.xRot = Mth.lerp(sleepProgress, 0.3127630032889644F, 0);
				this.Head.y = Mth.lerp(sleepProgress, -1.6F, -2.5F);
				this.Head.z = Mth.lerp(sleepProgress, -8, -9.0F);
				this.Head.xRot = Mth.lerp(sleepProgress, -0.8600982340775168F, 0);
				this.Head.yRot = Mth.lerp(sleepProgress, -0.3909537457888271F, 0);
				this.Head.zRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				this.Leg_R.y = Mth.lerp(sleepProgress, 9, 7.0F);
				this.Leg_R.z = Mth.lerp(sleepProgress, 5, 3.0F);
				this.Leg_R.xRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
				this.Tail_1.x = Mth.lerp(sleepProgress, -1, 0F);
				this.Tail_1.z = Mth.lerp(sleepProgress, 5, 7.0F);
				this.Tail_1.xRot = Mth.lerp(sleepProgress, -0.15707963267948966F, 0);
				this.Tail_1.yRot = Mth.lerp(sleepProgress, 0.5082398928281348F, 0);
				this.Tail_1.zRot = Mth.lerp(sleepProgress, 0.0781907508222411F, 0);
				this.Tail_2.xRot = Mth.lerp(sleepProgress, -0.03490658503988659F, 0);
				this.Tail_2.yRot = Mth.lerp(sleepProgress, 0.5082398928281348F, 0);
				this.Tail_2.zRot = Mth.lerp(sleepProgress, -0.19547687289441354F, 0);
				this.Thigh_L.x = Mth.lerp(sleepProgress, -2.7F, -2);
				this.Thigh_L.y = Mth.lerp(sleepProgress, 12, 3.0F);
				this.Thigh_L.z = Mth.lerp(sleepProgress, 4.2F, -1);
				this.Thigh_L.xRot = Mth.lerp(sleepProgress, -0.8726646259971648F, 0);
				this.Thigh_L.yRot = Mth.lerp(sleepProgress, 0.3490658503988659F, 0);
			} else {
