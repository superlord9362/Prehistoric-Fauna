...
public class CoelophysisSleepingModel extends EntityModel<CoelophysisEntity> {
    ...
    public CoelophysisSleepingModel() {
        ...
        this.LLeg.setRotationPoint(-0.5F, 4.2F, 0.9F);
        this.LLeg.addBox(-1.0F, 0.0F, 0.0F, 2.0F, 6.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LLeg, -0.3979350561389017F, -0.0781907508222411F, -0.27366763203903305F);
        ...
        this.setRotateAngle(RArm, 0.0F, 0.0F, -1.3264502315156905F);
        ...
        this.RLeg.setRotationPoint(0.6F, 4.2F, 0.9F);
        this.RLeg.addBox(-1.0F, 0.0F, 0.0F, 2.0F, 6.0F, 0.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RLeg, -0.3979350561389017F, 0.0781907508222411F, 0.27366763203903305F);
