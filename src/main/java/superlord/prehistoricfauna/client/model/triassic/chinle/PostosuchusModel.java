	...
	public void setupAnim(Postosuchus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Head.y = Mth.lerp(sleepProgress, 0, 0.6F);
				this.Head.xRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
				this.Jaw.xRot = Mth.lerp(sleepProgress, 0, 0.5235987755982988F);
				this.Foot.xRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0, 0.27366763203903305F);
				this.Tail2.zRot = Mth.lerp(sleepProgress, 0, 0.03909537541112055F);
				this.Arm.xRot = Mth.lerp(sleepProgress, 0.3490658503988659F, -0.8203047484373349F);
				this.Arm.zRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Neck.y = Mth.lerp(sleepProgress, -3, -1.0F);
				this.Neck.z = Mth.lerp(sleepProgress, -23, -23.5F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, -0.10471975511965977F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -0.3490658503988659F);
				this.Foot_1.xRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.Thigh_1.y = Mth.lerp(sleepProgress, 6, 21.5F);
				this.Thigh_1.z = Mth.lerp(sleepProgress, 8, 7.0F);
				this.Thigh_1.xRot = Mth.lerp(sleepProgress, -0.3490658503988659F, -1.9198621771937625F);
				this.Thigh_1.yRot = Mth.lerp(sleepProgress, -0.17453292519943295F, -0.45378560551852565F);
				this.Tail.x = Mth.lerp(sleepProgress, 0, 0.4F);
				this.Tail.y = Mth.lerp(sleepProgress, -5, -4.0F);
				this.Tail.xRot = Mth.lerp(sleepProgress, 0, -0.17453292519943295F);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.Body.y = Mth.lerp(sleepProgress, 9, 19.0F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, 0.10471975511965977F);
				this.Arm_1.xRot = Mth.lerp(sleepProgress, 0.3490658503988659F, -0.8203047484373349F);
				this.Arm_1.zRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.Calf.z = Mth.lerp(sleepProgress, -4, -2.6F);
				this.Calf.xRot = Mth.lerp(sleepProgress, 0.3490658503988659F, 1.5009831567151235F);
				this.Thigh.x = Mth.lerp(sleepProgress, -2, -2.5F);
				this.Thigh.y = Mth.lerp(sleepProgress, 6, 21.5F);
				this.Thigh.z = Mth.lerp(sleepProgress, 8, 7.0F);
				this.Thigh.xRot = Mth.lerp(sleepProgress, -0.3490658503988659F, -1.9198621771937625F);
				this.Thigh.yRot = Mth.lerp(sleepProgress, 0.17453292519943295F, 0.41887902047863906F);
				this.Calf_1.z = Mth.lerp(sleepProgress, -4, -2.6F);
				this.Calf_1.xRot = Mth.lerp(sleepProgress, 0.3490658503988659F, 1.5009831567151235F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Head.y = Mth.lerp(sleepProgress, 0.6F, 0);
				this.Head.xRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
				this.Jaw.xRot = Mth.lerp(sleepProgress, 0.5235987755982988F, 0);
				this.Foot.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0.27366763203903305F, 0);
				this.Tail2.zRot = Mth.lerp(sleepProgress, 0.03909537541112055F, 0);
				this.Arm.xRot = Mth.lerp(sleepProgress, -0.8203047484373349F, 0.3490658503988659F);
				this.Arm.zRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Neck.y = Mth.lerp(sleepProgress, -1, -3.0F);
				this.Neck.z = Mth.lerp(sleepProgress, -23.5F, -23);
				this.Neck.xRot = Mth.lerp(sleepProgress, -0.10471975511965977F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, -0.3490658503988659F, 0);
				this.Foot_1.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.Thigh_1.y = Mth.lerp(sleepProgress, 21.5F, 6F);
				this.Thigh_1.z = Mth.lerp(sleepProgress, 7, 8.0F);
				this.Thigh_1.xRot = Mth.lerp(sleepProgress, -1.9198621771937625F, -0.3490658503988659F);
				this.Thigh_1.yRot = Mth.lerp(sleepProgress, -0.45378560551852565F, -0.17453292519943295F);
				this.Tail.x = Mth.lerp(sleepProgress, 0.4F, 0);
				this.Tail.y = Mth.lerp(sleepProgress, -4, -5.0F);
				this.Tail.xRot = Mth.lerp(sleepProgress, -0.17453292519943295F, 0);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 19, 9.0F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0.10471975511965977F, 0);
				this.Arm_1.xRot = Mth.lerp(sleepProgress, -0.8203047484373349F, 0.3490658503988659F);
				this.Arm_1.zRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.Calf.z = Mth.lerp(sleepProgress, -2.6F, -4);
				this.Calf.xRot = Mth.lerp(sleepProgress, 1.5009831567151235F, 0.3490658503988659F);
				this.Thigh.x = Mth.lerp(sleepProgress, -2.5F, -2);
				this.Thigh.y = Mth.lerp(sleepProgress, 21.5F, 6);
				this.Thigh.z = Mth.lerp(sleepProgress, 7, 8.0F);
				this.Thigh.xRot = Mth.lerp(sleepProgress, -1.9198621771937625F, -0.3490658503988659F);
				this.Thigh.yRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0.17453292519943295F);
				this.Calf_1.z = Mth.lerp(sleepProgress, -2.6F, -4);
				this.Calf_1.xRot = Mth.lerp(sleepProgress, 1.5009831567151235F, 0.3490658503988659F);
			} else {
