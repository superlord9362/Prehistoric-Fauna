	...
	public void setupAnim(Ischigualastia entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 9, 14);
				this.Body.zRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.LegL.x = Mth.lerp(sleepProgress, 7, 10.4F);
				this.LegL.zRot = Mth.lerp(sleepProgress, 0, 0.5235987755982988F);
				this.ArmR.xRot = Mth.lerp(sleepProgress, 0, 0.5235987755982988F);
				this.LegR.xRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				...
				this.ArmL.x = Mth.lerp(sleepProgress, 7, 11.0F);
				this.ArmL.xRot = Mth.lerp(sleepProgress, 0, 0.45378560551852565F);
				this.ArmL.yRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				this.ArmL.zRot = Mth.lerp(sleepProgress, 0, 0.5235987755982988F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Body.y = Mth.lerp(sleepProgress, 14, 9);
				this.Body.zRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.LegL.x = Mth.lerp(sleepProgress, 10.4F, 7F);
				this.LegL.zRot = Mth.lerp(sleepProgress, 0.5235987755982988F, 0);
				this.ArmR.xRot = Mth.lerp(sleepProgress, 0.5235987755982988F, 0);
				this.LegR.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.593411945678072F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0-0.13962634015954636F, 0);
				...
				this.ArmL.x = Mth.lerp(sleepProgress, 11, 7.0F);
				this.ArmL.xRot = Mth.lerp(sleepProgress, 0.45378560551852565F, 0);
				this.ArmL.yRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				this.ArmL.zRot = Mth.lerp(sleepProgress, 0.5235987755982988F, 0);
			} else {
