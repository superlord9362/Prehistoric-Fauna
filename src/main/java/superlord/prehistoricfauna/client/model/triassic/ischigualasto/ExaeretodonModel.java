	...
	public void setupAnim(Exaeretodon entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LeftBackLeg.xRot = Mth.lerp(sleepProgress, 0, 1.6816247076649256F);
				this.LeftBackLeg.yRot = Mth.lerp(sleepProgress, 0, -0.40125119103875473F);
				this.Tail.z = Mth.lerp(sleepProgress, 10, 9.1F);
				...
				this.Head.y = Mth.lerp(sleepProgress, -3, -2.6F);
				this.Head.z = Mth.lerp(sleepProgress, -2, 0.0F);
				...
				this.Body.y = Mth.lerp(sleepProgress, 21, 23.6F);
				this.Body.xRot = Mth.lerp(sleepProgress, 0, -0.1459095194746135F);
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, -3, -2.6F);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, -0.5F, -0.1F);
				this.LeftFrontLeg.z = Mth.lerp(sleepProgress, -0.5F, -0.6F);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, 0, -1.314407417066352F);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, 0, -1.1299261204568736F);
				this.LeftFrontLeg.zRot = Mth.lerp(sleepProgress, 0, -0.2556907287592666F);
				this.RightBackLeg.xRot = Mth.lerp(sleepProgress, 0, 1.605702911834783F);
				...
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, 0, 1.1311478456069475F);
				this.RightFrontLeg.zRot = Mth.lerp(sleepProgress, 0, 0.6201154619282966F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.LeftBackLeg.xRot = Mth.lerp(sleepProgress, 1.6816247076649256F, 0);
				this.LeftBackLeg.yRot = Mth.lerp(sleepProgress, -0.40125119103875473F, 0);
				this.Tail.z = Mth.lerp(sleepProgress, 9.1F, 10);
				...
				this.Head.y = Mth.lerp(sleepProgress, -2.6F, -3F);
				this.Head.z = Mth.lerp(sleepProgress, 0, -2.0F);
				...
				this.Body.y = Mth.lerp(sleepProgress, 23.6F, 21);
				this.Body.xRot = Mth.lerp(sleepProgress, -0.1459095194746135F, 0);
				this.LeftFrontLeg.x = Mth.lerp(sleepProgress, -2.6F, -3);
				this.LeftFrontLeg.y = Mth.lerp(sleepProgress, -0.1F, -0.5F);
				this.LeftFrontLeg.z = Mth.lerp(sleepProgress, -0.6F, -0.5F);
				this.LeftFrontLeg.xRot = Mth.lerp(sleepProgress, -1.314407417066352F, 0);
				this.LeftFrontLeg.yRot = Mth.lerp(sleepProgress, -1.1299261204568736F, 0);
				this.LeftFrontLeg.zRot = Mth.lerp(sleepProgress, -0.2556907287592666F, 0);
				this.RightBackLeg.xRot = Mth.lerp(sleepProgress, 1.605702911834783F, 0);
				...
				this.RightFrontLeg.yRot = Mth.lerp(sleepProgress, 1.1311478456069475F, 0);
				this.RightFrontLeg.zRot = Mth.lerp(sleepProgress, 0.6201154619282966F, 0);
			} else {
