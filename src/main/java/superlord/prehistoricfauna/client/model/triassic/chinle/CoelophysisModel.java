	...
	public void setupAnim(Coelophysis entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RLeg.y = Mth.lerp(sleepProgress, 4.5F, 4.2F);
				this.RLeg.z = Mth.lerp(sleepProgress, 2, 0.9F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, -0.3979350561389017F);
				this.RLeg.yRot = Mth.lerp(sleepProgress, 0, -0.0781907508222411F);
				this.RLeg.zRot = Mth.lerp(sleepProgress, 0, -0.27366763203903305F);
				this.LThigh.xRot = Mth.lerp(sleepProgress, 0, -1.1728612040769677F);
				this.LThigh.yRot = Mth.lerp(sleepProgress, 0, -0.46914448828868976F);
				...
				this.RArm.zRot = Mth.lerp(sleepProgress, 0, 1.3292428222347474F);
				...
				this.LArm.zRot = Mth.lerp(sleepProgress, 0, -1.3264502315156905F);
				this.Body.y = Mth.lerp(sleepProgress, 11, 19);
				this.LLeg.y = Mth.lerp(sleepProgress, 4.5F, 4.2F);
				this.LLeg.z = Mth.lerp(sleepProgress, 2, 0.9F);
				this.LLeg.xRot = Mth.lerp(sleepProgress, 0, -0.3979350561389017F);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0, 0.0781907508222411F);
				this.LLeg.zRot = Mth.lerp(sleepProgress, 0, 0.27366763203903305F);
				this.RThigh.xRot = Mth.lerp(sleepProgress, 0, -1.1728612040769677F);
				this.RThigh.yRot = Mth.lerp(sleepProgress, 0, 0.46914448828868976F);
			...
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				...
				this.RLeg.y = Mth.lerp(sleepProgress, 4.2F, 4.5F);
				this.RLeg.z = Mth.lerp(sleepProgress, 0.9F, 2F);
				this.RLeg.xRot = Mth.lerp(sleepProgress, -0.3979350561389017F, 0);
				this.RLeg.yRot = Mth.lerp(sleepProgress, -0.0781907508222411F, 0);
				this.RLeg.zRot = Mth.lerp(sleepProgress, -0.27366763203903305F, 0);
				this.LThigh.xRot = Mth.lerp(sleepProgress, -1.1728612040769677F, 0);
				this.LThigh.yRot = Mth.lerp(sleepProgress, -0.46914448828868976F, 0);
				...
				this.RArm.zRot = Mth.lerp(sleepProgress, 1.3292428222347474F, 0);
				...
				this.LArm.zRot = Mth.lerp(sleepProgress, -1.3264502315156905F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 19, 11);
				this.LLeg.y = Mth.lerp(sleepProgress, 4.2F, 4.5F);
				this.LLeg.z = Mth.lerp(sleepProgress, 0.9F, 2F);
				this.LLeg.xRot = Mth.lerp(sleepProgress, -0.3979350561389017F, 0);
				this.LLeg.yRot = Mth.lerp(sleepProgress, 0.0781907508222411F, 0);
				this.LLeg.zRot = Mth.lerp(sleepProgress, 0.27366763203903305F, 0);
				this.RThigh.xRot = Mth.lerp(sleepProgress, -1.1728612040769677F, 0);
				this.RThigh.yRot = Mth.lerp(sleepProgress, 0.46914448828868976F, 0);
