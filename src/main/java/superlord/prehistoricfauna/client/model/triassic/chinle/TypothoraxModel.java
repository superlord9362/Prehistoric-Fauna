	...
	public void setupAnim(Typothorax entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.tail_base.xRot = Mth.lerp(sleepProgress, 0, -0.17121680694433672F);
				this.tail_base.yRot = Mth.lerp(sleepProgress, 0, 0.2932153010192419F);
				this.tail_base.zRot = Mth.lerp(sleepProgress, 0, 0.048869218223603385F);
				this.Leg_L_front.y = Mth.lerp(sleepProgress, 18, 22.0F);
				this.Leg_L_front.xRot = Mth.lerp(sleepProgress, 0, -1.1494738560161097F);
				this.Leg_L_front.yRot = Mth.lerp(sleepProgress, 0, -0.36634460599886814F);
				this.armor.xRot = Mth.lerp(sleepProgress, 0, -0.07330382525481048F);
				this.armor.yRot = Mth.lerp(sleepProgress, 0, 0.09773843644720677F);
				this.Foot.xRot = Mth.lerp(sleepProgress, 0, 1.7608626716844347F);
				this.Foot.zRot = Mth.lerp(sleepProgress, 0, 0.293389837939183F);
				this.neck.xRot = Mth.lerp(sleepProgress, 0, 0.5133013303483712F);
				this.neck.yRot = Mth.lerp(sleepProgress, 0, -0.17104227002439565F);
				this.neck.zRot = Mth.lerp(sleepProgress, 0, -0.12217304763960307F);
				this.Thigh_R.x = Mth.lerp(sleepProgress, 2.5F, 3.5F);
				this.Thigh_R.y = Mth.lerp(sleepProgress, 16, 19.1F);
				this.Thigh_R.xRot = Mth.lerp(sleepProgress, 0, -0.7333873596775006F);
				this.Thigh_R.yRot = Mth.lerp(sleepProgress, 0, -0.2200860126843725F);
				this.Leg_L_back.y = Mth.lerp(sleepProgress, 4, 2.0F);
				this.Leg_L_back.z = Mth.lerp(sleepProgress, 0, 2.0F);
				this.Leg_L_back.xRot = Mth.lerp(sleepProgress, 0, -0.6590362962582867F);
				this.Leg_L_back.yRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				this.Leg_L_back.zRot = Mth.lerp(sleepProgress, 0, 0.1464331302344367F);
				this.Leg_R_front.y = Mth.lerp(sleepProgress, 18, 22.0F);
				this.Leg_R_front.xRot = Mth.lerp(sleepProgress, 0, -1.07634451774697F);
				this.Leg_R_front.yRot = Mth.lerp(sleepProgress, 0, 0.2932153010192419F);
				this.Thigh_L.y = Mth.lerp(sleepProgress, 16, 19.0F);
				this.Thigh_L.xRot = Mth.lerp(sleepProgress, 0, -0.7087782198875415F);
				this.Thigh_L.yRot = Mth.lerp(sleepProgress, 0, 0.19547687289441354F);
				this.belly.y = Mth.lerp(sleepProgress, 15, 19.0F);
				this.Leg_R_back.y = Mth.lerp(sleepProgress, 4, 2.0F);
				this.Leg_R_back.z = Mth.lerp(sleepProgress, 0, 2.0F);
				this.Leg_R_back.xRot = Mth.lerp(sleepProgress, 0, -0.7819074915776542F);
				this.Leg_R_back.yRot = Mth.lerp(sleepProgress, 0, -0.2200860126843725F);
				this.Leg_R_back.zRot = Mth.lerp(sleepProgress, 0, -0.2686061778740398F);
				this.tail_tip.xRot = Mth.lerp(sleepProgress, 0, 0.048869218223603385F);
				this.tail_tip.yRot = Mth.lerp(sleepProgress, 0, 0.24434609527920614F);
				this.tail_tip.zRot = Mth.lerp(sleepProgress, 0, -0.07330382525481048F);
				this.Foot_L.xRot = Mth.lerp(sleepProgress, 0, 1.4903366376253135F);
				this.Foot_L.yRot = Mth.lerp(sleepProgress, 0, -0.024260076353049827F);
				this.Foot_L.zRot = Mth.lerp(sleepProgress, 0, -0.048869218223603385F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.tail_base.xRot = Mth.lerp(sleepProgress, -0.17121680694433672F, 0);
				this.tail_base.yRot = Mth.lerp(sleepProgress, 0.2932153010192419F, 0);
				this.tail_base.zRot = Mth.lerp(sleepProgress, 0.048869218223603385F, 0);
				this.Leg_L_front.y = Mth.lerp(sleepProgress, 22, 18.0F);
				this.Leg_L_front.xRot = Mth.lerp(sleepProgress, -1.1494738560161097F, 0);
				this.Leg_L_front.yRot = Mth.lerp(sleepProgress, -0.36634460599886814F, 0);
				this.armor.xRot = Mth.lerp(sleepProgress, -0.07330382525481048F, 0);
				this.armor.yRot = Mth.lerp(sleepProgress, 0.09773843644720677F, 0);
				this.Foot.xRot = Mth.lerp(sleepProgress, 1.7608626716844347F, 0);
				this.Foot.zRot = Mth.lerp(sleepProgress, 0.293389837939183F, 0);
				this.neck.xRot = Mth.lerp(sleepProgress, 0.5133013303483712F, 0);
				this.neck.yRot = Mth.lerp(sleepProgress, -0.17104227002439565F, 0);
				this.neck.zRot = Mth.lerp(sleepProgress, -0.12217304763960307F, 0);
				this.Thigh_R.x = Mth.lerp(sleepProgress, 3.5F, 2.5F);
				this.Thigh_R.y = Mth.lerp(sleepProgress, 19.1F, 16);
				this.Thigh_R.xRot = Mth.lerp(sleepProgress, -0.7333873596775006F, 0);
				this.Thigh_R.yRot = Mth.lerp(sleepProgress, -0.2200860126843725F, 0);
				this.Leg_L_back.y = Mth.lerp(sleepProgress, 2, 4.0F);
				this.Leg_L_back.z = Mth.lerp(sleepProgress, 2, 0.0F);
				this.Leg_L_back.xRot = Mth.lerp(sleepProgress, -0.6590362962582867F, 0);
				this.Leg_L_back.yRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				this.Leg_L_back.zRot = Mth.lerp(sleepProgress, 0.1464331302344367F, 0);
				this.Leg_R_front.y = Mth.lerp(sleepProgress, 22, 18.0F);
				this.Leg_R_front.xRot = Mth.lerp(sleepProgress, -1.07634451774697F, 0);
				this.Leg_R_front.yRot = Mth.lerp(sleepProgress, 0.2932153010192419F, 0);
				this.Thigh_L.y = Mth.lerp(sleepProgress, 19, 16.0F);
				this.Thigh_L.xRot = Mth.lerp(sleepProgress, -0.7087782198875415F, 0);
				this.Thigh_L.yRot = Mth.lerp(sleepProgress, 0.19547687289441354F, 0);
				this.belly.y = Mth.lerp(sleepProgress, 19, 15.0F);
				this.Leg_R_back.y = Mth.lerp(sleepProgress, 2, 4.0F);
				this.Leg_R_back.z = Mth.lerp(sleepProgress, 2, 0.0F);
				this.Leg_R_back.xRot = Mth.lerp(sleepProgress, -0.7819074915776542F, 0);
				this.Leg_R_back.yRot = Mth.lerp(sleepProgress, -0.2200860126843725F, 0);
				this.Leg_R_back.zRot = Mth.lerp(sleepProgress, -0.2686061778740398F, 0);
				this.tail_tip.xRot = Mth.lerp(sleepProgress, 0.048869218223603385F, 0);
				this.tail_tip.yRot = Mth.lerp(sleepProgress, 0.24434609527920614F, 0);
				this.tail_tip.zRot = Mth.lerp(sleepProgress, -0.07330382525481048F, 0);
				this.Foot_L.xRot = Mth.lerp(sleepProgress, 1.4903366376253135F, 0);
				this.Foot_L.yRot = Mth.lerp(sleepProgress, -0.024260076353049827F, 0);
				this.Foot_L.zRot = Mth.lerp(sleepProgress, -0.048869218223603385F, 0);
			} else {
