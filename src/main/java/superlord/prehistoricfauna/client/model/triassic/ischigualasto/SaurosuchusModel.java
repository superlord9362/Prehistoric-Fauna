	...
	public void setupAnim(Saurosuchus entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Arm.y = Mth.lerp(sleepProgress, 7, 21.5F);
				this.Arm.xRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.Arm_1.y = Mth.lerp(sleepProgress, 7, 21.5F);
				this.Arm_1.xRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.Tail.xRot = Mth.lerp(sleepProgress, 0, -0.17453292519943295F);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0, 0.6108652381980153F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.0499F, 0.17453292519943295F);
				this.Tail2.z = Mth.lerp(sleepProgress, 21, 20);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0, 0.6108652381980153F);
				this.Body.y = Mth.lerp(sleepProgress, 8, 19.0F);
				this.Thigh.x = Mth.lerp(sleepProgress, -4, 3.5F);
				this.Thigh.y = Mth.lerp(sleepProgress, 7, 20.5F);
				this.Thigh.z = Mth.lerp(sleepProgress, 12.5F, 17);
				this.Thigh.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Thigh.yRot = Mth.lerp(sleepProgress, 0, 0.6981317007977318F);
				this.Thigh_1.x = Mth.lerp(sleepProgress, 4, -3.5F);
				this.Thigh_1.y = Mth.lerp(sleepProgress, 7, 20.5F);
				this.Thigh_1.z = Mth.lerp(sleepProgress, 12.5F, 17);
				this.Thigh_1.xRot = Mth.lerp(sleepProgress, 0, 1.5707963267948966F);
				this.Thigh_1.yRot = Mth.lerp(sleepProgress, 0, -0.6981317007977318F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Arm.y = Mth.lerp(sleepProgress, 21.5F, 7);
				this.Arm.xRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.Arm_1.y = Mth.lerp(sleepProgress, 21.5F, 7);
				this.Arm_1.xRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.Tail.xRot = Mth.lerp(sleepProgress, -0.17453292519943295F, 0);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0.6108652381980153F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.17453292519943295F, 0.0499F);
				this.Tail2.z = Mth.lerp(sleepProgress, 20, 21);
				this.Tail2.yRot = Mth.lerp(sleepProgress, 0.6108652381980153F, 0);
				this.Body.y = Mth.lerp(sleepProgress, 19, 8.0F);
				this.Thigh.x = Mth.lerp(sleepProgress, 3.5F, -4);
				this.Thigh.y = Mth.lerp(sleepProgress, 20.5F, 7);
				this.Thigh.z = Mth.lerp(sleepProgress, 17, 12.5F);
				this.Thigh.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Thigh.yRot = Mth.lerp(sleepProgress, 0.6981317007977318F, 0);
				this.Thigh_1.x = Mth.lerp(sleepProgress, -3.5F, 4);
				this.Thigh_1.y = Mth.lerp(sleepProgress, 20.5F, 7F);
				this.Thigh_1.z = Mth.lerp(sleepProgress, 17F, 12.5F);
				this.Thigh_1.xRot = Mth.lerp(sleepProgress, 1.5707963267948966F, 0);
				this.Thigh_1.yRot = Mth.lerp(sleepProgress, -0.6981317007977318F, 0);
			} else {
