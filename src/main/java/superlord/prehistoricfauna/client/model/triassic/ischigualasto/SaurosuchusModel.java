...
public class SaurosuchusModel extends EntityModel<SaurosuchusEntity> {
	...
	public void setRotationAngles(SaurosuchusEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if(entityIn.isAsleep()) {
			this.Arm.rotationPointY = 21.5F;
			this.Arm.rotateAngleX = -1.5707963267948966F;
			this.Arm_1.rotationPointY = 21.5F;
			this.Arm_1.rotateAngleX = -1.5707963267948966F;
			this.Tail.rotateAngleX = -0.17453292519943295F;
			this.Tail.rotateAngleY = 0.6108652381980153F;
			this.Neck.rotateAngleX = 0.17453292519943295F;
			this.Tail2.rotationPointZ = 20;
			this.Tail2.rotateAngleY = 0.6108652381980153F;
			this.Body.rotationPointY = 19.0F;
			this.Thigh.rotationPointX = 3.5F;
			this.Thigh.rotationPointY = 20.5F;
			this.Thigh.rotationPointZ = 17;
			this.Thigh.rotateAngleX = 1.5707963267948966F;
			this.Thigh.rotateAngleY = 0.6981317007977318F;
			this.Thigh_1.rotationPointX = -3.5F;
			this.Thigh_1.rotationPointY = 20.5F;
			this.Thigh_1.rotationPointZ = 17;
			this.Thigh_1.rotateAngleX = 1.5707963267948966F;
			this.Thigh_1.rotateAngleY = -0.6981317007977318F;
		} else {
			...
			if (entityIn.getMotion().x !=  0 && entityIn.getMotion().y != 0 && entityIn.getMotion().z != 0) {
				...
				if (entityIn.isInWater()) {
					...
					this.Thigh.rotationPointY = 19;
					this.Thigh_1.rotationPointY = 19;
					this.Arm.rotationPointY = 21;
					this.Arm_1.rotationPointY = 21;
					this.Thigh.rotateAngleX = -0.25F * MathHelper.sin(0.2F * ageInTicks / 1.5F);
					this.Thigh_1.rotateAngleX = 0.25F * MathHelper.sin(0.2F * ageInTicks / 1.5F);
					...
					this.Arm_1.rotateAngleX = -0.25F * MathHelper.sin(0.2F * ageInTicks / 1.5F);
					this.Arm.rotateAngleX = 0.25F * MathHelper.sin(0.2F * ageInTicks / 1.5F);
	...
	public void resetModel() {
		this.Arm.rotationPointY = 9.0F;
		this.Arm.rotateAngleX = 0;
		this.Arm_1.rotationPointY = 9.0F;
		this.Arm_1.rotateAngleX = 0;
		this.Tail.rotateAngleX = 0;
		this.Tail.rotateAngleY = 0;
		this.Neck.rotateAngleX = 0.17453292519943295F;
		this.Tail2.rotationPointZ = 21.0F;
		this.Tail2.rotateAngleY = 0;
		this.Tail2.rotateAngleX = 0;
		this.Body.rotationPointY = 8.0F;
		this.Body.rotateAngleX = 0;
		this.Calf.rotationPointX = 0.5F;
		this.Calf.rotationPointZ = 0.5F;
		this.Thigh.rotationPointX = 0;
		this.Thigh.rotationPointY = 0;
		this.Thigh.rotationPointZ = 0;
		this.Thigh.rotateAngleX = 0;
		this.Thigh.rotateAngleY = 0;
		this.Thigh_1.rotateAngleX = 0;
		this.Thigh_1.rotateAngleY = 0;
		this.Thigh_1.rotationPointX = -4;
		this.Thigh_1.rotationPointY = 7;
		this.Thigh_1.rotationPointZ = 12.5F;
		this.Thigh.rotationPointX = 4;
		this.Thigh.rotationPointY = 7;
		this.Thigh.rotationPointZ = 12.5F;
	}
