...
public class SaurosuchusModel extends EntityModel<Saurosuchus> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Thigh_1 = partdefinition.addOrReplaceChild("Thigh_1", CubeListBuilder.create().texOffs(58, 0).addBox(-3.0F, -2.0F, -3.5F, 5.0F, 12.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 7.0F, 12.5F));

		PartDefinition Calf_1 = Thigh_1.addOrReplaceChild("Calf_1", CubeListBuilder.create().texOffs(18, 0).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-0.5F, 10.0F, 0.5F));

		PartDefinition Foot_1 = Calf_1.addOrReplaceChild("Foot_1", CubeListBuilder.create().texOffs(83, 0).mirror().addBox(-2.5F, 0.0F, -6.0F, 5.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 5.0F, 0.0F));

		PartDefinition Arm = partdefinition.addOrReplaceChild("Arm", CubeListBuilder.create().texOffs(180, 19).addBox(0.0F, -2.0F, -2.5F, 4.0F, 17.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(2.5F, 9.0F, -10.5F));

		PartDefinition Thigh = partdefinition.addOrReplaceChild("Thigh", CubeListBuilder.create().texOffs(11, 15).addBox(-2.0F, -2.0F, -3.5F, 5.0F, 12.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 7.0F, 12.5F));

		PartDefinition Calf = Thigh.addOrReplaceChild("Calf", CubeListBuilder.create().texOffs(58, 19).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.5F, 10.0F, 0.5F));

		PartDefinition Foot = Calf.addOrReplaceChild("Foot", CubeListBuilder.create().texOffs(98, 20).mirror().addBox(-2.5F, 0.0F, -6.0F, 5.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 5.0F, 0.0F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -8.0F, -21.0F, 12.0F, 13.0F, 35.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.0F, 6.0F));
		...
		PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, -3.0F, 0.0F, 4.0F, 5.0F, 40.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, 21.0F));
		...
		PartDefinition Arm_1 = partdefinition.addOrReplaceChild("Arm_1", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-3.5F, -2.0F, -2.5F, 4.0F, 17.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-3.0F, 9.0F, -10.5F));
