 ...
 */
@OnlyIn(Dist.CLIENT)
public class SaurosuchusSleepingModel extends EntityModel<SaurosuchusEntity> {
    ...
    public SaurosuchusSleepingModel() {
        ...
        this.Calf_1.setRotationPoint(-2.5F, 10.0F, -2.0F);
        ...
        this.Calf.setRotationPoint(2.5F, 10.0F, -2.0F);
        ...
        this.Thigh.addBox(0.0F, -2.0F, -6.0F, 5.0F, 12.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.Arm_1.addBox(-5.0F, 0.0F, 1.0F, 4.0F, 17.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.Thigh_1.addBox(-5.0F, -2.0F, -6.0F, 5.0F, 12.0F, 7.0F, 0.0F, 0.0F, 0.0F);
