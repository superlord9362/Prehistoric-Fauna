	...
	public void setupAnim(Ischigualastia entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity.isAsleep()) {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Torso.y = Mth.lerp(sleepProgress, 15, 20);
				this.Torso.zRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.LLeg.x = Mth.lerp(sleepProgress, -3, 4.4F);
				this.LLeg.y = Mth.lerp(sleepProgress, 19, 16);
				this.LLeg.zRot = Mth.lerp(sleepProgress, 0, -1.04719755118F);
				this.RArm.y = Mth.lerp(sleepProgress, 21, 23);
				this.RArm.x = Mth.lerp(sleepProgress, 3, 5);
				this.RArm.xRot = Mth.lerp(sleepProgress, 0, 0.5235987755982988F);
				this.RArm.zRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.RLeg.x = Mth.lerp(sleepProgress, 3, 4);
				this.RLeg.y = Mth.lerp(sleepProgress, 19, 23);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0, 0.41887902047863906F);
				this.RLeg.zRot = Mth.lerp(sleepProgress, 0, -1.5707963267948966F);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0, 0.593411945678072F);
				this.Neck.yRot = Mth.lerp(sleepProgress, 0, -0.13962634015954636F);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0, 0.8377580409572781F);
				this.Tail.xRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.Tail.yRot = Mth.lerp(sleepProgress, 0, -0.10471975511965977F);
				this.Tail.zRot = Mth.lerp(sleepProgress, 0, 0.593411945678072F);
				this.LArm.x = Mth.lerp(sleepProgress, -3, 7F);
				this.LArm.y = Mth.lerp(sleepProgress, 21, 17);
				this.LArm.xRot = Mth.lerp(sleepProgress, 0, -0.45378560551852565F);
				this.LArm.yRot = Mth.lerp(sleepProgress, 0, -0.24434609527920614F);
				this.LArm.zRot = Mth.lerp(sleepProgress, 0, -0.5235987755982988F);
			} else sleepPose();
		} else {
			if (sleepProgress != 0 && entity.getEntityData().get(DinosaurEntity.SLEEP_TICK) > 0) {
				this.Torso.y = Mth.lerp(sleepProgress, 20, 15);
				this.Torso.zRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.LLeg.x = Mth.lerp(sleepProgress, 4.4F, -3F);
				this.LLeg.y = Mth.lerp(sleepProgress, 16, 19);
				this.LLeg.zRot = Mth.lerp(sleepProgress, -1.04719755118F, 0);
				this.RArm.y = Mth.lerp(sleepProgress, 23, 21);
				this.RArm.x = Mth.lerp(sleepProgress, 5, 3);
				this.RArm.xRot = Mth.lerp(sleepProgress, 0.5235987755982988F, 0);
				this.RArm.zRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.RLeg.x = Mth.lerp(sleepProgress, 4, 3);
				this.RLeg.y = Mth.lerp(sleepProgress, 23, 19);
				this.RLeg.xRot = Mth.lerp(sleepProgress, 0.41887902047863906F, 0);
				this.RLeg.zRot = Mth.lerp(sleepProgress, -1.5707963267948966F, 0);
				this.Neck.xRot = Mth.lerp(sleepProgress, 0.593411945678072F, 0);
				this.Neck.yRot = Mth.lerp(sleepProgress, -0.13962634015954636F, 0);
				this.Neck.zRot = Mth.lerp(sleepProgress, 0.8377580409572781F, 0);
				this.Tail.xRot = Mth.lerp(sleepProgress, -0.24434609527920614F, 0);
				this.Tail.yRot = Mth.lerp(sleepProgress, -0.10471975511965977F, 0);
				this.Tail.zRot = Mth.lerp(sleepProgress, 0.593411945678072F, 0);
				this.LArm.x = Mth.lerp(sleepProgress, 7, -3F);
				this.LArm.y = Mth.lerp(sleepProgress, 17, 21);
				this.LArm.xRot = Mth.lerp(sleepProgress, -0.45378560551852565F, 0);
				this.LArm.yRot = Mth.lerp(sleepProgress, -0.24434609527920614F, 0);
				this.LArm.zRot = Mth.lerp(sleepProgress, -0.5235987755982988F, 0);
			} else {
