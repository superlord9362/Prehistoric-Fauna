...
public class AnkylosaurusSkeletonSquatModel extends EntityModel<AnkylosaurusSkeletonEntity> {
    ...
    public AnkylosaurusSkeletonSquatModel() {
        ...
        this.setRotateAngle(LeftHindLeg2, 0.0F, 0.0F, 0.35185837453889574F);
        ...
        this.LeftFrontLeg.setRotationPoint(15.5F, 7.0F, -21.0F);
        ...
        this.RightHindLeg1.setRotationPoint(-16.0F, 1.5F, 22.0F);
        this.RightHindLeg1.addBox(-2.0F, 0.0F, -7.0F, 10.0F, 19.0F, 16.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightHindLeg1, 0.0F, 0.0F, 0.5473352640780661F);
        ...
        this.LeftHindLeg1.setRotationPoint(16.0F, 1.5F, 22.0F);
        this.LeftHindLeg1.addBox(-8.0F, 0.0F, -7.0F, 10.0F, 18.0F, 16.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftHindLeg1, 0.0F, 0.0F, -0.5473352640780661F);
        ...
        this.setRotateAngle(RightHindLeg3, 0.0F, 0.0F, -0.19547687289441354F);
        ...
        this.setRotateAngle(Neck, 0.15655603856442327F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftHindLeg3, 0.0F, 0.0F, 0.19547687289441354F);
        this.RightFrontLeg = new ModelRenderer(this, 0, 0);
        this.RightFrontLeg.mirror = true;
        this.RightFrontLeg.setRotationPoint(-13.5F, 7.0F, -21.0F);
        ...
        this.setRotateAngle(Tail1, -0.3017674436487861F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg2, 0.0F, 0.0F, -0.35185837453889574F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Body, this.LeftFrontLeg, this.RightHindLeg1, this.LeftHindLeg1, this.RightFrontLeg).forEach((modelRenderer) -> { 
