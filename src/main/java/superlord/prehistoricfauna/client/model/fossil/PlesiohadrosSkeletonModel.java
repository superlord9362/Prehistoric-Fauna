 ...
 */
@OnlyIn(Dist.CLIENT)
public class PlesiohadrosSkeletonModel extends EntityModel<PlesiohadrosSkeletonEntity> {
    ...
    public PlesiohadrosSkeletonModel() {
        ...
        this.Pelvis.setRotationPoint(0.0F, 2.0F, 10.0F);
        ...
        this.LegFrontR.setRotationPoint(-4.0F, 5.0F, -12.0F);
        ...
        this.setRotateAngle(CaudalVertebrae, -0.17453292519943295F, 0.0F, 0.0F);
        this.ThighR = new ModelRenderer(this, 98, 4);
        this.ThighR.mirror = true;
        this.ThighR.setRotationPoint(-6.5F, -2.5F, 11.0F);
        ...
        this.setRotateAngle(TailTip, 0.08726646259971647F, 0.0F, 0.0F);
        ...
        this.ThighL.setRotationPoint(6.5F, -2.5F, 11.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.LegFrontL, this.LegFrontR, this.Ribs, this.ThighR, this.ThighL).forEach((modelRenderer) -> { 
