 ...
 */
@OnlyIn(Dist.CLIENT)
public class StegosaurusSkeletonRestingModel extends EntityModel<StegosaurusSkeletonEntity> {
    ...
    public StegosaurusSkeletonRestingModel() {
        this.textureWidth = 256;
        this.textureHeight = 148;
        this.Body = new ModelRenderer(this, 0, 0);
        this.Body.setRotationPoint(-14.0F, 8.0F, -21.0F);
        this.Body.addBox(-12.0F, 4.0F, 0.0F, 24.0F, 22.0F, 45.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Body, 0.0F, 0.0F, -1.4144148417951712F);
        ...
        this.setRotateAngle(Tail1, -0.1563815016444822F, -0.23457224414434488F, 0.35185837453889574F);
        ...
        this.setRotateAngle(RightLeg, 0.46914448828868976F, 0.0F, 0.0781907508222411F);
        ...
        this.setRotateAngle(Tail2, 0.0781907508222411F, 0.19547687289441354F, 0.46914448828868976F);
        ...
        this.setRotateAngle(LeftArm, 0.0F, 0.0F, 0.5082398928281348F);
        ...
        this.setRotateAngle(LeftLeg, 0.5473352640780661F, 0.0F, 0.35185837453889574F);
        ...
        this.setRotateAngle(RightArm, 0.0F, 0.0F, -0.1563815016444822F);
        ...
        this.setRotateAngle(Head, 0.0F, -0.27366763203903305F, 0.3127630032889644F);
        ...
        this.setRotateAngle(LeftThigh, -0.11728612207217244F, 0.0F, 0.3909537457888271F);
        ...
        this.setRotateAngle(RightThigh, -0.27366763203903305F, 0.0F, -0.1563815016444822F);
        ...
        this.setRotateAngle(Neck, 0.03909537541112055F, 0.35185837453889574F, 0.23457224414434488F);
