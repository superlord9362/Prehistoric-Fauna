...
public class AllosaurusSkeletonModel extends EntityModel<AllosaurusSkeleton> {
	private final ModelPart LeftLeg;
	private final ModelPart RightLeg1;
	private final ModelPart Ilium;

	public AllosaurusSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-8.0F, -3.0F, -6.0F, 8.0F, 22.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -13.5F, 3.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition LeftLeg2 = LeftLeg.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(44, 0).mirror().addBox(-3.5F, 0.0F, -3.0F, 7.0F, 20.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, 15.0F, 6.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition RightLeg1 = partdefinition.addOrReplaceChild("RightLeg1", CubeListBuilder.create().texOffs(96, 0).mirror().addBox(0.0F, -3.0F, -6.0F, 8.0F, 22.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.0F, -13.5F, 3.0F, -0.0873F, 0.0F, 0.0F));

		PartDefinition RightLeg2 = RightLeg1.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(140, 0).mirror().addBox(-3.5F, 0.0F, -3.0F, 7.0F, 20.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 15.0F, 6.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition Ilium = partdefinition.addOrReplaceChild("Ilium", CubeListBuilder.create().texOffs(144, 14).addBox(-7.0F, -5.0F, -11.0F, 14.0F, 23.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -17.5F, 3.0F));

		PartDefinition CaudalVertebrae1 = Ilium.addOrReplaceChild("CaudalVertebrae1", CubeListBuilder.create().texOffs(40, 14).addBox(0.0F, -4.0F, -3.0F, 0.0F, 13.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 13.0F, -0.0499F, 0.0F, 0.0F));
		...
		PartDefinition CaudalVertebrae2 = CaudalVertebrae1.addOrReplaceChild("CaudalVertebrae2", CubeListBuilder.create().texOffs(79, 39).addBox(0.0F, -3.0F, 0.0F, 0.0F, 9.0F, 42.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 29.0F, 0.0499F, 0.0F, 0.0F));
		...
		PartDefinition RightArm = Ribcage.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(205, 0).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.5F, 11.5F, -13.0F, 0.1484F, 0.0F, 0.0F));

		PartDefinition CervicalRibs = Ribcage.addOrReplaceChild("CervicalRibs", CubeListBuilder.create().texOffs(210, 49).addBox(-3.5F, -8.8F, -15.0F, 7.0F, 22.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -18.0F));
		...
		PartDefinition Head1 = CervicalRibs.addOrReplaceChild("Head1", CubeListBuilder.create().texOffs(198, 22).addBox(-4.5F, -2.0F, -7.0F, 9.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -8.0F, -11.0F));
		...
		PartDefinition LeftArm = Ribcage.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(181, 61).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 16.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.5F, 11.5F, -13.0F, 0.1484F, 0.0F, 0.0F));
