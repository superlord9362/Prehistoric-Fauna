...
public class LiaoningosaurusSkeletonBraceModel extends EntityModel<LiaoningosaurusSkeleton> {
	...
	public LiaoningosaurusSkeletonBraceModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(1, 1).addBox(-3.0F, -1.0F, -1.0F, 4.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 13.0F, 4.0F, 0.3491F, -0.1745F, 0.0F));
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(1, 1).mirror().addBox(-1.0F, -1.0F, -1.0F, 4.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.0F, 12.675F, 5.0F, -0.6109F, 0.3491F, 0.0F));
		...
		PartDefinition RightFoot = bone9.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(98, 105).mirror().addBox(-2.0F, 0.0F, -4.0F, 4.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
		...
		.texOffs(14, 80).addBox(-7.0F, -2.5F, -15.0F, 14.0F, 1.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 13.0F, 4.0F, -0.0349F, 0.0F, -0.1745F));
		...
		.texOffs(22, 32).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.1F, -15.0F, 0.0F, -0.2618F, 0.0F));
		...
		.texOffs(34, 46).addBox(-1.0F, -1.0F, -9.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.1F, -4.0F, 0.6676F, -0.332F, -0.151F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 30).mirror().addBox(-1.0F, -1.0F, -1.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.8546F, 2.0883F, -12.0318F, 0.0349F, -0.5236F, 0.1745F));

		PartDefinition LetArm = Body.addOrReplaceChild("LetArm", CubeListBuilder.create().texOffs(0, 30).addBox(-2.0F, 0.0F, -1.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 3.0F, -12.0F, 0.5236F, 0.1745F, -0.1745F));
		...
		.texOffs(-1, 86).addBox(-4.5F, 1.5F, 0.0F, 9.0F, 0.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 6.0F, 0.1855F, 0.3435F, 0.0631F));
		...
		.texOffs(3, 30).addBox(0.0F, -1.0F, 0.0F, 0.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 11.0F, 0.3491F, 0.2618F, 0.0F));
