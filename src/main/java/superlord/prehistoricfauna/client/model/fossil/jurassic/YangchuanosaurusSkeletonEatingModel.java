...
public class YangchuanosaurusSkeletonEatingModel extends EntityModel<YangchuanosaurusSkeleton> {
	private final ModelPart bone17;

	public YangchuanosaurusSkeletonEatingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(76, 105).addBox(-6.5F, -2.5F, -7.5F, 13.0F, 0.0F, 23.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -37.5F, -3.5F, 0.1484F, 0.0F, 0.0F));
		...
		PartDefinition left_arm = torso.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(14, 68).addBox(-3.0F, 0.0F, -3.0F, 4.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 10.0F, -18.0F, 0.48F, 0.1745F, -0.0436F));

		PartDefinition right_arm = torso.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(14, 68).mirror().addBox(-1.0F, 0.0F, -3.0F, 4.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.0F, 10.0F, -18.0F, 0.3491F, -0.1745F, -0.0436F));
		...
		.texOffs(154, 13).addBox(0.0F, -9.0F, -7.0F, 0.0F, 13.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -25.0F, 0.5847F, 0.1745F, 0.0F));

		PartDefinition skull = neck.addOrReplaceChild("skull", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -8.0F, -6.0F, -0.1222F, 0.0873F, 0.3491F));
		...
		.texOffs(134, 38).addBox(-2.0F, -1.0F, -18.99F, 4.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, 0.5149F, 0.0F, 0.0F));
		...
		.texOffs(1, 58).addBox(0.0F, -3.0F, -1.0F, 0.0F, 16.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 15.5F, -0.2182F, 0.1745F, 0.0F));
		...
		.texOffs(1, 1).addBox(0.0F, -3.0F, 0.0F, 0.0F, 9.0F, 48.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 33.0F, -0.0611F, 0.2182F, 0.0F));

		PartDefinition right_leg = bone17.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(1, 108).mirror().addBox(-4.0F, 0.0F, -5.0F, 9.0F, 22.0F, 15.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-7.0F, -38.0F, -3.0F, -0.3491F, 0.1745F, 0.0F));
		...
		PartDefinition bone10 = bone9.addOrReplaceChild("bone10", CubeListBuilder.create().texOffs(110, 35).mirror().addBox(-3.5F, 0.0F, -10.5F, 7.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 17.0F, 4.0F, 0.5236F, 0.0F, 0.0F));

		PartDefinition left_leg = bone17.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(1, 108).addBox(-5.0F, 0.0F, -5.0F, 9.0F, 22.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, -38.0F, -3.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition bone6 = left_leg.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, -1.5F, 6.0F, 21.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 17.0F, 6.5F));

		PartDefinition bone5 = bone6.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(110, 35).addBox(-3.5F, 0.0F, -10.5F, 7.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 4.0F));
