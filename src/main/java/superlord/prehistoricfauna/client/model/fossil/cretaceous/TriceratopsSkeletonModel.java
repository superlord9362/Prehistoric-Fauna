...
public class TriceratopsSkeletonModel extends EntityModel<TriceratopsSkeleton> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head1 = Neck.addOrReplaceChild("Head1", CubeListBuilder.create().texOffs(0, 130).addBox(-6.0F, -3.0F, -12.0F, 12.0F, 18.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, -16.0F, 0.5009F, 0.0F, 0.0F));
