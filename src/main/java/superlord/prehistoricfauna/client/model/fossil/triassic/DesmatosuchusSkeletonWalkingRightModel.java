...
public class DesmatosuchusSkeletonWalkingRightModel extends EntityModel<DesmatosuchusSkeleton> {
	...
	public DesmatosuchusSkeletonWalkingRightModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Belly = ASS.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(0, 24).addBox(-4.0F, -2.5F, -10.0F, 8.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, -0.6F, 0.1396F, 0.0F, 0.0F));

		PartDefinition Neck = Belly.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(47, 1).addBox(0.0F, -0.5F, -6.0F, 0.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.5F, -9.5F, -0.1745F, -0.1745F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(65, 11).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -6.0F, 0.2793F, -0.1745F, 0.0F));
		...
		PartDefinition TailCarapace = ASS.addOrReplaceChild("TailCarapace", CubeListBuilder.create().texOffs(84, 77).addBox(-3.5F, -1.0F, 0.0F, 7.0F, 2.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 12.0F, -0.3142F, 0.1396F, 0.0F));
		...
		PartDefinition Tail_tip = TailCarapace.addOrReplaceChild("Tail_tip", CubeListBuilder.create().texOffs(87, 105).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 4.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 15.0F, 0.1745F, 0.1745F, 0.0F));
