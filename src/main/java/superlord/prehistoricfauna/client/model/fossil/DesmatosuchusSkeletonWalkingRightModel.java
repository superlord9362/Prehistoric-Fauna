 ...
 */
@OnlyIn(Dist.CLIENT)
public class DesmatosuchusSkeletonWalkingRightModel extends EntityModel<DesmatosuchusSkeletonEntity> {
    ...
    public DesmatosuchusSkeletonWalkingRightModel() {
        this.textureWidth = 160;
        this.textureHeight = 160;
        this.Belly = new ModelRenderer(this, 0, 24);
        this.Belly.setRotationPoint(0.0F, -0.5F, -0.6F);
        ...
        this.setRotateAngle(Leg_L_1_1, -0.17453292519943295F, 0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Head, 0.2792526803190927F, 0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Leg_L_2_1, 0.5235987755982988F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Leg_L_2, 0.17453292519943295F, 0.0F, 0.0F);
        ...
        this.Feet_L_1.setRotationPoint(0.0F, 5.0F, -0.5F);
        this.Feet_L_1.addBox(-1.8F, 0.0F, -5.0F, 4.0F, 2.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Feet_L_1, -0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Arm_R, 0.0F, 0.17453292519943295F, -0.0F);
        ...
        this.setRotateAngle(Tail_tip, 0.17453292519943295F, -0.17453292519943295F, 0.0F);
        ...
        this.TailCarapace.setRotationPoint(0.0F, -3.0F, 12.0F);
        this.TailCarapace.addBox(-3.5F, -1.0F, 0.0F, 7.0F, 2.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(TailCarapace, -0.3141592653589793F, -0.13962634015954636F, 0.0F);
        ...
        this.Arm_L.setRotationPoint(4.0F, 11.0F, -7.0F);
        this.Arm_L.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 13.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Arm_L, -0.17453292519943295F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Leg_L_1, 0.5235987755982988F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.ASS, this.Leg_L_1_1, this.Arm_R, this.Arm_L, this.Leg_L_1).forEach((modelRenderer) -> { 
