...
public class YangchuanosaurusSkeletonSleepingModel extends EntityModel<YangchuanosaurusSkeleton> {
	private final ModelPart bone17;

	public YangchuanosaurusSkeletonSleepingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = torso.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(14, 68).addBox(-3.0F, 0.0F, -3.0F, 4.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 10.0F, -18.0F, 0.0F, 0.1745F, -0.6545F));

		PartDefinition right_arm = torso.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(14, 68).mirror().addBox(-1.0F, 0.0F, -3.0F, 4.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.0F, 10.0F, -18.0F, 0.0F, -0.1745F, 0.6545F));
		...
		.texOffs(154, 13).addBox(0.0F, -9.0F, -7.0F, 0.0F, 13.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -25.0F, 1.0647F, 0.3491F, 0.0F));

		PartDefinition skull = neck.addOrReplaceChild("skull", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -8.0F, -6.0F, -0.4712F, 0.3927F, -0.5672F));
		...
		.texOffs(1, 58).addBox(0.0F, -3.0F, -1.0F, 0.0F, 16.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 15.5F, -0.1309F, -0.1745F, 0.0F));
		...
		.texOffs(1, 1).addBox(0.0F, -3.0F, 0.0F, 0.0F, 9.0F, 48.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 33.0F, -0.0175F, -0.2182F, 0.0F));
