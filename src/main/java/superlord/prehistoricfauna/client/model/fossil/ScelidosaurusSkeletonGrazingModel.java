 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScelidosaurusSkeletonGrazingModel extends EntityModel<ScelidosaurusSkeletonEntity> {
    ...
    public ScelidosaurusSkeletonGrazingModel() {
        this.textureWidth = 160;
        this.textureHeight = 150;
        this.LegLeft = new ModelRenderer(this, 44, 33);
        this.LegLeft.mirror = true;
        this.LegLeft.setRotationPoint(-4.0F, 10.0F, 8.0F);
        this.LegLeft.addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegLeft, -0.17453292519943295F, 0.17453292519943295F, 0.0F);
        this.Leg2Left = new ModelRenderer(this, 44, 47);
        this.Leg2Left.mirror = true;
        this.Leg2Left.setRotationPoint(-0.4F, 7.6F, 2.5F);
        this.Leg2Left.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Leg2Left, 0.17453292519943295F, 0.0F, 0.0F);
        this.ArmRight = new ModelRenderer(this, 28, 34);
        this.ArmRight.setRotationPoint(5.0F, 1.3F, -16.0F);
        this.ArmRight.addBox(-2.0F, 0.0F, -1.0F, 3.0F, 10.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ArmRight, -0.17453292519943295F, 0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Head, 0.45378560551852565F, 0.10471975511965977F, 0.0F);
        ...
        this.Leg2Right.setRotationPoint(0.4F, 7.6F, 2.5F);
        this.Leg2Right.addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Leg2Right, 0.17453292519943295F, 0.0F, 0.0F);
        ...
        this.Neck.setRotationPoint(0.0F, 0.0F, -18.0F);
        this.Neck.addBox(-1.5F, -2.0F, -6.0F, 3.0F, 1.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Neck, 0.3490658503988659F, 0.10471975511965977F, 0.0F);
        this.ArmLeft = new ModelRenderer(this, 28, 34);
        this.ArmLeft.mirror = true;
        this.ArmLeft.setRotationPoint(-5.0F, 1.3F, -16.0F);
        this.ArmLeft.addBox(-1.0F, 0.0F, -1.0F, 3.0F, 10.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ArmLeft, -0.17453292519943295F, -0.17453292519943295F, 0.0F);
        this.part24 = new ModelRenderer(this, 44, 108);
        this.part24.setRotationPoint(-1.9F, -0.1F, -3.5F);
        ...
        this.LegRight.setRotationPoint(4.0F, 10.0F, 8.0F);
        this.LegRight.addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegRight, -0.17453292519943295F, -0.17453292519943295F, 0.0F);
        this.part24_1 = new ModelRenderer(this, 44, 108);
        this.part24_1.mirror = true;
        this.part24_1.setRotationPoint(-2.1F, -0.1F, -3.5F);
