...
public class PlesiohadrosSkeletonSittingModel extends EntityModel<PlesiohadrosSkeleton> {
	...
	public PlesiohadrosSkeletonSittingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Ribs = partdefinition.addOrReplaceChild("Ribs", CubeListBuilder.create().texOffs(0, 50).addBox(-5.0F, -5.0F, -6.0F, 10.0F, 18.0F, 17.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.2F, -12.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition Neck = Ribs.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(125, 47).addBox(0.0F, -2.0F, -8.0F, 0.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -6.0F, 0.0F, 0.1745F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(56, 0).addBox(-3.0F, -1.5F, -8.0F, 6.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.5F, -7.0F, 0.6981F, 0.0F, 0.2094F));
		...
		PartDefinition Pelvis = Ribs.addOrReplaceChild("Pelvis", CubeListBuilder.create().texOffs(0, 0).addBox(-6.5F, -8.0F, 0.0F, 13.0F, 6.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 9.4F, -0.0873F, 0.0F, 0.0F));

		PartDefinition CaudalVertebrae = Pelvis.addOrReplaceChild("CaudalVertebrae", CubeListBuilder.create().texOffs(62, 31).addBox(0.0F, -1.0F, 0.0F, 0.0F, 9.0F, 20.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, 22.0F, 0.0524F, 0.0873F, 0.0F));
		...
		PartDefinition TailTip = CaudalVertebrae.addOrReplaceChild("TailTip", CubeListBuilder.create().texOffs(34, 70).addBox(0.0F, -2.0F, -4.0F, 0.0F, 6.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 20.0F, 0.3142F, 0.0873F, 0.0F));
		...
		PartDefinition ThighL = partdefinition.addOrReplaceChild("ThighL", CubeListBuilder.create().texOffs(98, 4).mirror().addBox(-2.0F, -1.5F, -3.0F, 5.0F, 15.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-6.5F, 9.6F, 9.0F, -0.7854F, 0.1745F, 0.0F));

		PartDefinition LegBackL = ThighL.addOrReplaceChild("LegBackL", CubeListBuilder.create().texOffs(130, 0).mirror().addBox(-2.0F, -1.0F, -1.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 14.9F, 4.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition FeetL = LegBackL.addOrReplaceChild("FeetL", CubeListBuilder.create().texOffs(130, 20).addBox(-2.5F, 0.0F, -4.01F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 10.0F, -0.5F, 1.5708F, 0.0F, 0.0F));

		PartDefinition ThighR = partdefinition.addOrReplaceChild("ThighR", CubeListBuilder.create().texOffs(98, 4).addBox(-3.0F, -1.5F, -3.0F, 5.0F, 15.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.5F, 9.5F, 9.0F, -0.7854F, -0.1745F, 0.0F));

		PartDefinition LegBackR = ThighR.addOrReplaceChild("LegBackR", CubeListBuilder.create().texOffs(130, 0).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 14.9F, 4.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition FeetR = LegBackR.addOrReplaceChild("FeetR", CubeListBuilder.create().texOffs(130, 20).mirror().addBox(-2.5F, 0.0F, -4.0F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 10.0F, -0.5F, 1.5708F, 0.0F, 0.0F));

		PartDefinition LegFrontR = partdefinition.addOrReplaceChild("LegFrontR", CubeListBuilder.create().texOffs(89, 70).addBox(0.0F, -1.0F, -2.0F, 3.0F, 20.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 5.0F, -17.0F));

		PartDefinition LegFrontL = partdefinition.addOrReplaceChild("LegFrontL", CubeListBuilder.create().texOffs(89, 70).mirror().addBox(-3.0F, -1.0F, -2.0F, 3.0F, 20.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, 5.0F, -17.0F));
