...
public class IschigualastiaSkeletonModel extends EntityModel<IschigualastiaSkeleton> {
	private final ModelPart Body;

	public IschigualastiaSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-10.0F, -13.0F, -24.0F, 20.0F, 18.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 9.0F, 8.0F));

		PartDefinition LegL = Body.addOrReplaceChild("LegL", CubeListBuilder.create().texOffs(65, 57).mirror().addBox(-4.0F, 0.0F, -4.0F, 8.0F, 22.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-7.0F, -10.0F, 5.0F));
		...
		PartDefinition ArmL = Body.addOrReplaceChild("ArmL", CubeListBuilder.create().texOffs(62, 99).mirror().addBox(-4.0F, 0.0F, -4.0F, 6.0F, 17.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-7.0F, -2.0F, -18.0F));

		PartDefinition ArmR = Body.addOrReplaceChild("ArmR", CubeListBuilder.create().texOffs(62, 99).addBox(-2.0F, 0.0F, -4.0F, 6.0F, 17.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, -2.0F, -18.0F));
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 64).addBox(-6.0F, -6.0F, -13.0F, 12.0F, 14.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -6.0F, -25.0F));
		...
		PartDefinition LegR = Body.addOrReplaceChild("LegR", CubeListBuilder.create().texOffs(65, 57).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 22.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, -10.0F, 5.0F));
