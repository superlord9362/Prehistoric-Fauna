...
public class GoyocephaleSkeletonStepModel extends EntityModel<GoyocephaleSkeleton> {
	...
	public GoyocephaleSkeletonStepModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(21, 0).addBox(-2.5F, -1.0F, 0.0F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 15.0F, 0.0F, -0.2793F, 0.0F, 0.0F));
		...
		.texOffs(43, -4).addBox(0.0F, -1.0F, -8.0F, 0.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -1.0F, 0.0F, 0.1063F, -0.1736F, -0.0184F));
		...
		.texOffs(0, 2).mirror().addBox(-7.75F, -1.0F, -1.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(3.75F, 4.0F, -5.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(2, 14).addBox(0.0F, -4.0F, -3.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, -7.0F, -0.3491F, 0.0F, -0.1745F));
		...
		.texOffs(1, 25).addBox(-2.5F, -2.0F, -1.0F, 5.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, -2.0F, 1.0472F, -0.1745F, 0.0F));
		...
		.texOffs(17, 22).addBox(-0.5F, 0.5F, 0.0F, 1.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -1.0F, 5.0F, 0.3142F, -0.3491F, -0.1745F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(29, 11).addBox(-0.5F, 0.0F, -2.0F, 2.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 16.0F, 3.0F, -0.9163F, -0.576F, 0.0F));
