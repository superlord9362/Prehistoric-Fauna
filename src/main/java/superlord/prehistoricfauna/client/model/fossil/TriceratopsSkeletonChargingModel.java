 ...
 */
@OnlyIn(Dist.CLIENT)
public class TriceratopsSkeletonChargingModel extends EntityModel<TriceratopsSkeletonEntity> {
    ...
    public TriceratopsSkeletonChargingModel() {
        ...
        this.setRotateAngle(Head1, 0.6181955890984584F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg2, -0.3127630032889644F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg1, 0.35185837453889574F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftFrontLeg, 0.3127630032889644F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg3, 0.19547687289441354F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.LeftHindLeg1, this.Body, this.Saddle, this.RightFrontLeg, this.RightHindLeg1, this.LeftFrontLeg).forEach((modelRenderer) -> { 
