...
public class ShunosaurusSkeletonRearModel extends EntityModel<ShunosaurusSkeleton> {
	...
	public ShunosaurusSkeletonRearModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = root.addOrReplaceChild("body", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.4363F, 0.0F, 0.0F));
		...
		PartDefinition neck1 = body.addOrReplaceChild("neck1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -12.1467F, -33.5219F, 0.0928F, -0.3477F, -0.0317F));
		...
		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.0F, -16.25F, 0.0002F, -0.043F, -0.0076F));
		...
		.texOffs(152, 163).addBox(-2.0F, 3.0F, -9.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.3533F, -15.7281F, 0.3062F, 0.0852F, 0.0189F));
		...
		.texOffs(150, 138).addBox(-1.5F, 0.0F, -9.99F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 1.0F, 0.48F, 0.0F, 0.0F));
		...
		.texOffs(9, 65).addBox(0.0F, -3.0F, 0.0F, 0.0F, 12.0F, 33.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.6467F, 4.7281F, -0.0876F, 0.0869F, -0.0076F));
		...
		.texOffs(92, 70).addBox(-2.5F, 0.0F, 1.0F, 5.0F, 0.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 33.0F, 0.2189F, 0.1304F, 0.0115F));

		PartDefinition club = tail2.addOrReplaceChild("club", CubeListBuilder.create().texOffs(3, 144).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 25.0F, 0.1772F, 0.1719F, 0.0306F));
		...
		.texOffs(0, 0).mirror().addBox(-8.0F, 23.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(11.0F, 5.8533F, -28.2719F, -0.2618F, 0.0698F, 0.0F));
		...
		.texOffs(0, 0).addBox(6.0F, 23.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.0F, 5.8533F, -28.2719F, -0.6545F, -0.0698F, 0.0F));
