...
public class YangchuanosaurusSkeletonRetroModel extends EntityModel<YangchuanosaurusSkeleton> {
	private final ModelPart bone17;

	public YangchuanosaurusSkeletonRetroModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone17 = partdefinition.addOrReplaceChild("bone17", CubeListBuilder.create(), PartPose.offset(0.0F, 24.325F, 0.0F));
		...
		.texOffs(76, 105).addBox(-6.5F, -2.5F, -7.5F, 13.0F, 0.0F, 23.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -37.5F, -3.5F, -0.8727F, 0.0F, 0.0F));
		...
		.texOffs(20, -17).addBox(0.0F, -5.0F, -26.0F, 0.0F, 8.0F, 26.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.5F, -8.5F, 0.1745F, -0.0873F, 0.0F));

		PartDefinition left_arm = torso.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(14, 68).addBox(-3.0F, 0.0F, -3.0F, 4.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 10.0F, -18.0F, 1.0742F, 0.7513F, 0.6842F));

		PartDefinition right_arm = torso.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(14, 68).mirror().addBox(-1.0F, 0.0F, -3.0F, 4.0F, 17.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-8.0F, 10.0F, -18.0F, 0.8793F, -0.6999F, -0.4988F));
		...
		.texOffs(154, 13).addBox(0.0F, -9.0F, -7.0F, 0.0F, 13.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, -26.0F, 0.7156F, 0.0873F, 0.0873F));

		PartDefinition skull = neck.addOrReplaceChild("skull", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -8.0F, -6.0F, 0.1833F, 0.0F, 0.0F));
		...
		.texOffs(134, 38).addBox(-2.0F, -1.0F, -18.99F, 4.0F, 6.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, 0.0785F, 0.0F, 0.0F));
		...
		.texOffs(1, 58).addBox(0.0F, -3.0F, -1.0F, 0.0F, 16.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.6107F, 13.4484F, 0.4363F, 0.0873F, 0.0F));
		...
		.texOffs(1, 1).addBox(0.0F, -3.0F, 0.0F, 0.0F, 9.0F, 48.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 33.0F, 0.3316F, -0.0873F, 0.0F));
		...
		PartDefinition bone9 = right_leg.addOrReplaceChild("bone9", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-3.0F, 0.0F, -1.5F, 6.0F, 21.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.5F, 17.0F, 6.5F, 0.7854F, 0.0F, 0.0F));

		PartDefinition bone10 = bone9.addOrReplaceChild("bone10", CubeListBuilder.create().texOffs(110, 35).mirror().addBox(-3.5F, 0.0F, -10.5F, 7.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 18.5407F, 3.2816F, -0.4363F, 0.0F, 0.0F));
		...
		PartDefinition bone6 = left_leg.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(0, 0).addBox(-3.0F, 0.0F, -1.5F, 6.0F, 21.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, 17.0F, 6.5F, 0.7854F, 0.0F, 0.0F));
