 ...
 */
@OnlyIn(Dist.CLIENT)
public class CoelophysisSkeletonStrollModel extends EntityModel<CoelophysisSkeletonEntity> {
    ...
    public CoelophysisSkeletonStrollModel() {
        ...
        this.setRotateAngle(LFoot, 0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.LArm.setRotationPoint(-2.0F, 3.0F, -10.5F);
        this.LArm.addBox(-0.5F, -0.5F, 0.0F, 1.0F, 6.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LArm, 0.5235987755982988F, -0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Tail1, 0.24434609527920614F, 0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Neck, -0.41887902047863906F, 0.24434609527920614F, 0.0F);
        ...
        this.setRotateAngle(RFemur, 0.3490658503988659F, 0.0F, -0.06981317007977318F);
        ...
        this.RArm.setRotationPoint(2.0F, 3.0F, -10.5F);
        this.RArm.addBox(-0.5F, -0.5F, 0.0F, 1.0F, 6.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RArm, 0.5235987755982988F, 0.17453292519943295F, -0.0F);
        ...
        this.Skull.setRotationPoint(0.0F, -6.0F, -3.0F);
        this.Skull.addBox(-1.0F, 0.0F, -7.0F, 2.0F, 2.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Skull, 0.8726646259971648F, 0.0F, 0.0F);
        this.LFemur = new ModelRenderer(this, 101, 1);
        this.LFemur.mirror = true;
        this.LFemur.setRotationPoint(-1.5F, 12.6F, 3.5F);
        this.LFemur.addBox(-1.0F, -0.5F, -1.5F, 2.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LFemur, -0.3490658503988659F, 0.17453292519943295F, 0.0F);
