 ...
 */
@OnlyIn(Dist.CLIENT)
public class StegosaurusSkeletonActionLeftModel extends EntityModel<StegosaurusSkeletonEntity> {
    ...
    public StegosaurusSkeletonActionLeftModel() {
        ...
        this.setRotateAngle(RightThigh, -0.46914448828868976F, 0.4300491170387584F, 0.0F);
        ...
        this.setRotateAngle(LeftThigh, -0.2738421523142173F, 0.0F, 0.0F);
        ...
        this.RightLeg.setRotationPoint(2.5F, 16.0F, 6.0F);
        this.RightLeg.addBox(-3.0F, -1.0F, -4.0F, 6.0F, 15.0F, 8.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightLeg, 0.3909537457888271F, 0.0F, -0.0781907508222411F);
        ...
        this.setRotateAngle(LeftFoot, -0.19547687289441354F, 0.0F, 0.0F);
