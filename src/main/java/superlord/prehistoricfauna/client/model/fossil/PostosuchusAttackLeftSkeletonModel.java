 ...
 */
@OnlyIn(Dist.CLIENT)
public class PostosuchusAttackLeftSkeletonModel extends EntityModel<PostosuchusSkeletonEntity> {
    ...
    public PostosuchusAttackLeftSkeletonModel() {
        this.textureWidth = 200;
        this.textureHeight = 200;
        this.Thigh = new ModelRenderer(this, 79, 1);
        this.Thigh.mirror = true;
        this.Thigh.setRotationPoint(3.5F, 7.0F, 5.0F);
        this.Thigh.addBox(-2.0F, -1.0F, -2.0F, 5.0F, 11.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Thigh, -0.8726646259971648F, -0.4886921905584123F, 0.0F);
        ...
        this.setRotateAngle(Arm, 0.3490658503988659F, -0.3490658503988659F, 0.0F);
        ...
        this.setRotateAngle(Head, 0.17453292519943295F, -0.3490658503988659F, 0.0F);
        ...
        this.setRotateAngle(Jaw, 0.3839724354387525F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail2, -0.06981317007977318F, 0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.08726646259971647F, -0.3490658503988659F, -0.0F);
        this.Foot = new ModelRenderer(this, 79, 39);
        this.Foot.mirror = true;
        this.Foot.setRotationPoint(0.0F, 6.5F, 2.0F);
        ...
        this.setRotateAngle(Calf, 0.5235987755982988F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Arm_1, 0.3490658503988659F, 0.3490658503988659F, 0.0F);
