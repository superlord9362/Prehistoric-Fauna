 ...
 */
@OnlyIn(Dist.CLIENT)
public class DilophosaurusStrutSkeletonModel extends EntityModel<DilophosaurusSkeletonEntity> {
    ...
    public DilophosaurusStrutSkeletonModel() {
        ...
        this.setRotateAngle(FemurRight, -0.8726646259971648F, 0.3490658503988659F, 0.0F);
        ...
        this.setRotateAngle(Tail2, 0.2792526803190927F, -0.19198621771937624F, -0.41887902047863906F);
        ...
        this.setRotateAngle(ArmRight, 0.5235987755982988F, -0.6981317007977318F, 0.0F);
        ...
        this.setRotateAngle(FootRight, 0.8726646259971648F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(FemurLeft, -0.10471975511965977F, -0.22689280275926282F, 0.0F);
        ...
        this.setRotateAngle(CervicalRibs, 0.3490658503988659F, -0.5235987755982988F, 0.13962634015954636F);
        ...
        this.setRotateAngle(Skull, -0.19198621771937624F, -0.3839724354387525F, 0.0F);
        ...
        this.setRotateAngle(CaudalRibs, 0.2792526803190927F, -0.3490658503988659F, 0.22689280275926282F);
        this.Leg2Left = new ModelRenderer(this, 72, 75);
        this.Leg2Left.setRotationPoint(-0.5F, 13.0F, 2.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.FemurRight, this.FemurLeft, this.Ribcage).forEach((modelRenderer) -> { 
