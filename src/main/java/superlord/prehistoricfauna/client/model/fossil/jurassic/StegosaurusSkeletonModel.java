...
public class StegosaurusSkeletonModel extends EntityModel<StegosaurusSkeleton> {
	...
	public StegosaurusSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(107, 113).addBox(-12.0F, 5.9F, -0.5F, 24.0F, 20.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -18.0F, -21.0F));

		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(87, 77).addBox(-3.5F, 0.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, 0.1047F, 0.0F, 0.0F));
		...
		.texOffs(91, 14).addBox(-2.0F, -1.5F, -15.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, -19.0F, 0.1047F, 0.0F, 0.0F));
		...
		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(0, 130).mirror().addBox(-3.5F, 0.0F, -6.0F, 7.0F, 3.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-0.5F, 12.0F, 0.1F));
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 5.0F, 45.0F, -0.2094F, 0.0F, 0.0F));
		...
		PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 34.0F, -0.2443F, 0.0F, 0.0F));
