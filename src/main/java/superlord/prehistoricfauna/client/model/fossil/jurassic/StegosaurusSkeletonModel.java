...
public class StegosaurusSkeletonModel extends EntityModel<StegosaurusSkeleton> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(87, 77).addBox(-3.5F, 0.0F, -19.0F, 7.0F, 10.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));
		...
		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(93, 0).addBox(-3.5F, -1.5F, -9.0F, 7.0F, 7.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.5F, -19.0F));
		...
		PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(28, 73).addBox(-5.0F, 0.0F, 0.0F, 10.0F, 0.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 5.0F, 45.0F));
		...
		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(95, 7).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 30.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 34.0F));
