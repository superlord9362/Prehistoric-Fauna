...
public class DesmatosuchusSkeletonSleepingModel extends EntityModel<DesmatosuchusSkeleton> {
	...
	public DesmatosuchusSkeletonSleepingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Arm_L = partdefinition.addOrReplaceChild("Arm_L", CubeListBuilder.create().texOffs(44, 32).mirror().addBox(-1.5F, 0.0F, -1.5F, 3.0F, 13.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.5F, 21.5F, -3.5F, -1.4137F, 0.4887F, 0.0F));

		PartDefinition Arm_R = partdefinition.addOrReplaceChild("Arm_R", CubeListBuilder.create().texOffs(44, 32).addBox(-1.5F, 0.0F, -1.5F, 3.0F, 13.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 21.5F, -5.0F, -1.4137F, 0.1745F, 0.0F));

		PartDefinition Leg_L_1_1 = partdefinition.addOrReplaceChild("Leg_L_1_1", CubeListBuilder.create().texOffs(2, 48).addBox(0.0F, 0.0F, -2.0F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 19.5F, 10.0F, -2.0595F, -0.3491F, 0.1745F));
		...
		PartDefinition TailCarapace = ASS.addOrReplaceChild("TailCarapace", CubeListBuilder.create().texOffs(84, 77).addBox(-3.5F, -1.0F, 0.0F, 7.0F, 2.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, 12.0F, -0.2094F, -0.192F, 0.0F));

		PartDefinition Tail_tip = TailCarapace.addOrReplaceChild("Tail_tip", CubeListBuilder.create().texOffs(87, 105).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 4.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 15.0F, 0.0F, -0.384F, 0.0F));
		...
		PartDefinition Belly = ASS.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(0, 24).addBox(-4.0F, -2.5F, -10.0F, 8.0F, 7.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, 0.0F, 0.0873F, 0.2618F, 0.0F));
		...
		PartDefinition Neck = Belly.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(47, 1).addBox(0.0F, -0.5F, -6.0F, 0.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.5F, -9.5F, 0.2443F, 0.2618F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(65, 11).addBox(-2.0F, -1.0F, -3.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -6.0F));
		...
		PartDefinition Leg_L_1 = partdefinition.addOrReplaceChild("Leg_L_1", CubeListBuilder.create().texOffs(2, 48).mirror().addBox(-5.0F, 0.0F, -2.0F, 5.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, 19.5F, 10.0F, -2.0595F, 0.3491F, -0.1745F));
