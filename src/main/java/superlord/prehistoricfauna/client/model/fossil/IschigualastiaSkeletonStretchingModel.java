 ...
 */
@OnlyIn(Dist.CLIENT)
public class IschigualastiaSkeletonStretchingModel extends EntityModel<IschigualastiaSkeletonEntity> {
    ...
    public IschigualastiaSkeletonStretchingModel() {
        ...
        this.setRotateAngle(LegL, -0.19547687289441354F, 0.0F, 0.0F);
        ...
        this.ArmR.setRotationPoint(-7.0F, -3.0F, -18.0F);
        this.ArmR.addBox(-4.0F, 0.0F, -4.0F, 6.0F, 17.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ArmR, -0.4300491170387584F, 0.0F, 0.4300491170387584F);
        this.ArmL = new ModelRenderer(this, 62, 99);
        this.ArmL.setRotationPoint(7.0F, -3.0F, -18.0F);
        this.ArmL.addBox(-2.0F, 0.0F, -4.0F, 6.0F, 17.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ArmL, -0.4300491170387584F, 0.0F, -0.4300491170387584F);
        ...
        this.setRotateAngle(LegR, -0.23457224414434488F, 0.0F, 0.0F);
