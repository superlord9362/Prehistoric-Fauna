 ...
 */
@OnlyIn(Dist.CLIENT)
public class SarahsaurusSkeletonModel extends EntityModel<SarahsaurusSkeletonEntity> {
    ...
    public SarahsaurusSkeletonModel() {
        ...
        this.setRotateAngle(Tail2Vertabrae, 0.06981317007977318F, 0.0F, 0.0F);
        this.LLeg2 = new ModelRenderer(this, 19, 27);
        ...
        this.setRotateAngle(Neck1CervicalRibs, 0.06981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail1Vertabrae, -0.10471975511965977F, 0.0F, 0.0F);
        ...
        this.Ribs.setRotationPoint(0.0F, 6.0F, 2.0F);
        this.Ribs.addBox(-3.5F, 1.0F, -12.0F, 7.0F, 7.0F, 18.0F, 0.0F, 0.0F, 0.0F);
        this.RLeg2 = new ModelRenderer(this, 19, 27);
