 ...
 */
@OnlyIn(Dist.CLIENT)
public class CoelophysisSkeletonStrideModel extends EntityModel<CoelophysisSkeletonEntity> {
    ...
    public CoelophysisSkeletonStrideModel() {
        ...
        this.setRotateAngle(Tail2, 0.3490658503988659F, -0.3839724354387525F, 0.0F);
        this.Neck = new ModelRenderer(this, 34, 0);
        this.Neck.setRotationPoint(0.0F, -1.5F, -12.5F);
        this.Neck.addBox(-1.0F, -5.5F, -2.5F, 2.0F, 9.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Neck, 0.4886921905584123F, -0.4886921905584123F, 0.0F);
        ...
        this.setRotateAngle(Skull, -0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.LFemur.setRotationPoint(-1.5F, 13.2F, 3.5F);
        this.LFemur.addBox(-1.0F, -0.5F, -1.5F, 2.0F, 6.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LFemur, 0.2617993877991494F, 0.24434609527920614F, 0.0F);
        ...
        this.setRotateAngle(RFemur, -0.5235987755982988F, -0.45378560551852565F, 0.0F);
        ...
        this.setRotateAngle(LArm, 0.6108652381980153F, 0.0F, 0.2617993877991494F);
