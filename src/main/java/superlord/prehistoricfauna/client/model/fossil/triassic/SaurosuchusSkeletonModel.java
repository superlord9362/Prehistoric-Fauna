...
public class SaurosuchusSkeletonModel extends EntityModel<SaurosuchusSkeleton> {
	private final ModelPart Body;

	public SaurosuchusSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(11, 11).addBox(-6.0F, -7.0F, -21.0F, 12.0F, 12.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.0F, 6.0F));
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(101, 23).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.0F, 14.0F));
		...
		PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, 0.0F, 1.0F, 4.0F, 0.0F, 40.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 20.0F));
		...
		PartDefinition Arm = Body.addOrReplaceChild("Arm", CubeListBuilder.create().texOffs(-1, 0).mirror().addBox(-1.0F, 0.0F, -2.0F, 4.0F, 15.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-6.0F, 1.0F, -17.0F));

		PartDefinition Thigh = Body.addOrReplaceChild("Thigh", CubeListBuilder.create().texOffs(62, 3).mirror().addBox(-3.0F, -2.0F, -2.0F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-4.0F, -1.0F, 6.0F));
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(97, -1).addBox(-3.0F, -1.0F, -8.0F, 6.0F, 10.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.0F, -21.0F));
		...
		PartDefinition Arm_1 = Body.addOrReplaceChild("Arm_1", CubeListBuilder.create().texOffs(-1, 0).addBox(-3.0F, 0.0F, -2.0F, 4.0F, 15.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.0F, 1.0F, -17.0F, 0.0F, -0.0394F, 0.0F));

		PartDefinition Thigh_1 = Body.addOrReplaceChild("Thigh_1", CubeListBuilder.create().texOffs(62, 3).addBox(-2.0F, -2.0F, -2.0F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -1.0F, 6.0F));
