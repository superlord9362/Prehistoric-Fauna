...
public class PsittacosaurusSkeletonSaunterModel extends EntityModel<PsittacosaurusSkeleton> {
	private final ModelPart Body;
	private final ModelPart rightthigh;
	private final ModelPart leftthigh;

	public PsittacosaurusSkeletonSaunterModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Body.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(-1.5F, -4.0F, -3.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, -8.0F, 0.7679F, -0.1745F, 0.0F));
		...
		PartDefinition leftarm = Body.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(30, 40).mirror().addBox(-1.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, 4.5F, -6.0F, 0.3491F, 0.0F, -0.1745F));

		PartDefinition rightarm = Body.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(39, 40).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 4.5F, -6.0F, 0.3491F, 0.0F, 0.3491F));
		...
		PartDefinition rightthigh = partdefinition.addOrReplaceChild("rightthigh", CubeListBuilder.create().texOffs(15, 37).addBox(-1.0F, -1.0F, -2.0F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 14.5F, 3.0F, -0.4189F, -0.3491F, -0.1745F));

		PartDefinition rightleg = rightthigh.addOrReplaceChild("rightleg", CubeListBuilder.create().texOffs(10, 53).mirror().addBox(-0.5F, 0.0F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.5F, 6.0F, 2.0F, -0.5236F, 0.0F, 0.0F));

		PartDefinition rightleg_1 = rightleg.addOrReplaceChild("rightleg_1", CubeListBuilder.create().texOffs(7, 58).mirror().addBox(-1.5F, 0.0F, -3.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.5F, 4.0F, 0.0F, 1.0472F, 0.0F, 0.0F));

		PartDefinition leftthigh = partdefinition.addOrReplaceChild("leftthigh", CubeListBuilder.create().texOffs(0, 37).mirror().addBox(-2.0F, -1.0F, -2.0F, 3.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, 15.2F, 3.5F, 0.3491F, 0.1745F, 0.0F));
		...
		PartDefinition leftleg_1 = leftleg.addOrReplaceChild("leftleg_1", CubeListBuilder.create().texOffs(0, 58).mirror().addBox(-1.5F, 0.0F, -3.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-0.5F, 4.0F, 0.0F, -0.3491F, 0.0F, 0.0F));
