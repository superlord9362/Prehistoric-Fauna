...
public class ShunosaurusSkeletonWalkModel extends EntityModel<ShunosaurusSkeleton> {
	...
	public ShunosaurusSkeletonWalkModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition neck1 = body.addOrReplaceChild("neck1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -12.1467F, -33.5219F, 0.0F, 0.1309F, 0.0F));
		...
		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.0F, -16.25F, 0.0F, 0.3054F, 0.0F));
		...
		.texOffs(152, 163).addBox(-2.0F, 3.0F, -9.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.3533F, -15.7281F, 0.1766F, 0.2173F, 0.0193F));
		...
		.texOffs(9, 65).addBox(0.0F, -3.0F, 0.0F, 0.0F, 12.0F, 33.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.6467F, 4.7281F, -0.2657F, 0.1685F, -0.0456F));
		...
		.texOffs(92, 70).addBox(-2.5F, 0.0F, 1.0F, 5.0F, 0.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 33.0F, 0.0915F, 0.3042F, 0.0275F));

		PartDefinition club = tail2.addOrReplaceChild("club", CubeListBuilder.create().texOffs(3, 144).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 25.0F, 0.0F, 0.2618F, 0.0F));
		...
		.texOffs(0, 0).mirror().addBox(-8.0F, 23.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(11.0F, 5.8533F, -28.2719F, -0.1309F, 0.0698F, 0.0F));
		...
		.texOffs(0, 0).addBox(6.0F, 23.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.0F, 5.8533F, -28.2719F, 0.2182F, -0.0698F, 0.0F));

		PartDefinition legL = partdefinition.addOrReplaceChild("legL", CubeListBuilder.create().texOffs(152, 96).addBox(-4.0F, -2.1467F, -5.2719F, 8.0F, 20.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -8.8533F, 15.2719F, 0.2182F, -0.2094F, 0.0F));

		PartDefinition lowerlegL = legL.addOrReplaceChild("lowerlegL", CubeListBuilder.create().texOffs(30, 142).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.8533F, -3.2719F, 0.2182F, 0.0F, 0.0F));

		PartDefinition footL = lowerlegL.addOrReplaceChild("footL", CubeListBuilder.create().texOffs(79, 108).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.2182F, 0.0F, 0.0F));

		PartDefinition legR = partdefinition.addOrReplaceChild("legR", CubeListBuilder.create().texOffs(152, 96).mirror().addBox(-4.0F, -2.1467F, -5.2719F, 8.0F, 20.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-9.0F, -8.8533F, 15.2719F, -0.1309F, 0.2094F, 0.0F));
		...
		PartDefinition footR = lowerlegR.addOrReplaceChild("footR", CubeListBuilder.create().texOffs(79, 108).mirror().addBox(-4.0F, 0.0F, -3.0F, 8.0F, 4.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 11.0F, 0.0F, 0.1309F, 0.0F, 0.0F));
