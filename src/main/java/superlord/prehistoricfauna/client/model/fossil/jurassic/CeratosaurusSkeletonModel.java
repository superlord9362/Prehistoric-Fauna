...
public class CeratosaurusSkeletonModel extends EntityModel<CeratosaurusSkeleton> {
	private final ModelPart Body1;

	public CeratosaurusSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body1 = partdefinition.addOrReplaceChild("Body1", CubeListBuilder.create().texOffs(155, 56).addBox(-6.0F, -5.0F, -30.0F, 12.0F, 12.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 8.0F));

		PartDefinition Neck = Body1.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(4, 55).addBox(-3.0F, -13.0F, -4.0F, 6.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 4.0F, -30.0F));
		...
		PartDefinition LeftLeg1 = Body1.addOrReplaceChild("LeftLeg1", CubeListBuilder.create().texOffs(76, 153).mirror().addBox(-6.0F, -4.0F, -6.0F, 6.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-2.0F, -1.0F, -5.0F));
		...
		PartDefinition RightLeg1 = Body1.addOrReplaceChild("RightLeg1", CubeListBuilder.create().texOffs(128, 153).mirror().addBox(0.0F, -4.0F, -6.0F, 6.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(2.0F, -1.0F, -5.0F));
		...
		PartDefinition TailVetebrae = Body1.addOrReplaceChild("TailVetebrae", CubeListBuilder.create().texOffs(169, 124).addBox(0.0F, -4.0F, 0.0F, 0.0F, 13.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 4.0F));
		...
		PartDefinition TailVertebrae2 = TailVetebrae.addOrReplaceChild("TailVertebrae2", CubeListBuilder.create().texOffs(177, 126).addBox(0.0F, -2.0F, 0.0F, 0.0F, 7.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 22.0F));
