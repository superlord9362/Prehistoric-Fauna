 ...
 */
@OnlyIn(Dist.CLIENT)
public class AnkylosaurusSkeletonActionRightModel extends EntityModel<AnkylosaurusSkeletonEntity> {
    ...
    public AnkylosaurusSkeletonActionRightModel() {
        ...
        this.setRotateAngle(Head1, 0.0F, -0.27366763203903305F, 0.0F);
        ...
        this.setRotateAngle(LeftFrontLeg, 0.0F, -0.27366763203903305F, -0.0781907508222411F);
        ...
        this.setRotateAngle(Tail2, 0.0F, 0.23457224414434488F, 0.0F);
        ...
        this.setRotateAngle(RightFrontLeg, 0.0F, 0.27366763203903305F, 0.0781907508222411F);
        ...
        this.setRotateAngle(Tail1, -0.03909537541112055F, 0.1563815016444822F, 0.0F);
