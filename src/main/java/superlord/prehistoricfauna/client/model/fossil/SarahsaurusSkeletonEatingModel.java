 ...
 */
@OnlyIn(Dist.CLIENT)
public class SarahsaurusSkeletonEatingModel extends EntityModel<SarahsaurusSkeletonEntity> {
    ...
    public SarahsaurusSkeletonEatingModel() {
        ...
        this.setRotateAngle(LLeg1, 0.46914448828868976F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail1Vertabrae, 0.0781907508222411F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RArm, 0.46914448828868976F, 0.0F, 0.6646214111173737F);
        this.Ribs = new ModelRenderer(this, 4, 0);
        this.Ribs.setRotationPoint(0.0F, 5.7F, 2.0F);
        this.Ribs.addBox(-3.5F, 1.0F, -12.0F, 7.0F, 7.0F, 18.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Ribs, -0.46914448828868976F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck1CervicalRibs, 0.22619467172425536F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Skull, -0.6644468409079191F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RLeg1, 0.46914448828868976F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LArm, 0.46914448828868976F, 0.0F, -0.6646214111173737F);
        ...
        this.setRotateAngle(Tail2Vertabrae, 0.23457224414434488F, 0.0F, 0.0F);
