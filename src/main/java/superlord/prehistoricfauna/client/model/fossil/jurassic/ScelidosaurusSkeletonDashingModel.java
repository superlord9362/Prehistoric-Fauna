...
public class ScelidosaurusSkeletonDashingModel extends EntityModel<ScelidosaurusSkeleton> {
	private final ModelPart LegLeft;
	private final ModelPart Body;
	private final ModelPart LegRight;

	public ScelidosaurusSkeletonDashingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LegLeft = partdefinition.addOrReplaceChild("LegLeft", CubeListBuilder.create().texOffs(44, 33).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, 10.5F, 8.0F, 0.0F, -0.3142F, 0.0F));

		PartDefinition Leg2Left = LegLeft.addOrReplaceChild("Leg2Left", CubeListBuilder.create().texOffs(44, 47).mirror().addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.4F, 7.5F, 2.0F));

		PartDefinition FootLeft = Leg2Left.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(42, 57).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 5.9F, -1.5F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -3.0F, -19.0F, 9.0F, 10.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 12.0F, 8.0F, -0.2618F, 0.0F, 0.0F));

		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(44, 5).addBox(-2.5F, 0.0F, 0.0F, 5.0F, 0.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 3.0F, 0.0F, 0.1745F, 0.0F));
		...
		PartDefinition Tail2 = Tail_1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(65, 5).addBox(-1.5F, 0.0F, 1.0F, 3.0F, 0.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 9.0F, 0.1745F, 0.1745F, 0.0F));
		...
		PartDefinition ArmRight = Body.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(28, 34).mirror().addBox(-1.0F, 0.0F, -1.0F, 3.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 2.0F, -16.0F, 0.6109F, -0.1745F, -0.3491F));
		...
		PartDefinition ArmLeft = Body.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(28, 34).addBox(-2.0F, 0.0F, -1.0F, 3.0F, 10.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 2.0F, -16.0F, 0.6109F, 0.1745F, 0.3491F));
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 32).addBox(-1.5F, -2.0F, -6.0F, 3.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -19.0F, 0.0F, 0.2618F, 0.0F));
		...
		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 44).addBox(-2.0F, -2.0F, -4.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.6F, -6.0F, 0.2443F, 0.1745F, 0.0F));
		...
		PartDefinition LegRight = partdefinition.addOrReplaceChild("LegRight", CubeListBuilder.create().texOffs(44, 33).mirror().addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, 10.5F, 8.0F, -0.733F, 0.2967F, 0.0F));

		PartDefinition Leg2Right = LegRight.addOrReplaceChild("Leg2Right", CubeListBuilder.create().texOffs(44, 47).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4F, 7.5F, 3.5F, -0.5236F, 0.0F, 0.0F));

		PartDefinition FootRight = Leg2Right.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(42, 57).addBox(-2.0F, 0.0F, -4.0F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 6.0F, -1.0F, 1.5708F, 0.0F, 0.0F));
