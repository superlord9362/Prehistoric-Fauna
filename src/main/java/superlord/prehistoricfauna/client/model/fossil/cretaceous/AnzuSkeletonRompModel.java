...
public class AnzuSkeletonRompModel extends EntityModel<AnzuSkeleton> {
	...
	public AnzuSkeletonRompModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(46, 23).addBox(0.0F, -5.0F, -7.0F, 0.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.5F, -3.0F, -0.5236F, 0.0F, -0.0436F));
		...
		.texOffs(46, 20).addBox(0.0F, -1.0F, -14.0F, 0.0F, 4.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -7.0F, 0.0F, 0.1745F, 0.0F));
		...
		PartDefinition LeftArm = Body2.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(91, 72).mirror().addBox(-0.5F, -1.0F, 0.0F, 3.0F, 16.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.0F, 9.0F, -11.0F, 0.0F, -0.6981F, 0.6981F));

		PartDefinition RightArm = Body2.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(91, 72).addBox(-2.5F, -1.0F, 0.0F, 3.0F, 16.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 9.0F, -11.0F, 0.0F, 0.8727F, -0.8727F));
		...
		.texOffs(27, 64).addBox(-1.5F, 0.0F, -7.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1495F, -13.509F, 0.5236F, 0.1745F, 0.0F));
		...
		PartDefinition Head = Neck1.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 101).addBox(-1.5F, -1.0F, -6.0F, 3.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.0F, -7.0F, 0.3491F, 0.0F, 0.0873F));
		...
		.texOffs(56, 0).addBox(0.0F, -2.0F, 0.0F, 0.0F, 8.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 8.0F, 0.4189F, -0.1745F, 0.0F));
		...
		.texOffs(121, 7).addBox(-0.5F, 3.0F, 14.0F, 1.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 2.0F, 15.0F, 0.1396F, -0.3491F, 0.0F));

		PartDefinition RightThigh = partdefinition.addOrReplaceChild("RightThigh", CubeListBuilder.create().texOffs(118, 66).addBox(-5.0F, -2.0F, -5.0F, 6.0F, 15.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -0.5F, -2.0F, -1.0472F, -0.3491F, 0.0F));

		PartDefinition RightLeg = RightThigh.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(127, 94).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 12.0F, 5.025F));

		PartDefinition RightFoot = RightLeg.addOrReplaceChild("RightFoot", CubeListBuilder.create().texOffs(122, 112).addBox(-2.0F, 0.0F, -5.0F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.0F, 0.0F, 1.0472F, 0.0F, 0.0F));

		PartDefinition LeftThigh = partdefinition.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(118, 66).mirror().addBox(-1.0F, -2.0F, -5.0F, 6.0F, 15.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-5.0F, -2.5F, -1.0F, 0.3491F, 0.1745F, 0.0F));
		...
		PartDefinition LeftFoot = LeftLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create().texOffs(122, 112).mirror().addBox(-2.0F, 0.0F, -5.0F, 4.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 17.0F, 0.0F, -0.3491F, 0.0F, 0.0F));
