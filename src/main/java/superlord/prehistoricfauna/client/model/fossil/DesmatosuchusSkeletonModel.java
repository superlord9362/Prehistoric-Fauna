 ...
 */
@OnlyIn(Dist.CLIENT)
public class DesmatosuchusSkeletonModel extends EntityModel<DesmatosuchusSkeletonEntity> {
    ...
    public DesmatosuchusSkeletonModel() {
        ...
        this.setRotateAngle(TailCarapace, -0.149923785409474F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tail_tip, 0.149923785409474F, 0.0F, 0.0F);
        ...
        this.Feet_L_1.setRotationPoint(-0.4F, 5.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Leg_L_1, this.Leg_L_1_1, this.ASS, this.Arm_R, this.Arm_L).forEach((modelRenderer) -> { 
