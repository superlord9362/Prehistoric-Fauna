 ...
 */
@OnlyIn(Dist.CLIENT)
public class PlesiohadrosSkeletonDashLeftModel extends EntityModel<PlesiohadrosSkeletonEntity> {
    ...
    public PlesiohadrosSkeletonDashLeftModel() {
        ...
        this.setRotateAngle(CaudalVertebrae, 0.2617993877991494F, -0.3839724354387525F, 0.0F);
        this.FeetL = new ModelRenderer(this, 130, 20);
        this.FeetL.setRotationPoint(0.0F, 11.0F, 0.0F);
        this.FeetL.addBox(-2.5F, 0.0F, -4.01F, 5.0F, 2.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(FeetL, 1.0471975511965976F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Head, 0.7148868456379108F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.0F, -0.40142572795869574F, -0.2617993877991494F);
        this.LegFrontR = new ModelRenderer(this, 89, 70);
        this.LegFrontR.mirror = true;
        this.LegFrontR.setRotationPoint(-4.0F, -1.0F, -18.0F);
        this.LegFrontR.addBox(-3.0F, -1.0F, -2.0F, 3.0F, 20.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegFrontR, 0.5235987755982988F, 0.08726646259971647F, 0.0F);
        ...
        this.Pelvis.setRotationPoint(0.0F, 2.0F, 8.7F);
        this.Pelvis.addBox(-6.5F, -8.0F, 0.0F, 13.0F, 6.0F, 22.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Pelvis, -0.17453292519943295F, -0.3127630032889644F, 0.0F);
        ...
        this.LegFrontL.setRotationPoint(4.0F, -0.5F, -18.0F);
        this.LegFrontL.addBox(0.0F, -1.0F, -2.0F, 3.0F, 20.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegFrontL, 0.6702064593974334F, -0.20943951023931953F, -0.0F);
        ...
        this.setRotateAngle(LegBackL, -0.4363323129985824F, 0.0F, 0.0F);
        ...
        this.ThighL.setRotationPoint(2.0F, -1.5F, 10.0F);
        this.ThighL.addBox(-3.0F, -1.5F, -3.0F, 5.0F, 15.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ThighL, -0.6108652381980153F, -0.4363323129985824F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.ThighR, this.Ribs, this.LegFrontR, this.LegFrontL, this.ThighL).forEach((modelRenderer) -> { 
