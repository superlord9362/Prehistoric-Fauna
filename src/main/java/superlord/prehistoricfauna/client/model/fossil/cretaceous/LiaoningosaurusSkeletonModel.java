...
public class LiaoningosaurusSkeletonModel extends EntityModel<LiaoningosaurusSkeleton> {
	...
	public LiaoningosaurusSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(1, 1).addBox(-3.0F, -1.0F, -1.0F, 4.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, 13.0F, 4.0F));
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(1, 1).mirror().addBox(-1.0F, -1.0F, -1.0F, 4.0F, 8.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-7.0F, 13.0F, 4.0F));
		...
		.texOffs(22, 32).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.1F, -15.0F));
		...
		.texOffs(34, 46).addBox(-1.0F, -1.0F, -9.0F, 2.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.1F, -4.0F));

		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 30).mirror().addBox(-1.0F, -1.0F, -1.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-7.0F, 3.0F, -12.0F));

		PartDefinition LetArm = Body.addOrReplaceChild("LetArm", CubeListBuilder.create().texOffs(0, 30).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(7.0F, 3.0F, -12.0F));
		...
		.texOffs(-1, 86).addBox(-4.5F, 1.5F, 0.0F, 9.0F, 0.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -1.0F, 6.0F));
		...
		.texOffs(3, 30).addBox(0.0F, -1.0F, 0.0F, 0.0F, 3.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 1.0F, 11.0F));
