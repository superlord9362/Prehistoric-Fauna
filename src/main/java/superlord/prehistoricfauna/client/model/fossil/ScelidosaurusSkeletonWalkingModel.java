 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScelidosaurusSkeletonWalkingModel extends EntityModel<ScelidosaurusSkeletonEntity> {
    ...
    public ScelidosaurusSkeletonWalkingModel() {
        ...
        this.setRotateAngle(Tail, -0.13962634015954636F, -0.20943951023931953F, 0.0F);
        ...
        this.LegRight.setRotationPoint(4.0F, 11.5F, 8.5F);
        this.LegRight.addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegRight, -0.5235987755982988F, -0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(ArmLeft, 0.0F, -0.17453292519943295F, 0.0F);
        ...
        this.Leg2Right.setRotationPoint(0.4F, 7.5F, 3.0F);
        ...
        this.setRotateAngle(ArmRight, 0.5585053606381855F, 0.0F, 0.17453292519943295F);
        ...
        this.setRotateAngle(Head, 0.3141592653589793F, -0.17453292519943295F, 0.06981317007977318F);
        ...
        this.setRotateAngle(Tail2, -0.13962634015954636F, -0.20943951023931953F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.LegLeft, this.LegRight, this.Body).forEach((modelRenderer) -> { 
