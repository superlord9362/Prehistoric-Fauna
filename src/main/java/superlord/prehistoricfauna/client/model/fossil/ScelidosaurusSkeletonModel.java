 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScelidosaurusSkeletonModel extends EntityModel<ScelidosaurusSkeletonEntity> {
    ...
    public ScelidosaurusSkeletonModel() {
        ...
        this.setRotateAngle(Head, 0.2499311435592658F, 0.0F, 0.0F);
