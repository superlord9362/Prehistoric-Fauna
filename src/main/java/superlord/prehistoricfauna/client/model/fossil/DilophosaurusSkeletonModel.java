 ...
 */
@OnlyIn(Dist.CLIENT)
public class DilophosaurusSkeletonModel extends EntityModel<DilophosaurusSkeletonEntity> {
    ...
    public DilophosaurusSkeletonModel() {
        ...
        this.setRotateAngle(FemurRight, -0.10471975511965977F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(CaudalRibs, -0.06981317007977318F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(FemurLeft, -0.10471975511965977F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Skull, -0.17453292519943295F, 0.0F, 0.0F);
