 ...
 */
@OnlyIn(Dist.CLIENT)
public class ProtoceratopsSkeletonRunningModel extends EntityModel<ProtoceratopsSkeletonEntity> {
    ...
    public ProtoceratopsSkeletonRunningModel() {
        this.textureWidth = 64;
        this.textureHeight = 64;
        this.Body = new ModelRenderer(this, 0, 0);
        this.Body.setRotationPoint(0.0F, 13.3F, -3.0F);
        ...
        this.BLegLeft.setRotationPoint(1.5F, -0.67F, 5.0F);
        this.BLegLeft.addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(BLegLeft, -0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.FLegRight.setRotationPoint(1.5F, 4.7F, -2.0F);
        this.FLegRight.addBox(0.0F, -1.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(FLegRight, -0.3490658503988659F, 0.0F, 0.0F);
        this.Head = new ModelRenderer(this, 39, 12);
        this.Head.setRotationPoint(-0.2F, 1.1F, -2.0F);
        this.Head.addBox(-2.5F, -4.0F, -5.0F, 5.0F, 7.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Head, 0.0F, -0.17453292519943295F, 0.20943951023931953F);
        ...
        this.setRotateAngle(FeetLeft, 0.17453292519943295F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(BLegRight, 0.24434609527920614F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Tailtip, -0.17453292519943295F, 0.24434609527920614F, 0.0F);
        ...
        this.setRotateAngle(FeetRight, 0.24434609527920614F, 0.0F, 0.0F);
        this.FLegLeft = new ModelRenderer(this, 0, 0);
        this.FLegLeft.mirror = true;
        this.FLegLeft.setRotationPoint(-1.5F, 4.7F, -2.0F);
