...
public class DilophosaurusSkeletonModel extends EntityModel<DilophosaurusSkeleton> {
	private final ModelPart FemurLeft;
	private final ModelPart Ribcage;
	private final ModelPart FemurRight;

	public DilophosaurusSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FemurLeft = partdefinition.addOrReplaceChild("FemurLeft", CubeListBuilder.create().texOffs(72, 51).mirror().addBox(-2.0F, -1.0F, -3.5F, 6.0F, 14.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, -1.0F, 6.5F, -0.1047F, 0.0F, 0.0F));
		...
		PartDefinition Ribcage = partdefinition.addOrReplaceChild("Ribcage", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -3.0F, -27.0F, 8.0F, 13.0F, 32.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -3.0F, 9.0F));

		PartDefinition ArmRight = Ribcage.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(41, 46).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 6.0F, -23.0F, 0.1396F, 0.0F, 0.0F));

		PartDefinition ArmLeft = Ribcage.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(41, 46).mirror().addBox(-1.0F, 0.0F, -2.0F, 3.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.5F, 6.0F, -23.0F, 0.1396F, 0.0F, 0.0F));

		PartDefinition CaudalRibs = Ribcage.addOrReplaceChild("CaudalRibs", CubeListBuilder.create().texOffs(50, 4).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 5.0F, -0.0698F, 0.0F, 0.0F));

		PartDefinition Tail2 = CaudalRibs.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(95, 3).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 0.0F, 47.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 18.0F, 0.0698F, 0.0F, 0.0F));
		...
		PartDefinition Skull = CervicalRibs.addOrReplaceChild("Skull", CubeListBuilder.create().texOffs(0, 70).addBox(-2.5F, -1.0F, -5.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -13.0F, -2.5F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition FemurRight = partdefinition.addOrReplaceChild("FemurRight", CubeListBuilder.create().texOffs(72, 51).addBox(-4.0F, 0.0F, -3.5F, 6.0F, 14.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -2.0F, 6.5F, -0.1047F, 0.0F, 0.0F));
