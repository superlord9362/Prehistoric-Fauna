...
public class CoelophysisSkeletonSaunterModel extends EntityModel<CoelophysisSkeleton> {

	private final ModelPart LFemur;
	private final ModelPart RFemur;
	private final ModelPart Body;

	public CoelophysisSkeletonSaunterModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LFemur = partdefinition.addOrReplaceChild("LFemur", CubeListBuilder.create().texOffs(101, 1).addBox(-1.0F, -0.5F, -1.5F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 12.5F, 3.5F, 0.3491F, -0.3491F, -0.2443F));
		...
		PartDefinition RFemur = partdefinition.addOrReplaceChild("RFemur", CubeListBuilder.create().texOffs(101, 1).mirror().addBox(-1.0F, -0.5F, -1.5F, 2.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-1.5F, 12.5F, 3.5F, -0.2618F, 0.3491F, 0.0F));

		PartDefinition RLeg = RFemur.addOrReplaceChild("RLeg", CubeListBuilder.create().texOffs(6, 3).mirror().addBox(-1.0F, 0.0F, 0.0F, 2.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 5.5F, 1.5F));

		PartDefinition RFoot = RLeg.addOrReplaceChild("RFoot", CubeListBuilder.create().texOffs(0, 0).mirror().addBox(-1.0F, 0.0F, -3.0F, 2.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 6.0F, 0.0F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition RArm = Body.addOrReplaceChild("RArm", CubeListBuilder.create().texOffs(82, 0).mirror().addBox(-0.5F, -0.5F, 0.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, 3.5F, -10.5F, 1.0472F, 0.0F, -0.3491F));

		PartDefinition LArm = Body.addOrReplaceChild("LArm", CubeListBuilder.create().texOffs(82, 0).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 3.5F, -10.5F, 0.8727F, 0.0F, 0.3491F));
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(34, 0).addBox(-1.0F, -6.0F, -2.5F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -12.0F, -0.43F, 0.2443F, 0.0F));

		PartDefinition CervicalVertebrae = Neck.addOrReplaceChild("CervicalVertebrae", CubeListBuilder.create().texOffs(44, -1).addBox(0.0F, -6.5F, -3.0F, 0.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Skull = Neck.addOrReplaceChild("Skull", CubeListBuilder.create().texOffs(55, 10).addBox(-1.0F, 0.0F, -7.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.5F, -3.0F, 0.6109F, 0.1745F, 0.0F));
