...
public class PostosuchusSkeletonCuriousModel extends EntityModel<PostosuchusSkeleton> {
	private final ModelPart Thigh;
	private final ModelPart Thigh_1;
	private final ModelPart Body;

	public PostosuchusSkeletonCuriousModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -6.0F, -23.0F, 9.0F, 10.0F, 28.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 10.0F, 5.0F, -0.2793F, 0.0F, 0.0F));

		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(5, 0).addBox(0.0F, -2.5F, -8.0F, 0.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.5F, -22.0F, 0.2094F, -0.0698F, 0.0F));

		PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(107, 3).addBox(-2.5F, -1.5F, -5.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -7.5F, 0.2094F, 0.0F, 0.1396F));
		...
		PartDefinition Arm_1 = Body.addOrReplaceChild("Arm_1", CubeListBuilder.create().texOffs(54, 46).mirror().addBox(-2.0F, 0.0F, -1.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(5.0F, 1.5F, -19.5F, 0.8727F, 0.0F, 0.0698F));

		PartDefinition Arm = Body.addOrReplaceChild("Arm", CubeListBuilder.create().texOffs(54, 46).addBox(-1.0F, 0.0F, -1.0F, 3.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 1.5F, -19.5F, 0.8727F, 0.0F, -0.0698F));
		...
		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(2, 46).addBox(-4.0F, 0.0F, 0.0F, 8.0F, 0.0F, 21.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, 5.0F, -0.0873F, -0.1396F, 0.0F));

		PartDefinition Tail2 = Tail.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 80).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 38.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 21.0F, 0.1745F, -0.1396F, 0.0F));
