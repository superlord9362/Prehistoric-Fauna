 ...
 */
@OnlyIn(Dist.CLIENT)
public class DesmatosuchusSkeletonWalkingLeftModel extends EntityModel<DesmatosuchusSkeletonEntity> {
    ...
    public DesmatosuchusSkeletonWalkingLeftModel() {
        ...
        this.Leg_L_1_1.setRotationPoint(-2.5F, 9.0F, 10.0F);
        this.Leg_L_1_1.addBox(-5.0F, 0.0F, -2.0F, 5.0F, 9.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Leg_L_1_1, 0.17453292519943295F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Head_1, 0.3141592653589793F, 0.0F, 0.0F);
        ...
        this.Leg_L_2.setRotationPoint(2.9F, 8.0F, 1.0F);
        this.Leg_L_2.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Leg_L_2, 0.4363323129985824F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.08726646259971647F, -0.20943951023931953F, 0.0F);
        ...
        this.Belly.setRotationPoint(0.0F, -0.5F, -0.8F);
        this.Belly.addBox(-4.0F, -2.5F, -10.0F, 8.0F, 7.0F, 11.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Belly, 0.06981317007977318F, -0.03490658503988659F, 0.0F);
        ...
        this.Feet_L_1.setRotationPoint(-0.4F, 5.5F, -1.5F);
        this.Feet_L_1.addBox(-1.8F, 0.0F, -5.0F, 4.0F, 2.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Feet_L_1, -0.593411945678072F, 0.0F, 0.0F);
        this.Arm_R = new ModelRenderer(this, 44, 32);
        this.Arm_R.mirror = true;
        this.Arm_R.setRotationPoint(-3.7F, 11.0F, -7.5F);
        ...
        this.Leg_L_2_1.setRotationPoint(-2.9F, 8.0F, 1.0F);
        this.Leg_L_2_1.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Leg_L_2_1, 0.41887902047863906F, 0.0F, 0.0F);
        this.Leg_L_1 = new ModelRenderer(this, 2, 48);
        this.Leg_L_1.setRotationPoint(2.5F, 9.0F, 10.0F);
        this.Leg_L_1.addBox(0.0F, 0.0F, -2.0F, 5.0F, 9.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Leg_L_1, -0.5235987755982988F, -0.17453292519943295F, 0.0F);
        this.Arm_L = new ModelRenderer(this, 44, 32);
        this.Arm_L.setRotationPoint(3.5F, 12.0F, -7.5F);
        this.Arm_L.addBox(-1.5F, 0.0F, -1.5F, 3.0F, 13.0F, 3.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Arm_L, -0.41887902047863906F, -0.3839724354387525F, 0.0F);
        ...
        this.setRotateAngle(TailCarapace, -0.24434609527920614F, -0.20943951023931953F, 0.0F);
        ...
        this.Feet_L.setRotationPoint(0.0F, 5.0F, -0.5F);
        ...
        this.setRotateAngle(Tail_tip, 0.149923785409474F, -0.17453292519943295F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Leg_L_1_1, this.ASS, this.Arm_R, this.Leg_L_1, this.Arm_L).forEach((modelRenderer) -> { 
