...
public class TriceratopsSkeletonActionLeftModel extends EntityModel<TriceratopsSkeleton> {
	...
	public TriceratopsSkeletonActionLeftModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightHindLeg1 = partdefinition.addOrReplaceChild("RightHindLeg1", CubeListBuilder.create().texOffs(197, 1).addBox(-2.0F, -3.0F, -4.0F, 6.0F, 25.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(12.0F, -12.0F, 14.0F, 0.3491F, -0.3491F, -0.3491F));
		...
		PartDefinition LeftHindLeg1 = partdefinition.addOrReplaceChild("LeftHindLeg1", CubeListBuilder.create().texOffs(197, 1).mirror().addBox(-4.0F, -3.0F, -4.0F, 6.0F, 25.0F, 18.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-12.0F, -11.0F, 13.0F, -0.3491F, 0.3491F, 0.0F));
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(110, 6).addBox(0.0F, -4.0F, -13.0F, 0.0F, 11.0F, 13.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1F, -1.0F, -22.0F, 0.1745F, 0.3491F, 0.0F));
		...
		PartDefinition Head11 = Head1.addOrReplaceChild("Head11", CubeListBuilder.create().texOffs(79, 196).addBox(-4.0F, -4.0F, -12.0F, 8.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 11.0F, 0.1F, 0.2443F, 0.0F, 0.0F));
		...
		PartDefinition CaudalVertebrae2 = CaudalVertebrae.addOrReplaceChild("CaudalVertebrae2", CubeListBuilder.create().texOffs(88, 77).addBox(0.1F, -2.0F, -3.0F, 0.0F, 9.0F, 27.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 20.0F, 0.3491F, -0.3491F, 0.0F));
		...
		PartDefinition LeftFrontLeg = partdefinition.addOrReplaceChild("LeftFrontLeg", CubeListBuilder.create().texOffs(220, 75).mirror().addBox(-3.0F, 0.0F, -3.0F, 6.0F, 27.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-11.0F, -2.0F, -14.0F, 0.0F, -0.1745F, 0.0F));

		PartDefinition RightFrontLeg = partdefinition.addOrReplaceChild("RightFrontLeg", CubeListBuilder.create().texOffs(220, 75).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 27.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.0F, -3.0F, -14.0F, 0.3491F, 0.1745F, 0.0F));
