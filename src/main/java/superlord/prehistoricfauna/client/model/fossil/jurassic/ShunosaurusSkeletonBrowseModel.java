...
public class ShunosaurusSkeletonBrowseModel extends EntityModel<ShunosaurusSkeleton> {
	...
	public ShunosaurusSkeletonBrowseModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition neck1 = body.addOrReplaceChild("neck1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -12.1467F, -33.5219F, 0.1261F, -0.5522F, -0.137F));
		...
		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.0F, -16.25F, -0.0113F, -0.2087F, 0.0475F));
		...
		.texOffs(152, 163).addBox(-2.0F, 3.0F, -9.0F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.3533F, -15.7281F, -0.0435F, 0.0038F, 0.0872F));
		...
		.texOffs(150, 138).addBox(-1.5F, 0.0F, -9.99F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 1.0F, 0.3491F, 0.0F, 0.0F));
		...
		.texOffs(9, 65).addBox(0.0F, -3.0F, 0.0F, 0.0F, 12.0F, 33.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.6467F, 4.7281F, -0.264F, -0.1264F, 0.0341F));
		...
		PartDefinition club = tail2.addOrReplaceChild("club", CubeListBuilder.create().texOffs(3, 144).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 25.0F, 0.0F, -0.1309F, 0.0F));
		...
		.texOffs(0, 0).mirror().addBox(-8.0F, 23.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(11.0F, 5.8533F, -28.2719F, 0.0F, 0.0698F, 0.0F));
		...
		.texOffs(0, 0).addBox(6.0F, 23.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.0F, 5.8533F, -28.2719F, 0.0F, -0.0698F, 0.0F));

		PartDefinition legL = partdefinition.addOrReplaceChild("legL", CubeListBuilder.create().texOffs(152, 96).addBox(-4.0F, -2.1467F, -5.2719F, 8.0F, 20.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.0F, -8.8533F, 15.2719F, 0.0F, -0.2094F, 0.0F));

		PartDefinition lowerlegL = legL.addOrReplaceChild("lowerlegL", CubeListBuilder.create().texOffs(30, 142).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.8533F, -3.2719F));
		...
		PartDefinition legR = partdefinition.addOrReplaceChild("legR", CubeListBuilder.create().texOffs(152, 96).mirror().addBox(-4.0F, -2.1467F, -5.2719F, 8.0F, 20.0F, 12.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-9.0F, -8.8533F, 15.2719F, 0.0F, 0.2094F, 0.0F));

		PartDefinition lowerlegR = legR.addOrReplaceChild("lowerlegR", CubeListBuilder.create().texOffs(30, 142).mirror().addBox(-3.0F, 0.0F, 0.0F, 6.0F, 11.0F, 7.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 17.8533F, -3.2719F));
