 ...
 */
@OnlyIn(Dist.CLIENT)
public class PostosuchusWalkingSkeletonModel extends EntityModel<PostosuchusSkeletonEntity> {
    ...
    public PostosuchusWalkingSkeletonModel() {
        ...
        this.setRotateAngle(Arm_1, 0.3490658503988659F, 0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Foot, -0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Calf, 0.5585053606381855F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(Neck, 0.13962634015954636F, -0.17453292519943295F, -0.0F);
        ...
        this.setRotateAngle(Tail, -0.17453292519943295F, -0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Arm, 0.3490658503988659F, -0.4886921905584123F, 0.0F);
        ...
        this.setRotateAngle(Tail2, 0.10471975511965977F, -0.17453292519943295F, 0.0F);
        ...
        this.setRotateAngle(Head, 0.06981317007977318F, -0.17453292519943295F, -0.13962634015954636F);
        ...
        this.setRotateAngle(Thigh, 0.10471975511965977F, -0.24434609527920614F, -0.13962634015954636F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Body, this.Thigh_1, this.Thigh).forEach((modelRenderer) -> { 
