 ...
 */
@OnlyIn(Dist.CLIENT)
public class AnkylosaurusSkeletonModel extends EntityModel<AnkylosaurusSkeletonEntity> {
    ...
    public AnkylosaurusSkeletonModel() {
        ...
        this.setRotateAngle(LeftHindLeg2, 0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg1, -0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LeftHindLeg1, -0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RightHindLeg2, 0.3490658503988659F, 0.0F, 0.0F);
