...
public class DilophosaurusSkeletonGazeModel extends EntityModel<DilophosaurusSkeleton> {
	private final ModelPart FemurLeft;
	private final ModelPart Ribcage;
	private final ModelPart FemurRight;

	public DilophosaurusSkeletonGazeModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition FemurLeft = partdefinition.addOrReplaceChild("FemurLeft", CubeListBuilder.create().texOffs(72, 51).mirror().addBox(-2.0F, -1.0F, -3.5F, 6.0F, 14.0F, 10.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, -1.0F, 6.0F, -0.6458F, 0.384F, 0.0F));

		PartDefinition Leg2Left = FemurLeft.addOrReplaceChild("Leg2Left", CubeListBuilder.create().texOffs(72, 75).mirror().addBox(-2.0F, -4.0F, 0.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.5F, 11.0F, 4.0F, -0.1682F, 0.0F, 0.0F));

		PartDefinition FootLeft = Leg2Left.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(72, 94).addBox(-2.5F, 0.0F, -6.0F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 10.0F, 1.0F, 0.9365F, 0.0F, 0.0F));
		...
		PartDefinition CervicalRibs = Ribcage.addOrReplaceChild("CervicalRibs", CubeListBuilder.create().texOffs(0, 46).addBox(-2.0F, -13.0F, -6.0F, 4.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, -28.0F, 0.5845F, -0.5236F, 0.0F));

		PartDefinition Skull = CervicalRibs.addOrReplaceChild("Skull", CubeListBuilder.create().texOffs(0, 70).addBox(-2.5F, -1.0F, -5.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -12.5F, -3.0F, -0.7505F, 0.0F, 0.1745F));
		...
		PartDefinition CaudalRibs = Ribcage.addOrReplaceChild("CaudalRibs", CubeListBuilder.create().texOffs(50, 4).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 18.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 5.0F, 0.192F, -0.1396F, 0.0F));
		...
		PartDefinition Tail2 = CaudalRibs.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(95, 3).addBox(-1.5F, 0.0F, 0.0F, 3.0F, 0.0F, 47.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 18.0F, 0.3665F, -0.1396F, 0.0F));
		...
		PartDefinition ArmLeft = Ribcage.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(41, 46).mirror().addBox(-1.0F, 0.0F, -2.0F, 3.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.5F, 6.0F, -23.0F, 1.117F, -0.192F, -0.384F));

		PartDefinition ArmRight = Ribcage.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(41, 46).addBox(-2.0F, 0.0F, -2.0F, 3.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.5F, 6.0F, -23.0F, 1.1519F, 0.2618F, 0.1396F));
		...
		PartDefinition FemurRight = partdefinition.addOrReplaceChild("FemurRight", CubeListBuilder.create().texOffs(72, 51).addBox(-4.0F, 0.0F, -3.5F, 6.0F, 14.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -2.0F, 6.5F, -0.1047F, -0.2793F, 0.0F));
		...
		PartDefinition FootRight = Leg2Right.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(72, 94).mirror().addBox(-2.5F, 0.0F, -6.0F, 5.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 10.0F, 1.0F));
