...
public class DesmatosuchusSkeletonModel extends EntityModel<DesmatosuchusSkeleton> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Feet_L_1 = Leg_L_2_1.addOrReplaceChild("Feet_L_1", CubeListBuilder.create().texOffs(0, 61).addBox(-2.2F, 0.0F, -5.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.4F, 5.0F, 0.0F));
		...
		PartDefinition Feet_L = Leg_L_2.addOrReplaceChild("Feet_L", CubeListBuilder.create().texOffs(0, 61).mirror().addBox(-2.2F, 0.0F, -5.0F, 4.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 5.0F, 0.0F));
