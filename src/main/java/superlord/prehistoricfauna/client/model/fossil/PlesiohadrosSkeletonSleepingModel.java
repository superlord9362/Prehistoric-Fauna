 ...
 */
@OnlyIn(Dist.CLIENT)
public class PlesiohadrosSkeletonSleepingModel extends EntityModel<PlesiohadrosSkeletonEntity> {
    ...
    public PlesiohadrosSkeletonSleepingModel() {
        this.textureWidth = 256;
        this.textureHeight = 128;
        this.LegBackL = new ModelRenderer(this, 130, 0);
        this.LegBackL.setRotationPoint(0.0F, 14.9F, 3.9F);
        ...
        this.FeetR.setRotationPoint(0.0F, 11.0F, -0.5F);
        ...
        this.LegBackR.setRotationPoint(0.0F, 14.9F, 3.9F);
        ...
        this.LegFrontR.setRotationPoint(-4.5F, 19.8F, -7.5F);
        ...
        this.Pelvis.setRotationPoint(0.0F, 2.0F, 8.4F);
        this.Pelvis.addBox(-6.5F, -8.0F, 0.0F, 13.0F, 6.0F, 22.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Pelvis, -0.20943951023931953F, 0.3490658503988659F, 0.0F);
        ...
        this.setRotateAngle(TailTip, 0.3141592653589793F, 0.593411945678072F, 0.0F);
        ...
        this.LegFrontL.setRotationPoint(4.0F, 20.0F, -12.0F);
        this.LegFrontL.addBox(0.0F, -1.0F, -2.0F, 3.0F, 20.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegFrontL, -1.3788101090755203F, -0.593411945678072F, 0.04363323129985824F);
        ...
        this.setRotateAngle(CaudalVertebrae, -0.5585053606381855F, 0.41887902047863906F, 0.0F);
        this.ThighL = new ModelRenderer(this, 98, 4);
        this.ThighL.setRotationPoint(10.5F, 9.3F, 9.0F);
        ...
        this.Ribs.setRotationPoint(0.0F, 10.0F, -12.0F);
        this.Ribs.addBox(-5.0F, -5.0F, -6.0F, 10.0F, 18.0F, 17.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Ribs, 0.17453292519943295F, 0.0F, 0.0F);
        this.ThighR = new ModelRenderer(this, 98, 4);
        this.ThighR.mirror = true;
        this.ThighR.setRotationPoint(-1.0F, 9.3F, 12.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.LegFrontR, this.LegFrontL, this.ThighL, this.Ribs, this.ThighR).forEach((modelRenderer) -> { 
