...
public class ShunosaurusSkeletonGrazeModel extends EntityModel<ShunosaurusSkeleton> {
	...
	public ShunosaurusSkeletonGrazeModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition neck1 = body.addOrReplaceChild("neck1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -12.1467F, -33.5219F, 0.6801F, 0.315F, -0.0355F));
		...
		PartDefinition neck2 = neck1.addOrReplaceChild("neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -5.0F, -16.25F, 0.2918F, 0.1676F, 0.1602F));
		...
		PartDefinition club = tail2.addOrReplaceChild("club", CubeListBuilder.create().texOffs(3, 144).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 25.0F, 0.0F, 0.1745F, 0.0F));
