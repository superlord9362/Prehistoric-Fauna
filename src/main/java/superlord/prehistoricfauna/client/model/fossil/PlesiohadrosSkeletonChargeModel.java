 ...
 */
@OnlyIn(Dist.CLIENT)
public class PlesiohadrosSkeletonChargeModel extends EntityModel<PlesiohadrosSkeletonEntity> {
    ...
    public PlesiohadrosSkeletonChargeModel() {
        ...
        this.ThighL.setRotationPoint(6.5F, -2.5F, 9.0F);
        this.ThighL.addBox(-3.0F, -1.5F, -3.0F, 5.0F, 15.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ThighL, -0.593411945678072F, -0.20943951023931953F, 0.0F);
        ...
        this.setRotateAngle(Ribs, 0.24434609527920614F, 0.0F, 0.0F);
        ...
        this.LegBackL.setRotationPoint(0.0F, 13.3F, 4.3F);
        this.LegBackL.addBox(-2.0F, -1.0F, -1.0F, 4.0F, 13.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegBackL, 0.593411945678072F, 0.0F, 0.0F);
        ...
        this.Pelvis.setRotationPoint(0.0F, 2.0F, 7.5F);
        this.Pelvis.addBox(-6.5F, -8.0F, 0.0F, 13.0F, 6.0F, 22.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Pelvis, -0.3490658503988659F, 0.08726646259971647F, 0.0F);
        ...
        this.LegFrontL.setRotationPoint(4.0F, 5.0F, -11.0F);
        ...
        this.setRotateAngle(CaudalVertebrae, -0.20943951023931953F, 0.3839724354387525F, 0.0F);
        ...
        this.setRotateAngle(Head, 0.13962634015954636F, 0.767944870877505F, -0.06981317007977318F);
        ...
        this.setRotateAngle(TailTip, 0.13962634015954636F, 0.46914448828868976F, 0.0F);
        ...
        this.setRotateAngle(LegBackR, 0.41887902047863906F, 0.0F, 0.0F);
        this.ThighR = new ModelRenderer(this, 98, 4);
        this.ThighR.mirror = true;
        this.ThighR.setRotationPoint(-5.0F, -2.5F, 9.5F);
        this.ThighR.addBox(-2.0F, -1.5F, -3.0F, 5.0F, 15.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(ThighR, 0.2617993877991494F, 0.2792526803190927F, 0.0F);
        ...
        this.LegFrontR.setRotationPoint(-4.0F, 5.0F, -11.0F);
        this.LegFrontR.addBox(-3.0F, -1.0F, -2.0F, 3.0F, 20.0F, 4.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegFrontR, -0.41887902047863906F, 0.0F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.ThighL, this.Ribs, this.LegFrontL, this.ThighR, this.LegFrontR).forEach((modelRenderer) -> { 
