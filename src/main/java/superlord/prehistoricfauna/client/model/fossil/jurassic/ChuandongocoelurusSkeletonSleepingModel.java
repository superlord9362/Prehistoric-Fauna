...
public class ChuandongocoelurusSkeletonSleepingModel extends EntityModel<ChuandongocoelurusSkeleton> {
	private final ModelPart Root;

	public ChuandongocoelurusSkeletonSleepingModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(-16, 40).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.5F, 3.5F, -0.3054F, 0.3491F, 0.0F));
		...
		.texOffs(-2, 14).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 0.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 16.0F, 0.0698F, 0.5236F, 0.0F));
		...
		.texOffs(55, 50).addBox(0.0F, -8.0F, -3.0F, 0.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.5F, -13.5F, 0.48F, -1.2217F, 0.0F));
		...
		.texOffs(63, 52).addBox(-1.0F, 1.5F, -10.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(0.0F, -6.6F, -3.0F, 0.2182F, 0.0F, 0.0F));
