...
public class DongbeititanSkeletonModel extends EntityModel<DongbeititanSkeleton> {
	...
	public DongbeititanSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(48, 46).addBox(-5.0F, -3.0F, -45.0F, 10.0F, 9.0F, 49.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, -26.0F, -0.1309F, 0.0F, -0.0175F));

		PartDefinition Neck2 = Neck1.addOrReplaceChild("Neck2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -1.0F, -45.0F, -0.1745F, 0.0F, 0.0175F));
		...
		.texOffs(10, 31).addBox(-3.0F, 1.2777F, -11.1958F, 8.0F, 1.0F, 4.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-1.0F, -0.3473F, -56.0304F, 0.3054F, 0.0F, 0.0F));
		...
		.texOffs(253, 3).addBox(0.0F, -8.0F, -6.0F, 0.0F, 18.0F, 39.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 26.0F, -0.2618F, -0.0175F, 0.0F));
		...
		.texOffs(307, 82).addBox(-2.4564F, 0.0F, 25.0004F, 5.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 32.0F, 0.1745F, 0.0175F, 0.0F));

		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(139, 121).addBox(-6.5F, 0.0F, -5.5F, 9.0F, 26.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(15.75F, 9.25F, -16.5F));
		...
		PartDefinition LeftThigh = Body.addOrReplaceChild("LeftThigh", CubeListBuilder.create().texOffs(71, 127).addBox(-4.5F, -2.5F, -5.0F, 9.0F, 26.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(13.5F, -4.25F, 13.0F, -0.1745F, -0.3491F, 0.0F));
