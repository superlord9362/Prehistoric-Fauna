 ...
 */
@OnlyIn(Dist.CLIENT)
public class CoelophysisSkeletonSaunterModel extends EntityModel<CoelophysisSkeletonEntity> {
    ...
    public CoelophysisSkeletonSaunterModel() {
        ...
        this.setRotateAngle(RArm, 1.0471975511965976F, 0.0F, 0.3490658503988659F);
        ...
        this.setRotateAngle(LArm, 0.8726646259971648F, 0.0F, -0.3490658503988659F);
        ...
        this.CervicalVertebrae.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LFemur, 0.3490658503988659F, 0.3490658503988659F, 0.24434609527920614F);
        ...
        this.setRotateAngle(RFemur, -0.2617993877991494F, -0.3490658503988659F, 0.0F);
        this.Neck = new ModelRenderer(this, 34, 0);
        this.Neck.setRotationPoint(0.0F, -1.0F, -12.0F);
        this.Neck.addBox(-1.0F, -6.0F, -2.5F, 2.0F, 9.0F, 2.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Neck, -0.4300491170387584F, -0.24434609527920614F, 0.0F);
        ...
        this.Skull.setRotationPoint(0.0F, -6.5F, -3.0F);
        this.Skull.addBox(-1.0F, 0.0F, -7.0F, 2.0F, 2.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(Skull, 0.6108652381980153F, -0.17453292519943295F, 0.0F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.Body, this.LFemur, this.RFemur).forEach((modelRenderer) -> { 
