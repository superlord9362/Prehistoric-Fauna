...
public class TyrannosaurusSkeletonSittingModel extends EntityModel<TyrannosaurusSkeleton> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body1 = partdefinition.addOrReplaceChild("Body1", CubeListBuilder.create().texOffs(0, 0).addBox(-7.5F, -7.0F, -16.0F, 15.0F, 33.0F, 33.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.0F, 0.0F, 0.0F, -0.0063F, 0.0F));
		...
		PartDefinition Tail1 = Body1.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(8, 69).addBox(-4.0F, 0.0F, 0.0F, 9.0F, 0.0F, 58.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 17.0F, -0.3583F, -0.2346F, 0.0F));
		...
		PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(92, 63).addBox(-3.5F, 2.0F, -5.0F, 6.0F, 0.0F, 54.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 50.0F, 0.1173F, -0.2346F, 0.0F));
		...
		PartDefinition RightLeg1 = Body1.addOrReplaceChild("RightLeg1", CubeListBuilder.create().texOffs(152, 126).mirror().addBox(-3.0F, -6.0F, -9.0F, 10.0F, 30.0F, 15.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(6.0F, 3.0F, 3.0F, -0.5864F, -0.1955F, 0.0F));

		PartDefinition RightLeg2 = RightLeg1.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(212, 142).addBox(-3.0F, -8.0F, -1.0F, 6.0F, 30.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 26.0F, 5.0F, -0.7428F, 0.0F, 0.0F));

		PartDefinition RightFeet = RightLeg2.addOrReplaceChild("RightFeet", CubeListBuilder.create().texOffs(98, 50).addBox(-4.0F, -1.0F, -13.0F, 8.0F, 3.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 20.0F, 1.0F, 1.3292F, 0.0F, 0.1173F));

		PartDefinition LeftLeg1 = Body1.addOrReplaceChild("LeftLeg1", CubeListBuilder.create().texOffs(152, 126).addBox(-7.0F, -6.0F, -9.0F, 10.0F, 30.0F, 15.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.0F, 3.0F, 3.0F, -0.5864F, 0.1955F, 0.0F));

		PartDefinition LeftLeg2 = LeftLeg1.addOrReplaceChild("LeftLeg2", CubeListBuilder.create().texOffs(96, 72).mirror().addBox(-3.0F, -8.0F, -1.0F, 6.0F, 30.0F, 8.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, 26.0F, 5.0F, -0.743F, 0.0F, 0.0F));

		PartDefinition LeftFeet = LeftLeg2.addOrReplaceChild("LeftFeet", CubeListBuilder.create().texOffs(98, 50).addBox(-4.0F, -1.0F, -13.0F, 8.0F, 3.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 20.0F, 1.0F, 1.3292F, 0.0F, -0.1173F));
