 ...
 */
@OnlyIn(Dist.CLIENT)
public class AllosaurusSkeletonActionRightModel extends EntityModel<AllosaurusSkeletonEntity> {
    ...
    public AllosaurusSkeletonActionRightModel() {
        ...
        this.setRotateAngle(LeftLeg2, -0.11728612207217244F, 0.0F, 0.0F);
        this.LeftLeg1 = new ModelRenderer(this, 76, 153);
        this.LeftLeg1.mirror = true;
        this.LeftLeg1.setRotationPoint(5.5F, -8.5F, 8.5F);
        this.LeftLeg1.addBox(-3.0F, -6.5F, -5.5F, 8.0F, 21.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftLeg1, -0.23457224414434488F, -0.4300491170387584F, 0.0F);
        ...
        this.LeftFoot.setRotationPoint(0.0F, 18.0F, 0.0F);
        this.LeftFoot.addBox(-4.0F, 0.0F, -11.0F, 8.0F, 3.0F, 11.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LeftFoot, 0.35185837453889574F, 0.0F, 0.0F);
        ...
        this.RightLeg1.setRotationPoint(-5.5F, -6.5F, 8.5F);
        this.RightLeg1.addBox(-5.0F, -6.6F, -5.5F, 8.0F, 21.0F, 15.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(RightLeg1, 0.23457224414434488F, 0.27366763203903305F, 0.19547687289441354F);
        ...
        this.setRotateAngle(RightLeg2, -0.19547687289441354F, 0.0F, -0.15655603856442327F);
