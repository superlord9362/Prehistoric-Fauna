 ...
 */
@OnlyIn(Dist.CLIENT)
public class ScelidosaurusSleepingSkeletonModel extends EntityModel<ScelidosaurusSkeletonEntity> {
    ...
    public ScelidosaurusSleepingSkeletonModel() {
        ...
        this.setRotateAngle(FootRight, 1.2990485675857015F, -0.46478116515870393F, -0.2780309551690189F);
        ...
        this.LegLeft.setRotationPoint(-4.0F, 15.5F, 7.0F);
        this.LegLeft.addBox(-2.0F, 0.0F, -3.0F, 4.0F, 8.0F, 6.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(LegLeft, -0.0781907508222411F, -0.0781907508222411F, 0.35185837453889574F);
        ...
        this.FootLeft.setRotationPoint(0.0F, 6.0F, -1.0F);
        this.FootLeft.addBox(-2.0F, 0.0F, -4.0F, 4.0F, 0.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        this.setRotateAngle(FootLeft, 1.2990485675857015F, 0.46478116515870393F, 0.2780309551690189F);
        ...
        this.setRotateAngle(Leg2Left, -1.0953686092568693F, 0.0F, 0.0F);
        ...
        this.ArmRight.setRotationPoint(5.0F, 3.0F, -16.0F);
        ...
        this.ArmLeft.setRotationPoint(-5.0F, 3.0F, -16.0F);
