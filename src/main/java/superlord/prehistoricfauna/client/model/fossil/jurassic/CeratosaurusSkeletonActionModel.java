...
public class CeratosaurusSkeletonActionModel extends EntityModel<CeratosaurusSkeleton> {
	private final ModelPart Body1;

	public CeratosaurusSkeletonActionModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body1 = partdefinition.addOrReplaceChild("Body1", CubeListBuilder.create().texOffs(155, 56).addBox(-6.0F, -5.0F, -30.0F, 12.0F, 12.0F, 34.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 8.0F, 0.1564F, 0.0F, 0.0F));

		PartDefinition TailVetebrae = Body1.addOrReplaceChild("TailVetebrae", CubeListBuilder.create().texOffs(169, 124).addBox(0.0F, -4.0F, 0.0F, 0.0F, 13.0F, 22.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 4.0F, -0.0782F, 0.0F, 0.0F));

		PartDefinition TailVertebrae2 = TailVetebrae.addOrReplaceChild("TailVertebrae2", CubeListBuilder.create().texOffs(177, 126).addBox(0.0F, -2.0F, 0.0F, 0.0F, 7.0F, 36.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 22.0F, -0.0391F, 0.0F, 0.0F));
		...
		PartDefinition LeftArm = Body1.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(51, 51).mirror().addBox(-3.0F, -2.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-4.0F, 6.0F, -26.0F, 0.0F, 0.0F, 0.391F));

		PartDefinition LeftLeg1 = Body1.addOrReplaceChild("LeftLeg1", CubeListBuilder.create().texOffs(76, 153).mirror().addBox(-6.0F, -4.0F, -6.0F, 6.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-2.0F, -1.0F, -5.0F, -0.1955F, 0.2737F, 0.0F));
		...
		PartDefinition Neck = Body1.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(4, 55).addBox(-3.0F, -13.0F, -4.0F, 6.0F, 9.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.0F, -30.0F, -0.1173F, 0.0F, -0.1955F));

		PartDefinition Head1 = Neck.addOrReplaceChild("Head1", CubeListBuilder.create().texOffs(0, 94).addBox(-4.0F, -1.5F, -8.0F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.5F, -4.0F));

		PartDefinition Jaw1 = Head1.addOrReplaceChild("Jaw1", CubeListBuilder.create().texOffs(0, 119).addBox(-4.0F, 0.0F, -8.0F, 8.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 4.5F, 0.0F, 0.5473F, 0.0F, 0.0F));
		...
		PartDefinition RightLeg1 = Body1.addOrReplaceChild("RightLeg1", CubeListBuilder.create().texOffs(128, 153).mirror().addBox(0.0F, -4.0F, -6.0F, 6.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.0F, -0.3F, -5.0F, 0.0391F, -0.3519F, 0.0F));

		PartDefinition RightLeg2 = RightLeg1.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(126, 192).mirror().addBox(-2.5F, -3.0F, -3.0F, 4.0F, 16.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 12.0F, 5.0F, -0.1955F, 0.0F, 0.0F));
		...
		PartDefinition RightArm = Body1.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(73, 51).mirror().addBox(-1.0F, -2.0F, -2.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(4.0F, 6.0F, -26.0F, 0.0F, 0.0F, -0.391F));
