...
public class ProtoceratopsSkeletonModel extends EntityModel<ProtoceratopsSkeleton> {
	private final ModelPart Body;

	public ProtoceratopsSkeletonModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -2.5F, -4.0F, 5.0F, 8.0F, 12.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.0F, -2.0F));

		PartDefinition Tail = Body.addOrReplaceChild("Tail", CubeListBuilder.create().texOffs(5, 25).addBox(0.0F, -3.5F, -2.0F, 0.0F, 6.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -0.5F, 7.0F));
		...
		PartDefinition Tailtip = Tail.addOrReplaceChild("Tailtip", CubeListBuilder.create().texOffs(18, 19).addBox(0.0F, -1.5F, 0.0F, 0.0F, 4.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 7.0F));
		...
		PartDefinition BLegLeft = Body.addOrReplaceChild("BLegLeft", CubeListBuilder.create().texOffs(31, 34).mirror().addBox(-2.0F, 0.0F, -1.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.5F, -1.0F, 5.0F));

		PartDefinition FeetLeft = BLegLeft.addOrReplaceChild("FeetLeft", CubeListBuilder.create().texOffs(30, 46).mirror().addBox(-2.0F, 0.0F, -3.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(-1.0F, 8.0F, 2.0F));
		...
		PartDefinition BLegRight = Body.addOrReplaceChild("BLegRight", CubeListBuilder.create().texOffs(31, 34).addBox(0.0F, 0.0F, -1.0F, 2.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, -1.0F, 5.0F));

		PartDefinition FeetRight = BLegRight.addOrReplaceChild("FeetRight", CubeListBuilder.create().texOffs(30, 46).addBox(-2.0F, 0.0F, -3.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(1.0F, 8.0F, 2.0F));
