...
public class ClientProxy extends CommonProxy { 
	...
	public static void setupBlockRenders() {
		...
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.AZOLLA.get(), cutoutRenderType);
...
//		ItemBlockRenderTypes.setRenderLayer(PFBlocks.ARCHAEAMPHORA.get(), cutoutRenderType);
		...
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PURPLE_ZINGIBEROPSIS.get(), cutoutRenderType);
		...
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.CZEKANOWSKIA_DOOR.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.CZEKANOWSKIA_TRAPDOOR.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.CZEKANOWSKIA_SAPLING.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.POTTED_CZEKANOWSKIA_SAPLING.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.CZEKANOWSKIA_LEAVES.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.CZEKANOWSKIA_LEAF_CARPET.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.CZEKANOWSKIA_HEDGE.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_LADDER.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_DOOR.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_TRAPDOOR.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_SAPLING.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.POTTED_SCHIZOLEPIDOPSIS_SAPLING.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_LEAVES.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_LEAF_CARPET.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_HEDGE.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.SCHIZOLEPIDOPSIS_LADDER.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_DOOR.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_TRAPDOOR.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_SAPLING.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.POTTED_PODOZAMITES_SAPLING.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_LEAVES.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_LEAF_CARPET.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_HEDGE.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.PODOZAMITES_LADDER.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.RUFFORDIA.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.LEEFRUCTUS.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.EPHEDRA.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.QUEREUXIA_PAD.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.QUEREUXIA_STEM.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.POTTED_BISONIA.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.POTTED_ARCHAEOFRUCTUS.get(), cutoutRenderType);
		ItemBlockRenderTypes.setRenderLayer(PFBlocks.POTTED_EPHEDRA.get(), cutoutRenderType);
