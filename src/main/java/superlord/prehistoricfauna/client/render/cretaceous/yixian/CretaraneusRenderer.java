...
public class CretaraneusRenderer extends MobRenderer<Cretaraneus, CretaraneusModel> {
	...
	@Override
	protected void setupRotations(Cretaraneus entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Cretaraneus entity) {
		return CRETARANEUS_TEXTURE;
