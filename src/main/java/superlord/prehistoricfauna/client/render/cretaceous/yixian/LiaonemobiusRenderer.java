...
public class LiaonemobiusRenderer extends MobRenderer<Liaonemobius, LiaonemobiusModel> {
	...
	@Override
	protected void setupRotations(Liaonemobius entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Liaonemobius entity) {
		return LIAONEMOBIUS_TEXTURE;
