...
public class WallFossilRenderer extends EntityRenderer<WallFossilEntity> {
    private static final ResourceLocation BACK = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/fossils/back.png");
    ...
    public ResourceLocation getEntityTexture(WallFossilEntity entity) {
        return FOSSILS.computeIfAbsent(entity.fossil, k -> new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/fossils/" + k.name().toLowerCase() + ".png"));
    }
