...
import superlord.prehistoricfauna.client.model.jurassic.shaximiao.RhipidoblattinaModel;
...
public class RhipidoblattinaRenderer extends MobRenderer<Rhipidoblattina, RhipidoblattinaModel<Rhipidoblattina>> {
	...
	@Override
	protected void setupRotations(Rhipidoblattina entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Rhipidoblattina entity) {
		return RHIPIDOBLATTINA_TEXTURE;
	}
}
