...
import superlord.prehistoricfauna.client.model.jurassic.shaximiao.AboilusModel;
...
public class AboilusRenderer extends MobRenderer<Aboilus, AboilusModel<Aboilus>> {
	...
	@Override
	protected void setupRotations(Aboilus entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Aboilus entity) {
		return ABOILUS_TEXTURE;
	}
}
