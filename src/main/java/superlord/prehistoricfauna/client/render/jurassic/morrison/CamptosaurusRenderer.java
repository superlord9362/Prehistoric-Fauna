...
public class CamptosaurusRenderer extends MobRenderer<Camptosaurus, EntityModel<Camptosaurus>> {
	...
	private static final ResourceLocation CAMPTOSAURUS_BABY = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/camptosaurus/camptosaurus_baby.png");
	private static final ResourceLocation ALBINO_BABY = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/camptosaurus/albino_baby.png");
	private static final ResourceLocation MELANISTIC_BABY = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/camptosaurus/melanistic_baby.png");
	private static final ResourceLocation CAMPTOSAURUS_BABY_SLEEPING_TEXTURE = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/camptosaurus/camptosaurus_baby_sleeping.png");
	private static final ResourceLocation ALBINO_BABY_SLEEPING = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/camptosaurus/albino_baby_sleeping.png");
	private static final ResourceLocation MELANISTIC_BABY_SLEEPING = new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/camptosaurus/melanistic_baby_sleeping.png");
