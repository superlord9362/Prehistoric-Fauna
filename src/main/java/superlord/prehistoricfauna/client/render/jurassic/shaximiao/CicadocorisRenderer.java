...
import superlord.prehistoricfauna.client.model.jurassic.shaximiao.CicadocorisModel;
...
public class CicadocorisRenderer extends MobRenderer<Cicadocoris, CicadocorisModel<Cicadocoris>> {
	...
	@Override
	protected void setupRotations(Cicadocoris entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Cicadocoris entity) {
		return CICADOCORIS_TEXTURE;
	}
}
