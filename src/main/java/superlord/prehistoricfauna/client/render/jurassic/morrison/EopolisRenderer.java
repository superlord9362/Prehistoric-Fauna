...
import superlord.prehistoricfauna.client.model.jurassic.morrison.EopolisModel;
...
public class EopolisRenderer extends MobRenderer<Eopolis, EopolisModel<Eopolis>> {
	...
	@Override
	protected void setupRotations(Eopolis entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Eopolis entity) {
		return EOPOLIS_TEXTURE;
	}
}
