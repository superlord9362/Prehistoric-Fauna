...
import superlord.prehistoricfauna.client.model.jurassic.morrison.ParapleuritesModel;
...
public class ParapleuritesRenderer extends MobRenderer<Parapleurites, ParapleuritesModel<Parapleurites>> {
	...
	@Override
	protected void setupRotations(Parapleurites entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Parapleurites entity) {
		return PARAPLEURITES_TEXTURE;
	}
}
