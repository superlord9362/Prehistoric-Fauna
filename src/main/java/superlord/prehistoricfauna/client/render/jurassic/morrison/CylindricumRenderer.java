...
import superlord.prehistoricfauna.client.model.jurassic.morrison.CylindricumModel;
...
public class CylindricumRenderer extends MobRenderer<Cylindricum, CylindricumModel<Cylindricum>> {
	...
	@Override
	protected void setupRotations(Cylindricum entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Cylindricum entity) {
		return CYLINDRICUM_TEXTURE;
	}
}
