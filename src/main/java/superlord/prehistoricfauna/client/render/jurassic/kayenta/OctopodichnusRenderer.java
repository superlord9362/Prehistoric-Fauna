...
import superlord.prehistoricfauna.client.model.jurassic.kayenta.OctopodichnusModel;
...
public class OctopodichnusRenderer extends MobRenderer<Octopodichnus, OctopodichnusModel<Octopodichnus>> {
	...
	@Override
	protected void setupRotations(Octopodichnus entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Octopodichnus entity) {
		return OCTOPODICHNUS_TEXTURE;
	}
}
