...
import superlord.prehistoricfauna.client.model.jurassic.shaximiao.MesoforficulaModel;
...
public class MesoforficulaRenderer extends MobRenderer<Mesoforficula, MesoforficulaModel<Mesoforficula>> {
	...
	@Override
	protected void setupRotations(Mesoforficula entityLiving, PoseStack matrixStackIn, float ageInTicks, float rotationYaw, float partialTicks) {
	...
	@Override
	public ResourceLocation getTextureLocation(Mesoforficula entity) {
		return MESOFORFICULA_TEXTURE;
	}
}
