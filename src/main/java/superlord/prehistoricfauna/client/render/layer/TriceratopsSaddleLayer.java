...
public class TriceratopsSaddleLayer extends LayerRenderer<TriceratopsEntity, EntityModel<TriceratopsEntity>> {
	
	private static final RenderType TEXTURE = RenderType.getEntityCutoutNoCull(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/triceratops/triceratops_saddle_layer.png"));
	private final IEntityRenderer<TriceratopsEntity, EntityModel<TriceratopsEntity>> triceratopsRenderer;
	
	public TriceratopsSaddleLayer(IEntityRenderer<TriceratopsEntity, EntityModel<TriceratopsEntity>> triceratopsRenderer) {
