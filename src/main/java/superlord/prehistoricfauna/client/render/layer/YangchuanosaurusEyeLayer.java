...
public class YangchuanosaurusEyeLayer extends RenderLayer<Yangchuanosaurus, EntityModel<Yangchuanosaurus>> {
	...
	private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/yangchuanosaurus/yangchuanosaurus_eyeglow.png"));
