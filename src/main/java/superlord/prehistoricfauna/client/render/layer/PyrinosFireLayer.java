...
@OnlyIn(Dist.CLIENT)
public class PyrinosFireLayer extends AbstractHenosGlowLayer<Pyrinos, PyrinosModel> {
	private static final RenderType RENDER_TYPE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/pyrinos/pyrinos_fire.png"));

	public PyrinosFireLayer(RenderLayerParent<Pyrinos, PyrinosModel> rendererIn) {
		super(rendererIn);
	}
