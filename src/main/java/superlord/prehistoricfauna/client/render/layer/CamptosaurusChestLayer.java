...
public class CamptosaurusChestLayer extends RenderLayer<Camptosaurus, EntityModel<Camptosaurus>> {
	
	private static final RenderType TEXTURE = RenderType.entityCutoutNoCull(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/camptosaurus/camptosaurus_chest_layer.png"));
	private final RenderLayerParent<Camptosaurus, EntityModel<Camptosaurus>> camptosaurusRenderer;
	
	public CamptosaurusChestLayer(RenderLayerParent<Camptosaurus, EntityModel<Camptosaurus>> camptosaurusRenderer) {
