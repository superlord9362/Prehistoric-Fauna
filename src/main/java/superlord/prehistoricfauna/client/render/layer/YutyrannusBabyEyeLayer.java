...
public class YutyrannusBabyEyeLayer extends RenderLayer<Yutyrannus, EntityModel<Yutyrannus>> {
	
	private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/yutyrannus/yutyrannus_baby_eyeglow.png"));
	private final RenderLayerParent<Yutyrannus, EntityModel<Yutyrannus>> yutyrannusRenderer;
	
	public YutyrannusBabyEyeLayer(RenderLayerParent<Yutyrannus, EntityModel<Yutyrannus>> rendererIn) {
		super(rendererIn);
