...
public class SinraptorBabyEyeLayer extends RenderLayer<Sinraptor, EntityModel<Sinraptor>> {
	...
	private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/sinraptor/sinraptor_baby_eyeglow.png"));
