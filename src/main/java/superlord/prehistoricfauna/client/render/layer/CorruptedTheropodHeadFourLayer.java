...
public class CorruptedTheropodHeadFourLayer extends RenderLayer<CorruptedTheropod, CorruptedTheropodModel> {
	...
	private static final RenderType TEXTURE = RenderType.entityCutoutNoCull(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/corrupted_theropod/head_four_overlay.png"));
