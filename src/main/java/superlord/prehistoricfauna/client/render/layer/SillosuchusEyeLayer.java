...
public class SillosuchusEyeLayer extends RenderLayer<Sillosuchus, EntityModel<Sillosuchus>> {
	...
	public SillosuchusEyeLayer(RenderLayerParent<Sillosuchus, EntityModel<Sillosuchus>> rendererIn) {
		super(rendererIn);
