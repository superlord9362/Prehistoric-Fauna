...
public class SillosuchusEyeLayer extends RenderLayer<Sillosuchus, EntityModel<Sillosuchus>> {
	...
	private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/sillosuchus/sillosuchus_eyeglow.png"));
