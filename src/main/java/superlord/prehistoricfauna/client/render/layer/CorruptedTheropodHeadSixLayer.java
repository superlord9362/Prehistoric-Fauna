...
public class CorruptedTheropodHeadSixLayer extends RenderLayer<CorruptedTheropod, CorruptedTheropodModel> {
	...
	private static final RenderType TEXTURE = RenderType.entityCutoutNoCull(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/corrupted_theropod/head_six_overlay.png"));
