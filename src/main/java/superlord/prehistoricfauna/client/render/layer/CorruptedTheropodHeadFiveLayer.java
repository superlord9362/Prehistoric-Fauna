...
public class CorruptedTheropodHeadFiveLayer extends RenderLayer<CorruptedTheropod, CorruptedTheropodModel> {
	...
	private static final RenderType TEXTURE = RenderType.entityCutoutNoCull(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entities/corrupted_theropod/head_five_overlay.png"));
