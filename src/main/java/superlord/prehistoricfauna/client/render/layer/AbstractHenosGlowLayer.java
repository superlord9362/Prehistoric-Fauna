...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractHenosGlowLayer<T extends Entity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
   public AbstractHenosGlowLayer(IEntityRenderer<T, M> p_i226039_1_) {
      super(p_i226039_1_);
   }
