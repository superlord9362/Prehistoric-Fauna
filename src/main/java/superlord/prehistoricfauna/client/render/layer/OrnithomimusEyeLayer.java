...
public class OrnithomimusEyeLayer extends RenderLayer<Ornithomimus, EntityModel<Ornithomimus>> {
	...
	private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/ornithomimus/ornithomimus_eyeglow.png"));
