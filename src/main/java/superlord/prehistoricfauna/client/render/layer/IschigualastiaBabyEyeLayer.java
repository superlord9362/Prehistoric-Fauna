...
public class IschigualastiaBabyEyeLayer extends RenderLayer<Ischigualastia, EntityModel<Ischigualastia>> {
	...
	private static final RenderType TEXTURE = RenderType.eyes(new ResourceLocation(PrehistoricFauna.MOD_ID, "textures/entity/ischigualastia/ischigualastia_baby_eyeglow.png"));
