...
public class PFChestTileEntityRenderer<T extends TileEntity & IChestLid> extends TileEntityRenderer<T> {
	...
	public PFChestTileEntityRenderer(TileEntityRendererDispatcher rendererDispatcherIn) {
