...
public class BlockEggIncubator extends BlockBase

{
	...
	public BlockEggIncubator(String name) 
...

	{
		...
		return new ItemStack(ModBlocks.EGG_INCUBATOR);
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        else
        {
            ...
            if (tileentity instanceof TileEntityEggIncubator)
            {
                playerIn.displayGUIChest((TileEntityEggIncubator)tileentity);
