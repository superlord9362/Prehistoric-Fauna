...
public class JurassicPointOfInterest {
    private static final List<PointOfInterestType> POINTS_OF_INTEREST = new ArrayList<>();
    public static final PointOfInterestType JURASSIC_PORTAL = register("jurassic_portal", getAllStates(BlockInit.JURASSIC_PORTAL), 0, 1);
