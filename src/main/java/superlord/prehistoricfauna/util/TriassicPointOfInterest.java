...
public class TriassicPointOfInterest {
    private static final List<PointOfInterestType> POINTS_OF_INTEREST = new ArrayList<>();
    public static final PointOfInterestType TRIASSIC_PORTAL = register("triassic_portal", getAllStates(BlockInit.TRIASSIC_PORTAL), 0, 1);
