...
import superlord.prehistoricfauna.client.gui.Container_DNACombiner;
import superlord.prehistoricfauna.client.gui.GUICultivate;
import superlord.prehistoricfauna.client.gui.GUI_DNACombiner;
...
public class GUIHandler implements IGuiHandler {
	...
	public Object getServerGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
		...
		if (ID == Reference.GUI_DNA_COMBINER) return new Container_DNACombiner(player.inventory, (TileEntityDNACombiner)world.getTileEntity(new BlockPos(x,y,z)));
		return null;
	}
	...
	public Object getClientGuiElement(int ID, EntityPlayer player, World world, int x, int y, int z) {
        ...
        if (ID == Reference.GUI_DNA_COMBINER) return new GUI_DNACombiner(player.inventory, (TileEntityDNACombiner)world.getTileEntity(new BlockPos(x,y,z)));
		return null;
	}
