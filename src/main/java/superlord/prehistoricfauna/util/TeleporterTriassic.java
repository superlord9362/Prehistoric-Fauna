...
public class TeleporterTriassic implements ITeleporter {
    ...
    public boolean placeInPortal(ServerWorld world, Entity entity, float yaw) {
        ...
        BlockPattern.PortalInfo pattern = TeleporterTriassic.placeInExistingPortal(world, new BlockPos(entity.getPosX(), entity.getPosY(), entity.getPosZ()), entity.getMotion(), direction, vec3d.x, vec3d.y, entity instanceof PlayerEntity);
        if (pattern == null) {
            return false;
        } else {
