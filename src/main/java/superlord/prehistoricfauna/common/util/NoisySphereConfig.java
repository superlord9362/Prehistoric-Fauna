...
public class NoisySphereConfig implements FeatureConfiguration {
   ...
   public static final Codec<NoisySphereConfig> CODEC = RecordCodecBuilder.create((codecRecorder) -> {
    ...
    public static class Builder {
        private BlockStateProvider blockProvider = BlockStateProvider.simple(Blocks.STONE.defaultBlockState());
        private BlockStateProvider topBlockProvider = BlockStateProvider.simple(Blocks.STONE.defaultBlockState());
        ...
        private double noiseFrequency = 0.025F;

        public Builder setBlock(Block block) {
            if (block != null)
                blockProvider = BlockStateProvider.simple(block.defaultBlockState());
            else
                blockProvider = BlockStateProvider.simple(Blocks.STONE.defaultBlockState());
            return this;
        }

        public Builder setBlock(BlockState state) {
            if (state != null)
                blockProvider = BlockStateProvider.simple(state);
            else
                blockProvider = BlockStateProvider.simple(Blocks.STONE.defaultBlockState());
            return this;
        }
