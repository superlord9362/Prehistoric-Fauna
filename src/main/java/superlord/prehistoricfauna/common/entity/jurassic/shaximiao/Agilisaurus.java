...
public class Agilisaurus extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(8, new AvoidEntityGoal<LivingEntity>(this, LivingEntity.class, 7F, 1.5D, 1.75D, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.AGILISAURUS_AVOIDING);
		}));
	...
	protected SoundEvent getAmbientSound() {
		return this.isAsleep() ? null : PFSounds.AGILISAURUS_IDLE.get();
	}

	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
		return PFSounds.AGILISAURUS_HURT.get();
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
		Agilisaurus entity = new Agilisaurus(PFEntities.AGILISAURUS.get(), this.level());
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.AGILISAURUS_SPAWN_EGG.get());
	}

	public Item getEggItem() {
		return PFItems.AGILISAURUS_EGG.get();
	}

	public BlockState getEggBlock(Level world, BlockPos pos) {
		return PFBlocks.AGILISAURUS_EGG.get().defaultBlockState().setValue(DinosaurEggBlock.EGGS, Integer.valueOf(this.random.nextInt(4) + 1));
	}
