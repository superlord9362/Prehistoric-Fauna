...
public class Sinraptor extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Sinraptor.MeleeAttackGoal());
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem) {
			if (!itemstack.getTag().contains("Pages", EnumPaleoPages.SINRAPTOR.ordinal())) {
	...
	class MeleeAttackGoal extends net.minecraft.world.entity.ai.goal.MeleeAttackGoal {
		public MeleeAttackGoal() {
			super(Sinraptor.this, 1.25D, true);
		}
