...
public class Eilenodon extends BurrowingDinosaur {
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem) {
            ...
            if (!already.contains(EnumPaleoPages.EILENODON.ordinal())) {
				...
				player.displayClientMessage(Component.translatable("paleopedia.eilenodon_already_added"), true);
				return InteractionResult.SUCCESS;
			}
		}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(8, new AvoidEntityGoal<LivingEntity>(this, LivingEntity.class, 7F, 1.5D, 1.75D, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.EILENODON_AVOIDING);
		}));
