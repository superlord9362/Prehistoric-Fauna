...
public class Gigantspinosaurus extends DinosaurEntity {
	private int maxHunger = 100;
	private int warningSoundTicks;

	public Gigantspinosaurus(EntityType<? extends Gigantspinosaurus> p_21803_, Level p_21804_) {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new Gigantspinosaurus.MeleeAttackGoal());
		...
		this.goalSelector.addGoal(8, new AvoidEntityGoal<LivingEntity>(this, LivingEntity.class, 7F, 1.5D, 1.75D, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.GIGANTSPINOSAURUS_AVOIDING);
		}));
	}
	...
	protected SoundEvent getAmbientSound() {
		return this.isAsleep() ? null : PFSounds.GIGANTSPINOSAURUS_IDLE.get();
	}

	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
		return PFSounds.GIGANTSPINOSAURUS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.GIGANTSPINOSAURUS_DEATH.get();
	}
	...
	protected void playWarningSound() {
		if (this.warningSoundTicks <= 0) {
			this.playSound(PFSounds.GIGANTSPINOSAURUS_WARN.get(), 1.0F, this.getVoicePitch());
	...
	class MeleeAttackGoal extends net.minecraft.world.entity.ai.goal.MeleeAttackGoal {
		public MeleeAttackGoal() {
			super(Gigantspinosaurus.this, 1.25D, true);
		}
		...
		protected void checkAndPerformAttack(LivingEntity enemy, double distToEnemySqr) {
			...
			if (distToEnemySqr <= d0 && this.isTimeToAttack()) {
				...
				if (this.getTicksUntilNextAttack() <= 10) {
					Gigantspinosaurus.this.playWarningSound();
				}
			} else {
				this.resetAttackCooldown();
			}
	...
	public AgeableMob getBreedOffspring(ServerLevel p_241840_1_, AgeableMob p_241840_2_) {
		Gigantspinosaurus entity = new Gigantspinosaurus(PFEntities.GIGANTSPINOSAURUS.get(), this.level());
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.GIGANTSPINOSAURUS_SPAWN_EGG.get());
	}
	
	public Item getEggItem() {
		return PFItems.GIGANTSPINOSAURUS_EGG.get();
	}
    
	public BlockState getEggBlock(Level world, BlockPos pos) {
		return PFBlocks.GIGANTSPINOSAURUS_EGG.get().defaultBlockState().setValue(DinosaurEggBlock.EGGS, Integer.valueOf(this.random.nextInt(4) + 1));
	}
