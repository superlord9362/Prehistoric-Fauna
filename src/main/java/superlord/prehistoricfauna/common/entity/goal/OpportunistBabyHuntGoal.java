...
public class OpportunistBabyHuntGoal extends NearestAttackableTargetGoal {
	...
	public OpportunistBabyHuntGoal(DinosaurEntity goalOwnerIn, Class targetClassIn, int targetChanceIn, double huntSpeed, boolean checkSight, boolean nearbyOnly, @Nullable Predicate<LivingEntity> targetPredicate) {
