...
public class OvivoreEatFromFeederGoal extends MoveToBlockGoal {
	DinosaurEntity dinosaur;
	protected int field_220731_g;

	public OvivoreEatFromFeederGoal(DinosaurEntity dinosaur, double p_i50737_2_, int p_i50737_4_, int p_i50737_5_) {
