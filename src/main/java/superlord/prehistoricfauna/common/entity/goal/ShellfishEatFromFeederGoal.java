...
public class ShellfishEatFromFeederGoal extends MoveToBlockGoal {
	DinosaurEntity dinosaur;
	protected int field_220731_g;

	public ShellfishEatFromFeederGoal(DinosaurEntity dinosaur, double p_i50737_2_, int p_i50737_4_, int p_i50737_5_) {
	...
	protected boolean isValidTarget(LevelReader worldIn, BlockPos pos) {
		...
		return blockstate.getBlock() instanceof FeederBlock && (blockstate.getValue(FeederBlock.SHELLFISH) == true || blockstate.getValue(FeederBlock.MEAT) == true);
	}
