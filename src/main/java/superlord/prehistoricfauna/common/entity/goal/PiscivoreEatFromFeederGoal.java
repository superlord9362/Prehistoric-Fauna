...
public class PiscivoreEatFromFeederGoal extends MoveToBlockGoal {
	...
	public PiscivoreEatFromFeederGoal(DinosaurEntity dinosaur, double p_i50737_2_, int p_i50737_4_, int p_i50737_5_) {
	...
	protected boolean isValidTarget(LevelReader worldIn, BlockPos pos) {
		...
		return blockstate.getBlock() instanceof FeederBlock && (blockstate.getValue(FeederBlock.FISH) == true || blockstate.getValue(FeederBlock.MEAT) == true);
	}
