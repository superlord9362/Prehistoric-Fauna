...
public class BrachiosaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(BrachiosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(BrachiosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public BrachiosaurusSkull(EntityType<? extends BrachiosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level(), this.blockPosition(), new ItemStack(PFItems.BRACHIOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		BrachiosaurusSkull entity;
		
		public LookAtPlayerGoal(BrachiosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.BRACHIOSAURUS_SKULL.get());
	}
