...
public class CoelophysisSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(CoelophysisSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(CoelophysisSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public CoelophysisSkull(EntityType<? extends CoelophysisSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.COELOPHYSIS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		CoelophysisSkull entity;
		
		public LookAtPlayerGoal(CoelophysisSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
