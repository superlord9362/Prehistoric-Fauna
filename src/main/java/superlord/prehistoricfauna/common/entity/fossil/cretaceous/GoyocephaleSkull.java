...
public class GoyocephaleSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(GoyocephaleSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(GoyocephaleSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public GoyocephaleSkull(EntityType<? extends GoyocephaleSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level(), this.blockPosition(), new ItemStack(PFItems.GOYOCEPHALE_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		GoyocephaleSkull entity;
		
		public LookAtPlayerGoal(GoyocephaleSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.GOYOCEPHALE_SKULL.get());
	}
