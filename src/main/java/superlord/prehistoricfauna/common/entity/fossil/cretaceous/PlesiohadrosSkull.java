...
public class PlesiohadrosSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(PlesiohadrosSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(PlesiohadrosSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public PlesiohadrosSkull(EntityType<? extends PlesiohadrosSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.PLESIOHADROS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		PlesiohadrosSkull entity;
		
		public LookAtPlayerGoal(PlesiohadrosSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
