...
public class AnzuSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(AnzuSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(AnzuSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public AnzuSkull(EntityType<? extends AnzuSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level(), this.blockPosition(), new ItemStack(PFItems.ANZU_SKULL.get()));
	}
	...
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {
		...
		public LookAtPlayerGoal(AnzuSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.ANZU_SKULL.get());
	}
