...
public class TyrannosaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(TyrannosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(TyrannosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public TyrannosaurusSkull(EntityType<? extends TyrannosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.TYRANNOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		TyrannosaurusSkull entity;
		
		public LookAtPlayerGoal(TyrannosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
