...
public class ScelidosaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(ScelidosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(ScelidosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public ScelidosaurusSkull(EntityType<? extends ScelidosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.SCELIDOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		ScelidosaurusSkull entity;
		
		public LookAtPlayerGoal(ScelidosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
