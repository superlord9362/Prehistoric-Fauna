...
public class DesmatosuchusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(DesmatosuchusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(DesmatosuchusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public DesmatosuchusSkull(EntityType<? extends DesmatosuchusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.DESMATOSUCHUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		DesmatosuchusSkull entity;
		
		public LookAtPlayerGoal(DesmatosuchusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
