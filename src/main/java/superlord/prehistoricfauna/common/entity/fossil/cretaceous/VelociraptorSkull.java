...
public class VelociraptorSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(VelociraptorSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(VelociraptorSkull.class, EntityDataSerializers.BOOLEAN);
	...
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {
		...
		VelociraptorSkull entity;
		
		public LookAtPlayerGoal(VelociraptorSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
