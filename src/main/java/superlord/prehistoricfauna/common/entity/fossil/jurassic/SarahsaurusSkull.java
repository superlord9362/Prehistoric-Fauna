...
public class SarahsaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(SarahsaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(SarahsaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public SarahsaurusSkull(EntityType<? extends SarahsaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.SARAHSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		SarahsaurusSkull entity;
		
		public LookAtPlayerGoal(SarahsaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
