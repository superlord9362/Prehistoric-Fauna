...
public class AllosaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(AllosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(AllosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public AllosaurusSkull(EntityType<? extends AllosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.ALLOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		AllosaurusSkull entity;
		
		public LookAtPlayerGoal(AllosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
