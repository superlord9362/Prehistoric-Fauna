...
public class TriceratopsSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(TriceratopsSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(TriceratopsSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public TriceratopsSkull(EntityType<? extends TriceratopsSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.TRICERATOPS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		TriceratopsSkull entity;
		
		public LookAtPlayerGoal(TriceratopsSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
