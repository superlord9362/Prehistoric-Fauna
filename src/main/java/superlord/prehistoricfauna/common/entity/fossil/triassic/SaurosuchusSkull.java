...
public class SaurosuchusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(SaurosuchusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(SaurosuchusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public SaurosuchusSkull(EntityType<? extends SaurosuchusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.SAUROSUCHUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		SaurosuchusSkull entity;
		
		public LookAtPlayerGoal(SaurosuchusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
