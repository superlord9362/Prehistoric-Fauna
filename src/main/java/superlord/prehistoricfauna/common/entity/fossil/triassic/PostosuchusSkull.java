...
public class PostosuchusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(PostosuchusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(PostosuchusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public PostosuchusSkull(EntityType<? extends PostosuchusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.POSTOSUCHUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		PostosuchusSkull entity;
		
		public LookAtPlayerGoal(PostosuchusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
