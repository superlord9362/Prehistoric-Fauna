...
public class CeratosaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(CeratosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(CeratosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public CeratosaurusSkull(EntityType<? extends CeratosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.CERATOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		CeratosaurusSkull entity;
		
		public LookAtPlayerGoal(CeratosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
