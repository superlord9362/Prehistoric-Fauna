...
public class ProtoceratopsSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(ProtoceratopsSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(ProtoceratopsSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public ProtoceratopsSkull(EntityType<? extends ProtoceratopsSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.PROTOCERATOPS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		ProtoceratopsSkull entity;
		
		public LookAtPlayerGoal(ProtoceratopsSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
