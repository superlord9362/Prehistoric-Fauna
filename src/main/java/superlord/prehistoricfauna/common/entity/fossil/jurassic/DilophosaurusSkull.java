...
public class DilophosaurusSkull extends PrehistoricEntity {
	...
	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(DilophosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(DilophosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public DilophosaurusSkull(EntityType<? extends DilophosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level, this.blockPosition(), new ItemStack(PFItems.DILOPHOSAURUS_SKULL.get()));
	}
	...
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {
		...
		public LookAtPlayerGoal(DilophosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
