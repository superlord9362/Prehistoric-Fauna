...
public class YutyrannusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(YutyrannusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(YutyrannusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public YutyrannusSkull(EntityType<? extends YutyrannusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level(), this.blockPosition(), new ItemStack(PFItems.YUTYRANNUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		YutyrannusSkull entity;
		
		public LookAtPlayerGoal(YutyrannusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.YUTYRANNUS_SKULL.get());
	}
