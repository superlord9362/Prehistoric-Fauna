...
public class LiaoningosaurusSkull extends PrehistoricEntity {

	private static final EntityDataAccessor<Boolean> PUSHING = SynchedEntityData.defineId(LiaoningosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	private static final EntityDataAccessor<Boolean> LOOKING = SynchedEntityData.defineId(LiaoningosaurusSkull.class, EntityDataSerializers.BOOLEAN);
	...
	public LiaoningosaurusSkull(EntityType<? extends LiaoningosaurusSkull> type, Level worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
	      Block.popResource(this.level(), this.blockPosition(), new ItemStack(PFItems.LIAONINGOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends net.minecraft.world.entity.ai.goal.LookAtPlayerGoal {

		LiaoningosaurusSkull entity;
		
		public LookAtPlayerGoal(LiaoningosaurusSkull entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.LIAONINGOSAURUS_SKULL.get());
	}
