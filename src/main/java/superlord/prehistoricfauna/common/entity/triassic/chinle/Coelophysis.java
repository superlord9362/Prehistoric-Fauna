...
public class Coelophysis extends HerdDinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(4, new HuntGoal(this, LivingEntity.class, 10, false, false, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.COELOPHYSIS_HUNTING);
		}));
		...
		this.goalSelector.addGoal(8, new AvoidEntityGoal<LivingEntity>(this, LivingEntity.class, 7F, 1.5D, 1.75D, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.COELOPHYSIS_AVOIDING);
		}));
		...
		this.targetSelector.addGoal(0, new BabyCarnivoreHuntGoal(this, LivingEntity.class, 10, 1.75D, true, false, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.COELOPHYSIS_BABY_HUNTING);
		}));
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem) {
            ...
            if (!already.contains(EnumPaleoPages.COELOPHYSIS.ordinal())) {
				EnumPaleoPages.addPage(EnumPaleoPages.fromInt(EnumPaleoPages.COELOPHYSIS.ordinal()), itemstack);
				player.displayClientMessage(Component.translatable("paleopedia.coelophysis_added"), true);
				return InteractionResult.SUCCESS;
			} else {
				player.displayClientMessage(Component.translatable("paleopedia.coelophysis_already_added"), true);
				return InteractionResult.SUCCESS;
			}
		}
	...
	public Item getEggItem() {
		return PFItems.COELOPHYSIS_EGG.get();
	}
