...
public class Poposaurus extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(8, new AvoidEntityGoal<LivingEntity>(this, LivingEntity.class, 7F, 1.5D, 1.75D, (p_213487_0_) -> {
			return p_213487_0_.getType().is(PFTags.POPOSAURUS_AVOIDING);
		}));
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem) {
            ...
            if (!already.contains(EnumPaleoPages.POPOSAURUS.ordinal())) {
				...
				player.displayClientMessage(Component.translatable("paleopedia.poposaurus_already_added"), true);
				return InteractionResult.SUCCESS;
			}
		}
	...
	public BlockState getEggBlock(Level world, BlockPos pos) {
		return PFBlocks.POPOSAURUS_EGG.get().defaultBlockState().setValue(DinosaurEggBlock.EGGS, Integer.valueOf(this.random.nextInt(4) + 1));
	}
