...
public class Protoceratops extends BurrowingDinosaur {
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem) {
            ...
            if (!already.contains(EnumPaleoPages.PROTOCERATOPS.ordinal())) {
				...
				player.displayClientMessage(Component.translatable("paleopedia.protoceratops_already_added"), true);
				return InteractionResult.SUCCESS;
			}
		}
