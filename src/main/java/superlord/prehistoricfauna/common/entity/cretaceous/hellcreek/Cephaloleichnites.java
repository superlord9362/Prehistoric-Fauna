...
public class Cephaloleichnites extends WallClimbingBug {
	...
	protected void registerGoals() {
	    super.registerGoals();
	    this.goalSelector.addGoal(1, new BugAvoidGoal(this, 7F, 1.5D, 1.75D, PFTags.CEPHALOLEICHNITES_AVOIDING));
	}
