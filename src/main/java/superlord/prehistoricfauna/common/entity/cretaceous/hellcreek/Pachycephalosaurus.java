...
public class Pachycephalosaurus extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(0, new Pachycephalosaurus.MeleeAttackGoal());
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem) {
            ...
            if (!already.contains(EnumPaleoPages.PACHYCEPHALOSAURUS.ordinal())) {
				EnumPaleoPages.addPage(EnumPaleoPages.fromInt(EnumPaleoPages.PACHYCEPHALOSAURUS.ordinal()), itemstack);
				player.displayClientMessage(Component.translatable("paleopedia.pachycephalosaurus_added"), true);
				return InteractionResult.SUCCESS;
			} else {
				player.displayClientMessage(Component.translatable("paleopedia.pachycephalosaurus_already_added"), true);
				return InteractionResult.SUCCESS;
			}
		}
	...
	public Item getEggItem() {
		return PFItems.PACHYCEPHALOSAURUS_EGG.get();
	}

	public BlockState getEggBlock(Level world, BlockPos pos) {
		return PFBlocks.PACHYCEPHALOSAURUS_EGG.get().defaultBlockState().setValue(DinosaurEggBlock.EGGS, Integer.valueOf(this.random.nextInt(4) + 1));
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.PACHYCEPHALOSAURUS_SPAWN_EGG.get());
	}
	...
	class RamGoal extends net.minecraft.world.entity.ai.goal.MeleeAttackGoal {
		...
		public void stop() {
			Pachycephalosaurus.this.setRamming(false);
			super.stop();
		}
