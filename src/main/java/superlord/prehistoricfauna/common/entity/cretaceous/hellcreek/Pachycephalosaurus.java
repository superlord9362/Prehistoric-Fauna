...
public class Pachycephalosaurus extends DinosaurEntity {
	...
	public InteractionResult mobInteract(Player player, InteractionHand hand) {
		...
		if (item instanceof PaleopediaItem paleopedia) {
			if (!itemstack.getTag().contains("Pages", EnumPaleoPages.PACHYCEPHALOSAURUS.ordinal())) {
	...
	public BlockState getEggBlock(Level world, BlockPos pos) {
		return PFBlocks.PACHYCEPHALOSAURUS_NEST.get().defaultBlockState().setValue(NestAndEggsBlock.EGGS, Integer.valueOf(this.random.nextInt(4) + 1)).setValue(NestAndEggsBlock.PLANT_LEVEL, Integer.valueOf(this.random.nextInt(3) + 1));
	}
