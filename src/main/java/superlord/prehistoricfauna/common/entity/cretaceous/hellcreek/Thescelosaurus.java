...
public class Thescelosaurus extends BurrowingDinosaur {
	...
	public InteractionResult mobInteract(Player p_230254_1_, InteractionHand p_230254_2_) {
		...
		if (item instanceof PaleopediaItem) {
            ...
            if (!already.contains(EnumPaleoPages.THESCELOSAURUS.ordinal())) {
				...
				p_230254_1_.displayClientMessage(Component.translatable("paleopedia.thescelosaurus_already_added"), true);
				return InteractionResult.SUCCESS;
			}
		}
