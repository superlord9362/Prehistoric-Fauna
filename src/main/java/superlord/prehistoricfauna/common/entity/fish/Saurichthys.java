...
public class Saurichthys extends AbstractFish {

	public Saurichthys(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.SAURICHTHYS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.SAURICHTHYS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.SAURICHTHYS_SPAWN_EGG.get());
	}
}
