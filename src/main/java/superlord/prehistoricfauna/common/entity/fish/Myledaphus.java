...
public class Myledaphus extends AbstractBottomDwellerFish {

	public Myledaphus(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.MYLEDAPHUS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.MYLEDAPHUS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.MYLEDAPHUS_SPAWN_EGG.get());
	}
}
