...
import superlord.prehistoricfauna.common.entity.AbstractBottomDwellerFish;
import superlord.prehistoricfauna.init.PFItems;
import superlord.prehistoricfauna.init.PFSounds;

public class Toarcibatis extends AbstractBottomDwellerFish {

	public Toarcibatis(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.TOARCIBATIS_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.TOARCIBATIS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.TOARCIBATIS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.TOARCIBATIS_SPAWN_EGG.get());
	}
}
