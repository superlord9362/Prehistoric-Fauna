...
public class Parapsephurus extends AbstractFish {

	public Parapsephurus(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.PARAPSEPHURUS_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.PARAPSEPHURUS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.PARAPSEPHURUS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.PARAPSEPHURUS_SPAWN_EGG.get());
	}
}
