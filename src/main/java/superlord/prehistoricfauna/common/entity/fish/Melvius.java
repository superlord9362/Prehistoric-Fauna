...
public class Melvius extends AbstractFish {

	public Melvius(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.MELVIUS_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.MELVIUS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.MELVIUS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.MELVIUS_SPAWN_EGG.get());
	}
}
