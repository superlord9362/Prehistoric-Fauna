...
public class Sinamia extends AbstractSchoolingFish {
	public Sinamia(EntityType<? extends Sinamia> p_28276_, Level p_28277_) {
		super(p_28276_, p_28277_);
	}

	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.SINAMIA_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.SINAMIA_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.SINAMIA_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.SINAMIA_SPAWN_EGG.get());
	}
}
