...
public class Gar extends AbstractFish {
	...
	public Gar(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.GAR_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.GAR_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.GAR_SPAWN_EGG.get());
	}
}
