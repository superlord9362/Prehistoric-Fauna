...
public class Morrolepis extends AbstractSchoolingFish {
	
	public Morrolepis(EntityType<? extends AbstractSchoolingFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.MORROLEPIS_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.MORROLEPIS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.MORROLEPIS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.MORROLEPIS_SPAWN_EGG.get());
	}
}
