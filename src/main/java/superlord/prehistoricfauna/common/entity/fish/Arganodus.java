...
public class Arganodus extends AbstractFish {

	public Arganodus(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.ARGANODUS_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.ARGANODUS_HURT;
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.ARGANODUS_DEATH;
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.ARGANODUS_SPAWN_EGG.get());
	}
}
