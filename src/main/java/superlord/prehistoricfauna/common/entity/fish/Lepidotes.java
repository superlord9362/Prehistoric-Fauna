...
public class Lepidotes extends AbstractFish {

	public Lepidotes(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.LEPIDOTES_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.LEPIDOTES_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.LEPIDOTES_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.LEPIDOTES_SPAWN_EGG.get());
	}
}
