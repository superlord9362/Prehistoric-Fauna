...
public class Cyclurus extends AbstractFish {

	public Cyclurus(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.CYCLURUS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.CYCLURUS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.CYCLURUS_SPAWN_EGG.get());
	}
}
