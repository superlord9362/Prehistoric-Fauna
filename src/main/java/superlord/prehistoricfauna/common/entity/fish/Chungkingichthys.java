...
public class Chungkingichthys extends AbstractFish {

	public Chungkingichthys(EntityType<? extends AbstractFish> p_27461_, Level p_27462_) {
	...
	public ItemStack getBucketItemStack() {
		return new ItemStack(PFItems.CHUNGKINGICHTHYS_BUCKET.get());
	}
	...
	protected SoundEvent getHurtSound(DamageSource p_28306_) {
		return PFSounds.CHUNGKINGICHTHYS_HURT.get();
	}

	protected SoundEvent getDeathSound() {
		return PFSounds.CHUNGKINGICHTHYS_DEATH.get();
	}
	...
	public ItemStack getPickedResult(HitResult target) {
		return new ItemStack(PFItems.CHUNGKINGICHTHYS_SPAWN_EGG.get());
	}
}
