...
public class GinkgoParticle extends TextureSheetParticle {
	...
	public GinkgoParticle(ClientLevel p_277612_, double p_278010_, double p_277614_, double p_277673_, SpriteSet p_277465_) {
