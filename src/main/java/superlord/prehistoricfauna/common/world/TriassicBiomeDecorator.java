...
public class TriassicBiomeDecorator {
	...
	public static void onBiomeLoad(BiomeLoadingEvent event) {
		...
		if (name.equals("chinle_river")) {
			...
			if (PrehistoricFaunaConfig.desmatosuchusChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.DESMATOSUCHUS.get(), PrehistoricFaunaConfig.desmatosuchusChinleRiverSpawnWeight, 2, 4));
			if (PrehistoricFaunaConfig.trilophosaurusChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.TRILOPHOSAURUS.get(), PrehistoricFaunaConfig.trilophosaurusChinleRiverSpawnWeight, 1, 3));
	        if (PrehistoricFaunaConfig.chinleaChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(PFEntities.CHINLEA.get(), PrehistoricFaunaConfig.chinleaChinleRiverSpawnWeight, 1, 2));
	        if (PrehistoricFaunaConfig.arganodusChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(PFEntities.ARGANODUS.get(), PrehistoricFaunaConfig.saurichthysChinleRiverSpawnWeight, 1, 2));
	        if (PrehistoricFaunaConfig.mooreodontusChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(PFEntities.MOOREODONTUS.get(), PrehistoricFaunaConfig.saurichthysChinleRiverSpawnWeight, 1, 2));
	        if (PrehistoricFaunaConfig.saurichthysChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(PFEntities.SAURICHTHYS.get(), PrehistoricFaunaConfig.saurichthysChinleRiverSpawnWeight, 1, 2));
			if (PrehistoricFaunaConfig.postosuchusChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.POSTOSUCHUS.get(), PrehistoricFaunaConfig.postosuchusChinleRiverSpawnWeight, 1, 2));
			if (PrehistoricFaunaConfig.placeriasChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.PLACERIAS.get(), PrehistoricFaunaConfig.placeriasChinleRiverSpawnWeight, 1, 4));
			if (PrehistoricFaunaConfig.coelophysisChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.COELOPHYSIS.get(), PrehistoricFaunaConfig.coelophysisChinleRiverSpawnWeight, 1, 3));
			if (PrehistoricFaunaConfig.poposaurusChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.POPOSAURUS.get(), PrehistoricFaunaConfig.poposaurusChinleRiverSpawnWeight, 1, 2));
			if (PrehistoricFaunaConfig.typothoraxChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.TYPOTHORAX.get(), PrehistoricFaunaConfig.typothoraxChinleRiverSpawnWeight, 1, 4));
	        if (PrehistoricFaunaConfig.lonchidionChinleRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(PFEntities.LONCHIDION.get(), PrehistoricFaunaConfig.lonchidionChinleRiverSpawnWeight, 1, 2));
		}
		if (name.equals("ischigualasto_river")) {
			PFPlacedFeatures.withIschigualastoVegetation(builder);
			if (PrehistoricFaunaConfig.exaeretodonIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.EXAERETODON.get(), PrehistoricFaunaConfig.exaeretodonIschigualastoRiverSpawnWeight, 1, 3));
			if (PrehistoricFaunaConfig.chromogisaurusIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CHROMOGISAURUS.get(), PrehistoricFaunaConfig.chromogisaurusIschigualastoRiverSpawnWeight, 1, 4));
			if (PrehistoricFaunaConfig.herrerasaurusIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.HERRERASAURUS.get(), PrehistoricFaunaConfig.herrerasaurusIschigualastoRiverSpawnWeight, 1, 2));
			if (PrehistoricFaunaConfig.hyperodapedonIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.HYPERODAPEDON.get(), PrehistoricFaunaConfig.hyperodapedonIschigualastoRiverSpawnWeight, 2, 4));
			if (PrehistoricFaunaConfig.sillosuchusIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.SILLOSUCHUS.get(), PrehistoricFaunaConfig.sillosuchusIschigualastoRiverSpawnWeight, 1, 3));
			if (PrehistoricFaunaConfig.saurosuchusIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.SAUROSUCHUS.get(), PrehistoricFaunaConfig.saurosuchusIschigualastoRiverSpawnWeight, 1, 2));
			if (PrehistoricFaunaConfig.ischigualastiaIschigualastoRiverSpawnWeight != 0) event.getSpawns().addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.ISCHIGUALASTIA.get(), PrehistoricFaunaConfig.ischigualastiaIschigualastoRiverSpawnWeight, 2, 5));
