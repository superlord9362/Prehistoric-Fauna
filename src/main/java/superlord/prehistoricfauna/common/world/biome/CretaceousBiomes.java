...
public class CretaceousBiomes {
	...
	public static Biome hellCreekHardwoodForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.cephaloleichnitesHellCreekHardwoodForestSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CEPHALOLEICHNITES.get(), PrehistoricFaunaConfig.cephaloleichnitesHellCreekHardwoodForestSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.thoracosaurusHellCreekHardwoodForestSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.THORACOSAURUS.get(), PrehistoricFaunaConfig.thoracosaurusHellCreekHardwoodForestSpawnWeight, 1, 2));
		...
		return biome(true, 0x7C5D48, 0x6B4E3B, 0x7ebf9f, 12638463, 0.8F, 0.7F, spawnSettings, biomeFeatures);
	}
	...
	public static Biome hellCreekClearing(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.cephaloleichnitesHellCreekClearingSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CEPHALOLEICHNITES.get(), PrehistoricFaunaConfig.cephaloleichnitesHellCreekClearingSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.thoracosaurusHellCreekClearingSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.THORACOSAURUS.get(), PrehistoricFaunaConfig.thoracosaurusHellCreekClearingSpawnWeight, 1, 2));
	...
	public static Biome hellCreekBluffs(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.cephaloleichnitesHellCreekBluffsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CEPHALOLEICHNITES.get(), PrehistoricFaunaConfig.cephaloleichnitesHellCreekBluffsSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.thoracosaurusHellCreekBluffsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.THORACOSAURUS.get(), PrehistoricFaunaConfig.thoracosaurusHellCreekBluffsSpawnWeight, 1, 2));
	...
	public static Biome hellCreekRedwoods(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.cephaloleichnitesHellCreekRedwoodsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CEPHALOLEICHNITES.get(), PrehistoricFaunaConfig.cephaloleichnitesHellCreekRedwoodsSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.thoracosaurusHellCreekRedwoodsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.THORACOSAURUS.get(), PrehistoricFaunaConfig.thoracosaurusHellCreekRedwoodsSpawnWeight, 1, 2));
	...
	public static Biome hellCreekSwamp(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.cephaloleichnitesHellCreekSwampSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CEPHALOLEICHNITES.get(), PrehistoricFaunaConfig.cephaloleichnitesHellCreekSwampSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.thoracosaurusHellCreekSwampSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.THORACOSAURUS.get(), PrehistoricFaunaConfig.thoracosaurusHellCreekSwampSpawnWeight, 1, 1));
	...
	public static Biome hellCreekRiver(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.cephaloleichnitesHellCreekRiverSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CEPHALOLEICHNITES.get(), PrehistoricFaunaConfig.cephaloleichnitesHellCreekRiverSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.thoracosaurusHellCreekRiverSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.THORACOSAURUS.get(), PrehistoricFaunaConfig.thoracosaurusHellCreekRiverSpawnWeight, 1, 2));
	...
	public static Biome djadochtaArroyo(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.dermestidBeetleDjadochtaArroyoSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.DERMESTID_BEETLE.get(), PrehistoricFaunaConfig.dermestidBeetleDjadochtaArroyoSpawnWeight, 1, 3));
		if (PrehistoricFaunaConfig.gobiulusDjadochtaArroyoSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.GOBIULUS.get(), PrehistoricFaunaConfig.gobiulusDjadochtaArroyoSpawnWeight, 1, 1));
	...
	public static Biome djadochtaAlluvialPlains(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.dermestidBeetleDjadochtaAlluvialPlainsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.DERMESTID_BEETLE.get(), PrehistoricFaunaConfig.dermestidBeetleDjadochtaAlluvialPlainsSpawnWeight, 1, 3));
		if (PrehistoricFaunaConfig.gobiulusDjadochtaAlluvialPlainsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.GOBIULUS.get(), PrehistoricFaunaConfig.gobiulusDjadochtaAlluvialPlainsSpawnWeight, 1, 1));
	...
	public static Biome yixianForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.apoclionYixianForestSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.APOCLION.get(), PrehistoricFaunaConfig.apoclionYixianForestSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.cretaraneusYixianForestSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CRETARANEUS.get(), PrehistoricFaunaConfig.cretaraneusYixianForestSpawnWeight, 1, 1));
	...
	public static Biome yixianLakes(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.apoclionYixianLakesSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.APOCLION.get(), PrehistoricFaunaConfig.apoclionYixianLakesSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.cretaraneusYixianLakesSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CRETARANEUS.get(), PrehistoricFaunaConfig.cretaraneusYixianLakesSpawnWeight, 1, 1));
	...
	public static Biome yixianSnowyForest(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.apoclionYixianSnowyForestSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.APOCLION.get(), PrehistoricFaunaConfig.apoclionYixianSnowyForestSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.cretaraneusYixianSnowyForestSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CRETARANEUS.get(), PrehistoricFaunaConfig.cretaraneusYixianSnowyForestSpawnWeight, 1, 1));
	...
	public static Biome yixianSnowyMountains(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		PFPlacedFeatures.withYixianSnowyForestPlants(biomeFeatures);
		BiomeDefaultFeatures.addSurfaceFreezing(biomeFeatures);
		if (PrehistoricFaunaConfig.apoclionYixianSnowyMountainsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.APOCLION.get(), PrehistoricFaunaConfig.apoclionYixianSnowyMountainsSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.cretaraneusYixianSnowyMountainsSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CRETARANEUS.get(), PrehistoricFaunaConfig.cretaraneusYixianSnowyMountainsSpawnWeight, 1, 1));
	...
	public static Biome yixianRegrowth(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		if (PrehistoricFaunaConfig.apoclionYixianRegrowthSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.APOCLION.get(), PrehistoricFaunaConfig.apoclionYixianRegrowthSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.cretaraneusYixianRegrowthSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CRETARANEUS.get(), PrehistoricFaunaConfig.cretaraneusYixianRegrowthSpawnWeight, 1, 1));
	...
	public static Biome yixianVolcano(HolderGetter<PlacedFeature> placedFeatureGetter, HolderGetter<ConfiguredWorldCarver<?>> carverGetter) {
		...
		biomeFeatures.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PFPlacedFeatures.CLUBMOSS);
		PFPlacedFeatures.withYixianRegrowthPlants(biomeFeatures);
		if (PrehistoricFaunaConfig.apoclionYixianVolcanoSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.APOCLION.get(), PrehistoricFaunaConfig.apoclionYixianVolcanoSpawnWeight, 1, 3));
		...
		if (PrehistoricFaunaConfig.cretaraneusYixianVolcanoSpawnWeight != 0)spawnSettings.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(PFEntities.CRETARANEUS.get(), PrehistoricFaunaConfig.cretaraneusYixianVolcanoSpawnWeight, 1, 1));
