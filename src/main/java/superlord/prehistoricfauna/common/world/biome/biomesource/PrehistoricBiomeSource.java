...
public class PrehistoricBiomeSource  extends BiomeSource implements NoiseBiomeSource {
	...
	public static PrehistoricBiomeSource create(HolderGetter<Biome> biome) {
		return new PrehistoricBiomeSource(biome.getOrThrow(PFBiomes.HELL_CREEK_HARDWOOD_FOREST), biome.getOrThrow(PFBiomes.HELL_CREEK_CLEARING), biome.getOrThrow(PFBiomes.HELL_CREEK_BLUFFS), biome.getOrThrow(PFBiomes.HELL_CREEK_REDWOODS), biome.getOrThrow(PFBiomes.HELL_CREEK_SWAMP), biome.getOrThrow(PFBiomes.HELL_CREEK_RIVER), biome.getOrThrow(PFBiomes.DJADOCHTA_DUNES), biome.getOrThrow(PFBiomes.DJADOCHTA_ARROYO), biome.getOrThrow(PFBiomes.DJADOCHTA_ALLUVIAL_PLAINS), biome.getOrThrow(PFBiomes.YIXIAN_FOREST), biome.getOrThrow(PFBiomes.YIXIAN_SNOWY_FOREST), biome.getOrThrow(PFBiomes.YIXIAN_SNOWY_MOUNTAINS), biome.getOrThrow(PFBiomes.YIXIAN_REGROWTH), biome.getOrThrow(PFBiomes.YIXIAN_VOLCANO), biome.getOrThrow(PFBiomes.YIXIAN_LAKES), biome.getOrThrow(PFBiomes.CRETACEOUS_DRIPSTONE_CAVE), biome.getOrThrow(PFBiomes.CRETACEOUS_HENOSTONE_CAVE), biome.getOrThrow(PFBiomes.KAYENTA_DRY_FOREST), biome.getOrThrow(PFBiomes.KAYENTA_BUTTES), biome.getOrThrow(PFBiomes.KAYENTA_DESERT), biome.getOrThrow(PFBiomes.KAYENTA_RIVER), biome.getOrThrow(PFBiomes.MORRISON_SAVANNA), biome.getOrThrow(PFBiomes.MORRISON_HILLS), biome.getOrThrow(PFBiomes.CHINLE_RIVER), biome.getOrThrow(PFBiomes.CHINLE_FLATS), biome.getOrThrow(PFBiomes.CHINLE_SWAMP), biome.getOrThrow(PFBiomes.CHINLE_WOODED_MOUNTAINS), biome.getOrThrow(PFBiomes.ISCHIGUALASTO_RIVER), biome.getOrThrow(PFBiomes.ISCHIGUALASTO_FOREST), biome.getOrThrow(PFBiomes.ISCHIGUALASTO_CLEARING), biome.getOrThrow(PFBiomes.ISCHIGUALASTO_HILLS));
	}

	public PrehistoricBiomeSource(Holder<Biome> hellCreekHardwoodForest, Holder<Biome> hellCreekClearing, Holder<Biome> hellCreekBluffs, Holder<Biome> hellCreekRedwoods, Holder<Biome> hellCreekSwamp, Holder<Biome> hellCreekRiver, Holder<Biome> djadochtaDunes, Holder<Biome> djadochtaArroyo, Holder<Biome> djadochtaAlluvialPlains, Holder<Biome> yixianForest, Holder<Biome> yixianSnowyForest, Holder<Biome> yixianSnowyMountains, Holder<Biome> yixianRegrowth, Holder<Biome> yixianVolcano, Holder<Biome> yixianLakes, Holder<Biome> dripstoneCaves, Holder<Biome> henostoneCaves, Holder<Biome> kayentaDryForest, Holder<Biome> kayentaButtes, Holder<Biome> kayentaDesert, Holder<Biome> kayentaRiver, Holder<Biome> morrisonSavanna, Holder<Biome> morrisonHills, Holder<Biome> chinleRiver, Holder<Biome> chinleFlats, Holder<Biome> chinleSwamp, Holder<Biome> chinleWoodedMountains, Holder<Biome> ischigualastoRiver, Holder<Biome> ischigualastoForest, Holder<Biome> ischigualastoClearing, Holder<Biome> ischigualastoHills) {
	...
	public Holder<Biome> getNoiseBiome(int x, int y, int z) {
		double timelineNoise = timeLineNoise(x, y, z, PrehistoricChunkGenerator.noise);
		double periodNoise = periodNoise(x, y, z, PrehistoricChunkGenerator.noise);
		double tempNoise = tempNoise(x, y, z, PrehistoricChunkGenerator.noise);
		double humidityNoise = humidityNoise(x, y, z, PrehistoricChunkGenerator.noise);
		double hillinessNoise = hillinessNoise(x, y, z, PrehistoricChunkGenerator.noise);
		double caveTimeLineNoise = caveTimeLineNoise(x, y, z, PrehistoricChunkGenerator.noise);
		if (y < 6) {
