...
public class SurfaceDecorators {
	...
	static {
		...
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "hell_creek_clearing"),
				new NoiseBasedSurfaceDecorator(PFBlocks.SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.LOAM.get().defaultBlockState(), PFBlocks.PACKED_LOAM.get().defaultBlockState(), Blocks.CLAY.defaultBlockState(), Blocks.PODZOL.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.GRAVEL.defaultBlockState(), -0.3D, 0.4D, 4, noise));
