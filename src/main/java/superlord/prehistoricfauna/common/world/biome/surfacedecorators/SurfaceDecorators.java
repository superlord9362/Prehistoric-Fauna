...
public class SurfaceDecorators {
	...
	static {
		...
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "morrison_savanna"),
				new NoiseBasedSurfaceDecorator(PFBlocks.SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), Blocks.COARSE_DIRT.defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), Blocks.CLAY.defaultBlockState(), Blocks.SAND.defaultBlockState(), Blocks.SANDSTONE.defaultBlockState(), Blocks.SAND.defaultBlockState(), -0.5D, 0.5D, 4, noise));
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "morrison_sparse_forest"),
				new NoiseBasedSurfaceDecorator(PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), Blocks.DIRT.defaultBlockState(), PFBlocks.MOSSY_DIRT.get().defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.SAND.defaultBlockState(), -0.5D, 0.5D, 4, noise));
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "morrison_gallery_forest"),
				new NoiseBasedSurfaceDecorator(PFBlocks.SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.MOSSY_DIRT.get().defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.DIRT.defaultBlockState(), PFBlocks.LOAM.get().defaultBlockState(), PFBlocks.PACKED_LOAM.get().defaultBlockState(), Blocks.SAND.defaultBlockState(), -0.5D, 0.5D, 4, noise));
		...
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "morrison_upland_forest"),
				new FourNoiseBasedSurfaceDecorator(Blocks.PODZOL.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.DIRT.defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), PFBlocks.LOAM.get().defaultBlockState(), PFBlocks.PACKED_LOAM.get().defaultBlockState(), Blocks.CLAY.defaultBlockState(), Blocks.STONE.defaultBlockState(), Blocks.STONE.defaultBlockState(), Blocks.SAND.defaultBlockState(), -0.2D, 0.3D, 0.6D, 4, noise));
		...
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "shaximiao_arid_lakes"),
				new NoiseBasedSurfaceDecorator(Blocks.PODZOL.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.GRAVEL.defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), Blocks.RED_SAND.defaultBlockState(), Blocks.RED_SANDSTONE.defaultBlockState(), Blocks.RED_SAND.defaultBlockState(), -0.2D, 0.6D, 4, noise));
		...
		register(new ResourceLocation(PrehistoricFauna.MOD_ID, "shaximiao_mountains"),
				new FourNoiseBasedSurfaceDecorator(Blocks.PODZOL.defaultBlockState(), Blocks.DIRT.defaultBlockState(), Blocks.DIRT.defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.HARDENED_SILT.get().defaultBlockState(), PFBlocks.SILT.get().defaultBlockState(), Blocks.RED_SAND.defaultBlockState(), Blocks.RED_SANDSTONE.defaultBlockState(), Blocks.CLAY.defaultBlockState(), Blocks.STONE.defaultBlockState(), Blocks.STONE.defaultBlockState(), Blocks.SAND.defaultBlockState(), -0.2D, 0.3D, 0.6D, 4, noise));
