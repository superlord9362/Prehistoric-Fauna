...
public class PFSpawnEggItem extends SpawnEggItem {
	...
	public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
		if (stack.getItem() == PFItems.THESCELOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.THORACOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.ACIPENSER_SPAWN_EGG.get() || stack.getItem() == PFItems.LONCHIDION_SPAWN_EGG.get() || stack.getItem() == PFItems.MELVIUS_SPAWN_EGG.get() || stack.getItem() == PFItems.ANKYLOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.TRICERATOPS_SPAWN_EGG.get() || stack.getItem() == PFItems.TYRANNOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.DIDELPHODON_SPAWN_EGG.get() || stack.getItem() == PFItems.BASILEMYS_SPAWN_EGG.get() || stack.getItem() == PFItems.DAKOTARAPTOR_SPAWN_EGG.get() || stack.getItem() == PFItems.MYLEDAPHUS_SPAWN_EGG.get() || stack.getItem() == PFItems.GAR_SPAWN_EGG.get() || stack.getItem() == PFItems.CYCLURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.PALAEOSANIWA_SPAWN_EGG.get() || stack.getItem() == PFItems.PACHYCEPHALOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.ORNITHOMIMUS_SPAWN_EGG.get() || stack.getItem() == PFItems.CEPHALOLEICHNITES_SPAWN_EGG.get() || stack.getItem() == PFItems.EDMONTOSAURUS_SPAWN_EGG.get()) {
			...
			tooltip.add(new TranslatableComponent("jurassic").withStyle(ChatFormatting.DARK_GRAY));
		} else if (stack.getItem() == PFItems.YUTYRANNUS_SPAWN_EGG.get() || stack.getItem() == PFItems.PSITTACOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.SINOSAUROPTERYX_SPAWN_EGG.get() || stack.getItem() == PFItems.INCISIVOSAURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.APOCLION_SPAWN_EGG.get() || stack.getItem() == PFItems.CRETARANEUS_SPAWN_EGG.get() || stack.getItem() == PFItems.PROTOPSEPHURUS_SPAWN_EGG.get() || stack.getItem() == PFItems.SINAMIA_SPAWN_EGG.get() || stack.getItem() == PFItems.YANOSTEUS_SPAWN_EGG.get() || stack.getItem() == PFItems.BEIPIAOSAURUS_SPAWN_EGG.get()) {
