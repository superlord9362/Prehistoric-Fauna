...
public class JurassicTimeTotemItem extends Item {

	public JurassicTimeTotemItem(Properties properties) {
		super(properties);
	}
	...
	public InteractionResult useOn(UseOnContext context) {
        ...
        if (canOpenPortal(iworld.getBlockState(blockpos1), iworld, blockpos1)) {
           ...
           BlockState blockstate1 = ((JurassicTimeBlock)PFBlocks.JURASSIC_TIME_BLOCK.get()).defaultBlockState();
	...
	public static boolean canOpenPortal(BlockState existingState, LevelReader worldIn, BlockPos posIn) {
		BlockState blockstate = ((JurassicTimeBlock)PFBlocks.JURASSIC_TIME_BLOCK.get()).defaultBlockState();
		boolean flag = false;
