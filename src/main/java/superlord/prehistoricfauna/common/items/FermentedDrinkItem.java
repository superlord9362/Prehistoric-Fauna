...
public class FermentedDrinkItem extends Item {

	public FermentedDrinkItem(Item.Properties p_42921_) {
		super(p_42921_);
	}

	public ItemStack finishUsingItem(ItemStack p_42923_, Level p_42924_, LivingEntity p_42925_) {
		if (!p_42924_.isClientSide) {
			p_42925_.addEffect(new MobEffectInstance(MobEffects.CONFUSION, 300));
			p_42925_.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 1200));
		}
