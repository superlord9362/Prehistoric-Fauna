...
public class TriassicTimeTotemItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
        ...
        if (canOpenPortal(iworld.getBlockState(blockpos1), iworld, blockpos1)) {
           ...
           BlockState blockstate1 = ((TriassicTimeBlock)PFBlocks.TRIASSIC_TIME_BLOCK.get()).defaultBlockState();
	...
	public static boolean canOpenPortal(BlockState existingState, LevelReader worldIn, BlockPos posIn) {
		BlockState blockstate = ((TriassicTimeBlock)PFBlocks.TRIASSIC_TIME_BLOCK.get()).defaultBlockState();
		boolean flag = false;
