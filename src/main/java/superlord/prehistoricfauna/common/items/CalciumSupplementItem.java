...
public class CalciumSupplementItem extends Item {

	public CalciumSupplementItem(Item.Properties p_42921_) {
		super(p_42921_);
	}

	public ItemStack finishUsingItem(ItemStack p_42923_, Level p_42924_, LivingEntity p_42925_) {
		if (!p_42924_.isClientSide) {
			p_42925_.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 6000));
		}
