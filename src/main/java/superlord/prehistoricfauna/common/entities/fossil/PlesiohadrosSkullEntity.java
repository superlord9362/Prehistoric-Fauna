...
public class PlesiohadrosSkullEntity  extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(PlesiohadrosSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(PlesiohadrosSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public PlesiohadrosSkullEntity(EntityType<? extends PlesiohadrosSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.PLESIOHADROS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		PlesiohadrosSkullEntity entity;
		
		public LookAtPlayerGoal(PlesiohadrosSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.PLESIOHADROS_SKULL.get());
	}
