...
public class VelociraptorSkullEntity extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(VelociraptorSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(VelociraptorSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public VelociraptorSkullEntity(EntityType<? extends VelociraptorSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.VELOCIRAPTOR_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		VelociraptorSkullEntity entity;
		
		public LookAtPlayerGoal(VelociraptorSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
