...
public class AnkylosaurusSkullEntity extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(AnkylosaurusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(AnkylosaurusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public AnkylosaurusSkullEntity(EntityType<? extends AnkylosaurusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.ANKYLOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		AnkylosaurusSkullEntity entity;
		
		public LookAtPlayerGoal(AnkylosaurusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
