...
public class SaurosuchusSkullEntity extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(SaurosuchusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(SaurosuchusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public SaurosuchusSkullEntity(EntityType<? extends SaurosuchusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.SAUROSUCHUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		SaurosuchusSkullEntity entity;
		
		public LookAtPlayerGoal(SaurosuchusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.SAUROSUCHUS_SKULL.get());
	}
