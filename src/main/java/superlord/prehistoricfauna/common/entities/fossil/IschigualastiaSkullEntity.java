...
public class IschigualastiaSkullEntity extends PrehistoricEntity {
	...
	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(IschigualastiaSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(IschigualastiaSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public void readAdditional(CompoundNBT compound) {
		...
		this.setPushable(compound.getBoolean("IsLooking"));
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.ISCHIGUALASTIA_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		IschigualastiaSkullEntity entity;
		
		public LookAtPlayerGoal(IschigualastiaSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
