...
public class SarahsaurusSkullEntity extends PrehistoricEntity {
	
	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(SarahsaurusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(SarahsaurusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public SarahsaurusSkullEntity(EntityType<? extends SarahsaurusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.SARAHSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		SarahsaurusSkullEntity entity;
		
		public LookAtPlayerGoal(SarahsaurusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.SARAHSAURUS_SKULL.get());
	}
