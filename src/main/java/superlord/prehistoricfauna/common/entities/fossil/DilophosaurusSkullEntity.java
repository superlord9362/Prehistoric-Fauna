...
public class DilophosaurusSkullEntity extends PrehistoricEntity {
	
	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(DilophosaurusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(DilophosaurusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public DilophosaurusSkullEntity(EntityType<? extends DilophosaurusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.DILOPHOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		DilophosaurusSkullEntity entity;
		
		public LookAtPlayerGoal(DilophosaurusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.DILOPHOSAURUS_SKULL.get());
	}
