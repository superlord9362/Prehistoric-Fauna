...
public class DesmatosuchusSkullEntity extends PrehistoricEntity {
	
	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(DesmatosuchusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(DesmatosuchusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public DesmatosuchusSkullEntity(EntityType<? extends DesmatosuchusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.DESMATOSUCHUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		DesmatosuchusSkullEntity entity;
		
		public LookAtPlayerGoal(DesmatosuchusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.DESMATOSUCHUS_SKULL.get());
	}
