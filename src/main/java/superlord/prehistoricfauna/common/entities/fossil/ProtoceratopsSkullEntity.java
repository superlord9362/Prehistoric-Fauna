...
public class ProtoceratopsSkullEntity extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(ProtoceratopsSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(ProtoceratopsSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public ProtoceratopsSkullEntity(EntityType<? extends ProtoceratopsSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.PROTOCERATOPS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		ProtoceratopsSkullEntity entity;
		
		public LookAtPlayerGoal(ProtoceratopsSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.PROTOCERATOPS_SKULL.get());
	}
