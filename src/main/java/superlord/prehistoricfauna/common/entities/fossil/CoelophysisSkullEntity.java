...
public class CoelophysisSkullEntity extends PrehistoricEntity {
	
	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(CoelophysisSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(CoelophysisSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public CoelophysisSkullEntity(EntityType<? extends CoelophysisSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.COELOPHYSIS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		CoelophysisSkullEntity entity;
		
		public LookAtPlayerGoal(CoelophysisSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.COELOPHYSIS_SKULL.get());
	}
