...
public class PostosuchusSkullEntity  extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(PostosuchusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(PostosuchusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public PostosuchusSkullEntity(EntityType<? extends PostosuchusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.POSTOSUCHUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		PostosuchusSkullEntity entity;
		
		public LookAtPlayerGoal(PostosuchusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.POSTOSUCHUS_SKULL.get());
	}
