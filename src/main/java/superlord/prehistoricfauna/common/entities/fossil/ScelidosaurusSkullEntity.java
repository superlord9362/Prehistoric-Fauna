...
public class ScelidosaurusSkullEntity extends PrehistoricEntity {
	
	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(ScelidosaurusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(ScelidosaurusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public ScelidosaurusSkullEntity(EntityType<? extends ScelidosaurusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.SCELIDOSAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		ScelidosaurusSkullEntity entity;
		
		public LookAtPlayerGoal(ScelidosaurusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.SCELIDOSAURUS_SKULL.get());
	}
