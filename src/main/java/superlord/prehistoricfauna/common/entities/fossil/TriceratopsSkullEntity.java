...
public class TriceratopsSkullEntity extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(TriceratopsSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(TriceratopsSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public TriceratopsSkullEntity(EntityType<? extends TriceratopsSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	public ActionResultType fun_230254_b_(PlayerEntity player, Hand hand) {
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.TRICERATOPS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		TriceratopsSkullEntity entity;
		
		public LookAtPlayerGoal(TriceratopsSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.TRICERATOPS_SKULL.get());
	}
