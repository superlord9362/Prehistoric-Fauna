...
public class HerrerasaurusSkullEntity extends PrehistoricEntity {

	private static final DataParameter<Boolean> PUSHING = EntityDataManager.createKey(HerrerasaurusSkullEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> LOOKING = EntityDataManager.createKey(HerrerasaurusSkullEntity.class, DataSerializers.BOOLEAN);
	...
	public HerrerasaurusSkullEntity(EntityType<? extends HerrerasaurusSkullEntity> type, World worldIn) {
		super(type, worldIn);
	}
	...
	private void spawnFossil(DamageSource p_213815_1_) {
		Block.spawnAsEntity(this.world, new BlockPos(this.getPositionVec()), new ItemStack(PFItems.HERRERASAURUS_SKULL.get()));
	}
	
	static class LookAtPlayerGoal extends LookAtGoal {

		HerrerasaurusSkullEntity entity;
		
		public LookAtPlayerGoal(HerrerasaurusSkullEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance) {
	...
	public ItemStack getPickedResult(RayTraceResult target) {
		return new ItemStack(PFItems.HERRERASAURUS_SKULL.get());
	}
