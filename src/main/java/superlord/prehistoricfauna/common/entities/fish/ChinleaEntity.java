...
public class ChinleaEntity extends AbstractFishEntity {
	
	public ChinleaEntity(EntityType<? extends AbstractFishEntity> type, World worldIn) {
		super(type, worldIn);
	}
   ...
   protected SoundEvent getDeathSound() {
      return SoundInit.CHINLEA_DEATH;
   }

   protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
      return SoundInit.CHINLEA_HURT;
   }
