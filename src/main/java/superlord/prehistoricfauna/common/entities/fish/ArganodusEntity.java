...
public class ArganodusEntity extends AbstractFishEntity {
	
	public ArganodusEntity(EntityType<? extends AbstractFishEntity> type, World worldIn) {
		super(type, worldIn);
	}
   ...
   protected SoundEvent getDeathSound() {
      return SoundInit.ARGANODUS_DEATH;
   }

   protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
      return SoundInit.ARGANODUS_HURT;
   }
