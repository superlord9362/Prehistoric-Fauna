...
public class ScutellosaurusEntity extends DinosaurEntity {

	private static final DataParameter<Boolean> HAS_EGG = EntityDataManager.createKey(ScutellosaurusEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> IS_DIGGING = EntityDataManager.createKey(ScutellosaurusEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> ALBINO = EntityDataManager.createKey(ScutellosaurusEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MELANISTIC = EntityDataManager.createKey(ScutellosaurusEntity.class, DataSerializers.BOOLEAN);
	private static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(PFBlocks.CLATHOPTERIS.asItem());
	private static final DataParameter<Boolean> EATING = EntityDataManager.createKey(ScutellosaurusEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> NATURAL_LOVE = EntityDataManager.createKey(ScutellosaurusEntity.class, DataSerializers.BOOLEAN);
	...
	public ScutellosaurusEntity(EntityType<? extends ScutellosaurusEntity> type, World world) {
		super(type, world);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(0, new ScutellosaurusEntity.MateGoal(this, 1.0D));
		this.goalSelector.addGoal(0, new ScutellosaurusEntity.NaturalMateGoal(this, 1.0D));
		...
		this.goalSelector.addGoal(7, new AvoidEntityGoal<CitipatiEntity>(this, CitipatiEntity.class, 10, 1.75D, 1.5D));
		this.goalSelector.addGoal(7, new AvoidEntityGoal<TelmasaurusEntity>(this, TelmasaurusEntity.class, 10, 1.75D, 1.5D));
		this.goalSelector.addGoal(7, new AvoidEntityGoal<VelociraptorEntity>(this, VelociraptorEntity.class, 10, 1.75D, 1.5D));
		...
		this.goalSelector.addGoal(7, new AvoidEntityGoal<MegapnosaurusEntity>(this, MegapnosaurusEntity.class, 10, 1.75D, 1.5D));
		...
		this.goalSelector.addGoal(7, new AvoidEntityGoal<HesperornithoidesEntity>(this, HesperornithoidesEntity.class, 10, 1.75D, 1.5D));
		...
		this.goalSelector.addGoal(7, new AvoidEntityGoal<PlayerEntity>(this, PlayerEntity.class, 10, 1.75D, 1.5D));
	...
	protected SoundEvent getAmbientSound() {
		return this.isAsleep() ? null : SoundInit.SCUTELLOSAURUS_IDLE;
	}

	protected SoundEvent getHurtSound(DamageSource damageSourceIn) {
		return SoundInit.SCUTELLOSAURUS_HURT;
	}

	protected SoundEvent getDeathSound() {
		return SoundInit.SCUTELLOSAURUS_DEATH;
	}
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() {
		return MobEntity.func_233666_p_().createMutableAttribute(Attributes.MAX_HEALTH, 4.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.22D).createMutableAttribute(Attributes.ARMOR, 3);
	}
	...
	static class LayEggGoal extends MoveToBlockGoal {
		...
		LayEggGoal(ScutellosaurusEntity scutellosaurus, double speedIn) {
		...
		public boolean shouldExecute() {
			return this.scutellosaurus.hasEgg() ? super.shouldExecute() : false;
		}
		...
		public boolean shouldContinueExecuting() {
			return super.shouldContinueExecuting() && this.scutellosaurus.hasEgg();
		}
		...
		public void tick() {
			super.tick();
			BlockPos blockpos = new BlockPos(this.scutellosaurus.getPositionVec());
			if (!this.scutellosaurus.isInWater() && this.getIsAboveDestination()) {
				if (this.scutellosaurus.isDigging < 1) {
					this.scutellosaurus.setDigging(true);
				} else if (this.scutellosaurus.isDigging > 200) {
					World world = this.scutellosaurus.world;
					world.playSound((PlayerEntity)null, blockpos, SoundEvents.ENTITY_TURTLE_LAY_EGG, SoundCategory.BLOCKS, 0.3F, 0.9F + world.rand.nextFloat() * 0.2F);
					world.setBlockState(this.destinationBlock.up(), PFBlocks.SCUTELLOSAURUS_EGG.getDefaultState().with(DinosaurEggBlock.EGGS, Integer.valueOf(this.scutellosaurus.rand.nextInt(4) + 1)), 3);
					this.scutellosaurus.setHasEgg(false);
					this.scutellosaurus.setDigging(false);
					this.scutellosaurus.setInLove(600);
				}
	...
	static class MateGoal extends BreedGoal {
		...
		MateGoal(ScutellosaurusEntity scutellosaurus, double speed) {
			super(scutellosaurus, speed);
			this.scutellosaurus = scutellosaurus;
		}

		public boolean shouldExecute() {
			return super.shouldExecute() && !this.scutellosaurus.hasEgg() && !this.scutellosaurus.isInLoveNaturally();
		}
	...
	static class NaturalMateGoal extends BreedGoal {
		...
		NaturalMateGoal(ScutellosaurusEntity scutellosaurus, double speed) {
			super(scutellosaurus, speed);
			this.scutellosaurus = scutellosaurus;
		}

		public boolean shouldExecute() {
			return super.shouldExecute() && !this.scutellosaurus.hasEgg() && this.scutellosaurus.getCurrentHunger() >= this.scutellosaurus.getThreeQuartersHunger() && this.scutellosaurus.ticksExisted % 60 == 0 && (PrehistoricFaunaConfig.naturalEggBlockLaying || PrehistoricFaunaConfig.naturalEggItemLaying) && this.scutellosaurus.isInLoveNaturally();
		}

		protected void spawnBaby() {
			if (PrehistoricFaunaConfig.naturalEggItemLaying) {
				this.scutellosaurus.playSound(SoundEvents.ENTITY_CHICKEN_EGG, 1.0F, (this.scutellosaurus.rand.nextFloat() - this.scutellosaurus.rand.nextFloat()) * 0.2F + 1.0F);
				int eggAmount = this.scutellosaurus.rand.nextInt(4);
				if (eggAmount == 0) {
					this.scutellosaurus.entityDropItem(PFBlocks.SCUTELLOSAURUS_EGG.asItem());
				}
				if (eggAmount == 1) {
					this.scutellosaurus.entityDropItem(PFBlocks.SCUTELLOSAURUS_EGG.asItem());
					this.scutellosaurus.entityDropItem(PFBlocks.SCUTELLOSAURUS_EGG.asItem());
	...
	public AgeableEntity func_241840_a(ServerWorld p_241840_1_, AgeableEntity p_241840_2_) {
		ScutellosaurusEntity entity = new ScutellosaurusEntity(PFEntities.SCUTELLOSAURUS_ENTITY, this.world);
	...
	public class HerbivoreEatGoal extends MoveToBlockGoal {
		...
		public HerbivoreEatGoal(double p_i50737_2_, int p_i50737_4_, int p_i50737_5_) {
			super(ScutellosaurusEntity.this, p_i50737_2_, p_i50737_4_, p_i50737_5_);
		}
		...
		public void tick() {
			if (this.getIsAboveDestination()) {
				if (this.field_220731_g >= 20) {
					...
					++this.field_220731_g;
					ScutellosaurusEntity.this.setEating(true);
				}
				if (this.field_220731_g % 5 == 1) {
					ScutellosaurusEntity.this.world.playSound((PlayerEntity)null, this.destinationBlock, SoundEvents.BLOCK_GRASS_HIT, SoundCategory.NEUTRAL, 1, 1);
				}
			}
			super.tick();
		}
		...
		protected void eatBerry() {
			BlockState blockstate = ScutellosaurusEntity.this.world.getBlockState(this.destinationBlock);
			int hunger = ScutellosaurusEntity.this.getCurrentHunger();

			if (blockstate.isIn(PFBlocks.DEAD_OSMUNDACAULIS)) {
				if (hunger + 2 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 2);
				}
			}
			if (blockstate.isIn(Blocks.GRASS) || blockstate.isIn(Blocks.TALL_GRASS) || blockstate.isIn(BlockTags.FLOWERS)) {
				if (hunger + 4 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 4);
				}
			}
			if (blockstate.isIn(Blocks.VINE)) {
				if (hunger + 6 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 6);
				}
			}
			if (blockstate.isIn(PFBlocks.MARCHANTIA) || blockstate.isIn(PFBlocks.OSMUNDACAULIS) || blockstate.isIn(PFBlocks.OTOZAMITES)) {
				if (hunger + 8 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 8);
				}
			}
			if (blockstate.isIn(PFBlocks.HORSETAIL) || blockstate.isIn(PFBlocks.CLUBMOSS) || blockstate.isIn(PFBlocks.MICHELILLOA) || blockstate.isIn(PFBlocks.COBBANIA) || blockstate.isIn(PFBlocks.LAUROZAMITES) || blockstate.isIn(PFBlocks.CLATHOPTERIS)) {
				if (hunger + 10 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 10);
				}
			}
			if (blockstate.isIn(PFBlocks.TALL_OSMUNDACAULIS) || blockstate.isIn(PFBlocks.TALL_OTOZAMITES)) {
				if (hunger + 12 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 12);
				}
			}
			if (blockstate.isIn(PFBlocks.OSMUNDA) || blockstate.isIn(Blocks.FERN) || blockstate.isIn(PFBlocks.CONIOPTERIS) || blockstate.isIn(PFBlocks.CLADOPHLEBIS)) {
				if (hunger + 15 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 15);
				}
			}
			if (blockstate.isIn(PFBlocks.TALL_HORSETAIL) || blockstate.isIn(PFBlocks.SCYTOPHYLLUM)) {
				if (hunger + 20 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 20);
				}
			}
			if (blockstate.isIn(PFBlocks.TALL_OSMUNDA) || blockstate.isIn(Blocks.LARGE_FERN) || blockstate.isIn(PFBlocks.JOHNSTONIA)) {
				if (hunger + 25 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 25);
				}
			}
			if (blockstate.isIn(PFBlocks.DICROIDIUM)) {
				if (hunger + 30 >= ScutellosaurusEntity.this.maxHunger) {
					ScutellosaurusEntity.this.setHunger(ScutellosaurusEntity.this.maxHunger);
				} else {
					ScutellosaurusEntity.this.setHunger(hunger + 30);
				}
			}
			ScutellosaurusEntity.this.setEating(false);
		}
		 ...
		 */
		public boolean shouldExecute() {
			return !ScutellosaurusEntity.this.isAsleep() && super.shouldExecute() && ScutellosaurusEntity.this.getCurrentHunger() < ScutellosaurusEntity.this.getHalfHunger();
		}

		public boolean shouldContinueExecuting() {
			if (ScutellosaurusEntity.this.getCurrentHunger() >= ScutellosaurusEntity.this.maxHunger || ScutellosaurusEntity.this.isAsleep()) {
				return false;
