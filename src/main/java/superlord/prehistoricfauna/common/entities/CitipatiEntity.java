...
public class CitipatiEntity extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.attackAnimals = new HuntGoal(this, AnimalEntity.class, 10, false, false, (p_213487_0_) -> {
			return p_213487_0_ instanceof EilenodonEntity || p_213487_0_ instanceof RabbitEntity || p_213487_0_ instanceof ChickenEntity || p_213487_0_ instanceof ParrotEntity || p_213487_0_ instanceof HesperornithoidesEntity;
		});
	...
	protected SoundEvent getAmbientSound() {
		return SoundInit.CITIPATI_IDLE;
	}
	...
	static class MateGoal extends BreedGoal {
		...
		public boolean shouldExecute() {
			return super.shouldExecute() && !this.citipati.hasEgg();
		}
