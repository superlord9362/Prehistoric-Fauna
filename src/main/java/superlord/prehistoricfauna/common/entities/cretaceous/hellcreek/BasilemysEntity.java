		...
		public void tick() {
			...
			if (!this.basilemys.isInWater() && this.getIsAboveDestination()) {
				if (this.basilemys.isDigging < 1) {
					...
					world.setBlockState(this.destinationBlock.up(), PFBlocks.BASILEMYS_EGG.getDefaultState().with(DinosaurEggBlock.EGGS, Integer.valueOf(this.basilemys.rand.nextInt(4) + 1)), 3);
