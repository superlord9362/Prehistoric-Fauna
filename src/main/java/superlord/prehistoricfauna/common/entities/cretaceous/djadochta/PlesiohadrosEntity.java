...
public class PlesiohadrosEntity extends HerdDinosaurEntity {
	private static final DataParameter<Boolean> HAS_EGG = EntityDataManager.createKey(PlesiohadrosEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> IS_DIGGING = EntityDataManager.createKey(PlesiohadrosEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> ALBINO = EntityDataManager.createKey(PlesiohadrosEntity.class, DataSerializers.BOOLEAN);
	private static final DataParameter<Boolean> MELANISTIC = EntityDataManager.createKey(PlesiohadrosEntity.class, DataSerializers.BOOLEAN);
	...
	public AgeableEntity createChild(AgeableEntity ageable) {
		PlesiohadrosEntity entity = new PlesiohadrosEntity(PFEntities.PLESIOHADROS_ENTITY, this.world);
	...
	public boolean isDeoxidated() {
		return this.dataManager.get(DEOXIDATED);
	}

	private void setDeoxidated(boolean isDeoxidated) {
		this.dataManager.set(DEOXIDATED, isDeoxidated);
	}
	...
	public boolean isBreedingItem(ItemStack stack) {
		return stack.getItem() == PFBlocks.TROCHODENDROIDES_SAPLING.asItem();
	}
	...
	protected void registerGoals() {
		super.registerGoals();
		this.goalSelector.addGoal(1, new PlesiohadrosEntity.MeleeAttackGoal());
		this.goalSelector.addGoal(1, new PlesiohadrosEntity.PanicGoal());
		this.goalSelector.addGoal(4, new FollowParentGoal(this, 1.25D));
		this.goalSelector.addGoal(5, new WaterAvoidingRandomWalkingGoal(this, 1.0D));
		this.goalSelector.addGoal(5, new DinosaurLookAtGoal(this, PlayerEntity.class, 6.0F));
		this.goalSelector.addGoal(6, new DinosaurRandomLookGoal(this));
		this.targetSelector.addGoal(1, new PlesiohadrosEntity.HurtByTargetGoal());
		this.targetSelector.addGoal(2, new PlesiohadrosEntity.AttackPlayerGoal());
		this.targetSelector.addGoal(3, new PlesiohadrosEntity.ProtectBabyGoal());
		this.goalSelector.addGoal(0, new PlesiohadrosEntity.LayEggGoal(this, 1.0D));
		this.goalSelector.addGoal(0, new PlesiohadrosEntity.MateGoal(this, 1.0D));
		this.goalSelector.addGoal(0, new PlesiohadrosEntity.NaturalMateGoal(this, 1.0D));
		this.goalSelector.addGoal(1, new DiurnalSleepingGoal(this));
		this.goalSelector.addGoal(0, new PlesiohadrosEntity.HerbivoreEatGoal((double)1.2F, 12, 2));
	...
	protected void playWarningSound() {
		if (this.warningSoundTicks <= 0) {
			this.playSound(SoundInit.PLESIOHADROS_WARNING, 1.0F, this.getSoundPitch());
	...
	public void livingTick() {
		...
		if (!this.isAIDisabled()) {
			List<PlesiohadrosEntity> list = this.world.getEntitiesWithinAABB(this.getClass(), this.getBoundingBox().grow(20.0D, 20.0D, 20.0D));
		...
		public boolean shouldExecute() {
			if (PlesiohadrosEntity.this.isChild() || PlesiohadrosEntity.this.isTamed()) {
				...
				if (super.shouldExecute()) {
					for(PlesiohadrosEntity plesiohadros : PlesiohadrosEntity.this.world.getEntitiesWithinAABB(PlesiohadrosEntity.class, PlesiohadrosEntity.this.getBoundingBox().grow(8.0D, 4.0D, 8.0D))) {
						if (plesiohadros.isChild()) {
							return true;
						}
					}
				}
	...
	class HurtByTargetGoal extends net.minecraft.entity.ai.goal.HurtByTargetGoal {
		...
		protected void setAttackTarget(MobEntity mobIn, LivingEntity targetIn) {
			if (mobIn instanceof PlesiohadrosEntity && !mobIn.isChild()) {
	...
	class MeleeAttackGoal extends net.minecraft.entity.ai.goal.MeleeAttackGoal {
		public MeleeAttackGoal() {
			super(PlesiohadrosEntity.this, 1.25D, true);
		}
	...
	class PanicGoal extends net.minecraft.entity.ai.goal.PanicGoal {
		public PanicGoal() {
			super(PlesiohadrosEntity.this, 2.0D);
		}
		 ...
		 */
		public boolean shouldExecute() {
			return !PlesiohadrosEntity.this.isChild() && !PlesiohadrosEntity.this.isBurning() ? false : super.shouldExecute();
		}
	}
	...
	static class LayEggGoal extends MoveToBlockGoal {
		 ...
		 */
		public boolean shouldExecute() {
			return this.plesiohadros.hasEgg() ? super.shouldExecute() : false;
		}
		 ...
		 */
		public boolean shouldContinueExecuting() {
			return super.shouldContinueExecuting() && this.plesiohadros.hasEgg();
		}
		...
		public void tick() {
			super.tick();
			BlockPos blockpos = new BlockPos(this.plesiohadros.getPositionVec());
			if (!this.plesiohadros.isInWater() && this.getIsAboveDestination()) {
	...
	static class MateGoal extends BreedGoal {
		 ...
		 */
		public boolean shouldExecute() {
			return super.shouldExecute() && !this.plesiohadros.hasEgg() && !this.plesiohadros.isInLoveNaturally();
		}
	...
	static class NaturalMateGoal extends BreedGoal {
		...
		public boolean shouldExecute() {
			return super.shouldExecute() && !this.plesiohadros.hasEgg() && this.plesiohadros.getCurrentHunger() >= this.plesiohadros.getThreeQuartersHunger() && this.plesiohadros.ticksExisted % 60 == 0 && (PrehistoricFaunaConfig.naturalEggBlockLaying || PrehistoricFaunaConfig.naturalEggItemLaying) && this.plesiohadros.isInLoveNaturally();
		}

		protected void spawnBaby() {
			if (PrehistoricFaunaConfig.naturalEggItemLaying) {
				this.plesiohadros.playSound(SoundEvents.ENTITY_CHICKEN_EGG, 1.0F, (this.plesiohadros.rand.nextFloat() - this.plesiohadros.rand.nextFloat()) * 0.2F + 1.0F);
				int eggAmount = this.plesiohadros.rand.nextInt(4);
				if (eggAmount == 0) {
					this.plesiohadros.entityDropItem(PFBlocks.PLESIOHADROS_EGG.asItem());
				}
				if (eggAmount == 1) {
					this.plesiohadros.entityDropItem(PFBlocks.PLESIOHADROS_EGG.asItem());
					this.plesiohadros.entityDropItem(PFBlocks.PLESIOHADROS_EGG.asItem());
	...
	public class HerbivoreEatGoal extends MoveToBlockGoal {
		...
		public HerbivoreEatGoal(double p_i50737_2_, int p_i50737_4_, int p_i50737_5_) {
			super(PlesiohadrosEntity.this, p_i50737_2_, p_i50737_4_, p_i50737_5_);
		}
		...
		public void tick() {
			if (this.getIsAboveDestination()) {
				...
				if (this.field_220731_g % 5 == 1) {
					PlesiohadrosEntity.this.world.playSound((PlayerEntity)null, this.destinationBlock, SoundEvents.BLOCK_GRASS_HIT, SoundCategory.NEUTRAL, 1, 1);
				}
			}
			super.tick();
		}
		...
		protected void eatBerry() {
			BlockState blockstate = PlesiohadrosEntity.this.world.getBlockState(this.destinationBlock);
		 ...
		 */
		public boolean shouldExecute() {
			return !PlesiohadrosEntity.this.isAsleep() && super.shouldExecute() && PlesiohadrosEntity.this.getCurrentHunger() < PlesiohadrosEntity.this.getHalfHunger();
		}
