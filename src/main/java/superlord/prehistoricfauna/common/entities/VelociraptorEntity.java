...
public class VelociraptorEntity extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(6, new VelociraptorEntity.PounceGoal());
		...
		this.goalSelector.addGoal(12, new VelociraptorEntity.WatchGoal(this, PlayerEntity.class, 24.0F));
	...
	protected SoundEvent getAmbientSound()  {
		return SoundInit.VELOCIRAPTOR_IDLE;
	}
	...
	static class MateGoal extends BreedGoal {
		...
		public boolean shouldExecute() {
			return super.shouldExecute() && !this.velociraptor.hasEgg();
		}
	...
	class SleepGoal extends VelociraptorEntity.BaseGoal {
		...
		public boolean shouldExecute() {
			if (VelociraptorEntity.this.moveStrafing == 0.0F && VelociraptorEntity.this.moveVertical == 0.0F && VelociraptorEntity.this.moveForward == 0.0F) {
	...
	class TamedHuntGoal extends HuntGoal {
		...
		public boolean shouldExecute() {
			return super.shouldExecute() && !VelociraptorEntity.this.isTamed();
		}
