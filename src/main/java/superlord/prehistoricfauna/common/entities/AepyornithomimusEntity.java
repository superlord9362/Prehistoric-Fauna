...
public class AepyornithomimusEntity extends HerdDinosaurEntity {
	...
	protected SoundEvent getAmbientSound() {
		return SoundInit.AEPYORNITHOMIMUS_IDLE;
	}
	...
	static class LayEggGoal extends MoveToBlockGoal {
		...
		public void tick() {
			...
			if (this.aepyornithomimus.isInWater() && this.getIsAboveDestination()) {
	...
	static class MateGoal extends BreedGoal {
		...
		public boolean shouldExecute() {
			return super.shouldExecute() && !this.aepyornithomimus.hasEgg();
		}
