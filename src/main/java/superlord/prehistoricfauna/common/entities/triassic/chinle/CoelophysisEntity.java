...
public class CoelophysisEntity extends DinosaurEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new AvoidEntityGoal<SarahsaurusEntity>(this, SarahsaurusEntity.class, 10F, 1.75D, 1.5D));
		this.goalSelector.addGoal(7, new AvoidEntityGoal<ScelidosaurusEntity>(this, ScelidosaurusEntity.class, 10F, 1.75D, 1.5D));
	...
	public class CarnivoreHuntGoal extends NearestAttackableTargetGoal {
		...
		public boolean shouldExecute() {
			return super.shouldExecute() && CoelophysisEntity.this.getCurrentHunger() <= CoelophysisEntity.this.getHalfHunger() && !CoelophysisEntity.this.isChild() && PrehistoricFaunaConfig.advancedHunger == true;
		}

		public boolean shouldContinueExecuting() {
			return CoelophysisEntity.this.getCurrentHunger() < CoelophysisEntity.this.maxHunger && PrehistoricFaunaConfig.advancedHunger == true;
		}
	...
	public class BabyCarnivoreHuntGoal extends NearestAttackableTargetGoal {
		...
		public boolean shouldContinueExecuting() {
			return CoelophysisEntity.this.getCurrentHunger() < CoelophysisEntity.this.maxHunger && PrehistoricFaunaConfig.advancedHunger == true || !CoelophysisEntity.this.isChild() && PrehistoricFaunaConfig.advancedHunger == true;
		}
