...
public class ProtoceratopsEntity extends DinosaurEntity {
	...
	public static AttributeModifierMap.MutableAttribute createAttributes() {
		return MobEntity.func_233666_p_().createMutableAttribute(Attributes.MAX_HEALTH, 25.0D).createMutableAttribute(Attributes.MOVEMENT_SPEED, 0.21D).createMutableAttribute(Attributes.ATTACK_DAMAGE, 4.0D).createMutableAttribute(Attributes.FOLLOW_RANGE, 20.0D);
	}

	protected SoundEvent getAmbientSound() {
		return SoundInit.PROTOCERATOPS_IDLE;
	}
	...
	static class MateGoal extends BreedGoal {
		 ...
		 */
		public boolean shouldExecute() {
			return super.shouldExecute() && !this.protoceratops.hasEgg();
		}
