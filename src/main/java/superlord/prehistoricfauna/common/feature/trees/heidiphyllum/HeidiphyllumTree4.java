package superlord.prehistoricfauna.common.feature.trees.heidiphyllum;
...
public class HeidiphyllumTree4 extends PFAbstractTreeFeature<PFTreeConfig> {

	public HeidiphyllumTree4(Codec<PFTreeConfig> configIn) {
		super(configIn);
	}
