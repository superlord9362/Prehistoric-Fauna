package superlord.prehistoricfauna.common.feature.trees.cupressinocladus;
...
public class Cupressinocladus4 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Cupressinocladus4(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
