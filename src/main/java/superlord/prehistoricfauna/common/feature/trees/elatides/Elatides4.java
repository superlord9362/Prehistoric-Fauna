package superlord.prehistoricfauna.common.feature.trees.elatides;
...
public class Elatides4 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Elatides4(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
