...
public class Taxodium2 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Taxodium2(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
        ...
        if (pos.getY() + randTreeHeight + 1 < world.getHeight()) {
            if (!this.isAnotherTreeNearby(world, pos, randTreeHeight, 0, isSapling)) {
            	...
            	for (int buildTrunk = 0; buildTrunk <= randTreeHeight; buildTrunk++) {
                	buildTrunkBase(pos, changedBlocks, world, config, rand, boundsIn, mainmutable.set(pos).move(-1, 0, 0).immutable(), mainmutable.set(pos).move(-1, 0, 1).immutable(), mainmutable.set(pos).move(0, 0, 0).immutable(), mainmutable.set(pos).move(1, 0, -1).immutable(), mainmutable.set(pos).move(1, 0, 1).immutable());
