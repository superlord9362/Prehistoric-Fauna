package superlord.prehistoricfauna.common.feature.trees.ginkgo;
...
public class Ginkgo4 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Ginkgo4(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
