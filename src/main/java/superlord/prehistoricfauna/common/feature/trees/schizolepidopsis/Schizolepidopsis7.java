package superlord.prehistoricfauna.common.feature.trees.schizolepidopsis;
...
public class Schizolepidopsis7 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Schizolepidopsis7(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
