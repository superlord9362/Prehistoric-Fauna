...
public class BaieraTree5 extends PFAbstractTreeFeature<PFTreeConfig> {

	public BaieraTree5(Codec<PFTreeConfig> configIn) {
		super(configIn);
	}
	...
	protected boolean generate(Set<BlockPos> changedBlocks, WorldGenLevel world, RandomSource rand, BlockPos pos, BoundingBox boundsIn, boolean isSapling, PFTreeConfig config) {
		...
		if (pos.getY() + randTreeHeight + 1 < world.getHeight()) {
			if (!this.isAnotherTreeNearby(world, pos, randTreeHeight, 0, isSapling) ) {
				...
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 2, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 1), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 2, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 2, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 2, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 2, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				...
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 3, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 3, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 3, -2), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(2, randTreeHeight + 3, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(2, randTreeHeight + 3, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 3, 2), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 3, 2), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(-2, randTreeHeight + 3, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				...
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 4, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 1), 3);
				world.setBlock(mainmutable.set(pos).move(2, randTreeHeight + 4, 0), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(-2, randTreeHeight + 4, 0), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 4, -2), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 4, 2), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				...
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 5, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 2), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 5, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 5, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 5, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 5, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				...
				world.setBlock(mainmutable.set(pos).move(1, randTreeHeight + 6, 0), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(-1, randTreeHeight + 6, 0), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 6, -1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
				world.setBlock(mainmutable.set(pos).move(0, randTreeHeight + 6, 1), PFBlocks.BAIERA_LEAVES.get().defaultBlockState().setValue(LeavesBlock.DISTANCE, 3), 3);
