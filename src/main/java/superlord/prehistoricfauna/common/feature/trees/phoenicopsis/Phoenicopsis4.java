...
public class Phoenicopsis4 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Phoenicopsis4(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
...
//            	buildTrunkBase(pos, changedBlocks, world, config, rand, boundsIn, mainmutable.set(pos).move(0, 0, 0).immutable());
				...
				placeBranch(pos, config, rand, changedBlocks, world, mainmutable.set(pos).move(4, randTreeHeight - 8, 0), boundsIn);
				placeBranch(pos, config, rand, changedBlocks, world, mainmutable.set(pos).move(5, randTreeHeight - 8, 0), boundsIn);
				...
				placeBranch(pos, config, rand, changedBlocks, world, mainmutable.set(pos).move(0, randTreeHeight - 7, 5), boundsIn);
				...
				placeBranch(pos, config, rand, changedBlocks, world, mainmutable.set(pos).move(3, randTreeHeight - 5, 3), boundsIn);
