package superlord.prehistoricfauna.common.feature.trees.phoenicopsis;
...
public class Phoenicopsis2 extends PFAbstractTreeFeature<PFTreeConfig> {

    public Phoenicopsis2(Codec<PFTreeConfig> configIn) {
        super(configIn);
    }
