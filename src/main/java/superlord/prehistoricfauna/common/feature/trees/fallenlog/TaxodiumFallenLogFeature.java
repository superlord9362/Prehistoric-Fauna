...
public class TaxodiumFallenLogFeature extends Feature<JohnstoniaConfig> {

	public TaxodiumFallenLogFeature(Codec<JohnstoniaConfig> p_65786_) {
		super(p_65786_);
	}
				...
				if (length == 3) {
					if (direction == 0) {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.east()) && isAirBlock(world, pos.east(2)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().east()) && isWaterBlock(world, pos.below().east(2))) {
							world.setBlock(pos.below(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.below(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos, PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos, PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
						}
					} else {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.north()) && isAirBlock(world, pos.north(2)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().north()) && isWaterBlock(world, pos.below().north(2))) {
							world.setBlock(pos.below(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.below(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos, PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos, PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
						}
					}
				} else if (length == 4) {
					if (direction == 0) {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.east()) && isAirBlock(world, pos.east(2)) && isAirBlock(world, pos.east(3)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().east()) && isWaterBlock(world, pos.below().east(2)) && isWaterBlock(world, pos.below().east(3))) {
							...
							world.setBlock(pos.below().east(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.below().west(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.east(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.west(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
						}
					} else {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.north()) && isAirBlock(world, pos.north(2)) && isAirBlock(world, pos.north(3)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().north()) && isWaterBlock(world, pos.below().north(2)) && isWaterBlock(world, pos.below().north(3))) {
							...
							world.setBlock(pos.below().north(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.below().south(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.north(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.south(), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
						}
					}
				} else if (length == 5) {
					if (direction == 0) {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.east()) && isAirBlock(world, pos.east(2)) && isAirBlock(world, pos.east(3)) && isAirBlock(world, pos.east(4)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().east()) && isWaterBlock(world, pos.below().east(2)) && isWaterBlock(world, pos.below().east(3)) && isWaterBlock(world, pos.below().east(4))) {
							...
							world.setBlock(pos.below().east(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.below().west(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.east(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.west(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
						}
					} else {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.north()) && isAirBlock(world, pos.north(2)) && isAirBlock(world, pos.north(3)) && isAirBlock(world, pos.north(4)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().north()) && isWaterBlock(world, pos.below().north(2)) && isWaterBlock(world, pos.below().north(3)) && isWaterBlock(world, pos.below().north(4))) {
							...
							world.setBlock(pos.below().north(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.below().south(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.north(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.south(2), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
						}
					}
				} else if (length == 6) {
					if (direction == 0) {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.east()) && isAirBlock(world, pos.east(2)) && isAirBlock(world, pos.east(3)) && isAirBlock(world, pos.east(4)) && isAirBlock(world, pos.east(5)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().east()) && isWaterBlock(world, pos.below().east(2)) && isWaterBlock(world, pos.below().east(3)) && isWaterBlock(world, pos.below().east(4)) && isWaterBlock(world, pos.below().east(5))) {
							...
							world.setBlock(pos.below().east(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.below().west(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.east(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.west(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
						}
					} else {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.north()) && isAirBlock(world, pos.north(2)) && isAirBlock(world, pos.north(3)) && isAirBlock(world, pos.north(4)) && isAirBlock(world, pos.north(5)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().north()) && isWaterBlock(world, pos.below().north(2)) && isWaterBlock(world, pos.below().north(3)) && isWaterBlock(world, pos.below().north(4)) && isWaterBlock(world, pos.below().north(5))) {
							...
							world.setBlock(pos.below().north(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.below().south(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.north(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.south(3), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
						}
					}
				} else if (length == 7) {
					if (direction == 0) {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.east()) && isAirBlock(world, pos.east(2)) && isAirBlock(world, pos.east(3)) && isAirBlock(world, pos.east(4)) && isAirBlock(world, pos.east(5)) && isAirBlock(world, pos.east(6)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().east()) && isWaterBlock(world, pos.below().east(2)) && isWaterBlock(world, pos.below().east(3)) && isWaterBlock(world, pos.below().east(4)) && isWaterBlock(world, pos.below().east(5)) && isWaterBlock(world, pos.below().east(6))) {
							...
							world.setBlock(pos.below().east(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().east(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.below().west(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.below().west(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.east(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.east(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							...
							world.setBlock(pos.west(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
							world.setBlock(pos.west(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.X), 0);
						}
					} else {
						if (isAirBlock(world, pos) && isAirBlock(world, pos.north()) && isAirBlock(world, pos.north(2)) && isAirBlock(world, pos.north(3)) && isAirBlock(world, pos.north(4)) && isAirBlock(world, pos.north(5)) && isAirBlock(world, pos.north(6)) && isWaterBlock(world, pos.below()) && isWaterBlock(world, pos.below().north()) && isWaterBlock(world, pos.below().north(2)) && isWaterBlock(world, pos.below().north(3)) && isWaterBlock(world, pos.below().north(4)) && isWaterBlock(world, pos.below().north(5)) && isWaterBlock(world, pos.below().north(6))) {
							...
							world.setBlock(pos.below().north(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().north(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.below().south(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.below().south(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.north(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.north(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							...
							world.setBlock(pos.south(4), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(5), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
							world.setBlock(pos.south(6), PFBlocks.TAXODIUM_LOG.get().defaultBlockState().setValue(RotatedPillarBlock.AXIS, Direction.Axis.Z), 0);
						}
					}
				}
				++i;
