	...
	public void placeCalamites(FeaturePlaceContext<JohnstoniaConfig> context) {
		...
		if ((world.getBlockState(blockpos).getBlock() == Blocks.AIR) && world.getBlockState(blockpos.above()).getBlock() == Blocks.AIR && world.getBlockState(blockpos.above(2)).getBlock() == Blocks.AIR && (world.getBlockState(blockpos.below()).getBlock() == Blocks.PODZOL || world.getBlockState(blockpos.below()).getBlock() == Blocks.COARSE_DIRT || world.getBlockState(blockpos.below()).getBlock() == PFBlocks.MOSSY_DIRT.get() || world.getBlockState(blockpos.below()).getBlock() == PFBlocks.LOAM.get() || world.getBlockState(blockpos.below()).getBlock() == PFBlocks.PACKED_LOAM.get() || world.getBlockState(blockpos.below()).getBlock() == PFBlocks.SILT.get() || world.getBlockState(blockpos.below()).getBlock() == PFBlocks.HARDENED_SILT.get() || world.getBlockState(blockpos.below()).getBlock() == Blocks.SAND)) {
			...
			if (twoOrThree == 0) {
				...
				world.setBlock(blockpos.above(), PFBlocks.NEOCALAMITES.get().defaultBlockState().setValue(NeocalamitesBlock.PROPERTY_STAGE, 1).setValue(NeocalamitesBlock.PROPERTY_NEOCALAMITES_LEAVES, 1).setValue(NeocalamitesBlock.WATERLOGGED, false).setValue(NeocalamitesBlock.PLAYER_PLACED, false), l);
				...
				world.setBlock(blockpos.above(), PFBlocks.NEOCALAMITES.get().defaultBlockState().setValue(NeocalamitesBlock.PROPERTY_STAGE, 2).setValue(NeocalamitesBlock.PROPERTY_NEOCALAMITES_LEAVES, 1).setValue(NeocalamitesBlock.WATERLOGGED, false).setValue(NeocalamitesBlock.PLAYER_PLACED, false), l);
				world.setBlock(blockpos.above(2), PFBlocks.NEOCALAMITES.get().defaultBlockState().setValue(NeocalamitesBlock.PROPERTY_STAGE, 2).setValue(NeocalamitesBlock.PROPERTY_NEOCALAMITES_LEAVES, 2).setValue(NeocalamitesBlock.WATERLOGGED, false).setValue(NeocalamitesBlock.PLAYER_PLACED, false), l);
			}
		}
		if(world.getBlockState(blockpos.below()).getBlock() == Blocks.WATER && world.getBlockState(blockpos).getBlock() == Blocks.AIR && world.getBlockState(blockpos.above()).getBlock() == Blocks.AIR && (world.getBlockState(blockpos.below(2)).getBlock() == Blocks.COARSE_DIRT || world.getBlockState(blockpos.below(2)).getBlock() == PFBlocks.PACKED_LOAM.get() || world.getBlockState(blockpos.below(2)).getBlock() == PFBlocks.SILT.get() || world.getBlockState(blockpos.below(2)).getBlock() == Blocks.SAND)) {
			...
			if (twoOrThree == 0) {
				...
				world.setBlock(blockpos, PFBlocks.NEOCALAMITES.get().defaultBlockState().setValue(NeocalamitesBlock.PROPERTY_STAGE, 1).setValue(NeocalamitesBlock.PROPERTY_NEOCALAMITES_LEAVES, 1).setValue(NeocalamitesBlock.WATERLOGGED, false).setValue(NeocalamitesBlock.PLAYER_PLACED, false), l);
			} else {
				...
				world.setBlock(blockpos, PFBlocks.NEOCALAMITES.get().defaultBlockState().setValue(NeocalamitesBlock.PROPERTY_STAGE, 2).setValue(NeocalamitesBlock.PROPERTY_NEOCALAMITES_LEAVES, 1).setValue(NeocalamitesBlock.WATERLOGGED, false).setValue(NeocalamitesBlock.PLAYER_PLACED, false), l);
				world.setBlock(blockpos.above(), PFBlocks.NEOCALAMITES.get().defaultBlockState().setValue(NeocalamitesBlock.PROPERTY_STAGE, 2).setValue(NeocalamitesBlock.PROPERTY_NEOCALAMITES_LEAVES, 2).setValue(NeocalamitesBlock.WATERLOGGED, false).setValue(NeocalamitesBlock.PLAYER_PLACED, false), l);
			}
		}
	}
