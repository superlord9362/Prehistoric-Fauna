...
public class TimeTempleStructure extends StructureFeature<NoneFeatureConfiguration> {

	public TimeTempleStructure(Codec<NoneFeatureConfiguration> codec) {
		super(codec, PieceGeneratorSupplier.simple(TimeTempleStructure::checkLocation, TimeTempleStructure::generatePieces));
	}
	...
	private static void generatePieces(StructurePiecesBuilder p_197233_, PieceGenerator.Context<NoneFeatureConfiguration> p_197234_) {
		...
		TimeTempleStructurePiece.addStructure(p_197234_.structureManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
