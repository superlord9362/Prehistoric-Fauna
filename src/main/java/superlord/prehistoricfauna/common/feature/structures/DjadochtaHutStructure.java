...
public class DjadochtaHutStructure extends StructureFeature<NoneFeatureConfiguration> {
	public DjadochtaHutStructure(Codec<NoneFeatureConfiguration> p_i51440_1_) {
		super(p_i51440_1_, PieceGeneratorSupplier.simple(DjadochtaHutStructure::checkLocation, DjadochtaHutStructure::generatePieces));
	}
	...
	private static void generatePieces(StructurePiecesBuilder p_197233_, PieceGenerator.Context<NoneFeatureConfiguration> p_197234_) {
		...
		DjadochtaHutStructurePiece.addStructure(p_197234_.structureManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
