...
import superlord.prehistoricfauna.common.feature.structures.structurepiece.YixianHutStructurePiece;

public class YixianHutStructure extends StructureFeature<NoneFeatureConfiguration> {
	public YixianHutStructure(Codec<NoneFeatureConfiguration> p_i51440_1_) {
		super(p_i51440_1_, PieceGeneratorSupplier.simple(YixianHutStructure::checkLocation, YixianHutStructure::generatePieces));
	}
	...
	private static void generatePieces(StructurePiecesBuilder p_197233_, PieceGenerator.Context<NoneFeatureConfiguration> p_197234_) {
		...
		YixianHutStructurePiece.addStructure(p_197234_.structureManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
