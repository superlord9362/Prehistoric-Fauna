...
public class MorrisonHutStructure extends StructureFeature<NoneFeatureConfiguration> {
	public MorrisonHutStructure(Codec<NoneFeatureConfiguration> p_i51440_1_) {
		super(p_i51440_1_, PieceGeneratorSupplier.simple(MorrisonHutStructure::checkLocation, MorrisonHutStructure::generatePieces));
	}
	...
	private static void generatePieces(StructurePiecesBuilder p_197233_, PieceGenerator.Context<NoneFeatureConfiguration> p_197234_) {
		...
		MorrisonHutStructurePiece.addStructure(p_197234_.structureManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
