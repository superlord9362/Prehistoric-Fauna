...
public class KayentaHutStructure extends StructureFeature<NoneFeatureConfiguration> {
	public KayentaHutStructure(Codec<NoneFeatureConfiguration> p_i51440_1_) {
		super(p_i51440_1_, PieceGeneratorSupplier.simple(KayentaHutStructure::checkLocation, KayentaHutStructure::generatePieces));
	}
	...
	private static void generatePieces(StructurePiecesBuilder p_197233_, PieceGenerator.Context<NoneFeatureConfiguration> p_197234_) {
		...
		KayentaHutStructurePiece.addStructure(p_197234_.structureManager(), blockpos, rotation, p_197233_, p_197234_.random());
	}
