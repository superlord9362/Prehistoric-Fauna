...
public class GeologistCampStructure extends StructureFeature<NoneFeatureConfiguration> {
	public GeologistCampStructure(Codec<NoneFeatureConfiguration> p_i51440_1_) {
		super(p_i51440_1_, PieceGeneratorSupplier.simple(GeologistCampStructure::checkLocation, GeologistCampStructure::generatePieces));
	}
