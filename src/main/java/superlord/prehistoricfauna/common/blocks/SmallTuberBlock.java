...
public class SmallTuberBlock extends Block {

	public static final VoxelShape SHAPE = Block.box(3.5D, 0.0D, 3.5D, 12.5D, 11.0D, 12.5D);

	public SmallTuberBlock(Properties properties) {
		super(properties);
	}
	...
	public InteractionResult use(BlockState p_55289_, Level p_55290_, BlockPos p_55291_, Player p_55292_, InteractionHand p_55293_, BlockHitResult p_55294_) {
		...
		if (itemstack.canPerformAction(net.minecraftforge.common.ToolActions.SHEARS_CARVE)) {
			if (!p_55290_.isClientSide) {
				...
				p_55290_.setBlock(p_55291_, PFBlocks.SMALL_CARVED_TUBER.get().defaultBlockState().setValue(CarvedPumpkinBlock.FACING, direction1), 11);
