...
public class GrowingPrehistoricPlantBlock extends BushBlock implements IGrowable, IForgeShearable {
	protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 13.0D, 14.0D);
	
	public GrowingPrehistoricPlantBlock(Block.Properties properties) {
		super(properties);
	}
	...
	public void grow(ServerWorld world, Random rand, BlockPos pos, BlockState state) {
		DoublePlantBlock doubleplantblock = (DoublePlantBlock)(this == PFBlocks.OTOZAMITES ? PFBlocks.TALL_OTOZAMITES : PFBlocks.TALL_OSMUNDA);
