...
public class IschigualastoHutStructure extends Structure {

	public static final Codec<IschigualastoHutStructure> CODEC = simpleCodec(IschigualastoHutStructure::new);

	public IschigualastoHutStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		IschigualastoHutPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return PFStructureType.ISCHIGUALASTO_HUT.get();
	}
