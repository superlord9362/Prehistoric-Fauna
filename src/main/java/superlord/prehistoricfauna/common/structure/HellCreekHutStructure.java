...
public class HellCreekHutStructure extends Structure {

	public static final Codec<HellCreekHutStructure> CODEC = simpleCodec(HellCreekHutStructure::new);

	public HellCreekHutStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		HellCreekHutPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return PFStructureType.HELL_CREEK_HUT.get();
	}
