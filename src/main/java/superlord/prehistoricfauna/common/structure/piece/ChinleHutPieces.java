...
public class ChinleHutPieces {
	static final BlockPos PIVOT = new BlockPos(4, 0, 15);
	private static final ResourceLocation LOCATION = new ResourceLocation(PrehistoricFauna.MOD_ID, "chinle_hut");
	...
	public static void addPieces(StructureTemplateManager p_229346_, BlockPos p_229347_, Rotation p_229348_, StructurePieceAccessor p_229349_, RandomSource p_229350_) {
		p_229349_.addPiece(new ChinleHutPieces.ChinleHutPiece(p_229346_, LOCATION, p_229347_, p_229348_));
	}

	public static class ChinleHutPiece extends TemplateStructurePiece {
		public ChinleHutPiece(StructureTemplateManager p_229354_, ResourceLocation p_229355_, BlockPos p_229356_, Rotation p_229357_) {
			super(PFStructurePieceType.CHINLE_HUT.get(), 0, p_229354_, p_229355_, p_229355_.toString(), makeSettings(p_229357_), p_229356_);
		}

		public ChinleHutPiece(StructureTemplateManager p_229360_, CompoundTag p_229361_) {
			super(PFStructurePieceType.CHINLE_HUT.get(), p_229361_, p_229360_, (p_229383_) -> {
		...
		private static StructurePlaceSettings makeSettings(Rotation p_229371_) {
			return (new StructurePlaceSettings()).setRotation(p_229371_).setMirror(Mirror.NONE).setRotationPivot(ChinleHutPieces.PIVOT).addProcessor(BlockIgnoreProcessor.STRUCTURE_AND_AIR);
		}
