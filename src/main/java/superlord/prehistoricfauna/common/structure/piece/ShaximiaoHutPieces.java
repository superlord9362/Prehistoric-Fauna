...
public class ShaximiaoHutPieces {
	static final BlockPos PIVOT = new BlockPos(0, 0, 0);
	private static final ResourceLocation LOCATION = new ResourceLocation(PrehistoricFauna.MOD_ID, "shaximiao_hut");
	...
	public static void addPieces(StructureTemplateManager p_229346_, BlockPos p_229347_, Rotation p_229348_, StructurePieceAccessor p_229349_, RandomSource p_229350_) {
		p_229349_.addPiece(new ShaximiaoHutPieces.ShaximiaoHutPiece(p_229346_, LOCATION, p_229347_, p_229348_));
	}

	public static class ShaximiaoHutPiece extends TemplateStructurePiece {
		public ShaximiaoHutPiece(StructureTemplateManager p_229354_, ResourceLocation p_229355_, BlockPos p_229356_, Rotation p_229357_) {
			super(PFStructurePieceType.SHAXIMIAO_HUT.get(), 0, p_229354_, p_229355_, p_229355_.toString(), makeSettings(p_229357_), p_229356_);
		}

		public ShaximiaoHutPiece(StructureTemplateManager p_229360_, CompoundTag p_229361_) {
			super(PFStructurePieceType.SHAXIMIAO_HUT.get(), p_229361_, p_229360_, (p_229383_) -> {
		...
		private static StructurePlaceSettings makeSettings(Rotation p_229371_) {
			return (new StructurePlaceSettings()).setRotation(p_229371_).setMirror(Mirror.NONE).setRotationPivot(ShaximiaoHutPieces.PIVOT).addProcessor(BlockIgnoreProcessor.STRUCTURE_AND_AIR);
		}
