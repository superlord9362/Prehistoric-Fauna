...
public class DjadochtaHutStructure extends Structure {

	public static final Codec<DjadochtaHutStructure> CODEC = simpleCodec(DjadochtaHutStructure::new);

	public DjadochtaHutStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		DjadochtaHutPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return PFStructureType.DJADOCHTA_HUT.get();
	}
