...
public class KayentaHutStructure extends Structure {

	public static final Codec<KayentaHutStructure> CODEC = simpleCodec(KayentaHutStructure::new);

	public KayentaHutStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		KayentaHutPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return PFStructureType.KAYENTA_HUT.get();
	}
