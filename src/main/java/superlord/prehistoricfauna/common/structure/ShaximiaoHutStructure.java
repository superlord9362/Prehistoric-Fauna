...
import superlord.prehistoricfauna.common.structure.piece.ShaximiaoHutPieces;
import superlord.prehistoricfauna.init.PFStructures.PFStructureType;

public class ShaximiaoHutStructure extends Structure {

	public static final Codec<ShaximiaoHutStructure> CODEC = simpleCodec(ShaximiaoHutStructure::new);

	public ShaximiaoHutStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		ShaximiaoHutPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return PFStructureType.SHAXIMIAO_HUT.get();
	}
