...
public class MorrisonHutStructure extends Structure {

	public static final Codec<MorrisonHutStructure> CODEC = simpleCodec(MorrisonHutStructure::new);

	public MorrisonHutStructure(Structure.StructureSettings p_229388_) {
		super(p_229388_);
	}
	...
	private void generatePieces(StructurePiecesBuilder p_229396_, Structure.GenerationContext p_229397_) {
		...
		MorrisonHutPieces.addPieces(p_229397_.structureTemplateManager(), blockpos, rotation, p_229396_, p_229397_.random());
	}

	public StructureType<?> type() {
		return PFStructureType.MORRISON_HUT.get();
	}
