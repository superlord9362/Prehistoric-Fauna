...
public class PFChunkGenerator extends ChunkGenerator {
	
	public static final Codec<PFChunkGenerator> CODEC = RecordCodecBuilder.create((p_236091_0_) -> {
		return p_236091_0_.group(BiomeProvider.CODEC.fieldOf("biome_source").forGetter((p_236096_0_) -> {
			return p_236096_0_.biomeProvider;
		}), Codec.LONG.fieldOf("seed").orElseGet(WorldSeedHolder::getSeed).forGetter((p_236093_0_) -> {
		...
		})).apply(p_236091_0_, p_236091_0_.stable(PFChunkGenerator::new));
	});
	...
	public PFChunkGenerator(BiomeProvider p_i241975_1_, long p_i241975_2_, Supplier<DimensionSettings> p_i241975_4_) {
		this(p_i241975_1_, p_i241975_1_, p_i241975_2_, p_i241975_4_);
	}

	@SuppressWarnings("deprecation")
	private PFChunkGenerator(BiomeProvider p_i241976_1_, BiomeProvider p_i241976_2_, long p_i241976_3_, Supplier<DimensionSettings> p_i241976_5_) {
	...
	public ChunkGenerator func_230349_a_(long p_230349_1_) {
		return new PFChunkGenerator(this.biomeProvider.getBiomeProvider(p_230349_1_), p_230349_1_, this.field_236080_h_);
	}	
