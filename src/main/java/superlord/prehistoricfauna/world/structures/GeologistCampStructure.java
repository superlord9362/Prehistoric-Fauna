...
public class GeologistCampStructure  extends Structure<NoFeatureConfig>{
	...
	public GeologistCampStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn) {
	...
	public String getStructureName() {
		return PrehistoricFauna.MODID + ":geologist_camp";
	}
	...
	protected ChunkPos getStartPositionForPosition(ChunkGenerator<?> chunkGenerator, Random random, int x, int z, int spacingOffsetsX, int spacingOffsetsZ) {
		int maxDistance = PrehistoricFaunaConfig.geologistCampMaxDistance;
		int minDistance = PrehistoricFaunaConfig.geologistCampMinDistance;
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManagerIn, int chunkX, int chunkZ, Biome biomeIn) {
			...
			GeologistCampPieces.start(templateManagerIn, blockpos, rotation, this.components, this.rand);
