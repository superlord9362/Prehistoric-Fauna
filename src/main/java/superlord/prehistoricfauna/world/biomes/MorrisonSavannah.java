...
public class MorrisonSavannah extends Biome {
	...
	public MorrisonSavannah(Builder biomeBuilder) {
	    ...
	    this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.NORMAL_TREE.withConfiguration(ZamitesBush.ZAMITES_BUSH_CONFIG).withPlacement(Placement.COUNT_EXTRA_HEIGHTMAP.configure(new AtSurfaceWithExtraConfig(5, 0.1F, 1))));
