...
public class KayentaHutStructure extends Structure<NoFeatureConfig> {
	
	public KayentaHutStructure(Codec<NoFeatureConfig> codec) {
		super(codec);
		this.setRegistryName(PrehistoricFauna.MOD_ID + ":kayenta_hut");
	}
	
	public String getStructureName() {
		return PrehistoricFauna.MOD_ID + ":kayenta_hut";
	}
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
    	return KayentaHutStructure.Start::new;
    }
    ...
    public static class Piece extends TemplateStructurePiece {
    	...
    	public Piece(TemplateManager templateManager, ResourceLocation resourceLocation, BlockPos pos, Rotation rotation) {
    		super(PFStructures.KAYENTA_HUT_PIECE_TYPE, 0);
    	...
    	public Piece(TemplateManager templateManager, CompoundNBT compound) {
    		super(PFStructures.KAYENTA_HUT_PIECE_TYPE, compound);
        ...
        public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
    		...
    		pieceList.add(new Piece(templateManager, new ResourceLocation(PrehistoricFauna.MOD_ID, "kayenta_hut"), blockPos, rotation));
    	}
    	...
    	protected void handleDataMarker(String function, BlockPos pos, IServerWorld world, Random rand, MutableBoundingBox sbb) {
    		if (function.startsWith("chest")) {
                ...
                if (sbb.isVecInside(blockpos)) {
                    LockableLootTileEntity.setLootTable(world, rand, blockpos, PFLootTables.MORRISON_LOOT_TABLE);
                }
            }
