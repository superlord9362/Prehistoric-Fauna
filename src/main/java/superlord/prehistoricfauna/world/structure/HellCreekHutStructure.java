...
public class HellCreekHutStructure extends Structure<NoFeatureConfig> {
	...
	public String getStructureName() {
		return PrehistoricFauna.MOD_ID + ":hell_creek_hut";
	}
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
    	return HellCreekHutStructure.Start::new;
    }
    ...
    public static class Piece extends TemplateStructurePiece {
    	...
    	public Piece(TemplateManager templateManager, ResourceLocation resourceLocation, BlockPos pos, Rotation rotation) {
    		super(PFStructures.HELL_CREEK_HUT_PIECE_TYPE, 0);
    	...
    	public Piece(TemplateManager templateManager, CompoundNBT compound) {
    		super(PFStructures.HELL_CREEK_HUT_PIECE_TYPE, compound);
        ...
        public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
    		...
    		pieceList.add(new Piece(templateManager, new ResourceLocation(PrehistoricFauna.MOD_ID, "hell_creek_hut"), blockPos, rotation));
    	}
