...
public class TimeTempleStructure extends Structure<NoFeatureConfig> {
    ...
    public static class Piece extends TemplateStructurePiece {
    	...
    	public Piece(TemplateManager templateManager, ResourceLocation resourceLocation, BlockPos pos, Rotation rotation) {
    		super(PFStructures.TIME_TEMPLE_PIECE_TYPE, 0);
    	...
    	public Piece(TemplateManager templateManager, CompoundNBT compound) {
    		super(PFStructures.TIME_TEMPLE_PIECE_TYPE, compound);
        ...
        public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
    		...
    		pieceList.add(new Piece(templateManager, new ResourceLocation(PrehistoricFauna.MOD_ID, "time_temple"), blockPos, rotation));
    	}
    	...
    	protected void handleDataMarker(String function, BlockPos pos, IServerWorld world, Random rand, MutableBoundingBox sbb) {
            ...
            if ("henos".equals(function)) {
            	world.setBlockState(pos, Blocks.AIR.getDefaultState(), 2);
                TimeGuardianEntity entity = PFEntities.TIME_GUARDIAN_ENTITY.create(world.getWorld());
                if (entity != null) {
