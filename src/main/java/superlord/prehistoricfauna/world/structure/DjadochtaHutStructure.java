...
public class DjadochtaHutStructure extends Structure<NoFeatureConfig> {
	
	public DjadochtaHutStructure(Codec<NoFeatureConfig> codec) {
		super(codec);
		this.setRegistryName(PrehistoricFauna.MOD_ID + ":djadochta_hut");
	}
	
	public String getStructureName() {
		return PrehistoricFauna.MOD_ID + ":djadochta_hut";
	}
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
    	return DjadochtaHutStructure.Start::new;
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
    		...
    		pieceList.add(new Piece(templateManager, new ResourceLocation(PrehistoricFauna.MOD_ID, "djadochta_hut"), blockPos, rotation));
    	}
