...
public class AraucariaConfig implements IFeatureConfig {
   public final int count;

   public AraucariaConfig(int count) {
      this.count = count;
   }
   ...
   public static <T> AraucariaConfig deserialize(Dynamic<T> p_214659_0_) {
      int i = p_214659_0_.get("count").asInt(0);
      return new AraucariaConfig(i);
   }
}