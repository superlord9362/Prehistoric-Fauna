...
public class MorrisonHutPieces {
	...
	private static final ResourceLocation PART_1 = new ResourceLocation(PrehistoricFauna.MODID, "morrison_hut");
	...
	public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
		...
		pieceList.add(new MorrisonHutPieces.Piece(templateManager, PART_1, blockpos, rotation, true));
	}
	...
	public static class Piece extends TemplateStructurePiece
	{
		...
		{
			super(PrehistoricFeature.MORRISON_HUT_PIECE, 0);
			this.resourceLocation = resourceLocationIn;
			BlockPos blockpos = MorrisonHutPieces.OFFSET.get(resourceLocation);
		...
		{
			super(PrehistoricFeature.MORRISON_HUT_PIECE, tagCompound);
		...
		private void setupPiece(TemplateManager templateManager)
		{
			...
			PlacementSettings placementsettings = (this.overwrite ? MorrisonHutPieces.OVERWRITE : MorrisonHutPieces.INSERT).copy().setRotation(this.rotation).setMirror(Mirror.NONE);
		...
		public boolean create(IWorld worldIn, ChunkGenerator<?> chunkGeneratorIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos)
		{
			...
			BlockPos blockpos = MorrisonHutPieces.OFFSET.get(this.resourceLocation);
