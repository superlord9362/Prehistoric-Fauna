...
public class PortalChamberPieces {

    private static final ResourceLocation PART_1 = new ResourceLocation(PrehistoricFauna.MODID, "portal_chamber");
    ...
    public static void start(TemplateManager templateManager, BlockPos pos, Rotation rotation, List<StructurePiece> pieceList, Random random) {
        ...
        pieceList.add(new PortalChamberPieces.Piece(templateManager, PART_1, blockpos, rotation, true));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece(TemplateManager templateManagerIn, ResourceLocation resourceLocationIn, BlockPos pos, Rotation rotationIn, boolean overwrite) {
            super(PrehistoricFeature.PORTAL_CHAMBER_PIECE, 0);
            this.resourceLocation = resourceLocationIn;
            BlockPos blockpos = PortalChamberPieces.OFFSET.get(resourceLocation);
        ...
        public Piece(TemplateManager templateManagerIn, CompoundNBT tagCompound) {
            super(PrehistoricFeature.PORTAL_CHAMBER_PIECE, tagCompound);
        ...
        private void setupPiece(TemplateManager templateManager) {
            ...
            PlacementSettings placementsettings = (this.overwrite ? PortalChamberPieces.OVERWRITE : PortalChamberPieces.INSERT).copy().setRotation(this.rotation).setMirror(Mirror.NONE);
        ...
        public boolean create(IWorld worldIn, ChunkGenerator<?> chunkGeneratorIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos chunkPos) {
            ...
            BlockPos blockpos = PortalChamberPieces.OFFSET.get(this.resourceLocation);
