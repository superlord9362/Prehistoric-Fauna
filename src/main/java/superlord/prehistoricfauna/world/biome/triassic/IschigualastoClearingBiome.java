...
public class IschigualastoClearingBiome extends PFBiome {

	static final ConfiguredSurfaceBuilder<?> SURFACE_BUILDER = WorldGenRegistrationHelper.createConfiguredSurfaceBuilder("ischigualasto_clearing_sb", new ConfiguredSurfaceBuilder<>(PFSurfaceBuilders.ISCHIGUALASTO, new SurfaceBuilderConfig(Blocks.PODZOL.getDefaultState(), Blocks.COARSE_DIRT.getDefaultState(), Blocks.COARSE_DIRT.getDefaultState())));
	...
	public IschigualastoClearingBiome() {
