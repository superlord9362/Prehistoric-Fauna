...
public class PrehistoricLakesFeature extends Feature<BlockStateFeatureConfig> {
   ...
   public PrehistoricLakesFeature(Function<Dynamic<?>, ? extends BlockStateFeatureConfig> p_i51485_1_) {
      super(p_i51485_1_);
   }
                  ...
                  for(int j4 = 4; j4 < 8; ++j4) {
                     if (aboolean[(i2 * 16 + j3) * 8 + j4]) {
                        ...
                        if (isDirt(worldIn.getBlockState(blockpos).getBlock()) && worldIn.getLightFor(LightType.SKY, pos.add(i2, j4, j3)) > 0) {
                           ...
                           if (biome.getSurfaceBuilderConfig().getTop().getBlock() == Blocks.COARSE_DIRT) {
                              worldIn.setBlockState(blockpos, Blocks.COARSE_DIRT.getDefaultState(), 2);
                           } else {
                              worldIn.setBlockState(blockpos, Blocks.PODZOL.getDefaultState(), 2);
                           }
                        }
                     }
                  }
