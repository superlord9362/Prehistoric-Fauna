...
public abstract class PFAbstractTreeFeature<TFC extends PFTreeConfig> extends Feature<TFC> {
	 ...
	 protected static FastNoise fastNoise;
	    ...
	    public PFAbstractTreeFeature(Codec<TFC> configCodec) {
	        super(configCodec);
	    }
	    ...
	    public void placeTrunk(PFTreeConfig config, Random random, Set<BlockPos> blockSet, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
	        if (canLogPlaceHere(reader, pos)) {
	            this.setFinalBlockState(blockSet, reader, pos, config.getTrunkProvider().getBlockState(random, pos), boundingBox);
	        }
	    }

	    public void placeBranch(PFTreeConfig config, Random random, Set<BlockPos> blockSet, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
	        if (canLogPlaceHere(reader, pos)) {
	            this.setFinalBlockState(blockSet, reader, pos, config.getTrunkProvider().getBlockState(random, pos), boundingBox);
	        }
	    }

	    public void placeLeaves(PFTreeConfig config, Random random, Set<BlockPos> blockSet, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
	        if (isAir(reader, pos)) {
	    ...
	    public void placeLeaves(PFTreeConfig config, Random random, ISeedReader reader, int x, int y, int z, MutableBoundingBox boundingBox, Set<BlockPos> blockPos) {
	    ...
	    public void placeNetherTrunk(PFTreeConfig config, Random random, Set<BlockPos> blockSet, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
	        if (canLogPlaceHereNether(reader, pos)) {
	            this.setFinalBlockState(blockSet, reader, pos, config.getTrunkProvider().getBlockState(random, pos), boundingBox);
	        }
	    }

	    public void placeNetherBranch(PFTreeConfig config, Random random, Set<BlockPos> blockSet, ISeedReader reader, BlockPos pos, MutableBoundingBox boundingBox) {
	        if (canLogPlaceHereNether(reader, pos)) {
	            this.setFinalBlockState(blockSet, reader, pos, config.getTrunkProvider().getBlockState(random, pos), boundingBox);
	        }
	    }
	     ...
	     */
	    public static boolean isDesiredGroundwDirtTag(IWorldGenerationBaseReader reader, BlockPos pos, PFTreeConfig config) {
	    ...
	    public static boolean isDesiredGroundwNetherTags(IWorldGenerationBaseReader reader, BlockPos pos, PFTreeConfig config) {
	        if (config.isPlacementForced())
	            return true;
	    ...
	    public static boolean isDesiredGroundwEndTags(IWorldGenerationBaseReader reader, BlockPos pos, PFTreeConfig config) {
	        if (config.isPlacementForced())
	            return true;
	    ...
	    public static boolean isDesiredGroundwSandTag(IWorldGenerationBaseReader reader, BlockPos pos, PFTreeConfig config) {
	        if (config.isPlacementForced())
	            return true;
	    ...
	    public void buildTrunkBase(BlockPos centerPos, Set<BlockPos> treeBlocksSet, ISeedReader reader, PFTreeConfig config, Random rand, MutableBoundingBox boundingBox, BlockPos... trunkPositions) {
	        if (config.isPlacementForced())
	            return;
	     ...
	     */
	    public void setSoil(Set<BlockPos> treeBlocksSet, IWorldGenerationBaseReader reader, PFTreeConfig config, Random rand, MutableBoundingBox boundingBox, BlockPos... trunkPositions) {
	        if (trunkPositions.length > 0) {
	            BlockPos.Mutable mutableTrunk = new BlockPos.Mutable();
	            for (BlockPos trunkPos : trunkPositions) {
	                mutableTrunk.setPos(trunkPos);
	    ...
	    @SuppressWarnings("deprecation")
		public void setDisk(ISeedReader world, Random random, BlockPos pos, PFTreeConfig config) {
