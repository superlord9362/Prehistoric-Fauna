...
public class LiriodendritesTreeFlower extends Tree {
	
	public final static BlockState LIRIODENDRITES_LOG = BlockInit.LIRIODENDRITES_LOG.getDefaultState();
	public final static BlockState LIRIODENDRITES_LEAVES = BlockInit.LIRIODENDRITES_LEAVES_FLOWER.getDefaultState();
