...
public class ZamitesFoliageGenerator extends FoliagePlacer {
   public ZamitesFoliageGenerator(int p_i225846_1_, int p_i225846_2_) {
      super(p_i225846_1_, p_i225846_2_, PrehistoricFoliagePlacerType.ZAMITES);
   }

   public <T> ZamitesFoliageGenerator(Dynamic<T> p_i225847_1_) {
