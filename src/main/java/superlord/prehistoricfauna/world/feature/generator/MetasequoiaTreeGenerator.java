...
public class MetasequoiaTreeGenerator extends PrehistoricTreeFeature<PrehistoricGiantTreeFeatureConfig> {
    ...
    */
   @Override
   protected boolean place(IWorldGenerationReader generationReader, Random rand, BlockPos positionIn, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox boundingBoxIn, PrehistoricGiantTreeFeatureConfig configIn) {
      int i = this.func_227256_a_(rand, configIn);
      if (!this.hasRoom(generationReader, positionIn, i, configIn)) {
         return false;
      } else {
         this.func_227253_a_(generationReader, rand, positionIn.getX(), positionIn.getZ(), positionIn.getY() + i, 1, p_225557_5_, boundingBoxIn, configIn);
         this.func_227254_a_(generationReader, rand, positionIn, i, p_225557_4_, boundingBoxIn, configIn);
         return true;
      }
   }
   
   private void func_227253_a_(IWorldGenerationReader p_227253_1_, Random p_227253_2_, int p_227253_3_, int p_227253_4_, int p_227253_5_, int p_227253_6_, Set<BlockPos> p_227253_7_, MutableBoundingBox p_227253_8_, PrehistoricGiantTreeFeatureConfig p_227253_9_) {
