...
public class AraucariaTreeGenerator extends PrehistoricTreeFeature<PrehistoricGiantTreeFeatureConfig> {
   public AraucariaTreeGenerator(Function<Dynamic<?>, ? extends PrehistoricGiantTreeFeatureConfig> p_i225808_1_) {
      super(p_i225808_1_);
   }
    ...
    */
   public boolean place(IWorldGenerationReader generationReader, Random rand, BlockPos positionIn, Set<BlockPos> p_225557_4_, Set<BlockPos> p_225557_5_, MutableBoundingBox boundingBoxIn, PrehistoricGiantTreeFeatureConfig configIn) {
   ...
   private void func_227252_c_(IWorldGenerationReader p_227252_1_, Random p_227252_2_, BlockPos p_227252_3_, int p_227252_4_, Set<BlockPos> p_227252_5_, MutableBoundingBox p_227252_6_, PrehistoricGiantTreeFeatureConfig p_227252_7_) {
      for(int j = -2; j <= 0; ++j) {
