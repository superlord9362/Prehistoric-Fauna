...
public class AraucariaSmallTree2 extends PHFAbstractTreeFeature<PHFTreeConfig> {

    public AraucariaSmallTree2(Function<Dynamic<?>, ? extends PHFTreeConfig> configIn) {
        super(configIn);
    }
