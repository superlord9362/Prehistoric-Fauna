...
{
	public static final IRecipeType<IRecipe<IInventory>> RECIPE_TYPE_PALEONTOLOGY_TABLE = IRecipeType.register(PrehistoricFauna.MODID + ":recipe_paleontology_table");
	...
	{
		this.serializer = RecipeRegistry.RECIPE_SERIALIZER_PALEONTOLOGY_TABLE.get();
