...
public class EntityAllosaurus extends EntityTameable {
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks.addTask(4, new EntityAITargetNonTamed<>(this, EntityAnimal.class, false, new Predicate<Entity>() {
            public boolean apply(@Nullable Entity p_apply_1_) {
                return p_apply_1_ instanceof EntityGallimimus || p_apply_1_ instanceof EntityDryosaurus;
            }
        }));
    }
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(87.0D);
    ...
    public void onLivingUpdate() {
        ...
        if (!this.world.isRemote && !this.isChild() && --this.timeUntilNextEgg <= 0) {
            ...
            this.dropItem(ModItems.ALLOSAURUS_EGG, 1);
            this.timeUntilNextEgg = this.rand.nextInt(6000) + 6000;
        }
