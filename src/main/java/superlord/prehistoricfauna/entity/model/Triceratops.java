...
public class Triceratops extends EntityModel<TriceratopsEntity> {
    ...
    public Triceratops() {
        ...
        this.Saddle.addBox(-12.0F, -8.0F, -24.0F, 24.0F, 31.0F, 43.0F, 0.4F, 0.4F, 0.4F);
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) { 
        ImmutableList.of(this.RightHindLeg1, this.LeftFrontLeg, this.LeftHindLeg1, this.RightFrontLeg, this.Body, this.Saddle).forEach((modelRenderer) -> { 
