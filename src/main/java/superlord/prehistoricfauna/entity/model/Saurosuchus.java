...
public class Saurosuchus extends EntityModel<SaurosuchusEntity> {
    ...
    public Saurosuchus() {
        ...
        this.Cheek.addBox(-2.5F, -2.0F, -7.1F, 5.0F, 4.0F, 7.0F, 0.0F, 0.0F, 0.0F);
        this.Thigh_1 = new ModelRenderer(this, 11, 15);
        this.Thigh_1.setRotationPoint(-4.0F, -1.0F, 6.5F);
        ...
        this.Arm_1.setRotationPoint(-2.6F, 1.0F, -16.5F);
        ...
        this.Arm.setRotationPoint(2.6F, 1.0F, -16.5F);
        this.Arm.addBox(0.0F, -2.0F, -2.5F, 4.0F, 17.0F, 5.0F, 0.0F, 0.0F, 0.0F);
        ...
        this.Thigh.setRotationPoint(4.0F, -1.0F, 6.5F);
