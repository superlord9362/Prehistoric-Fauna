...
public class AllosaurusEntity extends PrehistoricEntity {
	...
	public AgeableEntity createChild(AgeableEntity ageable) {
		AllosaurusEntity entity = new AllosaurusEntity(ModEntityTypes.ALLOSAURUS_ENTITY, this.world);
	...
	public boolean isBreedingItem(ItemStack stack) {
		return stack.getItem() == ItemInit.RAW_STEGOSAURUS_MEAT.get();
	}
	...
	static class LayEggGoal extends MoveToBlockGoal {
		...
		public void tick() {
			super.tick();
			BlockPos blockpos = new BlockPos(this.allosaurus);
