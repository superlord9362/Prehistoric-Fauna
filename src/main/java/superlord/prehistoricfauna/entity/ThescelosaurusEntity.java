...
public class ThescelosaurusEntity extends PrehistoricEntity {
	
   private static final DataParameter<BlockPos> HOME_POS = EntityDataManager.createKey(ThescelosaurusEntity.class, DataSerializers.BLOCK_POS);
   ...
   private static final DataParameter<BlockPos> TRAVEL_POS = EntityDataManager.createKey(ThescelosaurusEntity.class, DataSerializers.BLOCK_POS);
   private static final DataParameter<Boolean> GOING_HOME = EntityDataManager.createKey(ThescelosaurusEntity.class, DataSerializers.BOOLEAN);
   private static final DataParameter<Boolean> TRAVELLING = EntityDataManager.createKey(ThescelosaurusEntity.class, DataSerializers.BOOLEAN);
