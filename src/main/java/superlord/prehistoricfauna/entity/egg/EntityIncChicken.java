...
public class EntityIncChicken extends EntityThrowable {
    public EntityIncChicken(World worldIn) {
        super(worldIn);
    }

    public EntityIncChicken(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncChicken(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
