...
public class EntityIncBaryonyx extends EntityThrowable {
    public EntityIncBaryonyx(World worldIn) {
        super(worldIn);
    }

    public EntityIncBaryonyx(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncBaryonyx(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            EntityBaryonyx entitychicken = new EntityBaryonyx(this.world);
