...
public class EntityParasaurolophusEgg extends EntityThrowable {
    public EntityParasaurolophusEgg(World worldIn) {
        super(worldIn);
    }

    public EntityParasaurolophusEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityParasaurolophusEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
