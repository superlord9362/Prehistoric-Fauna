...
public class EntityIncParasaurolophus extends EntityThrowable {
    public EntityIncParasaurolophus(World worldIn) {
        super(worldIn);
    }

    public EntityIncParasaurolophus(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncParasaurolophus(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            EntityParasaurolophus entitychicken = new EntityParasaurolophus(this.world);
