...
public class EntityIncAnkylosaurus extends EntityThrowable {
    public EntityIncAnkylosaurus(World worldIn) {
        super(worldIn);
    }

    public EntityIncAnkylosaurus(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncAnkylosaurus(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            EntityAnkylosaurus entitychicken = new EntityAnkylosaurus(this.world);
