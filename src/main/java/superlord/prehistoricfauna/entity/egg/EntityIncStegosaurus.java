...
public class EntityIncStegosaurus extends EntityThrowable {
    public EntityIncStegosaurus(World worldIn) {
        super(worldIn);
    }

    public EntityIncStegosaurus(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncStegosaurus(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            EntityStegosaurus entitychicken = new EntityStegosaurus(this.world);
