...
public class EntityBaryonyxEgg extends EntityThrowable {
    public EntityBaryonyxEgg(World worldIn) {
        super(worldIn);
    }

    public EntityBaryonyxEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityBaryonyxEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
