...
public class EntityIncAllosaurus extends EntityThrowable {
    public EntityIncAllosaurus(World worldIn) {
        super(worldIn);
    }

    public EntityIncAllosaurus(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncAllosaurus(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
