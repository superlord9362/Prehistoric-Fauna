...
public class EntityStegosaurusEgg extends EntityThrowable {
    public EntityStegosaurusEgg(World worldIn) {
        super(worldIn);
    }

    public EntityStegosaurusEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityStegosaurusEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
