...
public class EntityIncDryosaurus extends EntityThrowable {
    public EntityIncDryosaurus(World worldIn) {
        super(worldIn);
    }

    public EntityIncDryosaurus(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncDryosaurus(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            EntityDryosaurus entitychicken = new EntityDryosaurus(this.world);
