...
public class EntityAnkylosaurusEgg extends EntityThrowable {
    public EntityAnkylosaurusEgg(World worldIn) {
        super(worldIn);
    }

    public EntityAnkylosaurusEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityAnkylosaurusEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
