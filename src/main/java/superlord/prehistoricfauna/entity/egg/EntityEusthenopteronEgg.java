...
public class EntityEusthenopteronEgg extends EntityThrowable
{
    public EntityEusthenopteronEgg(World worldIn)
    {
        super(worldIn);
    }

    public EntityEusthenopteronEgg(World worldIn, EntityLivingBase throwerIn)
    {
        super(worldIn, throwerIn);
    }

    public EntityEusthenopteronEgg(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result)
    {
        ...
        EntityEusthenopteron entitychicken = new EntityEusthenopteron(this.world);
