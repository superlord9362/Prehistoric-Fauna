...
public class EntityDryosaurusEgg extends EntityThrowable {
    public EntityDryosaurusEgg(World worldIn) {
        super(worldIn);
    }

    public EntityDryosaurusEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityDryosaurusEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
