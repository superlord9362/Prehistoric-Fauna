...
public class EntityIncPrenocephale extends EntityThrowable {
    public EntityIncPrenocephale(World worldIn) {
        super(worldIn);
    }

    public EntityIncPrenocephale(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncPrenocephale(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
