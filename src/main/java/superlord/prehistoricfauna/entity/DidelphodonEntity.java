...
public class DidelphodonEntity extends AnimalEntity {
	...
	private static final Ingredient TEMPTATION_ITEMS = Ingredient.fromItems(BlockInit.CRASSOSTREA_OYSTER.asItem());
	private int isReady;
	...
	public boolean isBreedingItem(ItemStack stack) {
		return stack.getItem() == BlockInit.CRASSOSTREA_OYSTER.asItem();
	}
