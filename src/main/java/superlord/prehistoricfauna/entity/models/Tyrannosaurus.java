...
public class Tyrannosaurus extends ModelBase {
    ...
    public ModelRenderer AHorn2_1;
    public ModelRenderer shape48;
    public ModelRenderer shape50;
    public ModelRenderer shape48_1;
    public ModelRenderer AHorn2_2;
    public ModelRenderer AHorn2_3;
    ...
    public Tyrannosaurus() {
        ...
        this.shape48_1 = new ModelRenderer(this, 0, 100);
        this.shape48_1.setRotationPoint(0.0F, 0.0F, 0.0F);
        this.shape48_1.addBox(-1.0F, -1.0F, -6.5F, 3, 1, 7, 0.0F);
        ...
        this.shape50.setRotationPoint(0.0F, 0.0F, -1.0F);
        this.shape50.addBox(0.0F, -2.0F, -6.0F, 1, 1, 7, 0.0F);
        this.setRotateAngle(shape50, 0.045553093477052F, 0.0F, 0.0F);
        ...
        this.AHorn2.setRotationPoint(3.0F, -4.0F, -0.9F);
        this.AHorn2.addBox(-0.3F, -0.9F, -1.0F, 1, 1, 2, 0.0F);
        this.setRotateAngle(AHorn2, 0.7740535232594852F, -0.27314402793711257F, 0.5462880558742251F);
        ...
        this.AHorn2_2 = new ModelRenderer(this, 12, 0);
        this.AHorn2_2.setRotationPoint(0.0F, 0.2F, -0.5F);
        this.AHorn2_2.addBox(0.25F, 0.6F, -1.9F, 1, 1, 2, 0.0F);
        this.setRotateAngle(AHorn2_2, 1.9577358219620393F, -0.18203784098300857F, -0.4553564018453205F);
        ...
        this.JHead.setRotationPoint(0.0F, 0.0F, -9.0F);
        this.JHead.addBox(-2.5F, -2.4F, -3.0F, 5, 5, 5, 0.0F);
        this.setRotateAngle(JHead, 0.6373942428283291F, 0.0F, 0.0F);
        ...
        this.shape48 = new ModelRenderer(this, 0, 100);
        this.shape48.setRotationPoint(0.0F, 4.0F, -1.0F);
        this.shape48.addBox(-1.0F, -1.0F, -6.0F, 3, 1, 7, 0.0F);
        ...
        this.AHorn2_1 = new ModelRenderer(this, 12, 0);
        this.AHorn2_1.setRotationPoint(-2.7F, -3.9F, -0.9F);
        this.AHorn2_1.addBox(-0.3F, -0.9F, -1.0F, 1, 1, 2, 0.0F);
        this.setRotateAngle(AHorn2_1, 0.7740535232594852F, -0.27314402793711257F, 0.0F);
        ...
        this.AHorn2_3 = new ModelRenderer(this, 12, 0);
        this.AHorn2_3.setRotationPoint(0.0F, 0.2F, -0.5F);
        this.AHorn2_3.addBox(0.25F, 0.6F, -1.9F, 1, 1, 2, 0.0F);
        this.setRotateAngle(AHorn2_3, 1.9577358219620393F, -0.18203784098300857F, -0.4553564018453205F);
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) { 
    	if (this.isChild) {
            ...
            GlStateManager.translate(0.0F, 125.0F * f5, 1.0F);
            this.JBody.render(f5);
            GlStateManager.popMatrix();
    	} else {
        GlStateManager.pushMatrix();
        GlStateManager.translate(this.JBody.offsetX, this.JBody.offsetY, this.JBody.offsetZ);
        GlStateManager.translate(this.JBody.rotationPointX * f5, this.JBody.rotationPointY * f5, this.JBody.rotationPointZ * f5);
        ...
        GlStateManager.translate(this.ABody1.rotationPointX * f5, this.ABody1.rotationPointY * f5, this.ABody1.rotationPointZ * f5);
