...
public abstract class PrehistoricStagedEntity extends ThreeStageAgeEntity {
   private int inLove;
   private UUID playerInLove;

   protected PrehistoricStagedEntity(EntityType<? extends PrehistoricStagedEntity> type, World worldIn) {
      super(type, worldIn);
   }
    ...
    */
   public static boolean canAnimalSpawn(EntityType<? extends PrehistoricStagedEntity> animal, IWorld worldIn, SpawnReason reason, BlockPos pos, Random random) {
    ...
    */
   public boolean canMateWith(PrehistoricStagedEntity otherAnimal) {
      if (otherAnimal == this) {
         return false;
