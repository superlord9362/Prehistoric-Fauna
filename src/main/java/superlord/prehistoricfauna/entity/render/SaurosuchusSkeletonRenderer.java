...
import superlord.prehistoricfauna.entity.model.SaurosuchusSkeleton;
import superlord.prehistoricfauna.entity.model.SaurosuchusSkeletonActionLeft;
import superlord.prehistoricfauna.entity.model.SaurosuchusSkeletonActionRight;
import superlord.prehistoricfauna.entity.model.SaurosuchusSkeletonSleeping;
...
public class SaurosuchusSkeletonRenderer extends MobRenderer<SaurosuchusSkeletonEntity, EntityModel<SaurosuchusSkeletonEntity>> {
	...
	private static final ResourceLocation SKELETON = new ResourceLocation(PrehistoricFauna.MODID, "textures/entities/skeleton/saurosuchus_skeleton.png");
