...
public class PaleopaintingRenderer extends EntityRenderer<PaleopaintingEntity> {
   public PaleopaintingRenderer(EntityRendererManager renderManagerIn) {
      super(renderManagerIn);
   }

   public void render(PaleopaintingEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
      matrixStackIn.push();
      matrixStackIn.rotate(Vector3f.YP.rotationDegrees(180.0F - entityYaw));
      PaleopaintingType paintingtype = entityIn.art;
      float f = 0.0625F;
      ...
      PaleopaintingSpriteUploader paintingspriteuploader = PrehistoricFauna.instance.getPaintingSpriteUploader();
   ...
   private void func_229122_a_(MatrixStack p_229122_1_, IVertexBuilder p_229122_2_, PaleopaintingEntity p_229122_3_, int p_229122_4_, int p_229122_5_, TextureAtlasSprite p_229122_6_, TextureAtlasSprite p_229122_7_) {
