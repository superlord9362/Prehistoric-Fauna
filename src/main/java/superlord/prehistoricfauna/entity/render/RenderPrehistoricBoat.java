...
import superlord.prehistoricfauna.entity.model.PrehistoricBoatModel;

public class RenderPrehistoricBoat extends EntityRenderer<PrehistoricBoatEntity> {
	   private static final ResourceLocation[] BOAT_TEXTURES = new ResourceLocation[]{new ResourceLocation(PrehistoricFauna.MODID, "textures/entity/boat/araucaria.png")};
	   protected final PrehistoricBoatModel modelBoat = new PrehistoricBoatModel();

	   public RenderPrehistoricBoat(EntityRendererManager renderManagerIn) {
