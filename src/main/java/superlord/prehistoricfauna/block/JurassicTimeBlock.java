	...
	public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean isMoving) {
		if(world.getBlockState(pos.down()).getBlock() == BlockInit.PORTAL_FRAME) {
			if (world.getBlockState(pos.east()).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.east().up()).getBlock() == BlockInit.PORTAL_PROJECTOR && world.getBlockState(pos.east().up(2)).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.up(3)).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.west().up(3)).getBlock() == BlockInit.PORTAL_PROJECTOR && world.getBlockState(pos.west(2).up(3)).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.west(3)).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.west(3).up()).getBlock() == BlockInit.PORTAL_PROJECTOR && world.getBlockState(pos.west(3).up(2)).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.west().down()).getBlock() == BlockInit.PORTAL_PROJECTOR && world.getBlockState(pos.west(2).down()).getBlock() == BlockInit.PORTAL_FRAME && world.getBlockState(pos.up()).getBlock() == Blocks.AIR && world.getBlockState(pos.up(2)).getBlock() == Blocks.AIR && world.getBlockState(pos.west()).getBlock() == Blocks.AIR && world.getBlockState(pos.west().up()).getBlock() == Blocks.AIR && world.getBlockState(pos.west().up(2)).getBlock() == Blocks.AIR && world.getBlockState(pos.west(2)).getBlock() == Blocks.AIR && world.getBlockState(pos.west(2).up()).getBlock() == Blocks.AIR && world.getBlockState(pos.west(2).up(2)).getBlock() == Blocks.AIR) {
				world.setBlockState(pos, BlockInit.JURASSIC_PORTAL.getDefaultState());
				...
				world.setBlockState(pos.west(), BlockInit.JURASSIC_PORTAL.getDefaultState());
				...
				world.setBlockState(pos.west(2), BlockInit.JURASSIC_PORTAL.getDefaultState());
				world.setBlockState(pos.west(2).up(), BlockInit.JURASSIC_PORTAL.getDefaultState());
				world.setBlockState(pos.west(2).up(2), BlockInit.JURASSIC_PORTAL.getDefaultState());
				...
				world.setBlockState(pos.up(), BlockInit.JURASSIC_PORTAL.getDefaultState());
				world.setBlockState(pos.up(2), BlockInit.JURASSIC_PORTAL.getDefaultState());
				world.setBlockState(pos.east(), BlockInit.JURASSIC_PORTAL.getDefaultState());
				...
				world.setBlockState(pos.east(2), BlockInit.JURASSIC_PORTAL.getDefaultState());
				world.setBlockState(pos.east(2).up(), BlockInit.JURASSIC_PORTAL.getDefaultState());
				world.setBlockState(pos.east(2).up(2), BlockInit.JURASSIC_PORTAL.getDefaultState());
				...
				world.setBlockState(pos, BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.up(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.up(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.south(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.south().up(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.south().up(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.south(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.south(2).up(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.south(2).up(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				...
				world.setBlockState(pos.up(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.up(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.north(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.north().up(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.north().up(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.north(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.north(2).up(), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
				world.setBlockState(pos.north(2).up(2), BlockInit.JURASSIC_PORTAL.getDefaultState().with(JurassicPortalBlock.AXIS, Axis.Z));
			}
