...
public class DicroidiumBlock extends BushBlock {
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		return blockpos.getY() < context.getWorld().getDimension().getHeight() - 1 && context.getWorld().getBlockState(blockpos.up()).isReplaceable(context) && context.getWorld().getBlockState(blockpos.up(2)).isReplaceable(context) && context.getWorld().getBlockState(blockpos.up(3)).isReplaceable(context) && context.getWorld().getBlockState(blockpos.up(4)).isReplaceable(context) ? super.getStateForPlacement(context) : null;
	}
