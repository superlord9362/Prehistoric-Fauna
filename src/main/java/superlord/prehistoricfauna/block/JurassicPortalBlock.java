...
public class JurassicPortalBlock extends Block {
	...
	public JurassicPortalBlock(Properties builder) {
		super(builder);
	...
	protected void fillStateContainer(StateContainer.Builder<Block, BlockState> builder) {
	 ...
	 public boolean trySpawnPortal(World world, BlockPos pos) {
		 JurassicPortalBlock.Size size = new JurassicPortalBlock.Size(world, pos);
		 if (size.isValid()) {
			 size.placePortalBlocks();
			 world.playSound(null, pos, SoundEvents.BLOCK_END_PORTAL_SPAWN, SoundCategory.BLOCKS, 0.7F, 1.0F);
			 return true;
		 } else {
			 JurassicPortalBlock.Size size1 = new JurassicPortalBlock.Size(world, pos);
			 if (size1.isValid()) {
    ...
    public static class Size {
        ...
        void placePortalBlocks() {
            for (BlockPos portalPos : BlockPos.Mutable.getAllInBoxMutable(nw, se)) {
                this.world.setBlockState(portalPos, BlockInit.JURASSIC_PORTAL.getDefaultState(), 2);
            }
        }
    }
