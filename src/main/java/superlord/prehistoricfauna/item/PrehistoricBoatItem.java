...
public class PrehistoricBoatItem extends Item {
	   ...
	   private final PrehistoricBoatEntity.Type type;

	   public PrehistoricBoatItem(PrehistoricBoatEntity.Type typeIn, Item.Properties properties) {
	      super(properties);
	      this.type = typeIn;
	   }
	   ...
	   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
	      ...
	      if (raytraceresult.getType() == RayTraceResult.Type.MISS) {
	         ...
	         if (raytraceresult.getType() == RayTraceResult.Type.BLOCK) {
	        	 PrehistoricBoatEntity boatentity = new PrehistoricBoatEntity(worldIn, raytraceresult.getHitVec().x, raytraceresult.getHitVec().y, raytraceresult.getHitVec().z);
