...
public class JurassicTimeTotemItem extends Item {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
        ...
        if (canOpenPortal(iworld.getBlockState(blockpos1), iworld, blockpos1)) {
           ...
           BlockState blockstate1 = ((JurassicTimeBlock)BlockInit.JURASSIC_TIME_BLOCK).getDefaultState();
	...
	public static boolean canOpenPortal(BlockState existingState, IWorld worldIn, BlockPos posIn) {
		BlockState blockstate = ((JurassicTimeBlock)BlockInit.JURASSIC_TIME_BLOCK).getDefaultState();
		boolean flag = false;
