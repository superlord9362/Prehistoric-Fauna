...
public class PFEntities {
	...
	public static final EntityType<VelociraptorSkullEntity> VELOCIRAPTOR_SKULL = register(EntityType.Builder.<VelociraptorSkullEntity>create(VelociraptorSkullEntity::new, EntityClassification.MISC).size(1F, 1F), "velociraptor_skull");
	...
	public static final EntityType<ProtoceratopsSkeletonEntity> PROTOCERATOPS_SKELETON = register(EntityType.Builder.<ProtoceratopsSkeletonEntity>create(ProtoceratopsSkeletonEntity::new, EntityClassification.MISC).size(1F, 1F), "protoceratops_skeleton");
	public static final EntityType<PostosuchusSkullEntity> POSTOSUCHUS_SKULL = register(EntityType.Builder.<PostosuchusSkullEntity>create(PostosuchusSkullEntity::new, EntityClassification.MISC).size(1F, 1F), "postosuchus_skull");
