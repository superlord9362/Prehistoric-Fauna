...
//	public static final RegistryObject<EntityType<Thoracosaurus>> THORACOSAURUS = REGISTER.register("thoracosaurus", () -> EntityType.Builder.<Thoracosaurus>of(Thoracosaurus::new, MobCategory.CREATURE).sized(1, 1).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "thoracosaurus").toString()));
	...
	public static final RegistryObject<EntityType<Liaonemobius>> PARAPLEURITES = REGISTER.register("parapleurites", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "parapleurites").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> EOPOLIS = REGISTER.register("eopolis", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "eopolis").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> CYLINDRICUM = REGISTER.register("cylindricum", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "cylindricum").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> RHIPIDOBLATTINA = REGISTER.register("rhipidoblattina", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "rhipidoblattina").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> CICADOCORIS = REGISTER.register("cicadocoris", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "cicadocoris").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> MESOFORFICULA = REGISTER.register("mesoforficula", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "mesoforficula").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> ABOILUS = REGISTER.register("aboilus", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "aboilus").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> PALEOHELCURA = REGISTER.register("paleohelcura", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "paleohelcura").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> OCTOPODICHNUS = REGISTER.register("octopodichnus", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "octopodichnus").toString()));
	public static final RegistryObject<EntityType<Liaonemobius>> DIPLICHNITES = REGISTER.register("diplichnites", () -> EntityType.Builder.<Liaonemobius>of(Liaonemobius::new, MobCategory.AMBIENT).sized(0.25F, 0.25F).build(new ResourceLocation(PrehistoricFauna.MOD_ID, "diplichnites").toString()));
