...
import superlord.prehistoricfauna.common.effect.DilophosaurusEffect;
...
public class PFEffects {
	...
	public static final RegistryObject<MobEffect> HEARD_DILOPHOSAURUS = REGISTER.register("heard_dilophosaurus", () -> new DilophosaurusEffect(MobEffectCategory.NEUTRAL, 0x9D1618));
