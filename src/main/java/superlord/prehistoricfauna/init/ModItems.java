...
import superlord.prehistoricfauna.items.ItemDNADisk100;
...
public class ModItems {
    ...
    public static final Item TRICERATOPS_DNA = new ItemDNADisk100("triceratops_dna");
    public static final Item GALLIMIMUS_DNA = new ItemDNADisk100("gallimimus_dna");
    public static final Item TYRANNOSAURUS_DNA = new ItemDNADisk100("tyrannosaurus_dna");
    public static final Item VELOCIRAPTOR_DNA = new ItemDNADisk100("velociraptor_dna");
    ...
    public static final Item STEGOSAURUS_DNA = new ItemDNADisk100("stegosaurus_dna");
    public static final Item CAMARASAURUS_DNA = new ItemDNADisk100("camarasaurus_dna");
    public static final Item DRYOSAURUS_DNA = new ItemDNADisk100("dryosaurus_dna");
    public static final Item COBBLE_BRICK = new ItemCobbleBrick("cobble_brick");
    public static final Item ALLOSAURUS_DNA = new ItemDNADisk100("allosaurus_dna");
    ...
    public static final Item PARADOXIDES_DNA = new ItemDNADisk100("paradoxides_dna");
    public static final Item CLADOCYCLUS_DNA = new ItemDNADisk100("cladocyclus_dna");
    public static final Item EUSTHENOPTERON_DNA = new ItemDNADisk100("eusthenopteron_dna");
    public static final Item COOKSONIA_DNA = new ItemDNADisk100("cooksonia_dna");
    public static final Item ARCHAEAMPHORA_DNA = new ItemDNADisk100("archaeamphora_dna");
}
