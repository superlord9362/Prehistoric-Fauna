...
public class PFChunkGenerators {
    public static final DeferredRegister<Codec<? extends ChunkGenerator>> REGISTER = DeferredRegister.create(BuiltInRegistries.CHUNK_GENERATOR.key(), PrehistoricFauna.MOD_ID);
