...
public class PFWoodTypes {
	...
	public static final BlockSetType LIRIODENDRITES_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "liriodendrites").toString()));
	public static final BlockSetType GINKGO_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "ginkgo").toString()));
	public static final BlockSetType TROCHODENDROIDES_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "trochodendroides").toString()));
	public static final BlockSetType BRACHYPHYLLUM_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "brachyphyllum").toString()));
	public static final BlockSetType WOODWORTHIA_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "woodworthia").toString()));
	public static final BlockSetType SCHILDERIA_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "schilderia").toString()));
	public static final BlockSetType NEOCALAMITES_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "neocalamites").toString()));
	public static final BlockSetType DRYOPHYLLUM_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "dryophyllum").toString()));
	public static final BlockSetType TAXODIUM_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "taxodium").toString()));
	public static final BlockSetType SABALITES_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "sabalites").toString()));
	public static final BlockSetType PLATANITES_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "platanites").toString()));
	public static final BlockSetType TAXUS_TYPE = BlockSetType.register(new BlockSetType(new ResourceLocation(PrehistoricFauna.MOD_ID, "taxus").toString()));
	...
	public static WoodType LIRIODENDRITES = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "liriodendrites").toString(), LIRIODENDRITES_TYPE));
	public static WoodType GINKGO = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "ginkgo").toString(), GINKGO_TYPE));
	public static WoodType TROCHODENDROIDES = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "trochodendroides").toString(), TROCHODENDROIDES_TYPE));
	public static WoodType BRACHYPHYLLUM = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "brachyphyllum").toString(), BRACHYPHYLLUM_TYPE));
	public static WoodType WOODWORTHIA = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "woodworthia").toString(), WOODWORTHIA_TYPE));
	public static WoodType SCHILDERIA = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "schilderia").toString(), SCHILDERIA_TYPE));
	public static WoodType NEOCALAMITES = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "neocalamites").toString(), NEOCALAMITES_TYPE));
	public static WoodType DRYOPHYLLUM = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "dryophyllum").toString(), DRYOPHYLLUM_TYPE));
	public static WoodType TAXODIUM = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "taxodium").toString(), TAXODIUM_TYPE));
	public static WoodType SABALITES = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "sabalites").toString(), SABALITES_TYPE));
	public static WoodType PLATANITES = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "platanites").toString(), PLATANITES_TYPE));
	public static WoodType TAXUS = WoodType.register(new WoodType(new ResourceLocation(PrehistoricFauna.MOD_ID, "taxus").toString(), TAXUS_TYPE));
