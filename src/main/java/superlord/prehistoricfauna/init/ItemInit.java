...
public class ItemInit {
	...
	public static final RegistryObject<SpawnSkeletonItem> STEGOSAURUS_SKELETON = ITEMS.register("stegosaurus_skeleton", () -> new SpawnSkeletonItem(ModEntityTypes.STEGOSAURUS_SKELETON, new Item.Properties().group(PFFossil.instance)));
