...
public class PFProfessions {
	...
	public static void addGeologistTrades(Int2ObjectMap<List<VillagerTrades.ITrade>> trades) {
		...
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFBlocks.GIANT_AMMONITE_SHELL_BB.asItem()), 12, 6, rareItemForEmeraldsMultiplier));
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFBlocks.GIANT_AMMONITE_SHELL_BF.asItem()), 12, 6, rareItemForEmeraldsMultiplier));
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFBlocks.GIANT_AMMONITE_SHELL_TB.asItem()), 12, 6, rareItemForEmeraldsMultiplier));
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFBlocks.GIANT_AMMONITE_SHELL_TF.asItem()), 12, 6, rareItemForEmeraldsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(PFItems.TRICERATOPS_FOSSIL.get()), 12, 6, emeraldForItemsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(PFItems.ANKYLOSAURUS_FOSSIL.get()), 12, 6, emeraldForItemsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(PFItems.STEGOSAURUS_FOSSIL.get()), 12, 6, emeraldForItemsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(PFItems.CERATOSAURUS_FOSSIL.get()), 12, 6, emeraldForItemsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(PFItems.HERRERASAURUS_FOSSIL.get()), 12, 6, emeraldForItemsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(PFItems.ISCHIGUALASTIA_FOSSIL.get()), 12, 6, emeraldForItemsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFItems.TYRANNOSAURUS_FOSSIL.get()), 8, 7, rareItemForEmeraldsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFItems.ALLOSAURUS_FOSSIL.get()), 8, 7, rareItemForEmeraldsMultiplier));
		trades.get(4).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 4), new ItemStack(PFItems.SAUROSUCHUS_FOSSIL.get()), 8, 7, rareItemForEmeraldsMultiplier));
