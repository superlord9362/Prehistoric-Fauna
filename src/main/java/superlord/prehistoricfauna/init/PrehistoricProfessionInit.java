...
public class PrehistoricProfessionInit {
	...
	public static void addGeologistTrades(Int2ObjectMap<List<VillagerTrades.ITrade>> trades) {
		...
		trades.get(1).add((entity, random) -> new MerchantOffer(new ItemStack(BlockInit.SANDSTONE.asItem(), 24), new ItemStack(Items.EMERALD, 1), 25, 2, itemForEmeraldsMultiplier));
		trades.get(1).add((entity, random) -> new MerchantOffer(new ItemStack(BlockInit.SILTSTONE.asItem(), 24), new ItemStack(Items.EMERALD, 1), 25, 2, itemForEmeraldsMultiplier));
		trades.get(1).add((entity, random) -> new MerchantOffer(new ItemStack(BlockInit.CHALK.asItem(), 24), new ItemStack(Items.EMERALD, 1), 25, 2, itemForEmeraldsMultiplier));
		...
		trades.get(2).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(BlockInit.SANDSTONE.asItem()), 16, 5, emeraldForItemsMultiplier));
		trades.get(2).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(BlockInit.SILTSTONE.asItem()), 16, 5, emeraldForItemsMultiplier));
		trades.get(2).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 1), new ItemStack(BlockInit.CHALK.asItem()), 16, 5, emeraldForItemsMultiplier));
		...
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(BlockInit.SMALL_AMMONITE_FOSSIL.asItem()), 16, 5, emeraldForItemsMultiplier));
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(BlockInit.MEDIUM_AMMONITE_FOSSIL.asItem()), 16, 5, emeraldForItemsMultiplier));
		trades.get(3).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 3), new ItemStack(BlockInit.LARGE_AMMONITE_FOSSIL.asItem()), 16, 5, emeraldForItemsMultiplier));
		...
		trades.get(5).add((entity, random) -> new MerchantOffer(new ItemStack(Items.EMERALD, 6), new ItemStack(BlockInit.HENOSTONE.asItem()), 4, 8, rareItemForEmeraldsMultiplier));
