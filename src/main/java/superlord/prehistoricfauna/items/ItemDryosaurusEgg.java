...
import superlord.prehistoricfauna.entity.egg.EntityDryosaurusEgg;
...
public class ItemDryosaurusEgg extends ItemBase {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntityDryosaurusEgg entityegg = new EntityDryosaurusEgg(worldIn, playerIn);
