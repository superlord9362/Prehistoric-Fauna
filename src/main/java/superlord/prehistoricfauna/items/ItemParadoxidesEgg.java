...
import superlord.prehistoricfauna.entity.egg.EntityParadoxidesEgg;
import superlord.prehistoricfauna.init.ModItems;
import superlord.prehistoricfauna.tab.PFTabRegistry;
import superlord.prehistoricfauna.util.IHasModel;

public class ItemParadoxidesEgg extends Item implements IHasModel
{
    public ItemParadoxidesEgg(String name)
    {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityParadoxidesEgg entityegg = new EntityParadoxidesEgg(worldIn, playerIn);
