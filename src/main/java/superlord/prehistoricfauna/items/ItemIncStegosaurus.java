...
import superlord.prehistoricfauna.entity.egg.EntityIncStegosaurus;
...
public class ItemIncStegosaurus extends ItemBase {
    public ItemIncStegosaurus(String name) {
        super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntityIncStegosaurus entityegg = new EntityIncStegosaurus(worldIn, playerIn);
