...
import superlord.prehistoricfauna.entity.egg.EntityStegosaurusEgg;
...
public class ItemStegosaurusEgg extends ItemBase {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntityStegosaurusEgg entityegg = new EntityStegosaurusEgg(worldIn, playerIn);
