...
import superlord.prehistoricfauna.entity.egg.EntityIncBaryonyx;
...
public class ItemIncBaryonyx extends ItemBase {
    public ItemIncBaryonyx(String name) {
        super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntityIncBaryonyx entityegg = new EntityIncBaryonyx(worldIn, playerIn);
