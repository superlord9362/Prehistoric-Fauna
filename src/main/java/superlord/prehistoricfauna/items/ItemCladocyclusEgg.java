...
import superlord.prehistoricfauna.entity.egg.EntityCladocyclusEgg;
import superlord.prehistoricfauna.init.ModItems;
import superlord.prehistoricfauna.tab.PFTabRegistry;
import superlord.prehistoricfauna.util.IHasModel;

public class ItemCladocyclusEgg extends Item implements IHasModel
{
    public ItemCladocyclusEgg(String name)
    {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityCladocyclusEgg entityegg = new EntityCladocyclusEgg(worldIn, playerIn);
