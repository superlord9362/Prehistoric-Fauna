...
import superlord.prehistoricfauna.entity.egg.EntityBaryonyxEgg;
...
public class ItemBaryonyxEgg extends ItemBase {
    public ItemBaryonyxEgg(String name) {
        super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
        	EntityBaryonyxEgg entityegg = new EntityBaryonyxEgg(worldIn, playerIn);
