...
public class ItemIncDryosaurus extends ItemBase {
    public ItemIncDryosaurus(String name) {
        super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
        ...
        if (!worldIn.isRemote) {
            EntityIncDryosaurus entityegg = new EntityIncDryosaurus(worldIn, playerIn);
