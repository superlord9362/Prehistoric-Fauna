...
public class ServerConfig {
	...
	public final ForgeConfigSpec.IntValue protoceratopsSpawnWeight;
	public final ForgeConfigSpec.IntValue protoceratopsDunesSpawnWeight;
	public final ForgeConfigSpec.IntValue velociraptorSpawnWeight;
	public final ForgeConfigSpec.IntValue citipatiDunesSpawnWeight;
	public final ForgeConfigSpec.IntValue citipatiSpawnWeight;
	public final ForgeConfigSpec.IntValue velociraptorDuneSpawnWeight;
	public final ForgeConfigSpec.IntValue aepyornithomimusSpawnWeight;
	public final ForgeConfigSpec.IntValue aepyornithomimusDunesSpawnWeight;
	...
	public ServerConfig(final ForgeConfigSpec.Builder builder) {
		...
		this.potamoceratodusSpawnWeight = buildInt(builder, "Potamoceratodus Spawn Weight", "all", 3, 1, 300, "The weight of Potamoceratodus in vanilla's spawn rate. Default is 3");
		this.protoceratopsSpawnWeight = buildInt(builder, "Protoceratops Spawn Weight", "all", 4, 1, 300, "The weight of Protoceratops in the Djadochta Arroyo biome in vanilla's spawn rate. Default is 4");
		this.protoceratopsDunesSpawnWeight = buildInt(builder, "Protoceratops Dune Spawn Weight", "all", 7, 1, 300, "The weight of Protoceratops in the Djadochta Dunes biome in vanilla's spawn rate. Default is 7");
		this.velociraptorSpawnWeight = buildInt(builder, "Velociraptor Spawn Weight", "all", 3, 1, 300, "The weight of Velociraptor in the Djadochta Arroyo biome in vanilla's spawn rate. Default is 3");
		this.velociraptorDuneSpawnWeight = buildInt(builder, "Velociraptor Dune Spawn Weight", "all", 6, 1, 300, "The weight of Velociraptor in the Djadochta Dunes biome in vanilla's spawn rate. Default is 6");
		this.citipatiSpawnWeight = buildInt(builder, "Citipati Spawn Weight", "all", 5, 1, 300, "The weight of Citipati in the Djadochta Arroyo biome in vanilla's spawn rate. Default is 5");
		this.citipatiDunesSpawnWeight = buildInt(builder, "Citipati Dune Spawn Weight", "all", 5, 1, 300, "The weight of Citipati in the Djadochta Dunes biome in vanilla's spawn rate. Default is 5");
		this.aepyornithomimusSpawnWeight = buildInt(builder, "Aepyornithomimus Spawn Weight", "all", 12, 1, 300, "The weight of Aepyornithomimus in the Djadochta Arroyo biome in vanilla's spawn rate. Default is 12");
		this.aepyornithomimusDunesSpawnWeight = buildInt(builder, "Aepyornithomimus Dune Spawn Weight", "all", 2, 1, 300, "The weight of Aepyornithomimus in the Djadochta Dunes biome in vanilla's spawn rate. Default is 3");
