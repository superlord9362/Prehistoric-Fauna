...
public class PrehistoricFaunaConfig {
	...
	public static int protoceratopsSpawnWeight = 4;
	public static int protoceratopsDunesSpawnWeight = 7;
	public static int velociraptorSpawnWeight = 3;
	public static int citipatiDunesSpawnWeight = 5;
	public static int citipatiSpawnWeight = 5;
	public static int velociraptorDuneSpawnWeight = 7;
	public static int aepyornithomimusSpawnWeight = 12;
	public static int aepyornithomimusDunesSpawnWeight = 3;
	...
	public static void bakeServer(final ModConfig config) {
		try {
			...
			protoceratopsSpawnWeight = PFConfigHolder.SERVER.protoceratopsSpawnWeight.get();
			protoceratopsDunesSpawnWeight = PFConfigHolder.SERVER.protoceratopsDunesSpawnWeight.get();
			velociraptorDuneSpawnWeight = PFConfigHolder.SERVER.velociraptorDuneSpawnWeight.get();
			velociraptorSpawnWeight = PFConfigHolder.SERVER.velociraptorSpawnWeight.get();
			citipatiDunesSpawnWeight = PFConfigHolder.SERVER.citipatiDunesSpawnWeight.get();
			citipatiSpawnWeight = PFConfigHolder.SERVER.citipatiSpawnWeight.get();
			aepyornithomimusSpawnWeight = PFConfigHolder.SERVER.aepyornithomimusSpawnWeight.get();
			aepyornithomimusDunesSpawnWeight = PFConfigHolder.SERVER.aepyornithomimusDunesSpawnWeight.get();
