...
@OnlyIn(Dist.CLIENT)
public class TriassicPortalParticle extends SpriteTexturedParticle {

	private final double portalPosX;
	private final double portalPosY;
	private final double portalPosZ;

	public TriassicPortalParticle(World world, double xCoord, double yCoord, double zCoord, double xSpeed, double ySpeed, double zSpeed) {
	...
	public static class Factory implements IParticleFactory<BasicParticleType> {
		...
		public Particle makeParticle(BasicParticleType type, World world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
			TriassicPortalParticle portalParticle = new TriassicPortalParticle(world, x, y, z, xSpeed, ySpeed, zSpeed);
