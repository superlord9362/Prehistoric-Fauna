...
public class EntityVelociraptorEgg extends EntityThrowable {
    public EntityVelociraptorEgg(World worldIn) {
        super(worldIn);
    }

    public EntityVelociraptorEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityVelociraptorEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
