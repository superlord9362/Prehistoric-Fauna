package com.superlord.prehistoricfauna.entity.egg;
...
public class EntityIncubatedTriceratopsEgg extends EntityThrowable {
    public EntityIncubatedTriceratopsEgg(World worldIn) {
        super(worldIn);
    }

    public EntityIncubatedTriceratopsEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncubatedTriceratopsEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
    ...
    protected void onImpact(RayTraceResult result) {
        ...
        if (!this.world.isRemote) {
            ...
            EntityTriceratops entitychicken = new EntityTriceratops(this.world);
