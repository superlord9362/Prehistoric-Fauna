...
public class EntityCamarasaurusEgg extends EntityThrowable {
    public EntityCamarasaurusEgg(World worldIn) {
        super(worldIn);
    }

    public EntityCamarasaurusEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityCamarasaurusEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
