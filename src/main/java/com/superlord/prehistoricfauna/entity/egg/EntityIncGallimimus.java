...
public class EntityIncGallimimus extends EntityThrowable {
    public EntityIncGallimimus(World worldIn) {
        super(worldIn);
    }

    public EntityIncGallimimus(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityIncGallimimus(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
