...
public class EntityTyrannosaurusEgg extends EntityThrowable {
    public EntityTyrannosaurusEgg(World worldIn) {
        super(worldIn);
    }

    public EntityTyrannosaurusEgg(World worldIn, EntityLivingBase throwerIn) {
        super(worldIn, throwerIn);
    }

    public EntityTyrannosaurusEgg(World worldIn, double x, double y, double z) {
        super(worldIn, x, y, z);
    }
