...
import com.superlord.prehistoricfauna.entity.EntityDinoEgg;
import com.superlord.prehistoricfauna.entity.EntityIncTyrannosaurus;
...
public class ItemIncTyrannosaurus extends ItemBase
{
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityIncTyrannosaurus entityegg = new EntityIncTyrannosaurus(worldIn, playerIn);
