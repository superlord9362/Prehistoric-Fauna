...
public class ItemGallimimusEgg extends ItemBase
{
    public ItemGallimimusEgg(String name)
    {
    	super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        if (!worldIn.isRemote)
        {
            EntityGallimimusEgg entityegg = new EntityGallimimusEgg(worldIn, playerIn);
